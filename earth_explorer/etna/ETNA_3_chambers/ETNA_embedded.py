...
def chambers_3_Etna():
    ...
    rx_sin2 = 2552.7105 # location of points via trig functions -- gmsh doesn't appear to have these functions built in (change in future?)
    ry_cos2 = 1575.965
    ...
    rx_sin3 = 3896.68829 # location of points via trig functions -- gmsh doesn't appear to have these functions built in (change in future?)
    ry_cos3 = 4562.435794
    ...
    cx_d2_mid = 47974.9545
    cy_d2_mid = 55297.30575

    lc_if_lc3 = 30 # size at interface 
...
# 2nd chamber
    ...
    p72 =gmsh.model.geo.addPoint(cx_d2_mid+dx2, cy_d2_mid, dz_mid2, lc_if_mid2)
...
#lower conduit 
    ...
    p92 =gmsh.model.geo.addPoint(cx3, cy3-r4, cz3, lc_sides_c3)   
    ...
    p100 =gmsh.model.geo.addPoint(cx3, cy3, cz3+r3, lc_upper_c3) # top point   
    p101 =gmsh.model.geo.addPoint(cx3, cy3, cz3-r3, lc_bottom_c3)# bottom point
...
# DEEP CHAMBER - top connection to lower 3rd chamber -- 2nd dyke
    ...
    c140 = gmsh.model.geo.addEllipseArc(p92,p91,p100,p78)
    c141 = gmsh.model.geo.addEllipseArc(p93,p91,p100,p79)
    c142 = gmsh.model.geo.addEllipseArc(p94,p91,p100,p80)
    c143 = gmsh.model.geo.addEllipseArc(p95,p91,p100,p81)
    c144 = gmsh.model.geo.addEllipseArc(p96,p91,p100,p82)
    c145 = gmsh.model.geo.addEllipseArc(p97,p91,p100,p83)
    c146 = gmsh.model.geo.addEllipseArc(p98,p91,p100,p84)
    c147 = gmsh.model.geo.addEllipseArc(p99,p91,p100,p85)

# sides 

    c148 = gmsh.model.geo.addEllipseArc(p92,p91,p96,p93)
    c149 = gmsh.model.geo.addEllipseArc(p93,p91,p97,p94)
    c150 = gmsh.model.geo.addEllipseArc(p94,p91,p98,p95)
    c151 = gmsh.model.geo.addEllipseArc(p95,p91,p99,p96)
    c152 = gmsh.model.geo.addEllipseArc(p96,p91,p92,p97)
    c153 = gmsh.model.geo.addEllipseArc(p97,p91,p93,p98)
    c154 = gmsh.model.geo.addEllipseArc(p98,p91,p94,p99)
    c155 = gmsh.model.geo.addEllipseArc(p99,p91,p95,p92)


# bottom 

    c156 = gmsh.model.geo.addEllipseArc(p92,p91,p96,p101)
    c157 = gmsh.model.geo.addEllipseArc(p93,p91,p97,p101)
    c158 = gmsh.model.geo.addEllipseArc(p94,p91,p98,p101)
    c159 = gmsh.model.geo.addEllipseArc(p95,p91,p99,p101)
    c160 = gmsh.model.geo.addEllipseArc(p96,p91,p92,p101)
    c161 = gmsh.model.geo.addEllipseArc(p97,p91,p93,p101)
    c162 = gmsh.model.geo.addEllipseArc(p98,p91,p94,p101)
    c163 = gmsh.model.geo.addEllipseArc(p99,p91,p95,p101)
...
def execute():
    ...
    #gmsh.model.geo.synchronize()   
    gmsh.model.addPhysicalGroup(2, [v], 10)  # volume tag = 10
   # gmsh.model.addPhysicalGroup(2, [E_s1, E_s2, E_s3, E_s4, E_s5, E_s6, E_s7, E_s8], 4)   # hole boundaries tag = 4
    ...
    gmsh.model.addPhysicalGroup(2, [C_sl,C_s1, C_s2, C_s3, C_s4, C_s5, C_s6,C_s7,C_s8,C_s9, C_s10,C_s11,C_s12,C_s13,C_s14,C_s15,C_s16,C_s17,C_s18,C_s19,C_s20,C_s21,C_s22,C_s23,C_s24,C_s25,C_s26,C_s27,C_s28,C_s29,C_s30,C_s31,C_s32,C_s41,C_s42,C_s43,C_s44,C_s45,C_s46,C_s47,C_s48,C_s49,C_s50,C_s51,C_s52,C_s53,C_s54,C_s55,C_s56,C_s57,C_s58, C_s59,C_s60,C_s61,C_s62,C_s63,C_s64,C_s65,C_s66,C_s67,C_s68,C_s69,C_s70,C_s71,C_s72,C_s73,C_s74,C_s75,C_s76,C_s77,C_s78,C_s79,C_s80,C_s81,C_s82,C_s83,C_s84,C_s85,C_s86,C_s87,C_s88], 1)
