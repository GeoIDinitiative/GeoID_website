    ...
    const manifest = window.__neptuneViewerManifest;
    ...
    const labelData = [{"name":"Great Dark Spot","type":"Dark vortex","lat":-22.0,"lon":210.0,"theme":"storm","description":"Representative location for Neptune's large dark vortex systems observed by Voyager 2 and later monitoring."},{"name":"Scooter Cloud","type":"Bright methane cloud","lat":-42.0,"lon":150.0,"theme":"storm","description":"A bright fast-moving methane cloud feature associated with Neptune's dynamic weather."},{"name":"South Polar Band","type":"Polar atmosphere","lat":-70.0,"lon":260.0,"theme":"polar","description":"Representative high-latitude southern atmosphere and cloud structure."},{"name":"North Polar Haze","type":"Polar haze","lat":68.0,"lon":30.0,"theme":"polar","description":"A northern high-latitude haze region in enhanced atmospheric views."},{"name":"Equatorial Zone","type":"Cloud zone","lat":0.0,"lon":0.0,"theme":"band","description":"A broad equatorial cloud zone shaped by high-speed winds."},{"name":"Southern Mid-Latitude Belt","type":"Cloud belt","lat":-35.0,"lon":95.0,"theme":"band","description":"A southern mid-latitude belt where bright methane clouds and darker bands recur."},{"name":"Northern Mid-Latitude Belt","type":"Cloud belt","lat":35.0,"lon":285.0,"theme":"band","description":"A representative northern band used for orientation in the cloud-top texture."},{"name":"Voyager 2 Closest Approach","type":"Mission corridor","lat":-30.0,"lon":45.0,"theme":"landing","description":"Representative encounter region for Voyager 2's 1989 Neptune flyby."}];
    const ringLabelData = [{"name":"Galle Ring","type":"Diffuse inner ring","theme":"ring","description":"Galle Ring in the inner ring of the planet.","ring_region":"Inner ring","ring_radius_km":"~41,900 km from Neptune center","ring_anchor":[4.5315,0,2.1131],"ring_label":[4.9394,0.18,2.3033],"ring_line_end":[4.7309,0.12,2.2061]},{"name":"Le Verrier Ring","type":"Narrow ring","theme":"ring","description":"Le Verrier Ring in the middle ring of the planet.","ring_region":"Middle ring","ring_radius_km":"~53,200 km from Neptune center","ring_anchor":[-1.6047,0,5.9887],"ring_label":[-1.7211,0.18,6.4234],"ring_line_end":[-1.6616,0.12,6.2012]},{"name":"Lassell Ring","type":"Diffuse sheet","theme":"ring","description":"Lassell Ring in the broad diffuse ring of the planet.","ring_region":"Broad diffuse ring","ring_radius_km":"~53,200-57,200 km from Neptune center","ring_anchor":[-6.4717,0,1.7341],"ring_label":[-6.9064,0.18,1.8506],"ring_line_end":[-6.6842,0.12,1.791]},{"name":"Arago Ring","type":"Narrow ringlet","theme":"ring","description":"Arago Ring in the outer ringlet of the planet.","ring_region":"Outer ringlet","ring_radius_km":"~57,200 km from Neptune center","ring_anchor":[-5.0912,0,-5.0912],"ring_label":[-5.4094,0.18,-5.4094],"ring_line_end":[-5.2467,0.12,-5.2467]},{"name":"Adams Ring Arcs","type":"Arc-bearing ring","theme":"ring","description":"Adams Ring Arcs in the outer main ring of the planet.","ring_region":"Outer main ring","ring_radius_km":"~62,900 km from Neptune center","ring_anchor":[4.5886,0,-6.5532],"ring_label":[4.8467,0.18,-6.9218],"ring_line_end":[4.7148,0.12,-6.7334]}];
    const moonData = [{"name":"Triton","type":"Major moon","theme":"moon","description":"Neptune's largest moon, a captured Kuiper Belt object with nitrogen geysers and retrograde orbit.","moon_anchor":[7.8,0.1,5.8],"moon_radius":0.135,"moon_label_lift":0.255,"moon_color":"#d7c7b9","mean_radius_km":"1,353 km","orbit_distance_km":"~354,800 km","texture_source_url":null},{"name":"Proteus","type":"Inner moon","theme":"moon","description":"A dark irregular inner moon and one of Neptune's largest regular satellites.","moon_anchor":[-8.8,-0.06,6.6],"moon_radius":0.07,"moon_label_lift":0.19,"moon_color":"#5c5853","mean_radius_km":"210 km","orbit_distance_km":"~117,600 km","texture_source_url":null},{"name":"Nereid","type":"Irregular moon","theme":"moon","description":"A distant eccentric-orbit moon discovered before the Voyager encounter.","moon_anchor":[-12.4,0.12,-8.0],"moon_radius":0.052,"moon_label_lift":0.172,"moon_color":"#8b8174","mean_radius_km":"170 km","orbit_distance_km":"~5,513,400 km","texture_source_url":null},{"name":"Larissa","type":"Inner moon","theme":"moon","description":"A small dark inner moon orbiting near Neptune's rings.","moon_anchor":[9.8,-0.08,-7.6],"moon_radius":0.044,"moon_label_lift":0.164,"moon_color":"#615d58","mean_radius_km":"97 km","orbit_distance_km":"~73,500 km","texture_source_url":null},{"name":"Galatea","type":"Inner moon","theme":"moon","description":"An inner moon whose gravity helps confine structure in Neptune's ring arcs.","moon_anchor":[6.2,0.05,-8.4],"moon_radius":0.038,"moon_label_lift":0.158,"moon_color":"#6a6660","mean_radius_km":"88 km","orbit_distance_km":"~62,000 km","texture_source_url":null}];
    const NEPTUNE_EQUATORIAL_RADIUS_KM = 24764;
    ...
    const moonFeatureData = [{"name":"Triton South Polar Cap","type":"Nitrogen frost cap","theme":"moon","moon_name":"Triton","lat":-75.0,"lon":25.0,"description":"A bright volatile frost region on Triton's south polar terrain."},{"name":"Triton Geyser Province","type":"Plume source region","theme":"moon","moon_name":"Triton","lat":-50.0,"lon":300.0,"description":"Representative terrain for dark plume streaks seen by Voyager 2."},{"name":"Cipango Planum","type":"Canteloupe terrain","theme":"moon","moon_name":"Triton","lat":20.0,"lon":55.0,"description":"A named region associated with Triton's distinctive tectonic terrain."},{"name":"Proteus Cratered Terrain","type":"Impact terrain","theme":"moon","moon_name":"Proteus","lat":0.0,"lon":120.0,"description":"Representative old cratered terrain on Proteus."},{"name":"Nereid Reference Meridian","type":"Reference sector","theme":"moon","moon_name":"Nereid","lat":0.0,"lon":0.0,"description":"A representative orientation marker for Nereid in the moon viewer."}];
    const allFeatureData = [...labelData, ...ringLabelData, ...moonData, ...moonFeatureData];
    const TOUR_FACETS = [
      { id: "highlights", label: "Highlights", filter: (item) => ["Great Dark Spot", "Scooter Cloud", "Voyager 2 Closest Approach", "Triton", "Proteus", "Adams Ring Arcs"].includes(item.name) },
      ...
      { id: "mission", label: "Mission", filter: (item) => item.theme === "landing" || /voyager|juno|galileo|pioneer/i.test(`${item.name} ${item.description || ""}`) },
    ];
    ...
    function exportCurrentProfilePng() {
      ...
      const baseName = String(currentProfilePlotState.title || "neptune_elevation_profile")
        .toLowerCase()
        .replace(/[^a-z0-9]+/g, "_")
        .replace(/^_+|_+$/g, "") || "neptune_elevation_profile";
    ...
    const NEPTUNE_MEAN_RADIUS_KM = MARS_MEAN_RADIUS_KM;
    let activeCameraFlight = null;
    const neptuneViewModeSelect = document.getElementById("neptune-view-mode");
    ...
    function updateScaleReadout(camera, renderer, controls) {
      ...
      const kmPerWorldUnit = NEPTUNE_MEAN_RADIUS_KM / NEPTUNE_SCENE_RADIUS;
    ...
    function updateCenterReadout(camera, globe, marsGroup) {
      ...
      const point = direction.multiplyScalar(-1).normalize();
      const latLon = vectorToLatLon(point);
      if (hemisphereLocatorReadout) {
        hemisphereLocatorReadout.textContent = `Center ${latLon.lat.toFixed(1)}°, ${latLon.lon.toFixed(1)}°E`;
      }
      if (
    ...
    function configureNeptuneUi() {
      if (brandLogo) {
        brandLogo.src = "../../assets/neptune_icon.png";
      }
      ...
      if (basemapSection) {
        ...
        if (copy) copy.textContent = "Use this group for Neptune's body texture and derived atmospheric analysis layers.";
      }
      ...
      if (geologySection) {
        ...
        if (geologySummary) geologySummary.textContent = "Hide Neptune's upper atmospheric shells in core view.";
        ...
        if (compactCopy) compactCopy.textContent = "Remove the upper atmosphere and surface maps in both exterior and core views, while keeping Neptune\'s deeper interior and rings visible.";
      ...
      if (neptuneViewModeSelect) neptuneViewModeSelect.value = "tilted";
    }
    configureNeptuneUi();
    ...
    function greatCircleDistanceKm(a, b) {
      ...
      return 2 * MARS_MEAN_RADIUS_KM * Math.asin(Math.min(1, Math.sqrt(hav)));
    }
    ...
    function sphericalPolygonAreaKm2(points) {
      ...
      return Math.abs(excess) * (MARS_MEAN_RADIUS_KM ** 2);
    }
    ...
    function inferLayerMeta(layer, context = "base") {
      ...
      if (context === "seismic") {
        return {
          badge: "Derived",
          help: "Neptune does not include a Mars-style seismic event overlay in this package.",
    ...
    function buildLegendEntries(baseLayers, geologyLayers, mineralLayers, geologyInteractiveState = null) {
      ...
      if (seismicActive) {
        entries.push({
          ...
          copy: "No seismic symbology is active for Neptune in this package.",
          tags: ["seismic", "measure"],
          symbols: [
            {
              type: "ring",
              label: "Catalog placeholder",
              detail: "No active seismic markers are rendered for Neptune.",
            },
            {
              type: "dot",
              label: "No located events",
              detail: "Neptune has no bundled seismic source-location catalog in this workflow.",
            },
            {
              type: "line",
    ...
    function buildMetadataState(baseLayers, geologyLayers, mineralLayers, geologyInteractiveState = null) {
      ...
      if (seismicActive) {
        pushActiveLayer(
          ...
          "seismic",
          selectedBaseLayer,
          `No active seismic catalog is used for Neptune in this workflow.`,
        );
      }
      if (coreEnabled) {
        pushActiveLayer(
          ...
          "core",
          selectedBaseLayer,
          "Interior layers are a schematic Neptune model inferred from gravity, magnetic-field, and ring-seismology studies.",
        );
      }
      ...
      if (
        ...
        sourceEntries.push({
          ...
          copy: "Use the source pages below for the enhanced atmosphere layer and related Neptune context references.",
          citation: manifest.sources.geology_original_units_citation || "",
          links: [
            makeMetadataLink("Neptune facts", manifest.sources.geology_notes_url),
      ...
      if (seismicActive && manifest.seismic?.source_page_url) {
        sourceEntries.push({
          ...
          copy: "No Mars-style seismic catalog is used for this Neptune workflow.",
          links: [makeMetadataLink("Catalog source", manifest.seismic.source_page_url)].filter(Boolean),
        });
      }
      sourceEntries.push({
        title: "Neptune audio",
        copy: "No local Neptune radio-emission audio asset is included in this folder; the playback control is preserved for UI consistency.",
        links: [],
      });
      sourceEntries.push({
    ...
    function getMoonViewerMinDistance(feature) {
      const radius = Number(feature?.moon_radius || 0.1);
      return THREE.MathUtils.clamp(radius * 2.4, 0.2, 0.45);
    }
    ...
    function activateMoonViewer(feature, camera, controls) {
      if (!isMoonFeature(feature) || !neptuneSceneGroup) {
        return;
      }
      ...
      const target = neptuneSceneGroup.localToWorld(localTarget.clone());
      ...
      app.innerHTML = `
        <div class="webgl-fallback">
          <div class="webgl-fallback-card">
            ...
            <h2 style="margin:0 0 0.6rem;">Neptune viewer could not start.</h2>
    ...
    function findFeatureByName(name) {
      ...
      return allFeatureData.find((item) => item.name.toLowerCase() === needle)
        || allFeatureData.find((item) => item.name.toLowerCase().includes(needle));
    }
    ...
    // Neptune surface-conditions estimation helpers
    const _SUN_DIR = new THREE.Vector3(8, 4, 6).normalize();
    function estimateNeptuneCloudTopTemp(latDeg) {
      // Neptune cloud tops at 1 bar: ~-178°C at equator, colder toward poles
    ...
    function _neptuneInteriorInterp(pts, rFrac) {
    ...
    function neptuneInteriorLayerName(rFrac) {
      for (const layer of NEPTUNE_INTERIOR_LAYERS) {
    ...
    function neptuneInteriorPressureColor(gpa) {
    ...
    function focusSearchedFeature(feature, camera, controls, options = {}) {
      ...
      moveCameraToFeature(feature, camera, controls, options);
    ...
    function moveCameraToFeature(feature, camera, controls, options = {}) {
      ...
      if (parentMoon) {
        const lat = feature.lat !== undefined ? feature.lat : feature.anchor_lat;
        const lon = feature.lon !== undefined ? feature.lon : feature.anchor_lon;
        if (!parentMoon || !neptuneSceneGroup || !Array.isArray(parentMoon.moon_anchor) || lat === undefined || lon === undefined) {
          return;
        }
        ...
        const moonAnchor = new THREE.Vector3(parentMoon.moon_anchor[0], parentMoon.moon_anchor[1], parentMoon.moon_anchor[2]);
        const targetLocal = latLonToVector3(lat, lon, Number(parentMoon.moon_radius || 0.1) + 0.002).add(moonAnchor);
        const target = neptuneSceneGroup.localToWorld(targetLocal.clone());
        const moonCenter = neptuneSceneGroup.localToWorld(moonAnchor.clone());
        const direction = target.clone().sub(moonCenter).normalize();
        if (direction.lengthSq() < 0.0001) {
          direction.set(0.55, 0.18, 1).normalize();
        }
        const cameraPos = target.clone().addScaledVector(direction, getMoonViewerDistance(parentMoon));
        if (options.animate) {
          animateCameraFlight(camera, controls, cameraPos, target, options.durationMs || 1800);
        } else {
      ...
      if (Array.isArray(feature.ring_anchor)) {
        ...
        if (neptuneSceneGroup) {
          target = neptuneSceneGroup.localToWorld(target.clone());
        }
      ...
      if (options.animate) {
        if (options.isTour && !Array.isArray(feature.ring_anchor)) {
          animateTourFlight(camera, controls, cameraPosition, target, 2800);
        } else {
          animateCameraFlight(camera, controls, cameraPosition, target, options.durationMs || 1800);
        }
      } else {
    ...
    function reloadToDefaultGlobalView(camera, controls) {
      ...
      viewerApplyNeptuneViewMode?.(neptuneViewModeSelect ? neptuneViewModeSelect.value : "tilted");
      controls.saveState();
    }
    ...
    function openFeature(feature, isCoreLabel) {
      ...
      if (feature.moon_name && feature.lat !== undefined) {
        const elevStr = (feature.elevation_m !== undefined)
          ...
          : "";
        scenePopupMeta.textContent = `${feature.moon_name} | ${feature.lat.toFixed(2)}°, ${feature.lon.toFixed(2)}°E${elevStr}`;
        ...
        scenePopupMeta.textContent = `${feature.moon_name} | ${feature.anchor_lat.toFixed(2)}°, ${feature.anchor_lon.toFixed(2)}°E`;
    ...
    function buildCutawayInterior(radius, layerData, elevationMap, terrainRelief) {
      ...
      const innerCoreMesh = new THREE.Mesh(
        new THREE.SphereGeometry(radius * NEPTUNE_HEAVY_CORE_RADIUS, 96, 96, phiStart, phiLength),
      ...
      const outerCoreMesh = new THREE.Mesh(
        new THREE.SphereGeometry(radius * NEPTUNE_METALLIC_HYDROGEN_RADIUS, 128, 128, phiStart, phiLength),
        new THREE.ShaderMaterial({
          uniforms: {},
          vertexShader: LAYER_VERT,
      ...
      const mantleMesh = new THREE.Mesh(
        new THREE.SphereGeometry(radius * NEPTUNE_MOLECULAR_ENVELOPE_RADIUS, 128, 128, phiStart, phiLength),
        new THREE.ShaderMaterial({
          uniforms: {},
          vertexShader: LAYER_VERT,
      ...
      const mantleInnerBoundaryMesh = new THREE.Mesh(
        new THREE.SphereGeometry(radius * (NEPTUNE_METALLIC_HYDROGEN_RADIUS + 0.002), 128, 128, phiStart, phiLength),
        new THREE.ShaderMaterial({
          uniforms: {},
          vertexShader: LAYER_VERT,
          fragmentShader: MANTLE_FRAG,
      ...
      const CAP_X = -0.012;
      const crustInnerRadius = radius * NEPTUNE_MOLECULAR_ENVELOPE_RADIUS;
      ...
      const capDefs = [
        ...
        { outer: crustInnerRadius, inner: radius * NEPTUNE_METALLIC_HYDROGEN_RADIUS,  fragmentShader: MANTLE_SECTION_FRAG },  // molecular envelope ring
        { outer: radius * NEPTUNE_METALLIC_HYDROGEN_RADIUS,  inner: radius * NEPTUNE_HEAVY_CORE_RADIUS,  fragmentShader: CORE_SECTION_FRAG },  // metallic hydrogen ring
      ];
      let crustRing = null;
      ...
      const fluidCapDisk = new THREE.Mesh(
        new THREE.CircleGeometry(radius * NEPTUNE_METALLIC_HYDROGEN_RADIUS, 128),
        fluidCapMat,
      );
      ...
      const innerCapDisk = new THREE.Mesh(
        new THREE.CircleGeometry(radius * NEPTUNE_HEAVY_CORE_RADIUS, 96),
        innerCapMat,
      );
    ...
    function buildNeptuneSolidInterior(radius) {
      const group = new THREE.Group();
      const CAP_X = -0.0006;
    ...
    function getMoonOccluders() {
      if (!neptuneSceneGroup || !Array.isArray(moonData) || moonData.length === 0) {
        return [];
      }
      const scale = neptuneSceneGroup.scale;
      ...
      return moonData
        ...
        .map((item) => ({
          name: item.name,
          center: neptuneSceneGroup.localToWorld(new THREE.Vector3(
            item.moon_anchor[0],
            item.moon_anchor[1],
            item.moon_anchor[2],
          )),
    ...
    function buildMoonFeatureLabelLayer() {
      ...
      const entries = [];
      const interactiveObjects = [];
      const markerGeometry = new THREE.SphereGeometry(0.0026, 10, 10);
      const hitGeometry = new THREE.SphereGeometry(0.028, 12, 12);
      const hitMaterial = new THREE.MeshBasicMaterial({
        transparent: true,
        opacity: 0.01,
        depthTest: false,
      ...
      for (const item of moonFeatureData) {
        ...
        const anchor = latLonToVector3(lat, lon, moonRadius + 0.003).add(moonAnchor);
        const hitPoint = latLonToVector3(lat, lon, moonRadius + 0.04).add(moonAnchor);
        const surfacePoint = latLonToVector3(lat, lon, moonRadius).add(moonAnchor);
        ...
        const labelDistance = 0.055;
        const labelPos = anchor.clone().addScaledVector(normal, 0.018).addScaledVector(direction, labelDistance);
        ...
        const label = makeLabelTexture(item, { theme: "volcanic" });
        const sprite = new THREE.Sprite(new THREE.SpriteMaterial({
          map: label.texture,
          transparent: true,
          opacity: 0.92,
        ...
        sprite.renderOrder = MOON_LABEL_RENDER_ORDER;
        sprite.scale.set((label.width / 200) * 0.10, (label.height / 200) * 0.10, 1);
        sprite.position.copy(labelPos);
        sprite.userData.feature = item;
        group.add(sprite);
        ...
        interactiveObjects.push(hitTarget, marker, sprite);
        entries.push({ item, parentMoon, moonAnchor, marker, hitTarget, sprite, line, surfacePoint, relMarkerPos, relHitPos, relSurfacePoint, relLabelPos, category, priority: 5 });
      }
    ...
    async function init() {
      const startup = window.__neptuneViewerStartup;
      ...
      neptuneSceneGroup = marsGroup;
      scene.add(marsGroup);
      scene.add(buildStarfield(THREE));
      scene.add(buildSunObject());

      setStatus("Loading Neptune textures...");
      const textureLoader = new THREE.TextureLoader();
      const [seismicCatalog, geologyFeatureCatalog] = await Promise.all([
        loadJsonSafe(manifest.seismic ? manifest.seismic.path : ""),
        loadJsonSafe(manifest.geology_interactive ? manifest.geology_interactive.feature_path : ""),
      ]);
      const geologyInteractiveState = geologyFeatureCatalog
        ? {
            width: geologyFeatureCatalog.width || 4096,
            height: geologyFeatureCatalog.height || 2048,
            features: geologyFeatureCatalog.features || {},
            featureList: Object.values(geologyFeatureCatalog.features || {}),
            unit_legend: geologyFeatureCatalog.unit_legend || [],
            rock_legend: geologyFeatureCatalog.rock_legend || [],
            contacts: geologyFeatureCatalog.contacts || [],
            structures: geologyFeatureCatalog.structures || [],
            landing_sites: geologyFeatureCatalog.landing_sites || [],
          }
        : null;
      ...
      const baseLayers = manifest.layers || [{
        ...
        description: "Derived Neptune body texture separated from the rings.",
      }];
      const baseTextureResults = await Promise.all(
        baseLayers.map((layer) => loadTextureSafe(textureLoader, layer.path)),
      );
      const moonTextureEntries = await Promise.all(
        moonData.map(async (item) => [item.name, await loadTextureSafe(textureLoader, MOON_VIEWER_TEXTURES[item.name] || "")]),
      );
      const moonTextures = new Map();
      for (const [name, texture] of moonTextureEntries) {
        if (texture) {
          texture.colorSpace = THREE.SRGBColorSpace;
        }
        moonTextures.set(name, texture || null);
      }
      for (let index = 0; index < baseLayers.length; index += 1) {
        const texture = applyTextureTransforms(baseTextureResults[index], baseLayers[index]);
        if (texture) {
          texture.colorSpace = THREE.SRGBColorSpace;
        }
      ...
      const [elevationMap, ...overlayMaps] = await Promise.all([
        ...
        ...geologyLayers.map((layer) => loadTextureSafe(textureLoader, layer.path)),
        ...mineralLayers.map((layer) => loadTextureSafe(textureLoader, layer.path)),
      ]);
      ...
      const initialLayer = baseLayers.find((layer) => layer.label === "Neptune Body")
      ...
      const neptuneConfig = manifest.neptune || {};
      ...
      const ringsConfig = neptuneConfig.rings || null;
      let ringMaterial = null;
      if (ringsConfig && ringsConfig.path) {
        const ringTexture = await loadTextureSafe(textureLoader, ringsConfig.path);
        if (ringTexture) {
          ringTexture.colorSpace = THREE.SRGBColorSpace;
          ringTexture.wrapS = THREE.ClampToEdgeWrapping;
          ringTexture.wrapT = THREE.ClampToEdgeWrapping;
          // Optional centered UV scaling for ring texture atlases.
          // Keep defaults neutral so rings remain visible even without tuned manifest values.
          ...
          const ringMesh = new THREE.Mesh(
            new THREE.RingGeometry(innerRadius, outerRadius, 256),
            ringMaterial,
          );
      ...
      const NEPTUNE_UPPER_FACE_MAT = new THREE.ShaderMaterial({
        uniforms: {
      ...
      if (cutawayResult.metallicHydrogenCapMesh) cutawayResult.metallicHydrogenCapMesh.material = NEPTUNE_MH_FLAT;
      if (cutawayResult.metallicHydrogenRing) cutawayResult.metallicHydrogenRing.material = NEPTUNE_MH_FLAT;
      if (cutawayResult.heavyElementCoreMesh) cutawayResult.heavyElementCoreMesh.material = NEPTUNE_HC_MAT;
      if (cutawayResult.heavyElementCoreCapMesh) cutawayResult.heavyElementCoreCapMesh.material = NEPTUNE_HC_FLAT;
      const neptuneSolidInterior = buildNeptuneSolidInterior(3.2);
      const neptuneSolidInteriorGroup = neptuneSolidInterior.group;
      marsGroup.add(neptuneSolidInteriorGroup);
      const neptuneInteriorSphereMaterials = [
        neptuneSolidInterior.metallicHydrogenMaterial,
        neptuneSolidInterior.heavyElementCoreMaterial,
      ].filter(Boolean);
      const neptuneInteriorCapMaterials = [
        neptuneSolidInterior.metallicHydrogenCapMaterial,
        neptuneSolidInterior.heavyElementCoreCapMaterial,
      ].filter(Boolean);
      const neptuneBodyScaleY = Number(neptuneConfig.body_scale_y || 0.902);
      const neptuneAxialTiltDeg = Number(neptuneConfig.axial_tilt_deg || 26.7);
      marsGroup.scale.set(1, neptuneBodyScaleY, 1);
      const applyNeptuneViewMode = (mode = "tilted", resetCamera = false) => {
        const tiltRad = mode === "untilted"
          ? 0
          : THREE.MathUtils.degToRad(neptuneAxialTiltDeg);
      ...
      viewerApplyNeptuneViewMode = applyNeptuneViewMode;
      applyNeptuneViewMode(neptuneViewModeSelect ? neptuneViewModeSelect.value : "tilted");
      ...
      function updateSeismicTimelineReadout() {
        ...
        if (!seismicTimelineEvents.length || cutoff === null) {
          seismicTimelineReadout.textContent = "No seismic timeline is available for Neptune.";
          return;
        }
    ...
    function isObjectActuallyVisible(object) {
      ...
      function exportCurrentMeasurementCsv() {
        ...
        if (measureMode === "distance" && measurePoints.length >= 2) {
          ...
          downloadCsv("neptune_distance_measurement.csv", [
        ...
        if (measureMode === "area" && measurePoints.length >= 3) {
          ...
          downloadCsv("neptune_area_measurement.csv", rows);
          return;
        }
        if (measureMode === "profile" && measureProfileSamples.length >= 2) {
          ...
          downloadCsv("neptune_profile_measurement.csv", rows);
        }
      }
      ...
      function getActiveMeasureContext() {
        if (activeMoonViewerFeature) {
          return getMoonMeasureContext(); // null if lookup fails — no Neptune fallback in moon viewer
        }
      ...
      function normalizeMeasureHitLocalPoint(localPoint, context) {
        ...
        // measurement overlay with Neptune so markers and area vertices stay locked.
      ...
      function intersectExposedNeptuneInteriorSurface(clientX, clientY) {
        const rect = renderer.domElement.getBoundingClientRect();
        pointer.x = ((clientX - rect.left) / rect.width) * 2 - 1;
        pointer.y = -(((clientY - rect.top) / rect.height) * 2 - 1);
        raycaster.setFromCamera(pointer, camera);
        const exposedTargets = [
          neptuneSolidInterior?.metallicHydrogenMesh,
          neptuneSolidInterior?.heavyElementCoreMesh,
        ...
        return { ...hit, localPoint, lat: latLon.lat, lon: latLon.lon, context: { kind: "neptune-interior-surface" } };
      }
      ...
      function intersectMeasurementSurface(clientX, clientY) {
        ...
        const latLon = vectorToLatLonInMeasureContext(localPoint, context);
      ...
      function addMeasureMarker(point, index) {
        ...
        const spriteScale = isMoon ? markerRadius * 4 : 0.18;
        labelSprite.scale.set(spriteScale, spriteScale, 1);
        // Offset outward from globe centre so label sits just above the dot
        const outDir = markerPos.clone().normalize();
        labelSprite.position.copy(markerPos).addScaledVector(outDir, isMoon ? markerRadius * 2.5 : 0.14);
      ...
      function updateMeasureVisualization() {
        ...
        if (measureMode === "distance" && measurePoints.length >= 2) {
          const distanceKm = greatCircleDistanceKm(measurePoints[0], measurePoints[1]);
          const body = measurePoints[0].bodyName || "Neptune";
          ...
          profileCanvas.hidden = true;
          showProfileModal(
            `${measurePoints[0].bodyName || "Neptune"} Elevation Profile`,
      ...
      function applyNeptuneAtmosphereRemoval() {
        ...
        neptuneSolidInteriorGroup.visible = removeAtmosphere && !coreEnabled;
        if (neptuneSolidInterior.metallicHydrogenCapMesh) {
          neptuneSolidInterior.metallicHydrogenCapMesh.visible = false;
        }
        if (neptuneSolidInterior.heavyElementCoreCapMesh) {
          neptuneSolidInterior.heavyElementCoreCapMesh.visible = false;
        }
        for (const material of neptuneInteriorSphereMaterials) {
          material.clippingPlanes = [];
          material.needsUpdate = true;
        }
        for (const material of neptuneInteriorCapMaterials) {
          material.clippingPlanes = [];
          material.needsUpdate = true;
        }
        if (baseMaterial) {
      ...
      seismicMagnitudeMin.addEventListener("input", () => {
        ...
        seismicMagnitudeCopy.textContent = minMagnitude <= 0
          ? "No seismic magnitude filtering is available for Neptune."
      ...
      if (neptuneViewModeSelect) {
        neptuneViewModeSelect.addEventListener("change", () => {
          resetExploreView(camera, controls);
          applyNeptuneViewMode(neptuneViewModeSelect.value);
        });
      }
      ...
      renderer.domElement.addEventListener("pointermove", (event) => {
        ...
        if (!coreToggle.checked) {
          ...
          if (surfaceHit) {
            ...
            cursorReadout.textContent = `${latLon.lat.toFixed(2)}°, ${latLon.lon.toFixed(2)}°E`;
            if (scTemp && scPressure) {
              if (surfaceHit.context?.kind === "moon") {
              ...
              } else if (surfaceHit.context?.kind === "neptune-interior-surface") {
                const local = surfaceHit.localPoint || marsGroup.worldToLocal(surfaceHit.point.clone());
                const rFrac = Math.max(0, Math.min(1, local.length() / NEPTUNE_SCENE_RADIUS));
                const layerName = neptuneInteriorLayerName(rFrac);
                const tempC = neptuneInteriorTempC(rFrac);
                const pGPa = neptuneInteriorPressureGPa(rFrac);
                scTemp.textContent = `${tempC > 0 ? "+" : ""}${tempC.toLocaleString()} °C`;
                scTemp.style.color = neptuneInteriorTempColor(tempC);
                scPressure.textContent = formatPressureGPa(pGPa);
                scPressure.style.color = neptuneInteriorPressureColor(pGPa);
                if (scContext) scContext.textContent = `LAYER: ${layerName.toUpperCase()} (SURFACE)`;
              } else {
                const tempC = estimateNeptuneCloudTopTemp(latLon.lat);
                const pressurePa = estimateNeptuneCloudTopPressure();
                ...
                if (scContext) scContext.textContent = "NEPTUNE CLOUD TOPS";
              }
            }
          } else {
            cursorReadout.hidden = true;
          ...
          if (activeCutClipPlane && icDepth) {
            ...
            if (coreGlobeHit) {
              ...
              if (signedDistance >= 0) {
                ...
                const tempC = estimateNeptuneCloudTopTemp(latLon.lat);
                const pPa = estimateNeptuneCloudTopPressure();
                const pGPa = pPa / 1e9;
                icDepth.textContent = "0 km";
                icLayer.textContent = "Upper Atmosphere (surface)";
                icLayer.style.color = neptuneInteriorLayerColor("Upper Atmosphere");
                icTemp.textContent = `${tempC > 0 ? "+" : ""}${tempC.toLocaleString()} °C`;
                icTemp.style.color = neptuneInteriorTempColor(tempC);
                icPressure.textContent = formatPressureGPa(pGPa);
                icPressure.style.color = neptuneInteriorPressureColor(pGPa);
                return;
              }
            }
            ...
            if (visibleSurfaceHit && !removeAtmosphereActive) {
              ...
              icLayer.style.color = neptuneInteriorLayerColor(layerName);
              icTemp.textContent = `${tempC > 0 ? "+" : ""}${tempC.toLocaleString()} °C`;
              icTemp.style.color = neptuneInteriorTempColor(tempC);
              icPressure.textContent = formatPressureGPa(pGPa);
              icPressure.style.color = neptuneInteriorPressureColor(pGPa);
            ...
            if (raycaster.ray.intersectPlane(activeCutClipPlane, coreHit)) {
              ...
              const rScene = localHit.length();
              const GLOBE_R = 3.2;
              const NEPTUNE_R_KM = 24764;
              if (rScene <= GLOBE_R) {
                const rFrac = rScene / GLOBE_R;
                const depthKm = Math.round((1.0 - rFrac) * NEPTUNE_R_KM);
                const layerName = neptuneInteriorLayerName(rFrac);
                const tempC = neptuneInteriorTempC(rFrac);
                const pGPa = neptuneInteriorPressureGPa(rFrac);
                icDepth.textContent = `${depthKm.toLocaleString()} km`;
              ...
              if (coreSurfaceHit) {
                ...
                if (removeAtmosphereActive) {
                  const rFrac = NEPTUNE_EXPOSED_INTERIOR_RFRAC;
                  const depthKm = Math.round((1.0 - rFrac) * 60268);
                  const layerName = neptuneInteriorLayerName(rFrac);
                  const tempC = neptuneInteriorTempC(rFrac);
                  const pGPa = neptuneInteriorPressureGPa(rFrac);
      ...
      async function runEmbeddedSmokeTest() {
        ...
        try {
          let state = window.__neptuneViewerDebug.getState();
          assert(state.solidGeology === true, "Solid geology should load enabled by default.");

          const feature = window.__neptuneViewerDebug.openFeatureAtViewport(0.5, 0.5);
          ...
          state = window.__neptuneViewerDebug.getState();
          assert(state.selectedOutlineVisible === true, "Selected geology outline should be visible.");

          window.__neptuneViewerDebug.setToggle("geology-toggle", false);
          window.__neptuneViewerDebug.setToggle("geology-contacts-toggle", true);
          window.__neptuneViewerDebug.setToggle("geology-structures-toggle", true);
          state = window.__neptuneViewerDebug.getState();
          ...
          const radiusBefore = window.__neptuneViewerDebug.getFirstLineRadius("contacts");
          assert(radiusBefore !== null, "Expected a visible contact line sample radius.");
          window.__neptuneViewerDebug.setTerrainRelief(0.2);
          await new Promise((resolve) => setTimeout(resolve, 250));
          const radiusAfter = window.__neptuneViewerDebug.getFirstLineRadius("contacts");
          assert(radiusAfter !== null && Math.abs(radiusAfter - radiusBefore) > 1e-4, "Contact linework should move with terrain relief.");

          window.__neptuneViewerDebug.setToggle("core-toggle", true);
          state = window.__neptuneViewerDebug.getState();
...
${error && error.message ? error.message : error}`;
      ...
      // Globe completes one rotation every 120,000 ms; Neptune's real sidereal day is 10.6566 h.
      const _NEPTUNE_ROT_REAL_MS = 16.11 * 3600000;
      const _MOON_SPEED_FACTOR = _NEPTUNE_ROT_REAL_MS / 120000; // ≈ 319.7×
      ...
      function updateMoonOrbits(moonEntries, featureEntries, t) {
        ...
        for (const entry of featureEntries) {
          const { parentMoon, moonAnchor, marker, hitTarget, sprite, line, surfacePoint, relMarkerPos, relHitPos, relSurfacePoint, relLabelPos } = entry;
          ...
          fp[0] = relMarkerPos.x + mx;  fp[1] = relMarkerPos.y + my;  fp[2] = relMarkerPos.z + mz;
          fp[3] = relLabelPos.x + mx;   fp[4] = relLabelPos.y + my;   fp[5] = relLabelPos.z + mz;
          line.geometry.attributes.position.needsUpdate = true;
        }
      }
      ...
      function render() {
        ...
        if (!coreToggle.checked) {
          updateLabelVisibility(
            ...
            renderer,
            neptuneLabelsEnabled,
            neptuneLabelsEnabled && volcanicLabelsToggle.checked,
            neptuneLabelsEnabled && landingLabelsToggle.checked,
            neptuneLabelsEnabled && habitationLabelsToggle.checked,
            false,
            stormLabelsToggle ? (neptuneLabelsEnabled && stormLabelsToggle.checked) : true,
          );
          updateRingLabelVisibility(
            ringLabelLayer.entries,
            marsGroup,
