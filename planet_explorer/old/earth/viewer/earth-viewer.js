import * as THREE from "./vendor/three.module.js";
    ...
    if (brandLogo) {
      brandLogo.src = "../../../assets/earth_icon.png?v=20260430a";
    }
    ...
    const MOON_VIEWER_TEXTURES = {
      Moon: "assets/moon_color_map.jpg",
    };
    ...
    function moveCameraToFeature(feature, camera, controls, options = {}) {
      ...
      if (Array.isArray(feature.ring_anchor)) {
        ...
        const _spinDelta = getSpinTime() * (2 * Math.PI / 120000);
    ...
    async function init() {
      ...
      const baseLayers = manifest.layers || [{
        ...
        description: "Global color basemap.",
      }];
      ...
      const BASE_LAYER_GROUPS = [
        ...
        { label: "Terrain",  ids: ["derived-hillshade", TERRAIN_PICKER_SLOPE_LAYER_ID] },
      ];
      ...
      function appendUserPinLayerEntry(pin, options = {}) {
        ...
        if (options.minimalMarkerOnly) {
          ...
          const anchor = options.anchorPoint
            ...
            : getReliefPoint(3.2, elevationSampler, labelElevationCache, getTerrainRelief, pin.lat, pin.lon, USER_PIN_SURFACE_LIFT);
          ...
          const pinTex = makePinIconTexture('#e05c1a');
          const pinSprite = new THREE.Sprite(new THREE.SpriteMaterial({
            map: pinTex,
            transparent: true,
            depthTest: false,
...
${error && error.message ? error.message : error}`;
      ...
      function render() {
        ...
        if (!coreToggle.checked) {
          ...
          globe.rotation.y = Math.PI + _spinT * (2 * Math.PI / 120000);
