    ...
    const JUPITER_MEAN_RADIUS_KM = MARS_MEAN_RADIUS_KM;
    ...
    function updateScaleReadout(camera, renderer, controls) {
      ...
      const kmPerWorldUnit = JUPITER_MEAN_RADIUS_KM / JUPITER_SCENE_RADIUS;
    ...
    function buildMetadataState(baseLayers, geologyLayers, mineralLayers, geologyInteractiveState = null) {
      ...
      sourceEntries.push({
        title: "Jupiter audio",
        copy: "No local Jupiter radio-emission audio asset is included in this folder; the playback control is preserved for UI consistency.",
        links: [],
      });
      sourceEntries.push({
...
${error && error.message ? error.message : error}`;
      ...
      // Globe completes one rotation every 120,000 ms; Jupiter's real sidereal day is 10.6566 h.
      const _JUPITER_ROT_REAL_MS = 9.925 * 3600000;
      const _MOON_SPEED_FACTOR = _JUPITER_ROT_REAL_MS / 120000; // ≈ 319.7×
