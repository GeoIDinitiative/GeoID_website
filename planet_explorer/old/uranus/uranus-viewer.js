    ...
    const labelData = [{"name":"North Polar Hood","type":"Polar haze cap","lat":70.0,"lon":20.0,"theme":"polar","description":"A bright high-latitude hood associated with Uranus' seasonal polar atmosphere."},{"name":"South Polar Region","type":"Polar atmosphere","lat":-70.0,"lon":210.0,"theme":"polar","description":"Representative southern polar atmosphere shaped by Uranus' extreme axial tilt."},{"name":"Equatorial Band","type":"Subtle cloud band","lat":0.0,"lon":0.0,"theme":"band","description":"A muted equatorial cloud band visible in enhanced contrast products."},{"name":"Northern Mid-Latitude Band","type":"Cloud band","lat":32.0,"lon":120.0,"theme":"band","description":"A representative northern mid-latitude band where methane haze and cloud contrast vary."},{"name":"Southern Mid-Latitude Band","type":"Cloud band","lat":-32.0,"lon":300.0,"theme":"band","description":"A representative southern band used for tracking subtle atmospheric circulation."},{"name":"Bright Cloud Complex","type":"Methane cloud complex","lat":28.0,"lon":80.0,"theme":"storm","description":"A representative bright methane cloud region in Uranus' upper atmosphere."},{"name":"Dark Spot Latitude","type":"Storm latitude","lat":-27.0,"lon":240.0,"theme":"storm","description":"Representative latitude for dark storm systems observed in Uranus monitoring campaigns."},{"name":"Voyager 2 Closest Approach","type":"Mission corridor","lat":-14.0,"lon":35.0,"theme":"landing","description":"Representative encounter region for Voyager 2's 1986 Uranus flyby."}];
    const ringLabelData = [{"name":"6 Ring","type":"Narrow inner ring","theme":"ring","description":"6 Ring in the inner narrow ring of the planet.","ring_region":"Inner narrow ring","ring_radius_km":"~41,800 km from Uranus center","ring_anchor":[4.4166,0,1.6075],"ring_label":[4.8394,0.18,1.7614],"ring_line_end":[4.6233,0.12,1.6827]},{"name":"Beta Ring","type":"Narrow ring","theme":"ring","description":"Beta Ring in the inner ring system of the planet.","ring_region":"Inner ring system","ring_radius_km":"~45,700 km from Uranus center","ring_anchor":[1.7785,0,4.8864],"ring_label":[1.9324,0.18,5.3093],"ring_line_end":[1.8537,0.12,5.0931]},{"name":"Eta Ring","type":"Narrow ring","theme":"ring","description":"Eta Ring in the middle ring system of the planet.","ring_region":"Middle ring system","ring_radius_km":"~47,200 km from Uranus center","ring_anchor":[-3.5996,0,4.2898],"ring_label":[-3.8889,0.18,4.6346],"ring_line_end":[-3.741,0.12,4.4584]},{"name":"Epsilon Ring","type":"Bright narrow ring","theme":"ring","description":"Epsilon Ring in the outer main ring of the planet.","ring_region":"Outer main ring","ring_radius_km":"~51,100 km from Uranus center","ring_anchor":[-5.5426,0,-3.2],"ring_label":[-5.9323,0.18,-3.425],"ring_line_end":[-5.7331,0.12,-3.31]},{"name":"Mu Ring","type":"Diffuse dusty ring","theme":"ring","description":"Mu Ring in the outer diffuse ring of the planet.","ring_region":"Outer diffuse ring","ring_radius_km":"~97,700 km from Uranus center","ring_anchor":[3.6,0,-6.2354],"ring_label":[3.825,0.18,-6.6251],"ring_line_end":[3.71,0.12,-6.4259]}];
    const moonData = [{"name":"Miranda","type":"Major moon","theme":"moon","description":"A small icy moon with dramatic tectonic coronae and varied terrain.","moon_anchor":[6.8,0.08,4.4],"moon_radius":0.07,"moon_label_lift":0.19,"moon_color":"#b9b4aa","mean_radius_km":"236 km","orbit_distance_km":"~129,900 km","texture_source_url":null},{"name":"Ariel","type":"Major moon","theme":"moon","description":"A bright icy moon marked by canyons, scarps, and possible resurfacing.","moon_anchor":[-7.6,-0.06,5.8],"moon_radius":0.092,"moon_label_lift":0.212,"moon_color":"#c9c6bd","mean_radius_km":"579 km","orbit_distance_km":"~190,900 km","texture_source_url":null},{"name":"Umbriel","type":"Major moon","theme":"moon","description":"A darker icy moon with an ancient cratered surface.","moon_anchor":[-9.8,0.04,-6.4],"moon_radius":0.09,"moon_label_lift":0.21,"moon_color":"#77736c","mean_radius_km":"585 km","orbit_distance_km":"~266,000 km","texture_source_url":null},{"name":"Titania","type":"Major moon","theme":"moon","description":"Uranus' largest moon, cut by major rift valleys and impact terrains.","moon_anchor":[11.5,0.1,-8.6],"moon_radius":0.12,"moon_label_lift":0.24,"moon_color":"#aaa49b","mean_radius_km":"789 km","orbit_distance_km":"~436,300 km","texture_source_url":null},{"name":"Oberon","type":"Major moon","theme":"moon","description":"A distant major moon with old cratered terrain and bright crater deposits.","moon_anchor":[14.0,-0.12,8.8],"moon_radius":0.115,"moon_label_lift":0.235,"moon_color":"#8f8980","mean_radius_km":"761 km","orbit_distance_km":"~583,500 km","texture_source_url":null}];
    ...
    const MOON_VIEWER_TEXTURES = {
      Miranda: "viewer/assets/miranda_color_map.jpg",
      Ariel:   "viewer/assets/ariel_color_map.jpg",
      Umbriel: "viewer/assets/umbriel_color_map.jpg",
      Titania: "viewer/assets/titania_color_map.jpg",
      Oberon:  "viewer/assets/oberon_color_map.jpg",
    };
    let currentMetadataState = null;
    let activeCutClipPlane = null;
    const MARS_MEAN_RADIUS_KM = 58232.0;
    const URANUS_MEAN_RADIUS_KM = MARS_MEAN_RADIUS_KM;
    ...
    function updateScaleReadout(camera, renderer, controls) {
      ...
      const kmPerWorldUnit = URANUS_MEAN_RADIUS_KM / URANUS_SCENE_RADIUS;
    ...
    function buildMetadataState(baseLayers, geologyLayers, mineralLayers, geologyInteractiveState = null) {
      ...
      sourceEntries.push({
        title: "Uranus audio",
        copy: "No local Uranus radio-emission audio asset is included in this folder; the playback control is preserved for UI consistency.",
        links: [],
      });
      sourceEntries.push({
    ...
    async function init() {
      const startup = window.__uranusViewerStartup;
    ...
    function isObjectActuallyVisible(object) {
      ...
      async function runEmbeddedSmokeTest() {
        ...
        try {
          let state = window.__uranusViewerDebug.getState();
          assert(state.solidGeology === true, "Solid geology should load enabled by default.");

          const feature = window.__uranusViewerDebug.openFeatureAtViewport(0.5, 0.5);
          ...
          state = window.__uranusViewerDebug.getState();
          assert(state.selectedOutlineVisible === true, "Selected geology outline should be visible.");

          window.__uranusViewerDebug.setToggle("geology-toggle", false);
          window.__uranusViewerDebug.setToggle("geology-contacts-toggle", true);
          window.__uranusViewerDebug.setToggle("geology-structures-toggle", true);
          state = window.__uranusViewerDebug.getState();
          ...
          const radiusBefore = window.__uranusViewerDebug.getFirstLineRadius("contacts");
          assert(radiusBefore !== null, "Expected a visible contact line sample radius.");
          window.__uranusViewerDebug.setTerrainRelief(0.2);
          await new Promise((resolve) => setTimeout(resolve, 250));
          const radiusAfter = window.__uranusViewerDebug.getFirstLineRadius("contacts");
          assert(radiusAfter !== null && Math.abs(radiusAfter - radiusBefore) > 1e-4, "Contact linework should move with terrain relief.");

          window.__uranusViewerDebug.setToggle("core-toggle", true);
          state = window.__uranusViewerDebug.getState();
...
${error && error.message ? error.message : error}`;
      ...
      // Globe completes one rotation every 120,000 ms; Uranus's real sidereal day is 10.6566 h.
      const _URANUS_ROT_REAL_MS = 17.24 * 3600000;
      const _MOON_SPEED_FACTOR = _URANUS_ROT_REAL_MS / 120000; // ≈ 319.7×
      ...
      (function backgroundLoadLayers() {
        ...
        const queue = [
          ...
          // Moon textures
          // Uranus moon textures use West-positive longitude (mirrored U) and south-pole-at-top of image.
          // Fix both: repeat.x=-1 (mirror U: West→East), repeat.y=-1 (flip V: south→bottom of sphere).
          ...moonData
