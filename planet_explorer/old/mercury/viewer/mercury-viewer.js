import * as THREE from "./vendor/three.module.js";
    ...
    console.log("[ctxPatchDebug] mercury-viewer.js loaded", { manifest: window.__marsViewerManifest, verbose: window.__ctxPatchDebug.verbose });

    const PLANET_NAME = "Mercury";
    ...
    if (brandLogo) {
      brandLogo.src = "../../../assets/mercury_icon.png";
    }
    ...
    async function init() {
      ...
      const baseLayers = manifest.layers || [{
        id: "mercury-base",
        label: "Mercury basemap",
        path: manifest.texture.path,
        description: "Global Mercury basemap from the local viewer manifest.",
      }];
      ...
      const geologyLayers = manifest.geology_layers || [{
        id: "mercury-geology",
        label: "Mercury geology context",
        path: manifest.geology.path,
        description: "Enhanced-color compositional context overlay derived from MESSENGER global products.",
        default: true,
      }];
