...
import { moonLatLonToVector3, makeLabelTexture, isVolcanicMoonFeature, isCraterMoonFeature, getMoonFeatureConnectorStart, buildLabelLayer, buildMoonLayer, buildMoonFeatureLabelLayer, getEntryConnectorStart, updateLabelAnchors, rebuildLabelTextures, updateMoonFeatureLabelVisibility, updateMoonVisibility, updateLabelVisibility } from "./label-layer.js";
    ...
    const CORE_LAYER_DATA = [
      ...
      },
      {
        ...
        name: "Mantle",
        type: "Silicate shell",
        description: "A thick shell of iron-rich silicate rock. Earth lacks active plate tectonics, so heat escapes slowly through a thick, immobile lithosphere rather than at spreading centres. Much of the easily melted mantle source appears to be depleted relative to early Earth, helping explain why large-scale magma production is now limited and volcanism is far less vigorous than in the past.",
