...
import { fosSeries, wetnessSeries, materialFor, stabilityBand } from "./fos.js?v=20260827-4323be2";
import { makeRaster, slope as slopeOf } from "./raster-analysis.js?v=20260827-4323be2";
import { SOURCE as WEATHER_SOURCE } from "./forecast.js?v=20260827-4323be2";
