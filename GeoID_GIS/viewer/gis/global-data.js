...
import { runConnector } from "./research/connectors.js?v=20260915-fdefd0f";
import { explainFetchFailure, dataUrl } from "./data-base.js?v=20260915-fdefd0f";
import { mathsFor } from "./equations.js?v=20260915-fdefd0f";
import {
  riskEdges, RISK_LABELS,
} from "./cyclone-risk.js?v=20260915-fdefd0f";
import { colourRange as volcanicColourRange } from "./volcanic-risk.js?v=20260915-fdefd0f";
import { featureForModel, may, refusal } from "./membership.js?v=20260915-fdefd0f";
import { colourRange as seismicColourRange } from "./seismic-bands.js?v=20260915-fdefd0f";
...
import { SAFFIR_SIMPSON_KTS } from "./event-sources.js?v=20260915-fdefd0f";
