...
import { runConnector } from "./research/connectors.js?v=20260922-9c13628";
import { explainFetchFailure, dataUrl } from "./data-base.js?v=20260922-9c13628";
import { mathsFor } from "./equations.js?v=20260922-9c13628";
import {
  riskEdges, RISK_LABELS,
} from "./cyclone-risk.js?v=20260922-9c13628";
import { colourRange as volcanicColourRange } from "./volcanic-risk.js?v=20260922-9c13628";
import { featureForModel, may, refusal } from "./membership.js?v=20260922-9c13628";
import { colourRange as seismicColourRange } from "./seismic-bands.js?v=20260922-9c13628";
...
import { SAFFIR_SIMPSON_KTS } from "./event-sources.js?v=20260922-9c13628";
...
export const DATASETS = [
  ...
  },
  {
    ...
    defaultOn: true,
    colour: "#ffffff",
    // A fifth of full strength was the note here and 1 was the number; 30% is
    // the one asked for. White at full strength rules a political map over the
    // physical one it is meant to locate.
    opacity: 0.3,
  },
  {
    id: "countries-50m",
