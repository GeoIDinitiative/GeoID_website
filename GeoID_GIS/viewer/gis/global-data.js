...
import { runConnector } from "./research/connectors.js?v=20260920-1e7b58d";
import { explainFetchFailure, dataUrl } from "./data-base.js?v=20260920-1e7b58d";
import { mathsFor } from "./equations.js?v=20260920-1e7b58d";
import {
  riskEdges, RISK_LABELS,
} from "./cyclone-risk.js?v=20260920-1e7b58d";
import { colourRange as volcanicColourRange } from "./volcanic-risk.js?v=20260920-1e7b58d";
import { featureForModel, may, refusal } from "./membership.js?v=20260920-1e7b58d";
import { colourRange as seismicColourRange } from "./seismic-bands.js?v=20260920-1e7b58d";
...
import { SAFFIR_SIMPSON_KTS } from "./event-sources.js?v=20260920-1e7b58d";
