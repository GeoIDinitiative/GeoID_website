...
import { pointInPolygon, boundsOf, haversineMetres } from "./geometry.js?v=20260916-24452db";
...
import { rockClass, crustalSetting, rockClassLabel } from "./rock-class.js?v=20260916-24452db";
import { lithologyLabel } from "./lithology-label.js?v=20260916-24452db";
...
import { isRiskFeature, riskCard } from "./cyclone-risk-card.js?v=20260916-24452db";
import { isVolcanicRiskFeature, volcanicRiskCard } from "./volcanic-risk-card.js?v=20260916-24452db";
import { isSeismicRiskFeature, seismicRiskCard } from "./seismic-risk-card.js?v=20260916-24452db";
import { isEarthquakeFeature, earthquakeCard } from "./earthquake-card.js?v=20260916-24452db";
import { isZoneFeature, zoneCard } from "./volcanic-zone-card.js?v=20260916-24452db";
import {
  canEditRow, editableFields, applyRowChange,
} from "./table-editor.js?v=20260916-24452db";
