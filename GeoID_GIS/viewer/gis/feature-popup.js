...
import { pointInPolygon, boundsOf, haversineMetres } from "./geometry.js?v=20260916-cde4f6a";
...
import { rockClass, crustalSetting, rockClassLabel } from "./rock-class.js?v=20260916-cde4f6a";
import { lithologyLabel } from "./lithology-label.js?v=20260916-cde4f6a";
...
import { isRiskFeature, riskCard } from "./cyclone-risk-card.js?v=20260916-cde4f6a";
import { isVolcanicRiskFeature, volcanicRiskCard } from "./volcanic-risk-card.js?v=20260916-cde4f6a";
import { isSeismicRiskFeature, seismicRiskCard } from "./seismic-risk-card.js?v=20260916-cde4f6a";
import { isEarthquakeFeature, earthquakeCard } from "./earthquake-card.js?v=20260916-cde4f6a";
import { isZoneFeature, zoneCard } from "./volcanic-zone-card.js?v=20260916-cde4f6a";
import {
  canEditRow, editableFields, applyRowChange,
} from "./table-editor.js?v=20260916-cde4f6a";
