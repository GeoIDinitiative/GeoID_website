...
import { pointInPolygon, boundsOf, haversineMetres } from "./geometry.js?v=20260916-eb57f4d";
...
import { rockClass, crustalSetting, rockClassLabel } from "./rock-class.js?v=20260916-eb57f4d";
import { lithologyLabel } from "./lithology-label.js?v=20260916-eb57f4d";
...
import { isRiskFeature, riskCard } from "./cyclone-risk-card.js?v=20260916-eb57f4d";
import { isVolcanicRiskFeature, volcanicRiskCard } from "./volcanic-risk-card.js?v=20260916-eb57f4d";
import { isSeismicRiskFeature, seismicRiskCard } from "./seismic-risk-card.js?v=20260916-eb57f4d";
import { isEarthquakeFeature, earthquakeCard } from "./earthquake-card.js?v=20260916-eb57f4d";
import { isZoneFeature, zoneCard } from "./volcanic-zone-card.js?v=20260916-eb57f4d";
import {
  canEditRow, editableFields, applyRowChange,
} from "./table-editor.js?v=20260916-eb57f4d";
