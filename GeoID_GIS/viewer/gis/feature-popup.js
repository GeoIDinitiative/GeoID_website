...
import { pointInPolygon, boundsOf, haversineMetres } from "./geometry.js?v=20260914-4b4e967";
...
import { rockClass, crustalSetting, rockClassLabel } from "./rock-class.js?v=20260914-4b4e967";
import { lithologyLabel } from "./lithology-label.js?v=20260914-4b4e967";
...
import { isRiskFeature, riskCard } from "./cyclone-risk-card.js?v=20260914-4b4e967";
import { isVolcanicRiskFeature, volcanicRiskCard } from "./volcanic-risk-card.js?v=20260914-4b4e967";
import { isSeismicRiskFeature, seismicRiskCard } from "./seismic-risk-card.js?v=20260914-4b4e967";
import { isEarthquakeFeature, earthquakeCard } from "./earthquake-card.js?v=20260914-4b4e967";
import { isZoneFeature, zoneCard } from "./volcanic-zone-card.js?v=20260914-4b4e967";
import {
  canEditRow, editableFields, applyRowChange,
} from "./table-editor.js?v=20260914-4b4e967";
