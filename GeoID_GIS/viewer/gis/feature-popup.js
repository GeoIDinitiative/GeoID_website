...
import { pointInPolygon, boundsOf, haversineMetres } from "./geometry.js?v=20260909-fc4f45f";
...
import { rockClass, crustalSetting, rockClassLabel } from "./rock-class.js?v=20260909-fc4f45f";
import { lithologyLabel } from "./lithology-label.js?v=20260909-fc4f45f";
...
import { isRiskFeature, riskCard } from "./cyclone-risk-card.js?v=20260909-fc4f45f";
import { isVolcanicRiskFeature, volcanicRiskCard } from "./volcanic-risk-card.js?v=20260909-fc4f45f";
import { isSeismicRiskFeature, seismicRiskCard } from "./seismic-risk-card.js?v=20260909-fc4f45f";
import { isZoneFeature, zoneCard } from "./volcanic-zone-card.js?v=20260909-fc4f45f";
import {
  canEditRow, editableFields, applyRowChange,
} from "./table-editor.js?v=20260909-fc4f45f";
