...
import { pointInPolygon, boundsOf, haversineMetres } from "./geometry.js?v=20260908-d4eab7a";
...
import { rockClass, crustalSetting, rockClassLabel } from "./rock-class.js?v=20260908-d4eab7a";
import { lithologyLabel } from "./lithology-label.js?v=20260908-d4eab7a";
...
import { isRiskFeature, riskCard } from "./cyclone-risk-card.js?v=20260908-d4eab7a";
import {
  canEditRow, editableFields, applyRowChange,
} from "./table-editor.js?v=20260908-d4eab7a";
