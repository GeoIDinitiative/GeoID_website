...
import { pointInPolygon, boundsOf, haversineMetres } from "./geometry.js?v=20260909-d85ea73";
...
import { rockClass, crustalSetting, rockClassLabel } from "./rock-class.js?v=20260909-d85ea73";
import { lithologyLabel } from "./lithology-label.js?v=20260909-d85ea73";
...
import { isRiskFeature, riskCard } from "./cyclone-risk-card.js?v=20260909-d85ea73";
import { isZoneFeature, zoneCard } from "./volcanic-zone-card.js?v=20260909-d85ea73";
import {
  canEditRow, editableFields, applyRowChange,
} from "./table-editor.js?v=20260909-d85ea73";
