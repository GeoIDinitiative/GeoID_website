...
import { pointInPolygon, boundsOf, haversineMetres } from "./geometry.js?v=20260902-0cb4e4f";
import { sphericalPolygonAreaKm2 } from "./geo-utils.js?v=20260902-0cb4e4f";
import { attachReliefAttributes, followRelief } from "./vector-render.js?v=20260902-0cb4e4f";
import { rockClass, crustalSetting, rockClassLabel } from "./rock-class.js?v=20260902-0cb4e4f";
import { lithologyLabel } from "./lithology-label.js?v=20260902-0cb4e4f";
