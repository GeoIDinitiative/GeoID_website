...
import { QUALITATIVE_RAMP } from "./symbology.js?v=20260911-f4b36fe";
import { currentBodyId } from "./bodies.js?v=20260911-f4b36fe";
import { sphericalPolygonAreaKm2 } from "./geo-utils.js?v=20260911-f4b36fe";
import { rockClass } from "./rock-class.js?v=20260911-f4b36fe";
import { AREA_OPACITY } from "./layer-opacity.js?v=20260911-f4b36fe";
import { datasetInfoButton } from "./catalogue-list.js?v=20260911-f4b36fe";
import { isIceCover, isNotIceCover } from "./ice-cover.js?v=20260911-f4b36fe";
