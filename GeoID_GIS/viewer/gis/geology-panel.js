...
import { QUALITATIVE_RAMP } from "./symbology.js?v=20260905-c0e08d1";
import { currentBodyId } from "./bodies.js?v=20260905-c0e08d1";
import { sphericalPolygonAreaKm2 } from "./geo-utils.js?v=20260905-c0e08d1";
import { rockClass } from "./rock-class.js?v=20260905-c0e08d1";
import { AREA_OPACITY } from "./layer-opacity.js?v=20260905-c0e08d1";
import { datasetInfoButton } from "./catalogue-list.js?v=20260905-c0e08d1";
import { isIceCover, isNotIceCover } from "./ice-cover.js?v=20260905-c0e08d1";
import { isIceFeature, iceCard } from "./ice-card.js?v=20260905-c0e08d1";
import { isSoilFeature, soilCard } from "./soil-card.js?v=20260905-c0e08d1";

import { openSymbologyDialog } from "./symbology-dialog.js?v=20260905-c0e08d1";
