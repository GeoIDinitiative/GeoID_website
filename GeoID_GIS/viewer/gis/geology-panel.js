...
import { QUALITATIVE_RAMP } from "./symbology.js?v=20260908-a3e0dca";
import { currentBodyId } from "./bodies.js?v=20260908-a3e0dca";
import { sphericalPolygonAreaKm2 } from "./geo-utils.js?v=20260908-a3e0dca";
import { rockClass } from "./rock-class.js?v=20260908-a3e0dca";
import { AREA_OPACITY } from "./layer-opacity.js?v=20260908-a3e0dca";
import { datasetInfoButton } from "./catalogue-list.js?v=20260908-a3e0dca";
import { isIceCover, isNotIceCover } from "./ice-cover.js?v=20260908-a3e0dca";
import { isIceFeature, iceCard } from "./ice-card.js?v=20260908-a3e0dca";
import { isSoilFeature, soilCard } from "./soil-card.js?v=20260908-a3e0dca";

import { openSymbologyDialog } from "./symbology-dialog.js?v=20260908-a3e0dca";
