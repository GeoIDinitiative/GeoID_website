...
import { QUALITATIVE_RAMP } from "./symbology.js?v=20260915-436fbaa";
import { currentBodyId } from "./bodies.js?v=20260915-436fbaa";
import { sphericalPolygonAreaKm2 } from "./geo-utils.js?v=20260915-436fbaa";
import { rockClass } from "./rock-class.js?v=20260915-436fbaa";
import { AREA_OPACITY } from "./layer-opacity.js?v=20260915-436fbaa";
import { datasetInfoButton } from "./catalogue-list.js?v=20260915-436fbaa";
import { isIceCover, isNotIceCover } from "./ice-cover.js?v=20260915-436fbaa";
import { isIceFeature, iceCard } from "./ice-card.js?v=20260915-436fbaa";
import { isSoilFeature, soilCard } from "./soil-card.js?v=20260915-436fbaa";
import { waterCard, WATER_SAID } from "./water-card.js?v=20260915-436fbaa";

import { openSymbologyDialog } from "./symbology-dialog.js?v=20260915-436fbaa";
