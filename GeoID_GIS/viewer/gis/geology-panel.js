...
import { QUALITATIVE_RAMP } from "./symbology.js?v=20260912-03f0b7a";
import { currentBodyId } from "./bodies.js?v=20260912-03f0b7a";
import { sphericalPolygonAreaKm2 } from "./geo-utils.js?v=20260912-03f0b7a";
import { rockClass } from "./rock-class.js?v=20260912-03f0b7a";
import { AREA_OPACITY } from "./layer-opacity.js?v=20260912-03f0b7a";
import { datasetInfoButton } from "./catalogue-list.js?v=20260912-03f0b7a";
import { isIceCover, isNotIceCover } from "./ice-cover.js?v=20260912-03f0b7a";
import { isIceFeature, iceCard } from "./ice-card.js?v=20260912-03f0b7a";
import { isSoilFeature, soilCard } from "./soil-card.js?v=20260912-03f0b7a";
import { waterCard, WATER_SAID } from "./water-card.js?v=20260912-03f0b7a";

import { openSymbologyDialog } from "./symbology-dialog.js?v=20260912-03f0b7a";
