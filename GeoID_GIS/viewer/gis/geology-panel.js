...
import { QUALITATIVE_RAMP } from "./symbology.js?v=20260908-294767f";
import { currentBodyId } from "./bodies.js?v=20260908-294767f";
import { sphericalPolygonAreaKm2 } from "./geo-utils.js?v=20260908-294767f";
import { rockClass } from "./rock-class.js?v=20260908-294767f";
import { AREA_OPACITY } from "./layer-opacity.js?v=20260908-294767f";
import { datasetInfoButton } from "./catalogue-list.js?v=20260908-294767f";
import { isIceCover, isNotIceCover } from "./ice-cover.js?v=20260908-294767f";
import { isIceFeature, iceCard } from "./ice-card.js?v=20260908-294767f";
import { isSoilFeature, soilCard } from "./soil-card.js?v=20260908-294767f";

import { openSymbologyDialog } from "./symbology-dialog.js?v=20260908-294767f";
