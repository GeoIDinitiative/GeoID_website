...
import { QUALITATIVE_RAMP } from "./symbology.js?v=20260910-571bffd";
import { currentBodyId } from "./bodies.js?v=20260910-571bffd";
import { sphericalPolygonAreaKm2 } from "./geo-utils.js?v=20260910-571bffd";
import { rockClass } from "./rock-class.js?v=20260910-571bffd";
import { AREA_OPACITY } from "./layer-opacity.js?v=20260910-571bffd";
import { datasetInfoButton } from "./catalogue-list.js?v=20260910-571bffd";
import { isIceCover, isNotIceCover } from "./ice-cover.js?v=20260910-571bffd";
import { isIceFeature, iceCard } from "./ice-card.js?v=20260910-571bffd";
import { isSoilFeature, soilCard } from "./soil-card.js?v=20260910-571bffd";

import { openSymbologyDialog } from "./symbology-dialog.js?v=20260910-571bffd";
