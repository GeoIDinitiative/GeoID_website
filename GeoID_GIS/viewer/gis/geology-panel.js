...
import { QUALITATIVE_RAMP } from "./symbology.js?v=20260912-ba5913f";
import { currentBodyId } from "./bodies.js?v=20260912-ba5913f";
import { sphericalPolygonAreaKm2 } from "./geo-utils.js?v=20260912-ba5913f";
import { rockClass } from "./rock-class.js?v=20260912-ba5913f";
import { AREA_OPACITY } from "./layer-opacity.js?v=20260912-ba5913f";
import { datasetInfoButton } from "./catalogue-list.js?v=20260912-ba5913f";
import { isIceCover, isNotIceCover } from "./ice-cover.js?v=20260912-ba5913f";
import { isIceFeature, iceCard } from "./ice-card.js?v=20260912-ba5913f";
import { isSoilFeature, soilCard } from "./soil-card.js?v=20260912-ba5913f";
import { waterCard, WATER_SAID } from "./water-card.js?v=20260912-ba5913f";
