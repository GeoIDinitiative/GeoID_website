...
import { QUALITATIVE_RAMP } from "./symbology.js?v=20260909-be054cf";
import { currentBodyId } from "./bodies.js?v=20260909-be054cf";
import { sphericalPolygonAreaKm2 } from "./geo-utils.js?v=20260909-be054cf";
import { rockClass } from "./rock-class.js?v=20260909-be054cf";
import { AREA_OPACITY } from "./layer-opacity.js?v=20260909-be054cf";
import { datasetInfoButton } from "./catalogue-list.js?v=20260909-be054cf";
import { isIceCover, isNotIceCover } from "./ice-cover.js?v=20260909-be054cf";
import { isIceFeature, iceCard } from "./ice-card.js?v=20260909-be054cf";
import { isSoilFeature, soilCard } from "./soil-card.js?v=20260909-be054cf";

import { openSymbologyDialog } from "./symbology-dialog.js?v=20260909-be054cf";
