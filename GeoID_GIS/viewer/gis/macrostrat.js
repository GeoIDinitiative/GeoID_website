...
import { decodeTile, tilesForBounds } from "./mvt.js?v=20260916-64b58db";
import { geometryKind } from "./symbology-dialog.js?v=20260916-64b58db";
import { visibleBounds } from "./view-extent.js?v=20260916-64b58db";
