...
import { decodeTile, tilesForBounds } from "./mvt.js?v=20260915-7a4d9b0";
import { geometryKind } from "./symbology-dialog.js?v=20260915-7a4d9b0";
import { visibleBounds } from "./view-extent.js?v=20260915-7a4d9b0";
