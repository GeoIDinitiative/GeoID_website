...
import { decodeTile, tilesForBounds } from "./mvt.js?v=20260910-6b1d4e5";
import { geometryKind } from "./symbology-dialog.js?v=20260910-6b1d4e5";
import { visibleBounds } from "./view-extent.js?v=20260910-6b1d4e5";
