...
import { decodeTile, tilesForBounds } from "./mvt.js?v=20260912-ed0502f";
import { geometryKind } from "./symbology-dialog.js?v=20260912-ed0502f";
import { visibleBounds } from "./view-extent.js?v=20260912-ed0502f";
