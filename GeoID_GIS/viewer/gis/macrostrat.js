...
import { decodeTile, tilesForBounds } from "./mvt.js?v=20260919-2de9a83";
import { geometryKind } from "./symbology-dialog.js?v=20260919-2de9a83";
import { visibleBounds } from "./view-extent.js?v=20260919-2de9a83";
