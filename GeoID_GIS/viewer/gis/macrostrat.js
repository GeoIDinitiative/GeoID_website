...
import { decodeTile, tilesForBounds } from "./mvt.js?v=20260909-045648a";
import { geometryKind } from "./symbology-dialog.js?v=20260909-045648a";
import { visibleBounds } from "./view-extent.js?v=20260909-045648a";
