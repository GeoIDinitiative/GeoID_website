...
import { decodeTile, tilesForBounds } from "./mvt.js?v=20260915-fdefd0f";
import { geometryKind } from "./symbology-dialog.js?v=20260915-fdefd0f";
import { visibleBounds } from "./view-extent.js?v=20260915-fdefd0f";
