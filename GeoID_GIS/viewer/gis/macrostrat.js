...
import { decodeTile, tilesForBounds } from "./mvt.js?v=20260905-0d3d00f";
import { geometryKind } from "./symbology-dialog.js?v=20260905-0d3d00f";
import { visibleBounds } from "./view-extent.js?v=20260905-0d3d00f";
