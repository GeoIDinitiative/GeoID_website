...
import { decodeTile, tilesForBounds } from "./mvt.js?v=20260918-dcbe0e5";
import { geometryKind } from "./symbology-dialog.js?v=20260918-dcbe0e5";
import { visibleBounds } from "./view-extent.js?v=20260918-dcbe0e5";
