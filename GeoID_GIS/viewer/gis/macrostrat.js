...
import { decodeTile, tilesForBounds } from "./mvt.js?v=20260909-98d5a4e";
import { geometryKind } from "./symbology-dialog.js?v=20260909-98d5a4e";
import { visibleBounds } from "./view-extent.js?v=20260909-98d5a4e";
