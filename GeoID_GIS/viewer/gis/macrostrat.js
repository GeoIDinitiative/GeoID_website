...
import { decodeTile, tilesForBounds } from "./mvt.js?v=20260915-b1aefb2";
import { geometryKind } from "./symbology-dialog.js?v=20260915-b1aefb2";
import { visibleBounds } from "./view-extent.js?v=20260915-b1aefb2";
