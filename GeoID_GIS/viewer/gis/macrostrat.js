...
import { decodeTile, tilesForBounds } from "./mvt.js?v=20260910-db65dfd";
import { geometryKind } from "./symbology-dialog.js?v=20260910-db65dfd";
import { visibleBounds } from "./view-extent.js?v=20260910-db65dfd";
