...
import { decodeTile, tilesForBounds } from "./mvt.js?v=20260909-8e2ee95";
import { geometryKind } from "./symbology-dialog.js?v=20260909-8e2ee95";
import { visibleBounds } from "./view-extent.js?v=20260909-8e2ee95";
