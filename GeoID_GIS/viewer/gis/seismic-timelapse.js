...
import { colourOf, legendInfoFrom } from "./symbology.js?v=20260912-7310b6e";
import { startPlayer } from "./timelapse-player.js?v=20260912-7310b6e";
/**
...
import { MAG_EDGES, MAG_LABELS, MAG_FLOORS, magOf, bandSymbology }
  from "./seismic-magnitude.js?v=20260912-7310b6e";
