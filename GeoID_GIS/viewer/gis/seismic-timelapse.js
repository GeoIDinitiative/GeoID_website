...
import { colourOf, legendInfoFrom } from "./symbology.js?v=20260920-724172f";
import { startPlayer } from "./timelapse-player.js?v=20260920-724172f";
/**
...
import { MAG_EDGES, MAG_LABELS, MAG_FLOORS, magOf, bandSymbology }
  from "./seismic-magnitude.js?v=20260920-724172f";
