...
import { colourOf, legendInfoFrom } from "./symbology.js?v=20260911-fe2cd09";
import { startPlayer } from "./timelapse-player.js?v=20260911-fe2cd09";
/**
...
import { MAG_EDGES, MAG_LABELS, MAG_FLOORS, magOf, bandSymbology }
  from "./seismic-magnitude.js?v=20260911-fe2cd09";
