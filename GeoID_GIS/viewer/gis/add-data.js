...
import { CRS_OPTIONS } from "./projection.js?v=20260916-8ddd5ca";
import { readHead, validateMapping } from "./delimited.js?v=20260916-8ddd5ca";
import { RAMP_NAMES } from "./symbology.js?v=20260916-8ddd5ca";
import { AREA_OPACITY, MARK_OPACITY } from "./layer-opacity.js?v=20260916-8ddd5ca";
import { isEarth } from "./bodies.js?v=20260916-8ddd5ca";
import { DATA_TYPES, inferType, applyTag, markUserInput, suppressNextArrival } from "./data-tags.js?v=20260916-8ddd5ca";
...
function addButtonFor(role) {
  ...
  if (role.panel === "gis-group-polygons") {
    ...
    // Workspace header (side-panels' entry is rail: false).
    {
      ...
      cfg.type = "button";
      // An ID, because the header's bar presses the REAL control rather than
      // reimplementing it, and it finds a control by id.
      cfg.id = "gis-settings-btn";
