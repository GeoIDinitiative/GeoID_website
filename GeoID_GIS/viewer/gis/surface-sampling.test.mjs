...
// ── The GUI is wired to this module, both pages ───────────────────────────────
{
  ...
  check("the studio's camera floor and orbit follow a model that reaches below the ground", /function cameraFloorRadius/.test(studio) && /Math\.PI - MIN_POLAR_RAD/.test(studio) && /uniforms\.uOpen\.value = below \? 1 : 0/.test(studio) && /uOpen > 0\.5 && line < 0\.03/.test(studio) && /uHole\.value\.set\(/.test(studio));
