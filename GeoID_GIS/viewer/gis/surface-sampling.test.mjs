...
// ── The GUI is wired to this module, both pages ───────────────────────────────
{
  ...
  check("the studio offers no stars and no ground", !/data-toggle="stars"/.test(page) && !/data-toggle="ground"/.test(page) && /setStarsVisible\(false\);\n  setGroundVisible\(false\);/.test(studio));
