...
import * as sidecar from "./research/sidecar.js?v=20260826-422c702";
import { toGeoJson } from "./vector-formats.js?v=20260826-422c702";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260826-422c702";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260826-422c702");
