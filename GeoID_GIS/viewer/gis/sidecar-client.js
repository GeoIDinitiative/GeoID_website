...
import * as sidecar from "./research/sidecar.js?v=20260831-a4eab47";
import { toGeoJson } from "./vector-formats.js?v=20260831-a4eab47";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260831-a4eab47";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260831-a4eab47");
