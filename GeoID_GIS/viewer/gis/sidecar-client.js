...
import * as sidecar from "./research/sidecar.js?v=20260905-36e4cce";
import { toGeoJson } from "./vector-formats.js?v=20260905-36e4cce";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260905-36e4cce";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260905-36e4cce");
