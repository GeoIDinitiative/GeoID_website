...
import * as sidecar from "./research/sidecar.js?v=20260910-53c50ac";
import { toGeoJson } from "./vector-formats.js?v=20260910-53c50ac";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260910-53c50ac";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260910-53c50ac");
