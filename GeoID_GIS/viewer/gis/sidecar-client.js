...
import * as sidecar from "./research/sidecar.js?v=20260825-8cb95ab";
import { toGeoJson } from "./vector-formats.js?v=20260825-8cb95ab";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260825-8cb95ab";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260825-8cb95ab");
