...
import * as sidecar from "./research/sidecar.js?v=20260828-4c2b14d";
import { toGeoJson } from "./vector-formats.js?v=20260828-4c2b14d";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260828-4c2b14d";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260828-4c2b14d");
