...
import * as sidecar from "./research/sidecar.js?v=20260920-701060b";
import { toGeoJson } from "./vector-formats.js?v=20260920-701060b";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260920-701060b";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260920-701060b");
