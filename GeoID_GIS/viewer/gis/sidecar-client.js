...
import * as sidecar from "./research/sidecar.js?v=20260916-21dbb7d";
import { toGeoJson } from "./vector-formats.js?v=20260916-21dbb7d";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260916-21dbb7d";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260916-21dbb7d");
