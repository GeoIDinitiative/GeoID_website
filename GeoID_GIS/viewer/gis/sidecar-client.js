...
import * as sidecar from "./research/sidecar.js?v=20260827-c21ab4c";
import { toGeoJson } from "./vector-formats.js?v=20260827-c21ab4c";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260827-c21ab4c";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260827-c21ab4c");
