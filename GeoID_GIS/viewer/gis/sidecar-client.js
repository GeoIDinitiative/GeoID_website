...
import * as sidecar from "./research/sidecar.js?v=20260821-d1e8adb";
import { toGeoJson } from "./vector-formats.js?v=20260821-d1e8adb";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260821-d1e8adb";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260821-d1e8adb");
