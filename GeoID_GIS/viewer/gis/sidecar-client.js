...
import * as sidecar from "./research/sidecar.js?v=20260816-6ce8ecd";
import { toGeoJson } from "./vector-formats.js?v=20260816-6ce8ecd";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260816-6ce8ecd";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260816-6ce8ecd");
