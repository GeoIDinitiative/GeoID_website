...
import * as sidecar from "./research/sidecar.js?v=20260826-b7d1a76";
import { toGeoJson } from "./vector-formats.js?v=20260826-b7d1a76";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260826-b7d1a76";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260826-b7d1a76");
