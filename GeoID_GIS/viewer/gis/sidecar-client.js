...
import * as sidecar from "./research/sidecar.js?v=20260817-a184b6f";
import { toGeoJson } from "./vector-formats.js?v=20260817-a184b6f";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260817-a184b6f";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260817-a184b6f");
