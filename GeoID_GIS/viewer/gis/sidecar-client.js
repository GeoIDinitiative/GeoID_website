...
import * as sidecar from "./research/sidecar.js?v=20260828-c350daa";
import { toGeoJson } from "./vector-formats.js?v=20260828-c350daa";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260828-c350daa";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260828-c350daa");
