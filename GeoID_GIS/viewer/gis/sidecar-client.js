...
import * as sidecar from "./research/sidecar.js?v=20260914-b7630bb";
import { toGeoJson } from "./vector-formats.js?v=20260914-b7630bb";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260914-b7630bb";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260914-b7630bb");
