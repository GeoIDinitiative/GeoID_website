...
import * as sidecar from "./research/sidecar.js?v=20260825-db3d262";
import { toGeoJson } from "./vector-formats.js?v=20260825-db3d262";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260825-db3d262";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260825-db3d262");
