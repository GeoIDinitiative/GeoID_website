...
import * as sidecar from "./research/sidecar.js?v=20260915-3643e7a";
import { toGeoJson } from "./vector-formats.js?v=20260915-3643e7a";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260915-3643e7a";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260915-3643e7a");
