...
import * as sidecar from "./research/sidecar.js?v=20260826-e4a170d";
import { toGeoJson } from "./vector-formats.js?v=20260826-e4a170d";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260826-e4a170d";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260826-e4a170d");
