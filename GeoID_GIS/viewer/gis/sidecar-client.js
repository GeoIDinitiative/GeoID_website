...
import * as sidecar from "./research/sidecar.js?v=20260916-b88e8af";
import { toGeoJson } from "./vector-formats.js?v=20260916-b88e8af";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260916-b88e8af";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260916-b88e8af");
