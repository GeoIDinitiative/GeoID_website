...
import * as sidecar from "./research/sidecar.js?v=20260827-00849cb";
import { toGeoJson } from "./vector-formats.js?v=20260827-00849cb";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260827-00849cb";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260827-00849cb");
