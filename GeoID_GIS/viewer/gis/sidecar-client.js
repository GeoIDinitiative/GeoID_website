...
import * as sidecar from "./research/sidecar.js?v=20260831-b0a7fcc";
import { toGeoJson } from "./vector-formats.js?v=20260831-b0a7fcc";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260831-b0a7fcc";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260831-b0a7fcc");
