...
import * as sidecar from "./research/sidecar.js?v=20260818-55a4fdb";
import { toGeoJson } from "./vector-formats.js?v=20260818-55a4fdb";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260818-55a4fdb";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260818-55a4fdb");
