...
import * as sidecar from "./research/sidecar.js?v=20260907-563f782";
import { toGeoJson } from "./vector-formats.js?v=20260907-563f782";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260907-563f782";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260907-563f782");
