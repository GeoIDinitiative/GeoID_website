...
import * as sidecar from "./research/sidecar.js?v=20260916-bf9edbc";
import { toGeoJson } from "./vector-formats.js?v=20260916-bf9edbc";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260916-bf9edbc";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260916-bf9edbc");
