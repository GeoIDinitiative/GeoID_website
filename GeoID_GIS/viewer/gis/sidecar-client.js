...
import * as sidecar from "./research/sidecar.js?v=20260820-9a5639e";
import { toGeoJson } from "./vector-formats.js?v=20260820-9a5639e";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260820-9a5639e";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260820-9a5639e");
