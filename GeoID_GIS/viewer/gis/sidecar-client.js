...
import * as sidecar from "./research/sidecar.js?v=20260831-0eb96bf";
import { toGeoJson } from "./vector-formats.js?v=20260831-0eb96bf";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260831-0eb96bf";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260831-0eb96bf");
