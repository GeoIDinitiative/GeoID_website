...
import * as sidecar from "./research/sidecar.js?v=20260831-8d6bc3a";
import { toGeoJson } from "./vector-formats.js?v=20260831-8d6bc3a";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260831-8d6bc3a";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260831-8d6bc3a");
