...
import * as sidecar from "./research/sidecar.js?v=20260911-20d18ce";
import { toGeoJson } from "./vector-formats.js?v=20260911-20d18ce";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260911-20d18ce";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260911-20d18ce");
