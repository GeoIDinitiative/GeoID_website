...
import * as sidecar from "./research/sidecar.js?v=20260829-a7616de";
import { toGeoJson } from "./vector-formats.js?v=20260829-a7616de";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260829-a7616de";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260829-a7616de");
