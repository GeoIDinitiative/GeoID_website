...
import * as sidecar from "./research/sidecar.js?v=20260910-3e9f5be";
import { toGeoJson } from "./vector-formats.js?v=20260910-3e9f5be";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260910-3e9f5be";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260910-3e9f5be");
