...
import * as sidecar from "./research/sidecar.js?v=20260821-3dc92af";
import { toGeoJson } from "./vector-formats.js?v=20260821-3dc92af";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260821-3dc92af";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260821-3dc92af");
