...
import * as sidecar from "./research/sidecar.js?v=20260915-0e63adf";
import { toGeoJson } from "./vector-formats.js?v=20260915-0e63adf";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260915-0e63adf";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260915-0e63adf");
