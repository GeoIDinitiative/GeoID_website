...
import * as sidecar from "./research/sidecar.js?v=20260916-8ddd5ca";
import { toGeoJson } from "./vector-formats.js?v=20260916-8ddd5ca";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260916-8ddd5ca";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260916-8ddd5ca");
