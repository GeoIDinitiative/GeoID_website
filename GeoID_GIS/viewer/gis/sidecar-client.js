...
import * as sidecar from "./research/sidecar.js?v=20260829-cf6abbb";
import { toGeoJson } from "./vector-formats.js?v=20260829-cf6abbb";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260829-cf6abbb";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260829-cf6abbb");
