...
import * as sidecar from "./research/sidecar.js?v=20260907-7ffe8de";
import { toGeoJson } from "./vector-formats.js?v=20260907-7ffe8de";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260907-7ffe8de";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260907-7ffe8de");
