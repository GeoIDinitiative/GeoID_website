...
import * as sidecar from "./research/sidecar.js?v=20260822-654b5ae";
import { toGeoJson } from "./vector-formats.js?v=20260822-654b5ae";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260822-654b5ae";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260822-654b5ae");
