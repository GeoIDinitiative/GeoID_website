...
import * as sidecar from "./research/sidecar.js?v=20260825-0151daf";
import { toGeoJson } from "./vector-formats.js?v=20260825-0151daf";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260825-0151daf";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260825-0151daf");
