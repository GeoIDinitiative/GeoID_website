...
import * as sidecar from "./research/sidecar.js?v=20260909-8a7d11d";
import { toGeoJson } from "./vector-formats.js?v=20260909-8a7d11d";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260909-8a7d11d";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260909-8a7d11d");
