...
import * as sidecar from "./research/sidecar.js?v=20260920-817c7fc";
import { toGeoJson } from "./vector-formats.js?v=20260920-817c7fc";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260920-817c7fc";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260920-817c7fc");
