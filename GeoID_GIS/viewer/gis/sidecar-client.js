...
import * as sidecar from "./research/sidecar.js?v=20260821-4c3ed8b";
import { toGeoJson } from "./vector-formats.js?v=20260821-4c3ed8b";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260821-4c3ed8b";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260821-4c3ed8b");
