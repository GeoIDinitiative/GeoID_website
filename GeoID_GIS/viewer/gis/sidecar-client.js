...
import * as sidecar from "./research/sidecar.js?v=20260915-10e88cf";
import { toGeoJson } from "./vector-formats.js?v=20260915-10e88cf";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260915-10e88cf";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260915-10e88cf");
