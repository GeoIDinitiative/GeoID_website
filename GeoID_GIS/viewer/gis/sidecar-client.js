...
import * as sidecar from "./research/sidecar.js?v=20260830-d644fbd";
import { toGeoJson } from "./vector-formats.js?v=20260830-d644fbd";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260830-d644fbd";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260830-d644fbd");
