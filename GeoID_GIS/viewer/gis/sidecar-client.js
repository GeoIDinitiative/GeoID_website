...
import * as sidecar from "./research/sidecar.js?v=20260821-c97c8db";
import { toGeoJson } from "./vector-formats.js?v=20260821-c97c8db";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260821-c97c8db";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260821-c97c8db");
