...
import * as sidecar from "./research/sidecar.js?v=20260817-e80b34d";
import { toGeoJson } from "./vector-formats.js?v=20260817-e80b34d";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260817-e80b34d";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260817-e80b34d");
