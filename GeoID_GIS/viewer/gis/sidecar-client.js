...
import * as sidecar from "./research/sidecar.js?v=20260825-17061aa";
import { toGeoJson } from "./vector-formats.js?v=20260825-17061aa";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260825-17061aa";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260825-17061aa");
