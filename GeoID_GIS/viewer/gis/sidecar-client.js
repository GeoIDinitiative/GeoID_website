...
import * as sidecar from "./research/sidecar.js?v=20260911-d7f4f8c";
import { toGeoJson } from "./vector-formats.js?v=20260911-d7f4f8c";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260911-d7f4f8c";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260911-d7f4f8c");
