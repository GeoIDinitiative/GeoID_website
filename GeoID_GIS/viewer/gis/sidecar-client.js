...
import * as sidecar from "./research/sidecar.js?v=20260911-d3b1021";
import { toGeoJson } from "./vector-formats.js?v=20260911-d3b1021";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260911-d3b1021";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260911-d3b1021");
