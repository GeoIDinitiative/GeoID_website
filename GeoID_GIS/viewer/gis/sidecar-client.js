...
import * as sidecar from "./research/sidecar.js?v=20260909-b1377ab";
import { toGeoJson } from "./vector-formats.js?v=20260909-b1377ab";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260909-b1377ab";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260909-b1377ab");
