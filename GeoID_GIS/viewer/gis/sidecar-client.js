...
import * as sidecar from "./research/sidecar.js?v=20260905-0d3d00f";
import { toGeoJson } from "./vector-formats.js?v=20260905-0d3d00f";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260905-0d3d00f";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260905-0d3d00f");
