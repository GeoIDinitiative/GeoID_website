...
import * as sidecar from "./research/sidecar.js?v=20260828-be98b1a";
import { toGeoJson } from "./vector-formats.js?v=20260828-be98b1a";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260828-be98b1a";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260828-be98b1a");
