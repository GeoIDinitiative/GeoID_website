...
import * as sidecar from "./research/sidecar.js?v=20260914-a3436ee";
import { toGeoJson } from "./vector-formats.js?v=20260914-a3436ee";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260914-a3436ee";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260914-a3436ee");
