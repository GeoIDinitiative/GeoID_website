...
import * as sidecar from "./research/sidecar.js?v=20260910-4a62fde";
import { toGeoJson } from "./vector-formats.js?v=20260910-4a62fde";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260910-4a62fde";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260910-4a62fde");
