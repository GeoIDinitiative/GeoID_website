...
import * as sidecar from "./research/sidecar.js?v=20260827-e44795a";
import { toGeoJson } from "./vector-formats.js?v=20260827-e44795a";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260827-e44795a";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260827-e44795a");
