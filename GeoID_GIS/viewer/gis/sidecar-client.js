...
import * as sidecar from "./research/sidecar.js?v=20260916-f4b2153";
import { toGeoJson } from "./vector-formats.js?v=20260916-f4b2153";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260916-f4b2153";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260916-f4b2153");
