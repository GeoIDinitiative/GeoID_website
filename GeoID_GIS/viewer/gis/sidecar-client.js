...
import * as sidecar from "./research/sidecar.js?v=20260827-b2fc8ce";
import { toGeoJson } from "./vector-formats.js?v=20260827-b2fc8ce";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260827-b2fc8ce";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260827-b2fc8ce");
