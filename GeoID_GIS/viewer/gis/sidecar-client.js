...
import * as sidecar from "./research/sidecar.js?v=20260911-562dd6c";
import { toGeoJson } from "./vector-formats.js?v=20260911-562dd6c";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260911-562dd6c";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260911-562dd6c");
