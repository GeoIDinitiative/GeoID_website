...
import * as sidecar from "./research/sidecar.js?v=20260916-9211f8d";
import { toGeoJson } from "./vector-formats.js?v=20260916-9211f8d";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260916-9211f8d";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260916-9211f8d");
