...
import * as sidecar from "./research/sidecar.js?v=20260912-ba5913f";
import { toGeoJson } from "./vector-formats.js?v=20260912-ba5913f";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260912-ba5913f";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260912-ba5913f");
