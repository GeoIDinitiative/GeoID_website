...
import * as sidecar from "./research/sidecar.js?v=20260904-ea6488e";
import { toGeoJson } from "./vector-formats.js?v=20260904-ea6488e";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260904-ea6488e";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260904-ea6488e");
