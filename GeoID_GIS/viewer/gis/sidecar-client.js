...
import * as sidecar from "./research/sidecar.js?v=20260901-46a752d";
import { toGeoJson } from "./vector-formats.js?v=20260901-46a752d";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260901-46a752d";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260901-46a752d");
