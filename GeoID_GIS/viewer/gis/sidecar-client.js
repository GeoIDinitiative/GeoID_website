...
import * as sidecar from "./research/sidecar.js?v=20260817-b57b86d";
import { toGeoJson } from "./vector-formats.js?v=20260817-b57b86d";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260817-b57b86d";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260817-b57b86d");
