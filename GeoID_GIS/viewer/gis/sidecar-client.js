...
import * as sidecar from "./research/sidecar.js?v=20260828-5dbf95c";
import { toGeoJson } from "./vector-formats.js?v=20260828-5dbf95c";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260828-5dbf95c";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260828-5dbf95c");
