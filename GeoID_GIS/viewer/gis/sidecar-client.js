...
import * as sidecar from "./research/sidecar.js?v=20260830-f494dda";
import { toGeoJson } from "./vector-formats.js?v=20260830-f494dda";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260830-f494dda";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260830-f494dda");
