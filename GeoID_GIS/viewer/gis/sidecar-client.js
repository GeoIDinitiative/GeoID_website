...
import * as sidecar from "./research/sidecar.js?v=20260911-dd2e87b";
import { toGeoJson } from "./vector-formats.js?v=20260911-dd2e87b";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260911-dd2e87b";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260911-dd2e87b");
