...
import * as sidecar from "./research/sidecar.js?v=20260920-724172f";
import { toGeoJson } from "./vector-formats.js?v=20260920-724172f";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260920-724172f";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260920-724172f");
