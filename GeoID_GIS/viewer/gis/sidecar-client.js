...
import * as sidecar from "./research/sidecar.js?v=20260909-0df0bcc";
import { toGeoJson } from "./vector-formats.js?v=20260909-0df0bcc";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260909-0df0bcc";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260909-0df0bcc");
