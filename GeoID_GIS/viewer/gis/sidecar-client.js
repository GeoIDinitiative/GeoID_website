...
import * as sidecar from "./research/sidecar.js?v=20260828-eacf7cb";
import { toGeoJson } from "./vector-formats.js?v=20260828-eacf7cb";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260828-eacf7cb";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260828-eacf7cb");
