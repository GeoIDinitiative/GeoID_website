...
import * as sidecar from "./research/sidecar.js?v=20260817-4861be4";
import { toGeoJson } from "./vector-formats.js?v=20260817-4861be4";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260817-4861be4";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260817-4861be4");
