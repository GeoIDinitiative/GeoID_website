...
import * as sidecar from "./research/sidecar.js?v=20260826-9c40c2e";
import { toGeoJson } from "./vector-formats.js?v=20260826-9c40c2e";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260826-9c40c2e";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260826-9c40c2e");
