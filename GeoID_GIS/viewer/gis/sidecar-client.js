...
import * as sidecar from "./research/sidecar.js?v=20260910-77438fc";
import { toGeoJson } from "./vector-formats.js?v=20260910-77438fc";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260910-77438fc";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260910-77438fc");
