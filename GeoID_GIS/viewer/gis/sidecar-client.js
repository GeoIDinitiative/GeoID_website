...
import * as sidecar from "./research/sidecar.js?v=20260915-611c4ec";
import { toGeoJson } from "./vector-formats.js?v=20260915-611c4ec";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260915-611c4ec";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260915-611c4ec");
