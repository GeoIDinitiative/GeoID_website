...
import * as sidecar from "./research/sidecar.js?v=20260908-1357e7f";
import { toGeoJson } from "./vector-formats.js?v=20260908-1357e7f";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260908-1357e7f";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260908-1357e7f");
