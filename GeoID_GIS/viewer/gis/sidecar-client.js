...
import * as sidecar from "./research/sidecar.js?v=20260827-80c964b";
import { toGeoJson } from "./vector-formats.js?v=20260827-80c964b";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260827-80c964b";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260827-80c964b");
