...
import * as sidecar from "./research/sidecar.js?v=20260822-0525c9b";
import { toGeoJson } from "./vector-formats.js?v=20260822-0525c9b";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260822-0525c9b";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260822-0525c9b");
