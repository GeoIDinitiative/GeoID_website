...
import * as sidecar from "./research/sidecar.js?v=20260831-fd2a91f";
import { toGeoJson } from "./vector-formats.js?v=20260831-fd2a91f";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260831-fd2a91f";
