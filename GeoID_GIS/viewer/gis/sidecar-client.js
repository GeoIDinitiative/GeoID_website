...
import * as sidecar from "./research/sidecar.js?v=20260902-76018fd";
import { toGeoJson } from "./vector-formats.js?v=20260902-76018fd";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260902-76018fd";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260902-76018fd");
