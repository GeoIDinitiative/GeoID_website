...
import * as sidecar from "./research/sidecar.js?v=20260816-08df52e";
import { toGeoJson } from "./vector-formats.js?v=20260816-08df52e";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260816-08df52e";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260816-08df52e");
