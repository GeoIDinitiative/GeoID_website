...
import * as sidecar from "./research/sidecar.js?v=20260910-95bdfcc";
import { toGeoJson } from "./vector-formats.js?v=20260910-95bdfcc";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260910-95bdfcc";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260910-95bdfcc");
