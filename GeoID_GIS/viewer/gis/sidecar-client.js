...
import * as sidecar from "./research/sidecar.js?v=20260910-e1d61fb";
import { toGeoJson } from "./vector-formats.js?v=20260910-e1d61fb";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260910-e1d61fb";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260910-e1d61fb");
