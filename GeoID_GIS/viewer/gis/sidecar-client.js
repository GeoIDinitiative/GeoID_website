...
import * as sidecar from "./research/sidecar.js?v=20260820-7c152ed";
import { toGeoJson } from "./vector-formats.js?v=20260820-7c152ed";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260820-7c152ed";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260820-7c152ed");
