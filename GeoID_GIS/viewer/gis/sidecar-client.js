...
import * as sidecar from "./research/sidecar.js?v=20260909-139a227";
import { toGeoJson } from "./vector-formats.js?v=20260909-139a227";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260909-139a227";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260909-139a227");
