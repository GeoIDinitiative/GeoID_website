...
import * as sidecar from "./research/sidecar.js?v=20260816-547d4bf";
import { toGeoJson } from "./vector-formats.js?v=20260816-547d4bf";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260816-547d4bf";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260816-547d4bf");
