...
import * as sidecar from "./research/sidecar.js?v=20260827-5f1a5bb";
import { toGeoJson } from "./vector-formats.js?v=20260827-5f1a5bb";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260827-5f1a5bb";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260827-5f1a5bb");
