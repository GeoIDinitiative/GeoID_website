...
import * as sidecar from "./research/sidecar.js?v=20260816-e9794bf";
import { toGeoJson } from "./vector-formats.js?v=20260816-e9794bf";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260816-e9794bf";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260816-e9794bf");
