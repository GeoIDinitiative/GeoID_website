...
import * as sidecar from "./research/sidecar.js?v=20260825-631d9fa";
import { toGeoJson } from "./vector-formats.js?v=20260825-631d9fa";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260825-631d9fa";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260825-631d9fa");
