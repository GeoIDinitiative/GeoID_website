...
import * as sidecar from "./research/sidecar.js?v=20260827-2d7acfd";
import { toGeoJson } from "./vector-formats.js?v=20260827-2d7acfd";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260827-2d7acfd";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260827-2d7acfd");
