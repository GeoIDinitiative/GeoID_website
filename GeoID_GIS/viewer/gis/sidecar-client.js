...
import * as sidecar from "./research/sidecar.js?v=20260910-038cffc";
import { toGeoJson } from "./vector-formats.js?v=20260910-038cffc";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260910-038cffc";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260910-038cffc");
