...
import * as sidecar from "./research/sidecar.js?v=20260831-9afd15a";
import { toGeoJson } from "./vector-formats.js?v=20260831-9afd15a";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260831-9afd15a";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260831-9afd15a");
