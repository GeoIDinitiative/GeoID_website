...
import * as sidecar from "./research/sidecar.js?v=20260911-cd1cf4d";
import { toGeoJson } from "./vector-formats.js?v=20260911-cd1cf4d";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260911-cd1cf4d";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260911-cd1cf4d");
