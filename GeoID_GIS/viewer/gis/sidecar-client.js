...
import * as sidecar from "./research/sidecar.js?v=20260919-78b90bb";
import { toGeoJson } from "./vector-formats.js?v=20260919-78b90bb";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260919-78b90bb";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260919-78b90bb");
