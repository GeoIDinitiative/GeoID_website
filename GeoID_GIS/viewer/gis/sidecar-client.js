...
import * as sidecar from "./research/sidecar.js?v=20260901-31bd6ac";
import { toGeoJson } from "./vector-formats.js?v=20260901-31bd6ac";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260901-31bd6ac";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260901-31bd6ac");
