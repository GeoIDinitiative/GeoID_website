...
import * as sidecar from "./research/sidecar.js?v=20260910-fc6a32e";
import { toGeoJson } from "./vector-formats.js?v=20260910-fc6a32e";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260910-fc6a32e";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260910-fc6a32e");
