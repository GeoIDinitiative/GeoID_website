...
import * as sidecar from "./research/sidecar.js?v=20260915-2a75eee";
import { toGeoJson } from "./vector-formats.js?v=20260915-2a75eee";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260915-2a75eee";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260915-2a75eee");
