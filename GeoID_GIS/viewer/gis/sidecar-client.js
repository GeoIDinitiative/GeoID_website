...
import * as sidecar from "./research/sidecar.js?v=20260817-aef6fce";
import { toGeoJson } from "./vector-formats.js?v=20260817-aef6fce";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260817-aef6fce";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260817-aef6fce");
