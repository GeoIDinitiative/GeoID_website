...
import * as sidecar from "./research/sidecar.js?v=20260912-41e666e";
import { toGeoJson } from "./vector-formats.js?v=20260912-41e666e";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260912-41e666e";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260912-41e666e");
