...
import * as sidecar from "./research/sidecar.js?v=20260911-79b3dcf";
import { toGeoJson } from "./vector-formats.js?v=20260911-79b3dcf";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260911-79b3dcf";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260911-79b3dcf");
