...
import * as sidecar from "./research/sidecar.js?v=20260830-4d334dc";
import { toGeoJson } from "./vector-formats.js?v=20260830-4d334dc";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260830-4d334dc";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260830-4d334dc");
