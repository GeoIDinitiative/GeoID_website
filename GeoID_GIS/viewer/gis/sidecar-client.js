...
import * as sidecar from "./research/sidecar.js?v=20260816-7f8e66b";
import { toGeoJson } from "./vector-formats.js?v=20260816-7f8e66b";
import { writeGeoTiff } from "./geotiff-writer.js?v=20260816-7f8e66b";
...
export async function runSidecarEngine(desc, inputs, params, outputName) {
  ...
  const bridge = await import("./research/bridge.js?v=20260816-7f8e66b");
