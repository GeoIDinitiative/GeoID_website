...
import * as VF from "./vector-formats.js?v=20260908-f45bf2a";
import { downloadText } from "./extraction.js?v=20260908-f45bf2a";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260908-f45bf2a";
