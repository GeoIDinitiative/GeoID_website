...
import * as VF from "./vector-formats.js?v=20260901-bd1cc2f";
import { downloadText } from "./extraction.js?v=20260901-bd1cc2f";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260901-bd1cc2f";
