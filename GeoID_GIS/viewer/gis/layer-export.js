...
import * as VF from "./vector-formats.js?v=20260828-be98b1a";
import { downloadText } from "./extraction.js?v=20260828-be98b1a";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES } from "./shapefile-writer.js?v=20260828-be98b1a";
