...
import * as VF from "./vector-formats.js?v=20260912-28305db";
import { downloadText } from "./extraction.js?v=20260912-28305db";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260912-28305db";
