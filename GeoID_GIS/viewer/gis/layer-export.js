...
import * as VF from "./vector-formats.js?v=20260910-3e9f5be";
import { downloadText } from "./extraction.js?v=20260910-3e9f5be";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260910-3e9f5be";
