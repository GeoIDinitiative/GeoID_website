...
import * as VF from "./vector-formats.js?v=20260908-32f54a4";
import { downloadText } from "./extraction.js?v=20260908-32f54a4";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260908-32f54a4";
