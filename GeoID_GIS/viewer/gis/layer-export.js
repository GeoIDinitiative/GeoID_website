...
import * as VF from "./vector-formats.js?v=20260908-cafe4a0";
import { downloadText } from "./extraction.js?v=20260908-cafe4a0";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260908-cafe4a0";
