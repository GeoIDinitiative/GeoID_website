...
import * as VF from "./vector-formats.js?v=20260911-0776ffa";
import { downloadText } from "./extraction.js?v=20260911-0776ffa";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260911-0776ffa";
