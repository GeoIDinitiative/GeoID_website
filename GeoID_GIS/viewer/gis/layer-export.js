...
import * as VF from "./vector-formats.js?v=20260903-707d5b9";
import { downloadText } from "./extraction.js?v=20260903-707d5b9";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260903-707d5b9";
