...
import * as VF from "./vector-formats.js?v=20260821-d1e8adb";
import { downloadText } from "./extraction.js?v=20260821-d1e8adb";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES } from "./shapefile-writer.js?v=20260821-d1e8adb";
