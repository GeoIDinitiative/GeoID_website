...
import * as VF from "./vector-formats.js?v=20260914-9fe2e4a";
import { downloadText } from "./extraction.js?v=20260914-9fe2e4a";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260914-9fe2e4a";
