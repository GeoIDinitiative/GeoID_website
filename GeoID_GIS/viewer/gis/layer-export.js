...
import * as VF from "./vector-formats.js?v=20260905-f8b2b19";
import { downloadText } from "./extraction.js?v=20260905-f8b2b19";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260905-f8b2b19";
