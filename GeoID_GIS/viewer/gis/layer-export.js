...
import * as VF from "./vector-formats.js?v=20260818-d7ebe33";
import { downloadText } from "./extraction.js?v=20260818-d7ebe33";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES } from "./shapefile-writer.js?v=20260818-d7ebe33";
