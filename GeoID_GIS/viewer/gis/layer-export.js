...
import * as VF from "./vector-formats.js?v=20260911-231e03f";
import { downloadText } from "./extraction.js?v=20260911-231e03f";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260911-231e03f";
