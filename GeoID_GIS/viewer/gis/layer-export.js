...
import * as VF from "./vector-formats.js?v=20260817-f57d1df";
import { downloadText } from "./extraction.js?v=20260817-f57d1df";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES } from "./shapefile-writer.js?v=20260817-f57d1df";
