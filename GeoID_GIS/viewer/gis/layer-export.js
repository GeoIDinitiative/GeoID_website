...
import * as VF from "./vector-formats.js?v=20260902-0995c0f";
import { downloadText } from "./extraction.js?v=20260902-0995c0f";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260902-0995c0f";
