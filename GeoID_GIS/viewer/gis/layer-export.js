...
import * as VF from "./vector-formats.js?v=20260909-d242a3e";
import { downloadText } from "./extraction.js?v=20260909-d242a3e";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260909-d242a3e";
