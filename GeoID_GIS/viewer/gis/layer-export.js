...
import * as VF from "./vector-formats.js?v=20260910-f54ac16";
import { downloadText } from "./extraction.js?v=20260910-f54ac16";
import { buildShapefileZip, shapeTypeFor, SHAPE_NAMES, safeShapefileName,
  countSelfTouchingRings } from "./shapefile-writer.js?v=20260910-f54ac16";
