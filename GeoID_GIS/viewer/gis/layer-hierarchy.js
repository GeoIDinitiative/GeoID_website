...
import { bandOf } from "./draw-order.js?v=20260909-60ff59c";
import { paintOpacity } from "./layer-opacity.js?v=20260909-60ff59c";
import { currentBody } from "./bodies.js?v=20260909-60ff59c";
import { samplerToRaster } from "./raster-analysis.js?v=20260909-60ff59c";
import { buildRasterLayer } from "./geotiff-adapter.js?v=20260909-60ff59c";
import { datasetInfoButton } from "./catalogue-list.js?v=20260909-60ff59c";
import { isCatalogueLayer } from "./global-data.js?v=20260909-60ff59c";
import { MODEL_MODE_RADIUS } from "./geo-utils.js?v=20260909-60ff59c";
import {
  openSymbologyDialog, geometrySummary, geometryKind,
} from "./symbology-dialog.js?v=20260909-60ff59c";
import { chipHtml, typeSelect, applyTag, descriptionOf, isUserInput } from "./data-tags.js?v=20260909-60ff59c";
...
function layerColour(layer) {
  ...
  return fromVertex || fromMaterial || "var(--skin-data)";
}
