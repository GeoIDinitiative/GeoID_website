...
import { nearestSource, BANDS } from "./river-zones.js?v=20260911-acdf2a0";
 ...
 */
export function mergeOuterDepth(depth, outer, bounds, width, height, water = null) {
  if (!outer?.depth) return depth;
