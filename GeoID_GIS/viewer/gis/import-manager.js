...
import { loadStlFromArrayBuffer } from "./stl-loader-adapter.js?v=20260905-256204f";
import { loadGeoTiffFromArrayBuffer, buildRasterLayer } from "./geotiff-adapter.js?v=20260905-256204f";
import { loadObj, loadPly, parseAsciiGrid } from "./mesh-formats.js?v=20260905-256204f";
import { parseGeoJson, parseKml, parseGpx, parseWkt } from "./vector-formats.js?v=20260905-256204f";
import {
...
import { loadShapefile } from "./shapefile-adapter.js?v=20260905-256204f";
import { loadXyzPoints } from "./xyz-adapter.js?v=20260905-256204f";
import { loadMshFile } from "./msh-adapter.js?v=20260905-256204f";
import { frameGlobeBounds, placeLocalModel } from "./geo-utils.js?v=20260905-256204f";
import { defaultOpacityFor } from "./layer-opacity.js?v=20260905-256204f";
...
window.GeoIDImportManager = {
  ...
  releaseLayer,
  getLayers: () => layers,
  /** The relief the followed layers are drawn at -- for verifying that a
      layer never lags the ground, which is otherwise only checkable by eye. */
  getRenderRelief,
