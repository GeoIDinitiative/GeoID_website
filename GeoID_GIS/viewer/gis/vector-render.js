...
import { latLonToVector3, drapedRadius, looksLikeGeographic, sphericalPolygonAreaKm2 }
  from "./geo-utils.js?v=20260920-1e7b58d";
import { collectionBounds, geometryCoords, polygonsOf, linesOf } from "./geoprocessing.js?v=20260920-1e7b58d";
...
import { categoricalSymbology, suggestCategoryField } from "./symbology.js?v=20260920-1e7b58d";
