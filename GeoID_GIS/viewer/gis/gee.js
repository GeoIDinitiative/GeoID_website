...
import { attachReliefAttributes, followRelief } from "./vector-render.js?v=20260830-262805a";
import { latLonToVector3, drapedRadius } from "./geo-utils.js?v=20260830-262805a";
import { geeSamplerFromImage, columnName } from "./gee-sample.js?v=20260830-262805a";
import { visibleBounds, viewChangedEnough, onViewSettled }
  from "./view-extent.js?v=20260830-262805a";
import {
  resolvePolygonExtent, refreshPolygonOptions, promptDrawTool, drawnOverlayBounds,
  persistExtent,
} from "./extent-picker.js?v=20260830-262805a";
...
} from "./gee-catalogue-index.js?v=20260830-262805a";
...
async function openGeeDialog(homeName) {
  ...
  if (!geeMap) {
    mapLibrary = mapLibrary || await import("./research/map2d.js?v=20260830-262805a");
