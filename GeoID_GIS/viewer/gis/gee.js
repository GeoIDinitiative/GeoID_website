...
import { latLonToVector3, drapedRadius } from "./geo-utils.js?v=20260902-9fcef8f";
import { geeSamplerFromImage, columnName } from "./gee-sample.js?v=20260902-9fcef8f";
import { visibleBounds, viewChangedEnough, onViewSettled }
  from "./view-extent.js?v=20260902-9fcef8f";
import {
  resolvePolygonExtent, refreshPolygonOptions, promptDrawTool, drawnOverlayBounds,
  persistExtent,
} from "./extent-picker.js?v=20260902-9fcef8f";
...
} from "./gee-catalogue-index.js?v=20260902-9fcef8f";
...
async function openGeeDialog(homeName) {
  ...
  if (!geeMap) {
    mapLibrary = mapLibrary || await import("./research/map2d.js?v=20260902-9fcef8f");
