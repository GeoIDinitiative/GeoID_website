...
import { attachReliefAttributes, followRelief } from "./vector-render.js?v=20260830-d21568c";
import { latLonToVector3, drapedRadius } from "./geo-utils.js?v=20260830-d21568c";
import { geeSamplerFromImage, columnName } from "./gee-sample.js?v=20260830-d21568c";
import { visibleBounds, viewChangedEnough, onViewSettled }
  from "./view-extent.js?v=20260830-d21568c";
import {
  resolvePolygonExtent, refreshPolygonOptions, promptDrawTool, drawnOverlayBounds,
  persistExtent,
} from "./extent-picker.js?v=20260830-d21568c";
...
} from "./gee-catalogue-index.js?v=20260830-d21568c";
...
async function openGeeDialog(homeName) {
  ...
  if (!geeMap) {
    mapLibrary = mapLibrary || await import("./research/map2d.js?v=20260830-d21568c");
