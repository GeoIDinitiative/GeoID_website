...
import { latLonToVector3, drapedRadius } from "./geo-utils.js?v=20260901-0fb185c";
import { geeSamplerFromImage, columnName } from "./gee-sample.js?v=20260901-0fb185c";
import { visibleBounds, viewChangedEnough, onViewSettled }
  from "./view-extent.js?v=20260901-0fb185c";
import {
  resolvePolygonExtent, refreshPolygonOptions, promptDrawTool, drawnOverlayBounds,
  persistExtent,
} from "./extent-picker.js?v=20260901-0fb185c";
...
} from "./gee-catalogue-index.js?v=20260901-0fb185c";
...
async function openGeeDialog(homeName) {
  ...
  if (!geeMap) {
    mapLibrary = mapLibrary || await import("./research/map2d.js?v=20260901-0fb185c");
