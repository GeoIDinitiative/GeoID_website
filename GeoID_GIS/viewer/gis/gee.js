...
import { attachReliefAttributes, followRelief } from "./vector-render.js?v=20260828-536703d";
import { latLonToVector3, drapedRadius } from "./geo-utils.js?v=20260828-536703d";
import { geeSamplerFromImage, columnName } from "./gee-sample.js?v=20260828-536703d";
import { visibleBounds, viewChangedEnough, onViewSettled }
  from "./view-extent.js?v=20260828-536703d";
import {
  resolvePolygonExtent, refreshPolygonOptions, promptDrawTool, drawnOverlayBounds,
  persistExtent,
} from "./extent-picker.js?v=20260828-536703d";
...
} from "./gee-catalogue-index.js?v=20260828-536703d";
...
async function openGeeDialog(homeName) {
  ...
  if (!geeMap) {
    mapLibrary = mapLibrary || await import("./research/map2d.js?v=20260828-536703d");
