...
import { latLonToVector3, drapedRadius } from "./geo-utils.js?v=20260902-dd8203e";
import { geeSamplerFromImage, columnName } from "./gee-sample.js?v=20260902-dd8203e";
import { visibleBounds, viewChangedEnough, onViewSettled }
  from "./view-extent.js?v=20260902-dd8203e";
import {
  resolvePolygonExtent, refreshPolygonOptions, promptDrawTool, drawnOverlayBounds,
  persistExtent,
} from "./extent-picker.js?v=20260902-dd8203e";
...
} from "./gee-catalogue-index.js?v=20260902-dd8203e";
...
async function openGeeDialog(homeName) {
  ...
  if (!geeMap) {
    mapLibrary = mapLibrary || await import("./research/map2d.js?v=20260902-dd8203e");
