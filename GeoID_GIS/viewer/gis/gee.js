...
import { latLonToVector3, drapedRadius } from "./geo-utils.js?v=20260831-07f3e3f";
import { geeSamplerFromImage, columnName } from "./gee-sample.js?v=20260831-07f3e3f";
import { visibleBounds, viewChangedEnough, onViewSettled }
  from "./view-extent.js?v=20260831-07f3e3f";
import {
  resolvePolygonExtent, refreshPolygonOptions, promptDrawTool, drawnOverlayBounds,
  persistExtent,
} from "./extent-picker.js?v=20260831-07f3e3f";
...
} from "./gee-catalogue-index.js?v=20260831-07f3e3f";
...
async function openGeeDialog(homeName) {
  ...
  if (!geeMap) {
    mapLibrary = mapLibrary || await import("./research/map2d.js?v=20260831-07f3e3f");
