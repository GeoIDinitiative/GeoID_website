...
import { latLonToVector3, drapedRadius } from "./geo-utils.js?v=20260901-9575d66";
import { geeSamplerFromImage, columnName } from "./gee-sample.js?v=20260901-9575d66";
import { visibleBounds, viewChangedEnough, onViewSettled }
  from "./view-extent.js?v=20260901-9575d66";
import {
  resolvePolygonExtent, refreshPolygonOptions, promptDrawTool, drawnOverlayBounds,
  persistExtent,
} from "./extent-picker.js?v=20260901-9575d66";
...
} from "./gee-catalogue-index.js?v=20260901-9575d66";
...
async function openGeeDialog(homeName) {
  ...
  if (!geeMap) {
    mapLibrary = mapLibrary || await import("./research/map2d.js?v=20260901-9575d66");
