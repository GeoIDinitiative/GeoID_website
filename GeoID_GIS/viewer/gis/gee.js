...
import { latLonToVector3, drapedRadius } from "./geo-utils.js?v=20260828-53769a0";
import { geeSamplerFromImage, columnName } from "./gee-sample.js?v=20260828-53769a0";
...
import {
  ...
  persistExtent,
} from "./extent-picker.js?v=20260828-53769a0";
...
} from "./gee-catalogue-index.js?v=20260828-53769a0";
...
async function openGeeDialog(homeName) {
  ...
  if (!geeMap) {
    mapLibrary = mapLibrary || await import("./research/map2d.js?v=20260828-53769a0");
