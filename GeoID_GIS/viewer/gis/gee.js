...
import { attachReliefAttributes, followRelief } from "./vector-render.js?v=20260831-dcc4018";
import { latLonToVector3, drapedRadius } from "./geo-utils.js?v=20260831-dcc4018";
import { geeSamplerFromImage, columnName } from "./gee-sample.js?v=20260831-dcc4018";
import { visibleBounds, viewChangedEnough, onViewSettled }
  from "./view-extent.js?v=20260831-dcc4018";
import {
  resolvePolygonExtent, refreshPolygonOptions, promptDrawTool, drawnOverlayBounds,
  persistExtent,
} from "./extent-picker.js?v=20260831-dcc4018";
...
} from "./gee-catalogue-index.js?v=20260831-dcc4018";
...
async function openGeeDialog(homeName) {
  ...
  if (!geeMap) {
    mapLibrary = mapLibrary || await import("./research/map2d.js?v=20260831-dcc4018");
