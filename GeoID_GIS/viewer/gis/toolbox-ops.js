...
import * as RA from "./raster-analysis.js?v=20260830-0af4d12";
import * as VF from "./vector-formats.js?v=20260830-0af4d12";
import { buildVectorLayerResult } from "./vector-render.js?v=20260830-0af4d12";
...
import { CRS_OPTIONS } from "./projection.js?v=20260830-0af4d12";
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-0af4d12";
import { selection } from "./selection.js?v=20260830-0af4d12";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-0af4d12");
  } catch {
