...
import * as RA from "./raster-analysis.js?v=20260901-6ffcdfa";
import * as VF from "./vector-formats.js?v=20260901-6ffcdfa";
import { buildVectorLayerResult } from "./vector-render.js?v=20260901-6ffcdfa";
...
import { CRS_OPTIONS } from "./projection.js?v=20260901-6ffcdfa";
import { runQuery, QUERY_HELP } from "./query.js?v=20260901-6ffcdfa";
import { selection } from "./selection.js?v=20260901-6ffcdfa";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260901-6ffcdfa");
  } catch {
