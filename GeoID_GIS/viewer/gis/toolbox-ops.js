import * as GP from "./geoprocessing.js?v=20260911-da2bfde";
import * as RA from "./raster-analysis.js?v=20260911-da2bfde";
import * as VF from "./vector-formats.js?v=20260911-da2bfde";
import { buildVectorLayerResult } from "./vector-render.js?v=20260911-da2bfde";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260911-da2bfde";
import { selection } from "./selection.js?v=20260911-da2bfde";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260911-da2bfde");
  } catch {
