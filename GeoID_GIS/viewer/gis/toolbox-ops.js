import * as GP from "./geoprocessing.js?v=20260831-687d68a";
import * as RA from "./raster-analysis.js?v=20260831-687d68a";
import * as VF from "./vector-formats.js?v=20260831-687d68a";
import { buildVectorLayerResult } from "./vector-render.js?v=20260831-687d68a";
...
import { CRS_OPTIONS } from "./projection.js?v=20260831-687d68a";
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-687d68a";
import { selection } from "./selection.js?v=20260831-687d68a";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-687d68a");
  } catch {
