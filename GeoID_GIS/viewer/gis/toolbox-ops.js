import * as GP from "./geoprocessing.js?v=20260910-4a62fde";
import * as RA from "./raster-analysis.js?v=20260910-4a62fde";
import * as VF from "./vector-formats.js?v=20260910-4a62fde";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-4a62fde";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260910-4a62fde";
import { selection } from "./selection.js?v=20260910-4a62fde";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260910-4a62fde");
  } catch {
