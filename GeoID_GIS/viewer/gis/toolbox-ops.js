import * as GP from "./geoprocessing.js?v=20260910-77438fc";
import * as RA from "./raster-analysis.js?v=20260910-77438fc";
import * as VF from "./vector-formats.js?v=20260910-77438fc";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-77438fc";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260910-77438fc";
import { selection } from "./selection.js?v=20260910-77438fc";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260910-77438fc");
  } catch {
