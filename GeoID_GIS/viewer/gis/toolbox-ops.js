import * as GP from "./geoprocessing.js?v=20260827-c21ab4c";
import * as RA from "./raster-analysis.js?v=20260827-c21ab4c";
import * as VF from "./vector-formats.js?v=20260827-c21ab4c";
import { buildVectorLayerResult } from "./vector-render.js?v=20260827-c21ab4c";
...
import { CRS_OPTIONS } from "./projection.js?v=20260827-c21ab4c";
import { runQuery, QUERY_HELP } from "./query.js?v=20260827-c21ab4c";
import { selection } from "./selection.js?v=20260827-c21ab4c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260827-c21ab4c");
  } catch {
