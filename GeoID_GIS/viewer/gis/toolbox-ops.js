import * as GP from "./geoprocessing.js?v=20260830-97628ed";
import * as RA from "./raster-analysis.js?v=20260830-97628ed";
import * as VF from "./vector-formats.js?v=20260830-97628ed";
import { buildVectorLayerResult } from "./vector-render.js?v=20260830-97628ed";
...
import { CRS_OPTIONS } from "./projection.js?v=20260830-97628ed";
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-97628ed";
import { selection } from "./selection.js?v=20260830-97628ed";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-97628ed");
  } catch {
