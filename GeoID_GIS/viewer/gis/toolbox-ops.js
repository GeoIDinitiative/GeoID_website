import * as GP from "./geoprocessing.js?v=20260920-724172f";
import * as RA from "./raster-analysis.js?v=20260920-724172f";
import * as VF from "./vector-formats.js?v=20260920-724172f";
import { buildVectorLayerResult } from "./vector-render.js?v=20260920-724172f";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260920-724172f";
import { selection } from "./selection.js?v=20260920-724172f";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260920-724172f");
  } catch {
