...
import { runQuery, QUERY_HELP } from "./query.js?v=20260903-2983b5d";
import { selection } from "./selection.js?v=20260903-2983b5d";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260903-2983b5d");
  } catch {
