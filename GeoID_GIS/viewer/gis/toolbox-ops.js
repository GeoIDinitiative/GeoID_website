import * as GP from "./geoprocessing.js?v=20260829-cf6abbb";
import * as RA from "./raster-analysis.js?v=20260829-cf6abbb";
import * as VF from "./vector-formats.js?v=20260829-cf6abbb";
import { buildVectorLayerResult } from "./vector-render.js?v=20260829-cf6abbb";
...
import { CRS_OPTIONS } from "./projection.js?v=20260829-cf6abbb";
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-cf6abbb";
import { selection } from "./selection.js?v=20260829-cf6abbb";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-cf6abbb");
  } catch {
