import * as GP from "./geoprocessing.js?v=20260910-571bffd";
import * as RA from "./raster-analysis.js?v=20260910-571bffd";
import * as VF from "./vector-formats.js?v=20260910-571bffd";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-571bffd";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260910-571bffd";
import { selection } from "./selection.js?v=20260910-571bffd";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260910-571bffd");
  } catch {
