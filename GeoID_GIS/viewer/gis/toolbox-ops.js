...
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-5cd6a46";
import { selection } from "./selection.js?v=20260829-5cd6a46";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-5cd6a46");
  } catch {
