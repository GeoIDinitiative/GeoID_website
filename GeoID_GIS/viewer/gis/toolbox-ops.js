import * as GP from "./geoprocessing.js?v=20260908-294767f";
import * as RA from "./raster-analysis.js?v=20260908-294767f";
import * as VF from "./vector-formats.js?v=20260908-294767f";
import { buildVectorLayerResult } from "./vector-render.js?v=20260908-294767f";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260908-294767f";
import { selection } from "./selection.js?v=20260908-294767f";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260908-294767f");
  } catch {
