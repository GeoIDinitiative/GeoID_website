import * as GP from "./geoprocessing.js?v=20260831-b26f122";
import * as RA from "./raster-analysis.js?v=20260831-b26f122";
import * as VF from "./vector-formats.js?v=20260831-b26f122";
import { buildVectorLayerResult } from "./vector-render.js?v=20260831-b26f122";
...
import { CRS_OPTIONS } from "./projection.js?v=20260831-b26f122";
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-b26f122";
import { selection } from "./selection.js?v=20260831-b26f122";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-b26f122");
  } catch {
