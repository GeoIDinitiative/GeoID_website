...
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-7985cf8";
import { selection } from "./selection.js?v=20260829-7985cf8";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-7985cf8");
  } catch {
