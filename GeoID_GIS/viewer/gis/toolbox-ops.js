import * as GP from "./geoprocessing.js?v=20260827-5f1a5bb";
import * as RA from "./raster-analysis.js?v=20260827-5f1a5bb";
...
import { CRS_OPTIONS } from "./projection.js?v=20260827-5f1a5bb";
import { runQuery, QUERY_HELP } from "./query.js?v=20260827-5f1a5bb";
import { selection } from "./selection.js?v=20260827-5f1a5bb";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260827-5f1a5bb");
  } catch {
