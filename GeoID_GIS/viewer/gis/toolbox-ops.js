import * as GP from "./geoprocessing.js?v=20260919-a6338fd";
import * as RA from "./raster-analysis.js?v=20260919-a6338fd";
import * as VF from "./vector-formats.js?v=20260919-a6338fd";
import { buildVectorLayerResult } from "./vector-render.js?v=20260919-a6338fd";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260919-a6338fd";
import { selection } from "./selection.js?v=20260919-a6338fd";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260919-a6338fd");
  } catch {
