...
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-94ab3f0";
import { selection } from "./selection.js?v=20260831-94ab3f0";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-94ab3f0");
  } catch {
