import * as GP from "./geoprocessing.js?v=20260910-8e7baef";
import * as RA from "./raster-analysis.js?v=20260910-8e7baef";
import * as VF from "./vector-formats.js?v=20260910-8e7baef";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-8e7baef";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260910-8e7baef";
import { selection } from "./selection.js?v=20260910-8e7baef";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260910-8e7baef");
  } catch {
