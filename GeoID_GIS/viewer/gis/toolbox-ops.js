...
import { runQuery, QUERY_HELP } from "./query.js?v=20260904-200ef9b";
import { selection } from "./selection.js?v=20260904-200ef9b";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260904-200ef9b");
  } catch {
