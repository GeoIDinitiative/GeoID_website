import * as GP from "./geoprocessing.js?v=20260903-965d9bd";
import * as RA from "./raster-analysis.js?v=20260903-965d9bd";
import * as VF from "./vector-formats.js?v=20260903-965d9bd";
import { buildVectorLayerResult } from "./vector-render.js?v=20260903-965d9bd";
...
import { CRS_OPTIONS } from "./projection.js?v=20260903-965d9bd";
import { runQuery, QUERY_HELP } from "./query.js?v=20260903-965d9bd";
import { selection } from "./selection.js?v=20260903-965d9bd";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260903-965d9bd");
  } catch {
