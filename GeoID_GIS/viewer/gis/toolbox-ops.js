...
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-6197226";
import { selection } from "./selection.js?v=20260829-6197226";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-6197226");
  } catch {
