import * as GP from "./geoprocessing.js?v=20260908-f9360ff";
import * as RA from "./raster-analysis.js?v=20260908-f9360ff";
import * as VF from "./vector-formats.js?v=20260908-f9360ff";
import { buildVectorLayerResult } from "./vector-render.js?v=20260908-f9360ff";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260908-f9360ff";
import { selection } from "./selection.js?v=20260908-f9360ff";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260908-f9360ff");
  } catch {
