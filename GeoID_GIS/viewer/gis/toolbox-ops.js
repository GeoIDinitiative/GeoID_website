import * as GP from "./geoprocessing.js?v=20260826-cd9ecce";
import * as RA from "./raster-analysis.js?v=20260826-cd9ecce";
import * as VF from "./vector-formats.js?v=20260826-cd9ecce";
import { buildVectorLayerResult } from "./vector-render.js?v=20260826-cd9ecce";
...
import { CRS_OPTIONS } from "./projection.js?v=20260826-cd9ecce";
import { runQuery, QUERY_HELP } from "./query.js?v=20260826-cd9ecce";
import { selection } from "./selection.js?v=20260826-cd9ecce";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260826-cd9ecce");
  } catch {
