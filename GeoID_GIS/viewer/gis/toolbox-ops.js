import * as GP from "./geoprocessing.js?v=20260828-f00d0ce";
import * as RA from "./raster-analysis.js?v=20260828-f00d0ce";
import * as VF from "./vector-formats.js?v=20260828-f00d0ce";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-f00d0ce";
...
import { CRS_OPTIONS } from "./projection.js?v=20260828-f00d0ce";
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-f00d0ce";
import { selection } from "./selection.js?v=20260828-f00d0ce";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-f00d0ce");
  } catch {
