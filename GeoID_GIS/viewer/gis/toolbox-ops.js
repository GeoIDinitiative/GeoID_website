import * as GP from "./geoprocessing.js?v=20260919-d4689ee";
import * as RA from "./raster-analysis.js?v=20260919-d4689ee";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260919-d4689ee";
import { selection } from "./selection.js?v=20260919-d4689ee";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260919-d4689ee");
  } catch {
