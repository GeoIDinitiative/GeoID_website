import * as GP from "./geoprocessing.js?v=20260828-8cd2919";
import * as RA from "./raster-analysis.js?v=20260828-8cd2919";
import * as VF from "./vector-formats.js?v=20260828-8cd2919";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-8cd2919";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-8cd2919";
import { selection } from "./selection.js?v=20260828-8cd2919";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-8cd2919");
  } catch {
