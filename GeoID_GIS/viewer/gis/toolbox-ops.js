import * as GP from "./geoprocessing.js?v=20260830-4d334dc";
import * as RA from "./raster-analysis.js?v=20260830-4d334dc";
import * as VF from "./vector-formats.js?v=20260830-4d334dc";
import { buildVectorLayerResult } from "./vector-render.js?v=20260830-4d334dc";
...
import { CRS_OPTIONS } from "./projection.js?v=20260830-4d334dc";
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-4d334dc";
import { selection } from "./selection.js?v=20260830-4d334dc";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-4d334dc");
  } catch {
