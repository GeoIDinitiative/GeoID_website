import * as GP from "./geoprocessing.js?v=20260915-d574d90";
import * as RA from "./raster-analysis.js?v=20260915-d574d90";
import * as VF from "./vector-formats.js?v=20260915-d574d90";
import { buildVectorLayerResult } from "./vector-render.js?v=20260915-d574d90";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260915-d574d90";
import { selection } from "./selection.js?v=20260915-d574d90";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260915-d574d90");
  } catch {
