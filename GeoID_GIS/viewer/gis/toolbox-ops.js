...
import * as RA from "./raster-analysis.js?v=20260830-c299dad";
import * as VF from "./vector-formats.js?v=20260830-c299dad";
import { buildVectorLayerResult } from "./vector-render.js?v=20260830-c299dad";
...
import { CRS_OPTIONS } from "./projection.js?v=20260830-c299dad";
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-c299dad";
import { selection } from "./selection.js?v=20260830-c299dad";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-c299dad");
  } catch {
