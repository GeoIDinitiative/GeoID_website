import * as GP from "./geoprocessing.js?v=20260818-f7ce008";
import * as RA from "./raster-analysis.js?v=20260818-f7ce008";
import * as VF from "./vector-formats.js?v=20260818-f7ce008";
import { buildVectorLayerResult } from "./vector-render.js?v=20260818-f7ce008";
...
import { CRS_OPTIONS } from "./projection.js?v=20260818-f7ce008";
import { runQuery, QUERY_HELP } from "./query.js?v=20260818-f7ce008";
import { selection } from "./selection.js?v=20260818-f7ce008";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260818-f7ce008");
  } catch {
