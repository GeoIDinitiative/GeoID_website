import * as GP from "./geoprocessing.js?v=20260902-0cb4e4f";
import * as RA from "./raster-analysis.js?v=20260902-0cb4e4f";
import * as VF from "./vector-formats.js?v=20260902-0cb4e4f";
import { buildVectorLayerResult } from "./vector-render.js?v=20260902-0cb4e4f";
...
import { CRS_OPTIONS } from "./projection.js?v=20260902-0cb4e4f";
import { runQuery, QUERY_HELP } from "./query.js?v=20260902-0cb4e4f";
import { selection } from "./selection.js?v=20260902-0cb4e4f";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260902-0cb4e4f");
  } catch {
