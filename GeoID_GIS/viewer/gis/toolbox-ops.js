import * as GP from "./geoprocessing.js?v=20260828-d7a673c";
import * as RA from "./raster-analysis.js?v=20260828-d7a673c";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-d7a673c";
import { selection } from "./selection.js?v=20260828-d7a673c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-d7a673c");
  } catch {
