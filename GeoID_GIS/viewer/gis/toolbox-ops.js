import * as GP from "./geoprocessing.js?v=20260916-b88e8af";
import * as RA from "./raster-analysis.js?v=20260916-b88e8af";
import * as VF from "./vector-formats.js?v=20260916-b88e8af";
import { buildVectorLayerResult } from "./vector-render.js?v=20260916-b88e8af";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260916-b88e8af";
import { selection } from "./selection.js?v=20260916-b88e8af";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260916-b88e8af");
  } catch {
