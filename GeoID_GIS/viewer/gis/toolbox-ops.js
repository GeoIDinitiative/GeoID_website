import * as GP from "./geoprocessing.js?v=20260919-b0ce896";
import * as RA from "./raster-analysis.js?v=20260919-b0ce896";
import * as VF from "./vector-formats.js?v=20260919-b0ce896";
import { buildVectorLayerResult } from "./vector-render.js?v=20260919-b0ce896";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260919-b0ce896";
import { selection } from "./selection.js?v=20260919-b0ce896";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260919-b0ce896");
  } catch {
