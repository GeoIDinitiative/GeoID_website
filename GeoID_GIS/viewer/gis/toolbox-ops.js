import * as GP from "./geoprocessing.js?v=20260912-4b6c6ec";
import * as RA from "./raster-analysis.js?v=20260912-4b6c6ec";
import * as VF from "./vector-formats.js?v=20260912-4b6c6ec";
import { buildVectorLayerResult } from "./vector-render.js?v=20260912-4b6c6ec";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260912-4b6c6ec";
import { selection } from "./selection.js?v=20260912-4b6c6ec";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260912-4b6c6ec");
  } catch {
