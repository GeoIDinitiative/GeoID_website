import * as GP from "./geoprocessing.js?v=20260821-c97c8db";
import * as RA from "./raster-analysis.js?v=20260821-c97c8db";
import * as VF from "./vector-formats.js?v=20260821-c97c8db";
import { buildVectorLayerResult } from "./vector-render.js?v=20260821-c97c8db";
...
import { CRS_OPTIONS } from "./projection.js?v=20260821-c97c8db";
import { runQuery, QUERY_HELP } from "./query.js?v=20260821-c97c8db";
import { selection } from "./selection.js?v=20260821-c97c8db";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260821-c97c8db");
  } catch {
