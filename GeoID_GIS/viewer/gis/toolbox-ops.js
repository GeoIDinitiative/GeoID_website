import * as GP from "./geoprocessing.js?v=20260827-5caec2a";
import * as RA from "./raster-analysis.js?v=20260827-5caec2a";
import * as VF from "./vector-formats.js?v=20260827-5caec2a";
import { buildVectorLayerResult } from "./vector-render.js?v=20260827-5caec2a";
...
import { CRS_OPTIONS } from "./projection.js?v=20260827-5caec2a";
import { runQuery, QUERY_HELP } from "./query.js?v=20260827-5caec2a";
import { selection } from "./selection.js?v=20260827-5caec2a";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260827-5caec2a");
  } catch {
