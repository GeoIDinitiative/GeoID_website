import * as GP from "./geoprocessing.js?v=20260909-24d6edb";
import * as RA from "./raster-analysis.js?v=20260909-24d6edb";
import * as VF from "./vector-formats.js?v=20260909-24d6edb";
import { buildVectorLayerResult } from "./vector-render.js?v=20260909-24d6edb";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260909-24d6edb";
import { selection } from "./selection.js?v=20260909-24d6edb";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260909-24d6edb");
  } catch {
