...
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-e9c73b1";
import { selection } from "./selection.js?v=20260829-e9c73b1";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-e9c73b1");
  } catch {
