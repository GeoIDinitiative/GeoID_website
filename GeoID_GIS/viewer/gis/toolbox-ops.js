...
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-d3cc9f6";
import { selection } from "./selection.js?v=20260829-d3cc9f6";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-d3cc9f6");
  } catch {
