import * as GP from "./geoprocessing.js?v=20260828-3353e2b";
import * as RA from "./raster-analysis.js?v=20260828-3353e2b";
import * as VF from "./vector-formats.js?v=20260828-3353e2b";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-3353e2b";
...
import { CRS_OPTIONS } from "./projection.js?v=20260828-3353e2b";
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-3353e2b";
import { selection } from "./selection.js?v=20260828-3353e2b";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-3353e2b");
  } catch {
