import * as GP from "./geoprocessing.js?v=20260909-a2d80ee";
import * as RA from "./raster-analysis.js?v=20260909-a2d80ee";
import * as VF from "./vector-formats.js?v=20260909-a2d80ee";
import { buildVectorLayerResult } from "./vector-render.js?v=20260909-a2d80ee";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260909-a2d80ee";
import { selection } from "./selection.js?v=20260909-a2d80ee";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260909-a2d80ee");
  } catch {
