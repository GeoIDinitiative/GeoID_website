...
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-4030a73";
import { selection } from "./selection.js?v=20260828-4030a73";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-4030a73");
  } catch {
