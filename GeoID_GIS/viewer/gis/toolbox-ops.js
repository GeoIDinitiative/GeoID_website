...
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-e513d83";
import { selection } from "./selection.js?v=20260831-e513d83";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-e513d83");
  } catch {
