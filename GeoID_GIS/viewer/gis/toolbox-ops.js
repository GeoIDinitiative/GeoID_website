import * as GP from "./geoprocessing.js?v=20260915-fe100ae";
import * as RA from "./raster-analysis.js?v=20260915-fe100ae";
import * as VF from "./vector-formats.js?v=20260915-fe100ae";
import { buildVectorLayerResult } from "./vector-render.js?v=20260915-fe100ae";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260915-fe100ae";
import { selection } from "./selection.js?v=20260915-fe100ae";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260915-fe100ae");
  } catch {
