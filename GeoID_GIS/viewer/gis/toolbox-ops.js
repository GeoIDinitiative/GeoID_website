import * as GP from "./geoprocessing.js?v=20260829-525555a";
import * as RA from "./raster-analysis.js?v=20260829-525555a";
import * as VF from "./vector-formats.js?v=20260829-525555a";
import { buildVectorLayerResult } from "./vector-render.js?v=20260829-525555a";
...
import { CRS_OPTIONS } from "./projection.js?v=20260829-525555a";
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-525555a";
import { selection } from "./selection.js?v=20260829-525555a";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-525555a");
  } catch {
