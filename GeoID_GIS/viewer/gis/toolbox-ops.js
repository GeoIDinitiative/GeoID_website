import * as GP from "./geoprocessing.js?v=20260831-b0a7fcc";
import * as RA from "./raster-analysis.js?v=20260831-b0a7fcc";
import * as VF from "./vector-formats.js?v=20260831-b0a7fcc";
import { buildVectorLayerResult } from "./vector-render.js?v=20260831-b0a7fcc";
...
import { CRS_OPTIONS } from "./projection.js?v=20260831-b0a7fcc";
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-b0a7fcc";
import { selection } from "./selection.js?v=20260831-b0a7fcc";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-b0a7fcc");
  } catch {
