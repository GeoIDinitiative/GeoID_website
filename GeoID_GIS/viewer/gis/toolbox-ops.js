import * as GP from "./geoprocessing.js?v=20260916-bf9edbc";
import * as RA from "./raster-analysis.js?v=20260916-bf9edbc";
import * as VF from "./vector-formats.js?v=20260916-bf9edbc";
import { buildVectorLayerResult } from "./vector-render.js?v=20260916-bf9edbc";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260916-bf9edbc";
import { selection } from "./selection.js?v=20260916-bf9edbc";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260916-bf9edbc");
  } catch {
