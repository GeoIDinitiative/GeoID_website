import * as GP from "./geoprocessing.js?v=20260829-9509145";
import * as RA from "./raster-analysis.js?v=20260829-9509145";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-9509145";
import { selection } from "./selection.js?v=20260829-9509145";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-9509145");
  } catch {
