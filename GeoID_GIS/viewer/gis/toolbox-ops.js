import * as GP from "./geoprocessing.js?v=20260919-4bf29ee";
import * as RA from "./raster-analysis.js?v=20260919-4bf29ee";
import * as VF from "./vector-formats.js?v=20260919-4bf29ee";
import { buildVectorLayerResult } from "./vector-render.js?v=20260919-4bf29ee";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260919-4bf29ee";
import { selection } from "./selection.js?v=20260919-4bf29ee";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260919-4bf29ee");
  } catch {
