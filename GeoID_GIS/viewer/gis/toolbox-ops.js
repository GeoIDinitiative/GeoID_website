import * as GP from "./geoprocessing.js?v=20260903-c5fa13f";
import * as RA from "./raster-analysis.js?v=20260903-c5fa13f";
import * as VF from "./vector-formats.js?v=20260903-c5fa13f";
import { buildVectorLayerResult } from "./vector-render.js?v=20260903-c5fa13f";
...
import { CRS_OPTIONS } from "./projection.js?v=20260903-c5fa13f";
import { runQuery, QUERY_HELP } from "./query.js?v=20260903-c5fa13f";
import { selection } from "./selection.js?v=20260903-c5fa13f";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260903-c5fa13f");
  } catch {
