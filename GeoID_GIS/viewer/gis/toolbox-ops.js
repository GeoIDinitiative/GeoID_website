import * as GP from "./geoprocessing.js?v=20260912-b8e3eef";
import * as RA from "./raster-analysis.js?v=20260912-b8e3eef";
import * as VF from "./vector-formats.js?v=20260912-b8e3eef";
import { buildVectorLayerResult } from "./vector-render.js?v=20260912-b8e3eef";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260912-b8e3eef";
import { selection } from "./selection.js?v=20260912-b8e3eef";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260912-b8e3eef");
  } catch {
