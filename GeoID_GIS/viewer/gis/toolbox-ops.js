import * as GP from "./geoprocessing.js?v=20260816-6ce8ecd";
import * as RA from "./raster-analysis.js?v=20260816-6ce8ecd";
import * as VF from "./vector-formats.js?v=20260816-6ce8ecd";
import { buildVectorLayerResult } from "./vector-render.js?v=20260816-6ce8ecd";
...
import { CRS_OPTIONS } from "./projection.js?v=20260816-6ce8ecd";
import { runQuery, QUERY_HELP } from "./query.js?v=20260816-6ce8ecd";
import { selection } from "./selection.js?v=20260816-6ce8ecd";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260816-6ce8ecd");
  } catch {
