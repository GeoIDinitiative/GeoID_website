import * as GP from "./geoprocessing.js?v=20260912-136b2bf";
import * as RA from "./raster-analysis.js?v=20260912-136b2bf";
import * as VF from "./vector-formats.js?v=20260912-136b2bf";
import { buildVectorLayerResult } from "./vector-render.js?v=20260912-136b2bf";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260912-136b2bf";
import { selection } from "./selection.js?v=20260912-136b2bf";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260912-136b2bf");
  } catch {
