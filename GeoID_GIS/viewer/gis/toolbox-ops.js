...
import { runQuery, QUERY_HELP } from "./query.js?v=20260904-8334fff";
import { selection } from "./selection.js?v=20260904-8334fff";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260904-8334fff");
  } catch {
