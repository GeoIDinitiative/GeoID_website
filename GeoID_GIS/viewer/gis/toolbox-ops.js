import * as GP from "./geoprocessing.js?v=20260830-14d2b0c";
import * as RA from "./raster-analysis.js?v=20260830-14d2b0c";
import * as VF from "./vector-formats.js?v=20260830-14d2b0c";
import { buildVectorLayerResult } from "./vector-render.js?v=20260830-14d2b0c";
...
import { CRS_OPTIONS } from "./projection.js?v=20260830-14d2b0c";
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-14d2b0c";
import { selection } from "./selection.js?v=20260830-14d2b0c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-14d2b0c");
  } catch {
