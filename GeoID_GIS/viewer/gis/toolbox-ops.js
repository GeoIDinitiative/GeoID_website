import * as GP from "./geoprocessing.js?v=20260903-eee230b";
import * as RA from "./raster-analysis.js?v=20260903-eee230b";
import * as VF from "./vector-formats.js?v=20260903-eee230b";
import { buildVectorLayerResult } from "./vector-render.js?v=20260903-eee230b";
...
import { CRS_OPTIONS } from "./projection.js?v=20260903-eee230b";
import { runQuery, QUERY_HELP } from "./query.js?v=20260903-eee230b";
import { selection } from "./selection.js?v=20260903-eee230b";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260903-eee230b");
  } catch {
