import * as GP from "./geoprocessing.js?v=20260831-f0bd25c";
import * as RA from "./raster-analysis.js?v=20260831-f0bd25c";
import * as VF from "./vector-formats.js?v=20260831-f0bd25c";
import { buildVectorLayerResult } from "./vector-render.js?v=20260831-f0bd25c";
...
import { CRS_OPTIONS } from "./projection.js?v=20260831-f0bd25c";
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-f0bd25c";
import { selection } from "./selection.js?v=20260831-f0bd25c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-f0bd25c");
  } catch {
