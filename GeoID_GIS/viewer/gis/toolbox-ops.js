import * as GP from "./geoprocessing.js?v=20260902-76018fd";
import * as RA from "./raster-analysis.js?v=20260902-76018fd";
import * as VF from "./vector-formats.js?v=20260902-76018fd";
import { buildVectorLayerResult } from "./vector-render.js?v=20260902-76018fd";
...
import { CRS_OPTIONS } from "./projection.js?v=20260902-76018fd";
import { runQuery, QUERY_HELP } from "./query.js?v=20260902-76018fd";
import { selection } from "./selection.js?v=20260902-76018fd";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260902-76018fd");
  } catch {
