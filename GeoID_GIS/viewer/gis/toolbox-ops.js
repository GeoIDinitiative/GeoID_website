import * as GP from "./geoprocessing.js?v=20260910-7b939fa";
import * as RA from "./raster-analysis.js?v=20260910-7b939fa";
import * as VF from "./vector-formats.js?v=20260910-7b939fa";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-7b939fa";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260910-7b939fa";
import { selection } from "./selection.js?v=20260910-7b939fa";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260910-7b939fa");
  } catch {
