...
import { runQuery, QUERY_HELP } from "./query.js?v=20260818-d95b0ab";
import { selection } from "./selection.js?v=20260818-d95b0ab";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260818-d95b0ab");
  } catch {
