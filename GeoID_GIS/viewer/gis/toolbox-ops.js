import * as GP from "./geoprocessing.js?v=20260909-8a7d11d";
import * as RA from "./raster-analysis.js?v=20260909-8a7d11d";
import * as VF from "./vector-formats.js?v=20260909-8a7d11d";
import { buildVectorLayerResult } from "./vector-render.js?v=20260909-8a7d11d";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260909-8a7d11d";
import { selection } from "./selection.js?v=20260909-8a7d11d";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260909-8a7d11d");
  } catch {
