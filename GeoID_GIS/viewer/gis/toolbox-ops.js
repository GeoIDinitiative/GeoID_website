import * as GP from "./geoprocessing.js?v=20260909-0df0bcc";
import * as RA from "./raster-analysis.js?v=20260909-0df0bcc";
import * as VF from "./vector-formats.js?v=20260909-0df0bcc";
import { buildVectorLayerResult } from "./vector-render.js?v=20260909-0df0bcc";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260909-0df0bcc";
import { selection } from "./selection.js?v=20260909-0df0bcc";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260909-0df0bcc");
  } catch {
