import * as GP from "./geoprocessing.js?v=20260822-0525c9b";
import * as RA from "./raster-analysis.js?v=20260822-0525c9b";
import * as VF from "./vector-formats.js?v=20260822-0525c9b";
import { buildVectorLayerResult } from "./vector-render.js?v=20260822-0525c9b";
...
import { CRS_OPTIONS } from "./projection.js?v=20260822-0525c9b";
import { runQuery, QUERY_HELP } from "./query.js?v=20260822-0525c9b";
import { selection } from "./selection.js?v=20260822-0525c9b";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260822-0525c9b");
  } catch {
