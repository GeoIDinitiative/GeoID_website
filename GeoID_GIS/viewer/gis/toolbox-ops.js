import * as GP from "./geoprocessing.js?v=20260915-3e86bba";
import * as RA from "./raster-analysis.js?v=20260915-3e86bba";
import * as VF from "./vector-formats.js?v=20260915-3e86bba";
import { buildVectorLayerResult } from "./vector-render.js?v=20260915-3e86bba";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260915-3e86bba";
import { selection } from "./selection.js?v=20260915-3e86bba";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260915-3e86bba");
  } catch {
