import * as GP from "./geoprocessing.js?v=20260911-d7f4f8c";
import * as RA from "./raster-analysis.js?v=20260911-d7f4f8c";
import * as VF from "./vector-formats.js?v=20260911-d7f4f8c";
import { buildVectorLayerResult } from "./vector-render.js?v=20260911-d7f4f8c";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260911-d7f4f8c";
import { selection } from "./selection.js?v=20260911-d7f4f8c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260911-d7f4f8c");
  } catch {
