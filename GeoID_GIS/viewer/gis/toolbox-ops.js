import * as GP from "./geoprocessing.js?v=20260916-ab8bf4e";
import * as RA from "./raster-analysis.js?v=20260916-ab8bf4e";
import * as VF from "./vector-formats.js?v=20260916-ab8bf4e";
import { buildVectorLayerResult } from "./vector-render.js?v=20260916-ab8bf4e";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260916-ab8bf4e";
import { selection } from "./selection.js?v=20260916-ab8bf4e";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260916-ab8bf4e");
  } catch {
