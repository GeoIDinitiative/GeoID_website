import * as GP from "./geoprocessing.js?v=20260817-aef6fce";
import * as RA from "./raster-analysis.js?v=20260817-aef6fce";
import * as VF from "./vector-formats.js?v=20260817-aef6fce";
import { buildVectorLayerResult } from "./vector-render.js?v=20260817-aef6fce";
...
import { CRS_OPTIONS } from "./projection.js?v=20260817-aef6fce";
import { runQuery, QUERY_HELP } from "./query.js?v=20260817-aef6fce";
import { selection } from "./selection.js?v=20260817-aef6fce";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260817-aef6fce");
  } catch {
