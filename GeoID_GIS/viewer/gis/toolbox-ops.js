...
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-4030884";
import { selection } from "./selection.js?v=20260829-4030884";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-4030884");
  } catch {
