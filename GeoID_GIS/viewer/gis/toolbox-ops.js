import * as GP from "./geoprocessing.js?v=20260909-d64ef6c";
import * as RA from "./raster-analysis.js?v=20260909-d64ef6c";
import * as VF from "./vector-formats.js?v=20260909-d64ef6c";
import { buildVectorLayerResult } from "./vector-render.js?v=20260909-d64ef6c";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260909-d64ef6c";
import { selection } from "./selection.js?v=20260909-d64ef6c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260909-d64ef6c");
  } catch {
