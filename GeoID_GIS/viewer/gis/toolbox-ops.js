import * as GP from "./geoprocessing.js?v=20260831-500876b";
import * as RA from "./raster-analysis.js?v=20260831-500876b";
import * as VF from "./vector-formats.js?v=20260831-500876b";
import { buildVectorLayerResult } from "./vector-render.js?v=20260831-500876b";
...
import { CRS_OPTIONS } from "./projection.js?v=20260831-500876b";
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-500876b";
import { selection } from "./selection.js?v=20260831-500876b";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-500876b");
  } catch {
