...
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-3fb0f7c";
import { selection } from "./selection.js?v=20260831-3fb0f7c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-3fb0f7c");
  } catch {
