import * as GP from "./geoprocessing.js?v=20260903-3bb3d6a";
import * as RA from "./raster-analysis.js?v=20260903-3bb3d6a";
import * as VF from "./vector-formats.js?v=20260903-3bb3d6a";
import { buildVectorLayerResult } from "./vector-render.js?v=20260903-3bb3d6a";
...
import { CRS_OPTIONS } from "./projection.js?v=20260903-3bb3d6a";
import { runQuery, QUERY_HELP } from "./query.js?v=20260903-3bb3d6a";
import { selection } from "./selection.js?v=20260903-3bb3d6a";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260903-3bb3d6a");
  } catch {
