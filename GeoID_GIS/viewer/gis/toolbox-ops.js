import * as GP from "./geoprocessing.js?v=20260828-e738b7e";
import * as RA from "./raster-analysis.js?v=20260828-e738b7e";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-e738b7e";
import { selection } from "./selection.js?v=20260828-e738b7e";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-e738b7e");
  } catch {
