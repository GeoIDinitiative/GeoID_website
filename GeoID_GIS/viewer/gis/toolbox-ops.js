import * as GP from "./geoprocessing.js?v=20260903-4088cab";
import * as RA from "./raster-analysis.js?v=20260903-4088cab";
import * as VF from "./vector-formats.js?v=20260903-4088cab";
import { buildVectorLayerResult } from "./vector-render.js?v=20260903-4088cab";
...
import { CRS_OPTIONS } from "./projection.js?v=20260903-4088cab";
import { runQuery, QUERY_HELP } from "./query.js?v=20260903-4088cab";
import { selection } from "./selection.js?v=20260903-4088cab";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260903-4088cab");
  } catch {
