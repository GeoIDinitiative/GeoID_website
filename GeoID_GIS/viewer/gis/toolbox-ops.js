import * as GP from "./geoprocessing.js?v=20260826-4d8a13c";
import * as RA from "./raster-analysis.js?v=20260826-4d8a13c";
import * as VF from "./vector-formats.js?v=20260826-4d8a13c";
import { buildVectorLayerResult } from "./vector-render.js?v=20260826-4d8a13c";
...
import { CRS_OPTIONS } from "./projection.js?v=20260826-4d8a13c";
import { runQuery, QUERY_HELP } from "./query.js?v=20260826-4d8a13c";
import { selection } from "./selection.js?v=20260826-4d8a13c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260826-4d8a13c");
  } catch {
