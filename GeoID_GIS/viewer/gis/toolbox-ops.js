...
import { runQuery, QUERY_HELP } from "./query.js?v=20260816-960ffbc";
import { selection } from "./selection.js?v=20260816-960ffbc";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260816-960ffbc");
  } catch {
