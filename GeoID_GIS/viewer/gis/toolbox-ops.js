import * as GP from "./geoprocessing.js?v=20260826-585466e";
import * as RA from "./raster-analysis.js?v=20260826-585466e";
import * as VF from "./vector-formats.js?v=20260826-585466e";
import { buildVectorLayerResult } from "./vector-render.js?v=20260826-585466e";
...
import { CRS_OPTIONS } from "./projection.js?v=20260826-585466e";
import { runQuery, QUERY_HELP } from "./query.js?v=20260826-585466e";
import { selection } from "./selection.js?v=20260826-585466e";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260826-585466e");
  } catch {
