...
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-b9baa90";
import { selection } from "./selection.js?v=20260830-b9baa90";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-b9baa90");
  } catch {
