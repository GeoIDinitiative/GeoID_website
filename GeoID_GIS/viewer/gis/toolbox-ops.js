...
import * as RA from "./raster-analysis.js?v=20260910-6b5c330";
import * as VF from "./vector-formats.js?v=20260910-6b5c330";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-6b5c330";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260910-6b5c330";
import { selection } from "./selection.js?v=20260910-6b5c330";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260910-6b5c330");
  } catch {
