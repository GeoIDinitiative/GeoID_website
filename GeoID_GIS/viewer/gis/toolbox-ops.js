...
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-dc5ff7e";
import { selection } from "./selection.js?v=20260830-dc5ff7e";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-dc5ff7e");
  } catch {
