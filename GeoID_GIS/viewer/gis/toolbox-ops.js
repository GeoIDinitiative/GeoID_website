import * as GP from "./geoprocessing.js?v=20260818-576dd58";
import * as RA from "./raster-analysis.js?v=20260818-576dd58";
import * as VF from "./vector-formats.js?v=20260818-576dd58";
import { buildVectorLayerResult } from "./vector-render.js?v=20260818-576dd58";
...
import { CRS_OPTIONS } from "./projection.js?v=20260818-576dd58";
import { runQuery, QUERY_HELP } from "./query.js?v=20260818-576dd58";
import { selection } from "./selection.js?v=20260818-576dd58";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260818-576dd58");
  } catch {
