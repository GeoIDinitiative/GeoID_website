import * as GP from "./geoprocessing.js?v=20260825-8cb95ab";
import * as RA from "./raster-analysis.js?v=20260825-8cb95ab";
import * as VF from "./vector-formats.js?v=20260825-8cb95ab";
import { buildVectorLayerResult } from "./vector-render.js?v=20260825-8cb95ab";
...
import { CRS_OPTIONS } from "./projection.js?v=20260825-8cb95ab";
import { runQuery, QUERY_HELP } from "./query.js?v=20260825-8cb95ab";
import { selection } from "./selection.js?v=20260825-8cb95ab";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260825-8cb95ab");
  } catch {
