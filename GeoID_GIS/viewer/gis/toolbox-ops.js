import * as GP from "./geoprocessing.js?v=20260831-b81fbab";
import * as RA from "./raster-analysis.js?v=20260831-b81fbab";
import * as VF from "./vector-formats.js?v=20260831-b81fbab";
import { buildVectorLayerResult } from "./vector-render.js?v=20260831-b81fbab";
...
import { CRS_OPTIONS } from "./projection.js?v=20260831-b81fbab";
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-b81fbab";
import { selection } from "./selection.js?v=20260831-b81fbab";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-b81fbab");
  } catch {
