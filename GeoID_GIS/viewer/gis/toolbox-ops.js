import * as GP from "./geoprocessing.js?v=20260825-877d84e";
import * as RA from "./raster-analysis.js?v=20260825-877d84e";
import * as VF from "./vector-formats.js?v=20260825-877d84e";
import { buildVectorLayerResult } from "./vector-render.js?v=20260825-877d84e";
...
import { CRS_OPTIONS } from "./projection.js?v=20260825-877d84e";
import { runQuery, QUERY_HELP } from "./query.js?v=20260825-877d84e";
import { selection } from "./selection.js?v=20260825-877d84e";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260825-877d84e");
  } catch {
