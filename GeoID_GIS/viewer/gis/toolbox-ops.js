...
import * as RA from "./raster-analysis.js?v=20260911-2c8d57d";
import * as VF from "./vector-formats.js?v=20260911-2c8d57d";
import { buildVectorLayerResult } from "./vector-render.js?v=20260911-2c8d57d";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260911-2c8d57d";
import { selection } from "./selection.js?v=20260911-2c8d57d";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260911-2c8d57d");
  } catch {
