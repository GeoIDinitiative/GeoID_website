import * as GP from "./geoprocessing.js?v=20260831-1220b1b";
import * as RA from "./raster-analysis.js?v=20260831-1220b1b";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-1220b1b";
import { selection } from "./selection.js?v=20260831-1220b1b";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-1220b1b");
  } catch {
