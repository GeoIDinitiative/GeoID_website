import * as GP from "./geoprocessing.js?v=20260915-0e63adf";
import * as RA from "./raster-analysis.js?v=20260915-0e63adf";
import * as VF from "./vector-formats.js?v=20260915-0e63adf";
import { buildVectorLayerResult } from "./vector-render.js?v=20260915-0e63adf";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260915-0e63adf";
import { selection } from "./selection.js?v=20260915-0e63adf";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260915-0e63adf");
  } catch {
