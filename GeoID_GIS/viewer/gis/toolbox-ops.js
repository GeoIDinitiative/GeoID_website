import * as GP from "./geoprocessing.js?v=20260910-4df45fd";
import * as RA from "./raster-analysis.js?v=20260910-4df45fd";
import * as VF from "./vector-formats.js?v=20260910-4df45fd";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-4df45fd";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260910-4df45fd";
import { selection } from "./selection.js?v=20260910-4df45fd";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260910-4df45fd");
  } catch {
