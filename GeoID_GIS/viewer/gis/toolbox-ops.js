import * as GP from "./geoprocessing.js?v=20260827-1b4ae4e";
import * as RA from "./raster-analysis.js?v=20260827-1b4ae4e";
import * as VF from "./vector-formats.js?v=20260827-1b4ae4e";
import { buildVectorLayerResult } from "./vector-render.js?v=20260827-1b4ae4e";
...
import { CRS_OPTIONS } from "./projection.js?v=20260827-1b4ae4e";
import { runQuery, QUERY_HELP } from "./query.js?v=20260827-1b4ae4e";
import { selection } from "./selection.js?v=20260827-1b4ae4e";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260827-1b4ae4e");
  } catch {
