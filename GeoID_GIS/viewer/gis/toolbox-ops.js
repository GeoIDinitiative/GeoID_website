import * as GP from "./geoprocessing.js?v=20260831-4a108ec";
import * as RA from "./raster-analysis.js?v=20260831-4a108ec";
import * as VF from "./vector-formats.js?v=20260831-4a108ec";
import { buildVectorLayerResult } from "./vector-render.js?v=20260831-4a108ec";
...
import { CRS_OPTIONS } from "./projection.js?v=20260831-4a108ec";
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-4a108ec";
import { selection } from "./selection.js?v=20260831-4a108ec";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-4a108ec");
  } catch {
