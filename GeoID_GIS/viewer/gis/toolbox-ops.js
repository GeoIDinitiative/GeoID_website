import * as GP from "./geoprocessing.js?v=20260919-62d77fb";
import * as RA from "./raster-analysis.js?v=20260919-62d77fb";
import * as VF from "./vector-formats.js?v=20260919-62d77fb";
import { buildVectorLayerResult } from "./vector-render.js?v=20260919-62d77fb";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260919-62d77fb";
import { selection } from "./selection.js?v=20260919-62d77fb";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260919-62d77fb");
  } catch {
