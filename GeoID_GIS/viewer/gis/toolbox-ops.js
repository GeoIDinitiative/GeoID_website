import * as GP from "./geoprocessing.js?v=20260828-6e7f7fe";
import * as RA from "./raster-analysis.js?v=20260828-6e7f7fe";
import * as VF from "./vector-formats.js?v=20260828-6e7f7fe";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-6e7f7fe";
...
import { CRS_OPTIONS } from "./projection.js?v=20260828-6e7f7fe";
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-6e7f7fe";
import { selection } from "./selection.js?v=20260828-6e7f7fe";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-6e7f7fe");
  } catch {
