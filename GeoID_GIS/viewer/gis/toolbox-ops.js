...
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-1ca9cc0";
import { selection } from "./selection.js?v=20260831-1ca9cc0";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-1ca9cc0");
  } catch {
