import * as GP from "./geoprocessing.js?v=20260912-eacfbab";
import * as RA from "./raster-analysis.js?v=20260912-eacfbab";
import * as VF from "./vector-formats.js?v=20260912-eacfbab";
import { buildVectorLayerResult } from "./vector-render.js?v=20260912-eacfbab";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260912-eacfbab";
import { selection } from "./selection.js?v=20260912-eacfbab";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260912-eacfbab");
  } catch {
