import * as GP from "./geoprocessing.js?v=20260828-be98b1a";
import * as RA from "./raster-analysis.js?v=20260828-be98b1a";
import * as VF from "./vector-formats.js?v=20260828-be98b1a";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-be98b1a";
...
import { CRS_OPTIONS } from "./projection.js?v=20260828-be98b1a";
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-be98b1a";
import { selection } from "./selection.js?v=20260828-be98b1a";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-be98b1a");
  } catch {
