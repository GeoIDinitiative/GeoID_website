import * as GP from "./geoprocessing.js?v=20260817-981a0ae";
import * as RA from "./raster-analysis.js?v=20260817-981a0ae";
...
import { CRS_OPTIONS } from "./projection.js?v=20260817-981a0ae";
import { runQuery, QUERY_HELP } from "./query.js?v=20260817-981a0ae";
import { selection } from "./selection.js?v=20260817-981a0ae";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260817-981a0ae");
  } catch {
