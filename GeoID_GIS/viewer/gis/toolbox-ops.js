import * as GP from "./geoprocessing.js?v=20260828-5dbf95c";
import * as RA from "./raster-analysis.js?v=20260828-5dbf95c";
import * as VF from "./vector-formats.js?v=20260828-5dbf95c";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-5dbf95c";
...
import { CRS_OPTIONS } from "./projection.js?v=20260828-5dbf95c";
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-5dbf95c";
import { selection } from "./selection.js?v=20260828-5dbf95c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-5dbf95c");
  } catch {
