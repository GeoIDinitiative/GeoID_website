import * as GP from "./geoprocessing.js?v=20260916-2c5a8ad";
import * as RA from "./raster-analysis.js?v=20260916-2c5a8ad";
import * as VF from "./vector-formats.js?v=20260916-2c5a8ad";
import { buildVectorLayerResult } from "./vector-render.js?v=20260916-2c5a8ad";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260916-2c5a8ad";
import { selection } from "./selection.js?v=20260916-2c5a8ad";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260916-2c5a8ad");
  } catch {
