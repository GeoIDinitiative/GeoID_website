import * as GP from "./geoprocessing.js?v=20260831-be70440";
import * as RA from "./raster-analysis.js?v=20260831-be70440";
import * as VF from "./vector-formats.js?v=20260831-be70440";
import { buildVectorLayerResult } from "./vector-render.js?v=20260831-be70440";
...
import { CRS_OPTIONS } from "./projection.js?v=20260831-be70440";
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-be70440";
import { selection } from "./selection.js?v=20260831-be70440";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-be70440");
  } catch {
