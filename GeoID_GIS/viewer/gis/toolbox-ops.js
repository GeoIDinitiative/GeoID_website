import * as GP from "./geoprocessing.js?v=20260920-817c7fc";
import * as RA from "./raster-analysis.js?v=20260920-817c7fc";
import * as VF from "./vector-formats.js?v=20260920-817c7fc";
import { buildVectorLayerResult } from "./vector-render.js?v=20260920-817c7fc";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260920-817c7fc";
import { selection } from "./selection.js?v=20260920-817c7fc";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260920-817c7fc");
  } catch {
