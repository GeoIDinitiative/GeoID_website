import * as GP from "./geoprocessing.js?v=20260827-636ce9c";
import * as RA from "./raster-analysis.js?v=20260827-636ce9c";
...
import { CRS_OPTIONS } from "./projection.js?v=20260827-636ce9c";
import { runQuery, QUERY_HELP } from "./query.js?v=20260827-636ce9c";
import { selection } from "./selection.js?v=20260827-636ce9c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260827-636ce9c");
  } catch {
