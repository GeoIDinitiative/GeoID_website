...
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-78b3fc0";
import { selection } from "./selection.js?v=20260830-78b3fc0";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-78b3fc0");
  } catch {
