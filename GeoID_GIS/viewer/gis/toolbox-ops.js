...
import * as RA from "./raster-analysis.js?v=20260830-538554b";
import * as VF from "./vector-formats.js?v=20260830-538554b";
import { buildVectorLayerResult } from "./vector-render.js?v=20260830-538554b";
...
import { CRS_OPTIONS } from "./projection.js?v=20260830-538554b";
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-538554b";
import { selection } from "./selection.js?v=20260830-538554b";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-538554b");
  } catch {
