import * as GP from "./geoprocessing.js?v=20260828-8a780da";
import * as RA from "./raster-analysis.js?v=20260828-8a780da";
import * as VF from "./vector-formats.js?v=20260828-8a780da";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-8a780da";
...
import { CRS_OPTIONS } from "./projection.js?v=20260828-8a780da";
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-8a780da";
import { selection } from "./selection.js?v=20260828-8a780da";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-8a780da");
  } catch {
