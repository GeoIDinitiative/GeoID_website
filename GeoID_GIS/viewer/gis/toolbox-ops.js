import * as GP from "./geoprocessing.js?v=20260910-5468fdc";
import * as RA from "./raster-analysis.js?v=20260910-5468fdc";
import * as VF from "./vector-formats.js?v=20260910-5468fdc";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-5468fdc";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260910-5468fdc";
import { selection } from "./selection.js?v=20260910-5468fdc";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260910-5468fdc");
  } catch {
