import * as GP from "./geoprocessing.js?v=20260828-17debbb";
import * as RA from "./raster-analysis.js?v=20260828-17debbb";
import * as VF from "./vector-formats.js?v=20260828-17debbb";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-17debbb";
...
import { CRS_OPTIONS } from "./projection.js?v=20260828-17debbb";
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-17debbb";
import { selection } from "./selection.js?v=20260828-17debbb";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-17debbb");
  } catch {
