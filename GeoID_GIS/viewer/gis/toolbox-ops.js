...
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-2c501eb";
import { selection } from "./selection.js?v=20260828-2c501eb";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-2c501eb");
  } catch {
