import * as GP from "./geoprocessing.js?v=20260829-f33b428";
import * as RA from "./raster-analysis.js?v=20260829-f33b428";
import * as VF from "./vector-formats.js?v=20260829-f33b428";
import { buildVectorLayerResult } from "./vector-render.js?v=20260829-f33b428";
...
import { CRS_OPTIONS } from "./projection.js?v=20260829-f33b428";
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-f33b428";
import { selection } from "./selection.js?v=20260829-f33b428";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-f33b428");
  } catch {
