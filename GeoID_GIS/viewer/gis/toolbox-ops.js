import * as GP from "./geoprocessing.js?v=20260903-83171fb";
import * as RA from "./raster-analysis.js?v=20260903-83171fb";
import * as VF from "./vector-formats.js?v=20260903-83171fb";
import { buildVectorLayerResult } from "./vector-render.js?v=20260903-83171fb";
...
import { CRS_OPTIONS } from "./projection.js?v=20260903-83171fb";
import { runQuery, QUERY_HELP } from "./query.js?v=20260903-83171fb";
import { selection } from "./selection.js?v=20260903-83171fb";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260903-83171fb");
  } catch {
