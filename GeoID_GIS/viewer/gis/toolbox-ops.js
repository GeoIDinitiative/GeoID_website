import * as GP from "./geoprocessing.js?v=20260831-489244a";
import * as RA from "./raster-analysis.js?v=20260831-489244a";
import * as VF from "./vector-formats.js?v=20260831-489244a";
import { buildVectorLayerResult } from "./vector-render.js?v=20260831-489244a";
...
import { CRS_OPTIONS } from "./projection.js?v=20260831-489244a";
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-489244a";
import { selection } from "./selection.js?v=20260831-489244a";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-489244a");
  } catch {
