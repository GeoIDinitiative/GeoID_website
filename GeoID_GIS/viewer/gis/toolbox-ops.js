import * as GP from "./geoprocessing.js?v=20260821-4cbbabb";
import * as RA from "./raster-analysis.js?v=20260821-4cbbabb";
import * as VF from "./vector-formats.js?v=20260821-4cbbabb";
import { buildVectorLayerResult } from "./vector-render.js?v=20260821-4cbbabb";
...
import { CRS_OPTIONS } from "./projection.js?v=20260821-4cbbabb";
import { runQuery, QUERY_HELP } from "./query.js?v=20260821-4cbbabb";
import { selection } from "./selection.js?v=20260821-4cbbabb";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260821-4cbbabb");
  } catch {
