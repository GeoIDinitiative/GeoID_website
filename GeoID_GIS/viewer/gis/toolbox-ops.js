import * as GP from "./geoprocessing.js?v=20260817-f57d1df";
import * as RA from "./raster-analysis.js?v=20260817-f57d1df";
import * as VF from "./vector-formats.js?v=20260817-f57d1df";
import { buildVectorLayerResult } from "./vector-render.js?v=20260817-f57d1df";
...
import { CRS_OPTIONS } from "./projection.js?v=20260817-f57d1df";
import { runQuery, QUERY_HELP } from "./query.js?v=20260817-f57d1df";
import { selection } from "./selection.js?v=20260817-f57d1df";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260817-f57d1df");
  } catch {
