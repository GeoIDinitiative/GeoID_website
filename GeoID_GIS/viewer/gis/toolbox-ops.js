import * as GP from "./geoprocessing.js?v=20260903-4f44fbb";
import * as RA from "./raster-analysis.js?v=20260903-4f44fbb";
import * as VF from "./vector-formats.js?v=20260903-4f44fbb";
import { buildVectorLayerResult } from "./vector-render.js?v=20260903-4f44fbb";
...
import { CRS_OPTIONS } from "./projection.js?v=20260903-4f44fbb";
import { runQuery, QUERY_HELP } from "./query.js?v=20260903-4f44fbb";
import { selection } from "./selection.js?v=20260903-4f44fbb";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260903-4f44fbb");
  } catch {
