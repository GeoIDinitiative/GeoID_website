import * as GP from "./geoprocessing.js?v=20260911-06476dc";
import * as RA from "./raster-analysis.js?v=20260911-06476dc";
import * as VF from "./vector-formats.js?v=20260911-06476dc";
import { buildVectorLayerResult } from "./vector-render.js?v=20260911-06476dc";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260911-06476dc";
import { selection } from "./selection.js?v=20260911-06476dc";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260911-06476dc");
  } catch {
