...
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-602b59b";
import { selection } from "./selection.js?v=20260829-602b59b";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-602b59b");
  } catch {
