import * as GP from "./geoprocessing.js?v=20260831-bc6d692";
import * as RA from "./raster-analysis.js?v=20260831-bc6d692";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-bc6d692";
import { selection } from "./selection.js?v=20260831-bc6d692";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-bc6d692");
  } catch {
