import * as GP from "./geoprocessing.js?v=20260831-c94a0da";
import * as RA from "./raster-analysis.js?v=20260831-c94a0da";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-c94a0da";
import { selection } from "./selection.js?v=20260831-c94a0da";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-c94a0da");
  } catch {
