import * as GP from "./geoprocessing.js?v=20260905-36e4cce";
import * as RA from "./raster-analysis.js?v=20260905-36e4cce";
import * as VF from "./vector-formats.js?v=20260905-36e4cce";
import { buildVectorLayerResult } from "./vector-render.js?v=20260905-36e4cce";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260905-36e4cce";
import { selection } from "./selection.js?v=20260905-36e4cce";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260905-36e4cce");
  } catch {
