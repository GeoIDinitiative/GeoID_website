...
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-c879e4f";
import { selection } from "./selection.js?v=20260830-c879e4f";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-c879e4f");
  } catch {
