import * as GP from "./geoprocessing.js?v=20260826-3316f0e";
import * as RA from "./raster-analysis.js?v=20260826-3316f0e";
import * as VF from "./vector-formats.js?v=20260826-3316f0e";
import { buildVectorLayerResult } from "./vector-render.js?v=20260826-3316f0e";
...
import { CRS_OPTIONS } from "./projection.js?v=20260826-3316f0e";
import { runQuery, QUERY_HELP } from "./query.js?v=20260826-3316f0e";
import { selection } from "./selection.js?v=20260826-3316f0e";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260826-3316f0e");
  } catch {
