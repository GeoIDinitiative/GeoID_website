import * as GP from "./geoprocessing.js?v=20260822-e946bec";
import * as RA from "./raster-analysis.js?v=20260822-e946bec";
import * as VF from "./vector-formats.js?v=20260822-e946bec";
import { buildVectorLayerResult } from "./vector-render.js?v=20260822-e946bec";
...
import { CRS_OPTIONS } from "./projection.js?v=20260822-e946bec";
import { runQuery, QUERY_HELP } from "./query.js?v=20260822-e946bec";
import { selection } from "./selection.js?v=20260822-e946bec";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260822-e946bec");
  } catch {
