import * as GP from "./geoprocessing.js?v=20260915-2a75eee";
import * as RA from "./raster-analysis.js?v=20260915-2a75eee";
import * as VF from "./vector-formats.js?v=20260915-2a75eee";
import { buildVectorLayerResult } from "./vector-render.js?v=20260915-2a75eee";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260915-2a75eee";
import { selection } from "./selection.js?v=20260915-2a75eee";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260915-2a75eee");
  } catch {
