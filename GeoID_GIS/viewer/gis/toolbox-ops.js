...
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-8d8f261";
import { selection } from "./selection.js?v=20260831-8d8f261";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-8d8f261");
  } catch {
