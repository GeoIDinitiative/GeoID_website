...
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-8a9afe7";
import { selection } from "./selection.js?v=20260829-8a9afe7";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-8a9afe7");
  } catch {
