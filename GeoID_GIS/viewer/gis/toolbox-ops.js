import * as GP from "./geoprocessing.js?v=20260909-d6a403c";
import * as RA from "./raster-analysis.js?v=20260909-d6a403c";
import * as VF from "./vector-formats.js?v=20260909-d6a403c";
import { buildVectorLayerResult } from "./vector-render.js?v=20260909-d6a403c";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260909-d6a403c";
import { selection } from "./selection.js?v=20260909-d6a403c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260909-d6a403c");
  } catch {
