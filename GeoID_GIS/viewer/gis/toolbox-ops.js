import * as GP from "./geoprocessing.js?v=20260817-d542f72";
import * as RA from "./raster-analysis.js?v=20260817-d542f72";
...
import { CRS_OPTIONS } from "./projection.js?v=20260817-d542f72";
import { runQuery, QUERY_HELP } from "./query.js?v=20260817-d542f72";
import { selection } from "./selection.js?v=20260817-d542f72";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260817-d542f72");
  } catch {
