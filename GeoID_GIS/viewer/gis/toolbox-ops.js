...
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-398b7e7";
import { selection } from "./selection.js?v=20260828-398b7e7";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-398b7e7");
  } catch {
