import * as GP from "./geoprocessing.js?v=20260828-dec00bc";
import * as RA from "./raster-analysis.js?v=20260828-dec00bc";
import * as VF from "./vector-formats.js?v=20260828-dec00bc";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-dec00bc";
...
import { CRS_OPTIONS } from "./projection.js?v=20260828-dec00bc";
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-dec00bc";
import { selection } from "./selection.js?v=20260828-dec00bc";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-dec00bc");
  } catch {
