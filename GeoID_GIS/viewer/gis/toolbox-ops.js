import * as GP from "./geoprocessing.js?v=20260911-0776ffa";
import * as RA from "./raster-analysis.js?v=20260911-0776ffa";
import * as VF from "./vector-formats.js?v=20260911-0776ffa";
import { buildVectorLayerResult } from "./vector-render.js?v=20260911-0776ffa";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260911-0776ffa";
import { selection } from "./selection.js?v=20260911-0776ffa";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260911-0776ffa");
  } catch {
