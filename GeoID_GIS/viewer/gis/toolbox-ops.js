...
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-0b5e89a";
import { selection } from "./selection.js?v=20260829-0b5e89a";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-0b5e89a");
  } catch {
