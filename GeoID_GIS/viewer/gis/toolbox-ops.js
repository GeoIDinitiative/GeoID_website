import * as GP from "./geoprocessing.js?v=20260821-2f431fd";
import * as RA from "./raster-analysis.js?v=20260821-2f431fd";
import * as VF from "./vector-formats.js?v=20260821-2f431fd";
import { buildVectorLayerResult } from "./vector-render.js?v=20260821-2f431fd";
...
import { CRS_OPTIONS } from "./projection.js?v=20260821-2f431fd";
import { runQuery, QUERY_HELP } from "./query.js?v=20260821-2f431fd";
import { selection } from "./selection.js?v=20260821-2f431fd";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260821-2f431fd");
  } catch {
