import * as GP from "./geoprocessing.js?v=20260902-84811cf";
import * as RA from "./raster-analysis.js?v=20260902-84811cf";
import * as VF from "./vector-formats.js?v=20260902-84811cf";
import { buildVectorLayerResult } from "./vector-render.js?v=20260902-84811cf";
...
import { CRS_OPTIONS } from "./projection.js?v=20260902-84811cf";
import { runQuery, QUERY_HELP } from "./query.js?v=20260902-84811cf";
import { selection } from "./selection.js?v=20260902-84811cf";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260902-84811cf");
  } catch {
