import * as GP from "./geoprocessing.js?v=20260916-64b58db";
import * as RA from "./raster-analysis.js?v=20260916-64b58db";
import * as VF from "./vector-formats.js?v=20260916-64b58db";
import { buildVectorLayerResult } from "./vector-render.js?v=20260916-64b58db";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260916-64b58db";
import { selection } from "./selection.js?v=20260916-64b58db";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260916-64b58db");
  } catch {
