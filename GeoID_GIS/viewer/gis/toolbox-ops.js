import * as GP from "./geoprocessing.js?v=20260821-d1e8adb";
import * as RA from "./raster-analysis.js?v=20260821-d1e8adb";
import * as VF from "./vector-formats.js?v=20260821-d1e8adb";
import { buildVectorLayerResult } from "./vector-render.js?v=20260821-d1e8adb";
...
import { CRS_OPTIONS } from "./projection.js?v=20260821-d1e8adb";
import { runQuery, QUERY_HELP } from "./query.js?v=20260821-d1e8adb";
import { selection } from "./selection.js?v=20260821-d1e8adb";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260821-d1e8adb");
  } catch {
