import * as GP from "./geoprocessing.js?v=20260916-24452db";
import * as RA from "./raster-analysis.js?v=20260916-24452db";
import * as VF from "./vector-formats.js?v=20260916-24452db";
import { buildVectorLayerResult } from "./vector-render.js?v=20260916-24452db";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260916-24452db";
import { selection } from "./selection.js?v=20260916-24452db";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260916-24452db");
  } catch {
