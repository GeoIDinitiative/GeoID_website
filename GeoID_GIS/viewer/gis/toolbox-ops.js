import * as GP from "./geoprocessing.js?v=20260828-90f68be";
import * as RA from "./raster-analysis.js?v=20260828-90f68be";
import * as VF from "./vector-formats.js?v=20260828-90f68be";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-90f68be";
...
import { CRS_OPTIONS } from "./projection.js?v=20260828-90f68be";
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-90f68be";
import { selection } from "./selection.js?v=20260828-90f68be";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-90f68be");
  } catch {
