...
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-ca4e80a";
import { selection } from "./selection.js?v=20260828-ca4e80a";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-ca4e80a");
  } catch {
