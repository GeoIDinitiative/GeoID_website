import * as GP from "./geoprocessing.js?v=20260827-29377ee";
import * as RA from "./raster-analysis.js?v=20260827-29377ee";
...
import { CRS_OPTIONS } from "./projection.js?v=20260827-29377ee";
import { runQuery, QUERY_HELP } from "./query.js?v=20260827-29377ee";
import { selection } from "./selection.js?v=20260827-29377ee";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260827-29377ee");
  } catch {
