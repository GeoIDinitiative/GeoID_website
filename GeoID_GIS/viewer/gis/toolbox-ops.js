...
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-571718f";
import { selection } from "./selection.js?v=20260829-571718f";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-571718f");
  } catch {
