import * as GP from "./geoprocessing.js?v=20260915-5a781ca";
import * as RA from "./raster-analysis.js?v=20260915-5a781ca";
import * as VF from "./vector-formats.js?v=20260915-5a781ca";
import { buildVectorLayerResult } from "./vector-render.js?v=20260915-5a781ca";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260915-5a781ca";
import { selection } from "./selection.js?v=20260915-5a781ca";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260915-5a781ca");
  } catch {
