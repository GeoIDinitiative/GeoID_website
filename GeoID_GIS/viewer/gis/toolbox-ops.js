import * as GP from "./geoprocessing.js?v=20260820-7c152ed";
import * as RA from "./raster-analysis.js?v=20260820-7c152ed";
import * as VF from "./vector-formats.js?v=20260820-7c152ed";
import { buildVectorLayerResult } from "./vector-render.js?v=20260820-7c152ed";
...
import { CRS_OPTIONS } from "./projection.js?v=20260820-7c152ed";
import { runQuery, QUERY_HELP } from "./query.js?v=20260820-7c152ed";
import { selection } from "./selection.js?v=20260820-7c152ed";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260820-7c152ed");
  } catch {
