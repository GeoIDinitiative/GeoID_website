import * as GP from "./geoprocessing.js?v=20260816-547d4bf";
import * as RA from "./raster-analysis.js?v=20260816-547d4bf";
import * as VF from "./vector-formats.js?v=20260816-547d4bf";
import { buildVectorLayerResult } from "./vector-render.js?v=20260816-547d4bf";
...
import { CRS_OPTIONS } from "./projection.js?v=20260816-547d4bf";
import { runQuery, QUERY_HELP } from "./query.js?v=20260816-547d4bf";
import { selection } from "./selection.js?v=20260816-547d4bf";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260816-547d4bf");
  } catch {
