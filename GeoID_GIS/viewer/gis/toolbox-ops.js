...
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-0d4f8a0";
import { selection } from "./selection.js?v=20260828-0d4f8a0";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-0d4f8a0");
  } catch {
