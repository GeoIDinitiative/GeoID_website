import * as GP from "./geoprocessing.js?v=20260817-a184b6f";
import * as RA from "./raster-analysis.js?v=20260817-a184b6f";
import * as VF from "./vector-formats.js?v=20260817-a184b6f";
import { buildVectorLayerResult } from "./vector-render.js?v=20260817-a184b6f";
...
import { CRS_OPTIONS } from "./projection.js?v=20260817-a184b6f";
import { runQuery, QUERY_HELP } from "./query.js?v=20260817-a184b6f";
import { selection } from "./selection.js?v=20260817-a184b6f";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260817-a184b6f");
  } catch {
