...
import { runQuery, QUERY_HELP } from "./query.js?v=20260816-1a4e46c";
import { selection } from "./selection.js?v=20260816-1a4e46c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260816-1a4e46c");
  } catch {
