import * as GP from "./geoprocessing.js?v=20260909-40d5ccd";
import * as RA from "./raster-analysis.js?v=20260909-40d5ccd";
import * as VF from "./vector-formats.js?v=20260909-40d5ccd";
import { buildVectorLayerResult } from "./vector-render.js?v=20260909-40d5ccd";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260909-40d5ccd";
import { selection } from "./selection.js?v=20260909-40d5ccd";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260909-40d5ccd");
  } catch {
