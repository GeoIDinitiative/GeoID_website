import * as GP from "./geoprocessing.js?v=20260818-55a4fdb";
import * as RA from "./raster-analysis.js?v=20260818-55a4fdb";
...
import { CRS_OPTIONS } from "./projection.js?v=20260818-55a4fdb";
import { runQuery, QUERY_HELP } from "./query.js?v=20260818-55a4fdb";
import { selection } from "./selection.js?v=20260818-55a4fdb";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260818-55a4fdb");
  } catch {
