import * as GP from "./geoprocessing.js?v=20260915-350d02d";
import * as RA from "./raster-analysis.js?v=20260915-350d02d";
import * as VF from "./vector-formats.js?v=20260915-350d02d";
import { buildVectorLayerResult } from "./vector-render.js?v=20260915-350d02d";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260915-350d02d";
import { selection } from "./selection.js?v=20260915-350d02d";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260915-350d02d");
  } catch {
