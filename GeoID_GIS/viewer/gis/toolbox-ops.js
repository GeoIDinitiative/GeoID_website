...
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-449cf9b";
import { selection } from "./selection.js?v=20260830-449cf9b";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-449cf9b");
  } catch {
