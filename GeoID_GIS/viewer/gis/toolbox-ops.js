import * as GP from "./geoprocessing.js?v=20260825-17061aa";
import * as RA from "./raster-analysis.js?v=20260825-17061aa";
import * as VF from "./vector-formats.js?v=20260825-17061aa";
import { buildVectorLayerResult } from "./vector-render.js?v=20260825-17061aa";
...
import { CRS_OPTIONS } from "./projection.js?v=20260825-17061aa";
import { runQuery, QUERY_HELP } from "./query.js?v=20260825-17061aa";
import { selection } from "./selection.js?v=20260825-17061aa";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260825-17061aa");
  } catch {
