import * as GP from "./geoprocessing.js?v=20260904-0e4b9ad";
import * as RA from "./raster-analysis.js?v=20260904-0e4b9ad";
import * as VF from "./vector-formats.js?v=20260904-0e4b9ad";
import { buildVectorLayerResult } from "./vector-render.js?v=20260904-0e4b9ad";
...
import { CRS_OPTIONS } from "./projection.js?v=20260904-0e4b9ad";
import { runQuery, QUERY_HELP } from "./query.js?v=20260904-0e4b9ad";
import { selection } from "./selection.js?v=20260904-0e4b9ad";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260904-0e4b9ad");
  } catch {
