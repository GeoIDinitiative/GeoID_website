...
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-53d5a1c";
import { selection } from "./selection.js?v=20260830-53d5a1c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-53d5a1c");
  } catch {
