import * as GP from "./geoprocessing.js?v=20260827-170d4fd";
import * as RA from "./raster-analysis.js?v=20260827-170d4fd";
...
import { CRS_OPTIONS } from "./projection.js?v=20260827-170d4fd";
import { runQuery, QUERY_HELP } from "./query.js?v=20260827-170d4fd";
import { selection } from "./selection.js?v=20260827-170d4fd";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260827-170d4fd");
  } catch {
