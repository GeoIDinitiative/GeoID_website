import * as GP from "./geoprocessing.js?v=20260910-53c50ac";
import * as RA from "./raster-analysis.js?v=20260910-53c50ac";
import * as VF from "./vector-formats.js?v=20260910-53c50ac";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-53c50ac";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260910-53c50ac";
import { selection } from "./selection.js?v=20260910-53c50ac";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260910-53c50ac");
  } catch {
