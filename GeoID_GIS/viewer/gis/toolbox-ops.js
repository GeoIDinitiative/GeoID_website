...
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-59d51c3";
import { selection } from "./selection.js?v=20260830-59d51c3";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-59d51c3");
  } catch {
