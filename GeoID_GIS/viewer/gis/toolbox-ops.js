...
import * as RA from "./raster-analysis.js?v=20260910-7d63d6c";
import * as VF from "./vector-formats.js?v=20260910-7d63d6c";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-7d63d6c";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260910-7d63d6c";
import { selection } from "./selection.js?v=20260910-7d63d6c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260910-7d63d6c");
  } catch {
