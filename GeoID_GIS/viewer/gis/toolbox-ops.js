import * as GP from "./geoprocessing.js?v=20260903-94dd2ad";
import * as RA from "./raster-analysis.js?v=20260903-94dd2ad";
import * as VF from "./vector-formats.js?v=20260903-94dd2ad";
import { buildVectorLayerResult } from "./vector-render.js?v=20260903-94dd2ad";
...
import { CRS_OPTIONS } from "./projection.js?v=20260903-94dd2ad";
import { runQuery, QUERY_HELP } from "./query.js?v=20260903-94dd2ad";
import { selection } from "./selection.js?v=20260903-94dd2ad";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260903-94dd2ad");
  } catch {
