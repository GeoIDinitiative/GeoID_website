import * as GP from "./geoprocessing.js?v=20260820-9a5639e";
import * as RA from "./raster-analysis.js?v=20260820-9a5639e";
import * as VF from "./vector-formats.js?v=20260820-9a5639e";
import { buildVectorLayerResult } from "./vector-render.js?v=20260820-9a5639e";
...
import { CRS_OPTIONS } from "./projection.js?v=20260820-9a5639e";
import { runQuery, QUERY_HELP } from "./query.js?v=20260820-9a5639e";
import { selection } from "./selection.js?v=20260820-9a5639e";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260820-9a5639e");
  } catch {
