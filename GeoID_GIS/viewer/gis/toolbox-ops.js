import * as GP from "./geoprocessing.js?v=20260915-ce66302";
import * as RA from "./raster-analysis.js?v=20260915-ce66302";
import * as VF from "./vector-formats.js?v=20260915-ce66302";
import { buildVectorLayerResult } from "./vector-render.js?v=20260915-ce66302";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260915-ce66302";
import { selection } from "./selection.js?v=20260915-ce66302";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260915-ce66302");
  } catch {
