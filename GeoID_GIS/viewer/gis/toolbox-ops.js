...
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-e48729d";
import { selection } from "./selection.js?v=20260829-e48729d";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-e48729d");
  } catch {
