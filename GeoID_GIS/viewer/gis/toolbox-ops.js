...
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-d46a2f6";
import { selection } from "./selection.js?v=20260830-d46a2f6";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-d46a2f6");
  } catch {
