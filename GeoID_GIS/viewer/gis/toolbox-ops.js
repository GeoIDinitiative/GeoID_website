import * as GP from "./geoprocessing.js?v=20260908-a3e0dca";
import * as RA from "./raster-analysis.js?v=20260908-a3e0dca";
import * as VF from "./vector-formats.js?v=20260908-a3e0dca";
import { buildVectorLayerResult } from "./vector-render.js?v=20260908-a3e0dca";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260908-a3e0dca";
import { selection } from "./selection.js?v=20260908-a3e0dca";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260908-a3e0dca");
  } catch {
