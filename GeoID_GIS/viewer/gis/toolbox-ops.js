...
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-af48278";
import { selection } from "./selection.js?v=20260828-af48278";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-af48278");
  } catch {
