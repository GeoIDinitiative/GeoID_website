import * as GP from "./geoprocessing.js?v=20260915-43c303e";
import * as RA from "./raster-analysis.js?v=20260915-43c303e";
import * as VF from "./vector-formats.js?v=20260915-43c303e";
import { buildVectorLayerResult } from "./vector-render.js?v=20260915-43c303e";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260915-43c303e";
import { selection } from "./selection.js?v=20260915-43c303e";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260915-43c303e");
  } catch {
