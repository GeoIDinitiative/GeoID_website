...
import { runQuery, QUERY_HELP } from "./query.js?v=20260904-8648463";
import { selection } from "./selection.js?v=20260904-8648463";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260904-8648463");
  } catch {
