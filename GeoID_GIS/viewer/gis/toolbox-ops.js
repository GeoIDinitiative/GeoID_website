import * as GP from "./geoprocessing.js?v=20260826-3fbbbdd";
import * as RA from "./raster-analysis.js?v=20260826-3fbbbdd";
import * as VF from "./vector-formats.js?v=20260826-3fbbbdd";
import { buildVectorLayerResult } from "./vector-render.js?v=20260826-3fbbbdd";
...
import { CRS_OPTIONS } from "./projection.js?v=20260826-3fbbbdd";
import { runQuery, QUERY_HELP } from "./query.js?v=20260826-3fbbbdd";
import { selection } from "./selection.js?v=20260826-3fbbbdd";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260826-3fbbbdd");
  } catch {
