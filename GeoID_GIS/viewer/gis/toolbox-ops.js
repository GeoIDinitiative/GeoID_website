import * as GP from "./geoprocessing.js?v=20260816-7f8e66b";
import * as RA from "./raster-analysis.js?v=20260816-7f8e66b";
import * as VF from "./vector-formats.js?v=20260816-7f8e66b";
import { buildVectorLayerResult } from "./vector-render.js?v=20260816-7f8e66b";
...
import { CRS_OPTIONS } from "./projection.js?v=20260816-7f8e66b";
import { runQuery, QUERY_HELP } from "./query.js?v=20260816-7f8e66b";
import { selection } from "./selection.js?v=20260816-7f8e66b";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260816-7f8e66b");
  } catch {
