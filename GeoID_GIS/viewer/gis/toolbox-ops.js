import * as GP from "./geoprocessing.js?v=20260910-bb6419a";
import * as RA from "./raster-analysis.js?v=20260910-bb6419a";
import * as VF from "./vector-formats.js?v=20260910-bb6419a";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-bb6419a";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260910-bb6419a";
import { selection } from "./selection.js?v=20260910-bb6419a";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260910-bb6419a");
  } catch {
