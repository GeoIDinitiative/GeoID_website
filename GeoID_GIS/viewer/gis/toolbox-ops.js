import * as GP from "./geoprocessing.js?v=20260912-28305db";
import * as RA from "./raster-analysis.js?v=20260912-28305db";
import * as VF from "./vector-formats.js?v=20260912-28305db";
import { buildVectorLayerResult } from "./vector-render.js?v=20260912-28305db";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260912-28305db";
import { selection } from "./selection.js?v=20260912-28305db";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260912-28305db");
  } catch {
