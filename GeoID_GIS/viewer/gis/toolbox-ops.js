...
import { runQuery, QUERY_HELP } from "./query.js?v=20260830-ef00e07";
import { selection } from "./selection.js?v=20260830-ef00e07";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260830-ef00e07");
  } catch {
