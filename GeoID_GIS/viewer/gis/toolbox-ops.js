import * as GP from "./geoprocessing.js?v=20260831-bd8ef1f";
import * as RA from "./raster-analysis.js?v=20260831-bd8ef1f";
import * as VF from "./vector-formats.js?v=20260831-bd8ef1f";
import { buildVectorLayerResult } from "./vector-render.js?v=20260831-bd8ef1f";
...
import { CRS_OPTIONS } from "./projection.js?v=20260831-bd8ef1f";
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-bd8ef1f";
import { selection } from "./selection.js?v=20260831-bd8ef1f";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-bd8ef1f");
  } catch {
