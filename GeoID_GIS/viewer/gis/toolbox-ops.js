...
import * as RA from "./raster-analysis.js?v=20260911-289fca0";
import * as VF from "./vector-formats.js?v=20260911-289fca0";
import { buildVectorLayerResult } from "./vector-render.js?v=20260911-289fca0";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260911-289fca0";
import { selection } from "./selection.js?v=20260911-289fca0";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260911-289fca0");
  } catch {
