import * as GP from "./geoprocessing.js?v=20260925-ef2f43e";
import * as RA from "./raster-analysis.js?v=20260925-ef2f43e";
import * as VF from "./vector-formats.js?v=20260925-ef2f43e";
import { buildVectorLayerResult } from "./vector-render.js?v=20260925-ef2f43e";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260925-ef2f43e";
import { selection } from "./selection.js?v=20260925-ef2f43e";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260925-ef2f43e");
  } catch {
