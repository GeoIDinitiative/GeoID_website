import * as GP from "./geoprocessing.js?v=20260828-e363f0f";
import * as RA from "./raster-analysis.js?v=20260828-e363f0f";
import * as VF from "./vector-formats.js?v=20260828-e363f0f";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-e363f0f";
...
import { CRS_OPTIONS } from "./projection.js?v=20260828-e363f0f";
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-e363f0f";
import { selection } from "./selection.js?v=20260828-e363f0f";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-e363f0f");
  } catch {
