import * as GP from "./geoprocessing.js?v=20260827-d4c59fb";
import * as RA from "./raster-analysis.js?v=20260827-d4c59fb";
import * as VF from "./vector-formats.js?v=20260827-d4c59fb";
import { buildVectorLayerResult } from "./vector-render.js?v=20260827-d4c59fb";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260827-d4c59fb";
import { selection } from "./selection.js?v=20260827-d4c59fb";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260827-d4c59fb");
  } catch {
