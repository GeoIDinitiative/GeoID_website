import * as GP from "./geoprocessing.js?v=20260910-3e9f5be";
import * as RA from "./raster-analysis.js?v=20260910-3e9f5be";
import * as VF from "./vector-formats.js?v=20260910-3e9f5be";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-3e9f5be";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260910-3e9f5be";
import { selection } from "./selection.js?v=20260910-3e9f5be";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260910-3e9f5be");
  } catch {
