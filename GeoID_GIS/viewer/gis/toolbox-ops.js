import * as GP from "./geoprocessing.js?v=20260915-c40de8b";
import * as RA from "./raster-analysis.js?v=20260915-c40de8b";
import * as VF from "./vector-formats.js?v=20260915-c40de8b";
import { buildVectorLayerResult } from "./vector-render.js?v=20260915-c40de8b";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260915-c40de8b";
import { selection } from "./selection.js?v=20260915-c40de8b";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260915-c40de8b");
  } catch {
