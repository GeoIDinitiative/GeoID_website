...
import { runQuery, QUERY_HELP } from "./query.js?v=20260829-22173ee";
import { selection } from "./selection.js?v=20260829-22173ee";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260829-22173ee");
  } catch {
