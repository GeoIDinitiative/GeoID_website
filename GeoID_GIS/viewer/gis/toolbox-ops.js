import * as GP from "./geoprocessing.js?v=20260901-31bd6ac";
import * as RA from "./raster-analysis.js?v=20260901-31bd6ac";
import * as VF from "./vector-formats.js?v=20260901-31bd6ac";
import { buildVectorLayerResult } from "./vector-render.js?v=20260901-31bd6ac";
...
import { CRS_OPTIONS } from "./projection.js?v=20260901-31bd6ac";
import { runQuery, QUERY_HELP } from "./query.js?v=20260901-31bd6ac";
import { selection } from "./selection.js?v=20260901-31bd6ac";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260901-31bd6ac");
  } catch {
