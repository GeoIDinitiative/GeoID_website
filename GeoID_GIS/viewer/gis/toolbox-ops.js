import * as GP from "./geoprocessing.js?v=20260828-225874c";
import * as RA from "./raster-analysis.js?v=20260828-225874c";
import * as VF from "./vector-formats.js?v=20260828-225874c";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-225874c";
...
import { CRS_OPTIONS } from "./projection.js?v=20260828-225874c";
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-225874c";
import { selection } from "./selection.js?v=20260828-225874c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-225874c");
  } catch {
