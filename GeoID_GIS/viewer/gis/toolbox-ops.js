import * as GP from "./geoprocessing.js?v=20260831-38766de";
import * as RA from "./raster-analysis.js?v=20260831-38766de";
import * as VF from "./vector-formats.js?v=20260831-38766de";
import { buildVectorLayerResult } from "./vector-render.js?v=20260831-38766de";
...
import { CRS_OPTIONS } from "./projection.js?v=20260831-38766de";
import { runQuery, QUERY_HELP } from "./query.js?v=20260831-38766de";
import { selection } from "./selection.js?v=20260831-38766de";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260831-38766de");
  } catch {
