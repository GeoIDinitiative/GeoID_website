import * as GP from "./geoprocessing.js?v=20260816-f1f454d";
import * as RA from "./raster-analysis.js?v=20260816-f1f454d";
import * as VF from "./vector-formats.js?v=20260816-f1f454d";
import { buildVectorLayerResult } from "./vector-render.js?v=20260816-f1f454d";
...
import { CRS_OPTIONS } from "./projection.js?v=20260816-f1f454d";
import { runQuery, QUERY_HELP } from "./query.js?v=20260816-f1f454d";
import { selection } from "./selection.js?v=20260816-f1f454d";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260816-f1f454d");
  } catch {
