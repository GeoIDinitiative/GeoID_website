import * as GP from "./geoprocessing.js?v=20260828-b191bed";
import * as RA from "./raster-analysis.js?v=20260828-b191bed";
import * as VF from "./vector-formats.js?v=20260828-b191bed";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-b191bed";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260828-b191bed";
import { selection } from "./selection.js?v=20260828-b191bed";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260828-b191bed");
  } catch {
