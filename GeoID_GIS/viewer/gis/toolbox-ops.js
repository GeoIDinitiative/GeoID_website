import * as GP from "./geoprocessing.js?v=20260908-46e42ef";
import * as RA from "./raster-analysis.js?v=20260908-46e42ef";
import * as VF from "./vector-formats.js?v=20260908-46e42ef";
import { buildVectorLayerResult } from "./vector-render.js?v=20260908-46e42ef";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260908-46e42ef";
import { selection } from "./selection.js?v=20260908-46e42ef";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260908-46e42ef");
  } catch {
