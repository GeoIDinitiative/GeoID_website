import * as GP from "./geoprocessing.js?v=20260817-13c2be6";
import * as RA from "./raster-analysis.js?v=20260817-13c2be6";
...
import { CRS_OPTIONS } from "./projection.js?v=20260817-13c2be6";
import { runQuery, QUERY_HELP } from "./query.js?v=20260817-13c2be6";
import { selection } from "./selection.js?v=20260817-13c2be6";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260817-13c2be6");
  } catch {
