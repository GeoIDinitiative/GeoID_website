...
import { runQuery, QUERY_HELP } from "./query.js?v=20260904-198b771";
import { selection } from "./selection.js?v=20260904-198b771";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260904-198b771");
  } catch {
