import * as GP from "./geoprocessing.js?v=20260909-c0cc7ea";
import * as RA from "./raster-analysis.js?v=20260909-c0cc7ea";
import * as VF from "./vector-formats.js?v=20260909-c0cc7ea";
import { buildVectorLayerResult } from "./vector-render.js?v=20260909-c0cc7ea";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260909-c0cc7ea";
import { selection } from "./selection.js?v=20260909-c0cc7ea";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260909-c0cc7ea");
  } catch {
