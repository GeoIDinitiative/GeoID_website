import * as GP from "./geoprocessing.js?v=20260818-bb027bd";
import * as RA from "./raster-analysis.js?v=20260818-bb027bd";
import * as VF from "./vector-formats.js?v=20260818-bb027bd";
import { buildVectorLayerResult } from "./vector-render.js?v=20260818-bb027bd";
...
import { CRS_OPTIONS } from "./projection.js?v=20260818-bb027bd";
import { runQuery, QUERY_HELP } from "./query.js?v=20260818-bb027bd";
import { selection } from "./selection.js?v=20260818-bb027bd";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260818-bb027bd");
  } catch {
