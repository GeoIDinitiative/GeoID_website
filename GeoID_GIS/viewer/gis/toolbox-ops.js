import * as GP from "./geoprocessing.js?v=20260902-3203e9c";
import * as RA from "./raster-analysis.js?v=20260902-3203e9c";
import * as VF from "./vector-formats.js?v=20260902-3203e9c";
import { buildVectorLayerResult } from "./vector-render.js?v=20260902-3203e9c";
...
import { CRS_OPTIONS } from "./projection.js?v=20260902-3203e9c";
import { runQuery, QUERY_HELP } from "./query.js?v=20260902-3203e9c";
import { selection } from "./selection.js?v=20260902-3203e9c";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260902-3203e9c");
  } catch {
