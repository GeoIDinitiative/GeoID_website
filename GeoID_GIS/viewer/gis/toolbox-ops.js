import * as GP from "./geoprocessing.js?v=20260915-e0420cc";
import * as RA from "./raster-analysis.js?v=20260915-e0420cc";
import * as VF from "./vector-formats.js?v=20260915-e0420cc";
import { buildVectorLayerResult } from "./vector-render.js?v=20260915-e0420cc";
...
import { runQuery, QUERY_HELP } from "./query.js?v=20260915-e0420cc";
import { selection } from "./selection.js?v=20260915-e0420cc";
...
async function buildToolCatalogue() {
  ...
  let runner;
  try {
    runner = await import("./tool-runner.js?v=20260915-e0420cc");
  } catch {
