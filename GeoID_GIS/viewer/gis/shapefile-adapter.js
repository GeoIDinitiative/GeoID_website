import { looksLikeGeographic } from "./geo-utils.js?v=20260910-2350f9d";
import { featureCollection, feature } from "./geoprocessing.js?v=20260910-2350f9d";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-2350f9d";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260910-2350f9d";
import { parseQml } from "./qgis-style.js?v=20260910-2350f9d";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260910-2350f9d";
