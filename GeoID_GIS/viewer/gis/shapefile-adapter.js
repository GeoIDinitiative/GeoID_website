import { looksLikeGeographic } from "./geo-utils.js?v=20260909-089085f";
import { featureCollection, feature } from "./geoprocessing.js?v=20260909-089085f";
import { buildVectorLayerResult } from "./vector-render.js?v=20260909-089085f";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260909-089085f";
import { parseQml } from "./qgis-style.js?v=20260909-089085f";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260909-089085f";
