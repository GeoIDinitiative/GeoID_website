import { looksLikeGeographic } from "./geo-utils.js?v=20260905-4efeb94";
import { featureCollection, feature } from "./geoprocessing.js?v=20260905-4efeb94";
import { buildVectorLayerResult } from "./vector-render.js?v=20260905-4efeb94";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260905-4efeb94";
import { parseQml } from "./qgis-style.js?v=20260905-4efeb94";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260905-4efeb94";
...
export async function loadShapefile(file, { sidecars = [] } = {}) {
  ...
  const result = buildVectorLayerResult(featureCollection(features),
    { name: file.name, fields, style, contacts: style?.contacts || null });
