import { looksLikeGeographic } from "./geo-utils.js?v=20260901-7e2d242";
import { featureCollection, feature } from "./geoprocessing.js?v=20260901-7e2d242";
import { buildVectorLayerResult } from "./vector-render.js?v=20260901-7e2d242";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260901-7e2d242";
import { parseQml } from "./qgis-style.js?v=20260901-7e2d242";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260901-7e2d242";
