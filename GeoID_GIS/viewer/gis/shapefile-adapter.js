import { looksLikeGeographic } from "./geo-utils.js?v=20260909-d242a3e";
import { featureCollection, feature } from "./geoprocessing.js?v=20260909-d242a3e";
import { buildVectorLayerResult } from "./vector-render.js?v=20260909-d242a3e";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260909-d242a3e";
import { parseQml } from "./qgis-style.js?v=20260909-d242a3e";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260909-d242a3e";
