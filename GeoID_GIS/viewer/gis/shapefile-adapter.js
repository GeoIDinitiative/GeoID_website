import { looksLikeGeographic } from "./geo-utils.js?v=20260916-eb57f4d";
import { featureCollection, feature } from "./geoprocessing.js?v=20260916-eb57f4d";
import { buildVectorLayerResult } from "./vector-render.js?v=20260916-eb57f4d";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260916-eb57f4d";
import { parseQml } from "./qgis-style.js?v=20260916-eb57f4d";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260916-eb57f4d";
