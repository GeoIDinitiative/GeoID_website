import { looksLikeGeographic } from "./geo-utils.js?v=20260911-2446ced";
import { featureCollection, feature } from "./geoprocessing.js?v=20260911-2446ced";
import { buildVectorLayerResult } from "./vector-render.js?v=20260911-2446ced";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260911-2446ced";
import { parseQml } from "./qgis-style.js?v=20260911-2446ced";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260911-2446ced";
