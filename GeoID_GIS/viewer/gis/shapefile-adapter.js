import { looksLikeGeographic } from "./geo-utils.js?v=20260911-3209dea";
import { featureCollection, feature } from "./geoprocessing.js?v=20260911-3209dea";
import { buildVectorLayerResult } from "./vector-render.js?v=20260911-3209dea";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260911-3209dea";
import { parseQml } from "./qgis-style.js?v=20260911-3209dea";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260911-3209dea";
