import { looksLikeGeographic } from "./geo-utils.js?v=20260827-df8fe58";
import { featureCollection, feature } from "./geoprocessing.js?v=20260827-df8fe58";
import { buildVectorLayerResult } from "./vector-render.js?v=20260827-df8fe58";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260827-df8fe58";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260827-df8fe58";
