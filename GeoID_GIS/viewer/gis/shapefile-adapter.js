import { looksLikeGeographic } from "./geo-utils.js?v=20260828-e99a04f";
import { featureCollection, feature } from "./geoprocessing.js?v=20260828-e99a04f";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-e99a04f";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260828-e99a04f";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260828-e99a04f";
