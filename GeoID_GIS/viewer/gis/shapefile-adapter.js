import { looksLikeGeographic } from "./geo-utils.js?v=20260831-bd8ef1f";
import { featureCollection, feature } from "./geoprocessing.js?v=20260831-bd8ef1f";
import { buildVectorLayerResult } from "./vector-render.js?v=20260831-bd8ef1f";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260831-bd8ef1f";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260831-bd8ef1f";
