import { looksLikeGeographic } from "./geo-utils.js?v=20260910-3907c30";
import { featureCollection, feature } from "./geoprocessing.js?v=20260910-3907c30";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-3907c30";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260910-3907c30";
import { parseQml } from "./qgis-style.js?v=20260910-3907c30";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260910-3907c30";
