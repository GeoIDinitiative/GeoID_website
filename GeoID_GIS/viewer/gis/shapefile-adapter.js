import { looksLikeGeographic } from "./geo-utils.js?v=20260915-1257e0b";
import { featureCollection, feature } from "./geoprocessing.js?v=20260915-1257e0b";
import { buildVectorLayerResult } from "./vector-render.js?v=20260915-1257e0b";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260915-1257e0b";
import { parseQml } from "./qgis-style.js?v=20260915-1257e0b";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260915-1257e0b";
