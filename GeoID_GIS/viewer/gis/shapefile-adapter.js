import { looksLikeGeographic } from "./geo-utils.js?v=20260901-31bd6ac";
import { featureCollection, feature } from "./geoprocessing.js?v=20260901-31bd6ac";
import { buildVectorLayerResult } from "./vector-render.js?v=20260901-31bd6ac";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260901-31bd6ac";
import { parseQml } from "./qgis-style.js?v=20260901-31bd6ac";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260901-31bd6ac";
