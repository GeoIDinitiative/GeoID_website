import { looksLikeGeographic } from "./geo-utils.js?v=20260916-8097ff7";
import { featureCollection, feature } from "./geoprocessing.js?v=20260916-8097ff7";
import { buildVectorLayerResult } from "./vector-render.js?v=20260916-8097ff7";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260916-8097ff7";
import { parseQml } from "./qgis-style.js?v=20260916-8097ff7";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260916-8097ff7";
