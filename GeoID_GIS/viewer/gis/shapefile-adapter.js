import { looksLikeGeographic } from "./geo-utils.js?v=20260828-4030a73";
import { featureCollection, feature } from "./geoprocessing.js?v=20260828-4030a73";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-4030a73";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260828-4030a73";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260828-4030a73";
