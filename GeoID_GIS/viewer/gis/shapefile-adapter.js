import { looksLikeGeographic } from "./geo-utils.js?v=20260908-a3e0dca";
import { featureCollection, feature } from "./geoprocessing.js?v=20260908-a3e0dca";
import { buildVectorLayerResult } from "./vector-render.js?v=20260908-a3e0dca";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260908-a3e0dca";
import { parseQml } from "./qgis-style.js?v=20260908-a3e0dca";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260908-a3e0dca";
