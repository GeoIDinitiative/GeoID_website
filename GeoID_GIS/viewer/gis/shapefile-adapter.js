import { looksLikeGeographic } from "./geo-utils.js?v=20260919-d704be8";
import { featureCollection, feature } from "./geoprocessing.js?v=20260919-d704be8";
import { buildVectorLayerResult } from "./vector-render.js?v=20260919-d704be8";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260919-d704be8";
import { parseQml } from "./qgis-style.js?v=20260919-d704be8";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260919-d704be8";
