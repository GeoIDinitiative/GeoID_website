import { looksLikeGeographic } from "./geo-utils.js?v=20260903-4088cab";
import { featureCollection, feature } from "./geoprocessing.js?v=20260903-4088cab";
import { buildVectorLayerResult } from "./vector-render.js?v=20260903-4088cab";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260903-4088cab";
import { parseQml } from "./qgis-style.js?v=20260903-4088cab";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260903-4088cab";
