import { looksLikeGeographic } from "./geo-utils.js?v=20260829-5cd6a46";
import { featureCollection, feature } from "./geoprocessing.js?v=20260829-5cd6a46";
import { buildVectorLayerResult } from "./vector-render.js?v=20260829-5cd6a46";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260829-5cd6a46";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260829-5cd6a46";
