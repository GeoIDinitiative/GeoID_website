import { looksLikeGeographic } from "./geo-utils.js?v=20260828-6e7f7fe";
import { featureCollection, feature } from "./geoprocessing.js?v=20260828-6e7f7fe";
import { buildVectorLayerResult } from "./vector-render.js?v=20260828-6e7f7fe";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260828-6e7f7fe";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260828-6e7f7fe";
