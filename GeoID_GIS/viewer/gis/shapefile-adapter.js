import { looksLikeGeographic } from "./geo-utils.js?v=20260909-1027e8b";
import { featureCollection, feature } from "./geoprocessing.js?v=20260909-1027e8b";
import { buildVectorLayerResult } from "./vector-render.js?v=20260909-1027e8b";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260909-1027e8b";
import { parseQml } from "./qgis-style.js?v=20260909-1027e8b";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260909-1027e8b";
