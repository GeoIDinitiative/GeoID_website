import { looksLikeGeographic } from "./geo-utils.js?v=20260901-21db11b";
import { featureCollection, feature } from "./geoprocessing.js?v=20260901-21db11b";
import { buildVectorLayerResult } from "./vector-render.js?v=20260901-21db11b";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260901-21db11b";
import { parseQml } from "./qgis-style.js?v=20260901-21db11b";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260901-21db11b";
