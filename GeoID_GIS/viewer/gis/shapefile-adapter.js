import { looksLikeGeographic } from "./geo-utils.js?v=20260903-965d9bd";
import { featureCollection, feature } from "./geoprocessing.js?v=20260903-965d9bd";
import { buildVectorLayerResult } from "./vector-render.js?v=20260903-965d9bd";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260903-965d9bd";
import { parseQml } from "./qgis-style.js?v=20260903-965d9bd";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260903-965d9bd";
