import { looksLikeGeographic } from "./geo-utils.js?v=20260907-746df08";
import { featureCollection, feature } from "./geoprocessing.js?v=20260907-746df08";
import { buildVectorLayerResult } from "./vector-render.js?v=20260907-746df08";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260907-746df08";
import { parseQml } from "./qgis-style.js?v=20260907-746df08";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260907-746df08";
