import { looksLikeGeographic } from "./geo-utils.js?v=20260910-a4cc46f";
import { featureCollection, feature } from "./geoprocessing.js?v=20260910-a4cc46f";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-a4cc46f";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260910-a4cc46f";
import { parseQml } from "./qgis-style.js?v=20260910-a4cc46f";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260910-a4cc46f";
