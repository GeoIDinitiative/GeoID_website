import { looksLikeGeographic } from "./geo-utils.js?v=20260920-1e7b58d";
import { featureCollection, feature } from "./geoprocessing.js?v=20260920-1e7b58d";
import { buildVectorLayerResult } from "./vector-render.js?v=20260920-1e7b58d";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260920-1e7b58d";
import { parseQml } from "./qgis-style.js?v=20260920-1e7b58d";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260920-1e7b58d";
