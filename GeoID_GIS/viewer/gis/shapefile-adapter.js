import { looksLikeGeographic } from "./geo-utils.js?v=20260831-b0a7fcc";
import { featureCollection, feature } from "./geoprocessing.js?v=20260831-b0a7fcc";
import { buildVectorLayerResult } from "./vector-render.js?v=20260831-b0a7fcc";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260831-b0a7fcc";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260831-b0a7fcc";
