import { looksLikeGeographic } from "./geo-utils.js?v=20260912-8103bed";
import { featureCollection, feature } from "./geoprocessing.js?v=20260912-8103bed";
import { buildVectorLayerResult } from "./vector-render.js?v=20260912-8103bed";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260912-8103bed";
import { parseQml } from "./qgis-style.js?v=20260912-8103bed";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260912-8103bed";
