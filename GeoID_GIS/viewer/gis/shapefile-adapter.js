import { looksLikeGeographic } from "./geo-utils.js?v=20260914-7778b2c";
import { featureCollection, feature } from "./geoprocessing.js?v=20260914-7778b2c";
import { buildVectorLayerResult } from "./vector-render.js?v=20260914-7778b2c";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260914-7778b2c";
import { parseQml } from "./qgis-style.js?v=20260914-7778b2c";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260914-7778b2c";
