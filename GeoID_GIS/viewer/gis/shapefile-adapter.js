import { looksLikeGeographic } from "./geo-utils.js?v=20260909-be054cf";
import { featureCollection, feature } from "./geoprocessing.js?v=20260909-be054cf";
import { buildVectorLayerResult } from "./vector-render.js?v=20260909-be054cf";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260909-be054cf";
import { parseQml } from "./qgis-style.js?v=20260909-be054cf";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260909-be054cf";
