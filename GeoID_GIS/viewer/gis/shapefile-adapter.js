import { looksLikeGeographic } from "./geo-utils.js?v=20260903-661eb1e";
import { featureCollection, feature } from "./geoprocessing.js?v=20260903-661eb1e";
import { buildVectorLayerResult } from "./vector-render.js?v=20260903-661eb1e";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260903-661eb1e";
import { parseQml } from "./qgis-style.js?v=20260903-661eb1e";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260903-661eb1e";
