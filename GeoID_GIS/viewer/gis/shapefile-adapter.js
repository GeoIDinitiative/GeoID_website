import { looksLikeGeographic } from "./geo-utils.js?v=20260818-fb901be";
import { featureCollection, feature } from "./geoprocessing.js?v=20260818-fb901be";
import { buildVectorLayerResult } from "./vector-render.js?v=20260818-fb901be";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260818-fb901be";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260818-fb901be";
