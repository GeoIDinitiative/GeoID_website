import { looksLikeGeographic } from "./geo-utils.js?v=20260908-294767f";
import { featureCollection, feature } from "./geoprocessing.js?v=20260908-294767f";
import { buildVectorLayerResult } from "./vector-render.js?v=20260908-294767f";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260908-294767f";
import { parseQml } from "./qgis-style.js?v=20260908-294767f";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260908-294767f";
