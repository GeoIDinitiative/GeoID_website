import { looksLikeGeographic } from "./geo-utils.js?v=20260830-7fe2a24";
import { featureCollection, feature } from "./geoprocessing.js?v=20260830-7fe2a24";
import { buildVectorLayerResult } from "./vector-render.js?v=20260830-7fe2a24";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260830-7fe2a24";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260830-7fe2a24";
