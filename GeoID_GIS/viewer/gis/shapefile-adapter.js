import { looksLikeGeographic } from "./geo-utils.js?v=20260821-d1e8adb";
import { featureCollection, feature } from "./geoprocessing.js?v=20260821-d1e8adb";
import { buildVectorLayerResult } from "./vector-render.js?v=20260821-d1e8adb";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260821-d1e8adb";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260821-d1e8adb";
