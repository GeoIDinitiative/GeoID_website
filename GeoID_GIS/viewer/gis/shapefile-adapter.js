import { looksLikeGeographic } from "./geo-utils.js?v=20260830-6eb7bd1";
import { featureCollection, feature } from "./geoprocessing.js?v=20260830-6eb7bd1";
import { buildVectorLayerResult } from "./vector-render.js?v=20260830-6eb7bd1";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260830-6eb7bd1";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260830-6eb7bd1";
