import { looksLikeGeographic } from "./geo-utils.js?v=20260910-f54ac16";
import { featureCollection, feature } from "./geoprocessing.js?v=20260910-f54ac16";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-f54ac16";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260910-f54ac16";
import { parseQml } from "./qgis-style.js?v=20260910-f54ac16";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260910-f54ac16";
