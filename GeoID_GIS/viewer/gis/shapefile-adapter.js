import { looksLikeGeographic } from "./geo-utils.js?v=20260911-0db24ca";
import { featureCollection, feature } from "./geoprocessing.js?v=20260911-0db24ca";
import { buildVectorLayerResult } from "./vector-render.js?v=20260911-0db24ca";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260911-0db24ca";
import { parseQml } from "./qgis-style.js?v=20260911-0db24ca";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260911-0db24ca";
