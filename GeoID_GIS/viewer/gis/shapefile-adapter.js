import { looksLikeGeographic } from "./geo-utils.js?v=20260901-d87db3d";
import { featureCollection, feature } from "./geoprocessing.js?v=20260901-d87db3d";
import { buildVectorLayerResult } from "./vector-render.js?v=20260901-d87db3d";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260901-d87db3d";
import { parseQml } from "./qgis-style.js?v=20260901-d87db3d";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260901-d87db3d";
