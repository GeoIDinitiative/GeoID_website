import { looksLikeGeographic } from "./geo-utils.js?v=20260830-9155dd7";
import { featureCollection, feature } from "./geoprocessing.js?v=20260830-9155dd7";
import { buildVectorLayerResult } from "./vector-render.js?v=20260830-9155dd7";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260830-9155dd7";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260830-9155dd7";
