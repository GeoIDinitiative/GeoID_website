import { looksLikeGeographic } from "./geo-utils.js?v=20260826-be4ddd2";
import { featureCollection, feature } from "./geoprocessing.js?v=20260826-be4ddd2";
import { buildVectorLayerResult } from "./vector-render.js?v=20260826-be4ddd2";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260826-be4ddd2";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260826-be4ddd2";
