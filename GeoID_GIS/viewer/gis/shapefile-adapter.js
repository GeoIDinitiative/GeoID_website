import { looksLikeGeographic } from "./geo-utils.js?v=20260910-8e7baef";
import { featureCollection, feature } from "./geoprocessing.js?v=20260910-8e7baef";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-8e7baef";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260910-8e7baef";
import { parseQml } from "./qgis-style.js?v=20260910-8e7baef";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260910-8e7baef";
