import { looksLikeGeographic } from "./geo-utils.js?v=20260823-bfb3e5f";
import { featureCollection, feature } from "./geoprocessing.js?v=20260823-bfb3e5f";
import { buildVectorLayerResult } from "./vector-render.js?v=20260823-bfb3e5f";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260823-bfb3e5f";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260823-bfb3e5f";
