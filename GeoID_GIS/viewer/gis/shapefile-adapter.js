import { looksLikeGeographic } from "./geo-utils.js?v=20260911-e8b0ea4";
import { featureCollection, feature } from "./geoprocessing.js?v=20260911-e8b0ea4";
import { buildVectorLayerResult } from "./vector-render.js?v=20260911-e8b0ea4";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260911-e8b0ea4";
import { parseQml } from "./qgis-style.js?v=20260911-e8b0ea4";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260911-e8b0ea4";
