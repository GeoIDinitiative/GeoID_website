import { looksLikeGeographic } from "./geo-utils.js?v=20260909-d6a403c";
import { featureCollection, feature } from "./geoprocessing.js?v=20260909-d6a403c";
import { buildVectorLayerResult } from "./vector-render.js?v=20260909-d6a403c";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260909-d6a403c";
import { parseQml } from "./qgis-style.js?v=20260909-d6a403c";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260909-d6a403c";
