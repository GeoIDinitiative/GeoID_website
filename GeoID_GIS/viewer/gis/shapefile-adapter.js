import { looksLikeGeographic } from "./geo-utils.js?v=20260910-db65dfd";
import { featureCollection, feature } from "./geoprocessing.js?v=20260910-db65dfd";
import { buildVectorLayerResult } from "./vector-render.js?v=20260910-db65dfd";
import { detectCrs, crsLabel } from "./prj-detect.js?v=20260910-db65dfd";
import { parseQml } from "./qgis-style.js?v=20260910-db65dfd";
import { projectedToLatLon, CRS_OPTIONS } from "./projection.js?v=20260910-db65dfd";
