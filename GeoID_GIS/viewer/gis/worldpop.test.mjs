...
const card = populationCard({ lat: 51.5, lon: -0.12, density: 5432 }, { credit: "WorldPop" });
check("the card titles in people per km²", card.title, "5,432 people per km²");
check("and counts the cell", /about [\d,]+ people over 0\.\d\d km²/.test(card.headline[0][1]), true);
