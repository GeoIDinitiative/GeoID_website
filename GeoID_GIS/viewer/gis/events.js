...
import {
  ...
  activeGroups, sourcesInGroup, groupState, defaultEnabled, restoreSources, gdacsPoints } from "./event-sources.js?v=20260903-e9a2f94";
...
async function showTrace(event) {
  ...
  const [plot, { spectrogram }] = await Promise.all([
    import("./seismogram-plot.js?v=20260903-e9a2f94"),
    import("./research/dsp.js?v=20260903-e9a2f94"),
  ]);
  if (stale()) return;
