...
} from "./event-sources.js?v=20260925-f7cb0d0";
import { escapeHtml, safeUrl } from "./escape-html.js?v=20260925-f7cb0d0";
...
async function showTrace(event) {
  ...
  const [plot, { spectrogram }] = await Promise.all([
    import("./seismogram-plot.js?v=20260925-f7cb0d0"),
    import("./research/dsp.js?v=20260925-f7cb0d0"),
  ]);
  if (stale()) return;
