...
import {
  ...
  activeGroups, sourcesInGroup, groupState, defaultEnabled, restoreSources, gdacsPoints } from "./event-sources.js?v=20260831-687d68a";
...
async function showTrace(event) {
  ...
  const [plot, { spectrogram }] = await Promise.all([
    import("./seismogram-plot.js?v=20260831-687d68a"),
    import("./research/dsp.js?v=20260831-687d68a"),
  ]);
  if (stale()) return;
