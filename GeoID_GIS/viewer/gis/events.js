...
import {
  ...
  activeGroups, sourcesInGroup, groupState, defaultEnabled, restoreSources, gdacsPoints } from "./event-sources.js?v=20260828-71372b8";
...
async function showTrace(event) {
  ...
  const [plot, { spectrogram }] = await Promise.all([
    import("./seismogram-plot.js?v=20260828-71372b8"),
    import("./research/dsp.js?v=20260828-71372b8"),
  ]);
  if (stale()) return;
