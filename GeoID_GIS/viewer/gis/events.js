...
import {
  ...
  activeGroups, sourcesInGroup, groupState, defaultEnabled, restoreSources, gdacsPoints } from "./event-sources.js?v=20260902-0995c0f";
...
async function showTrace(event) {
  ...
  const [plot, { spectrogram }] = await Promise.all([
    import("./seismogram-plot.js?v=20260902-0995c0f"),
    import("./research/dsp.js?v=20260902-0995c0f"),
  ]);
  if (stale()) return;
