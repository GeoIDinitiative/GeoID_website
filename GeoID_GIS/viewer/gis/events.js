...
import {
  ...
  activeGroups, sourcesInGroup, groupState, defaultEnabled, restoreSources, gdacsPoints } from "./event-sources.js?v=20260901-f45e015";
...
async function showTrace(event) {
  ...
  const [plot, { spectrogram }] = await Promise.all([
    import("./seismogram-plot.js?v=20260901-f45e015"),
    import("./research/dsp.js?v=20260901-f45e015"),
  ]);
  if (stale()) return;
