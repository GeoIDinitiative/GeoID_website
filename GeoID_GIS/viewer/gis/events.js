...
import {
  ...
  activeGroups, sourcesInGroup, groupState, defaultEnabled, restoreSources, gdacsPoints } from "./event-sources.js?v=20260831-3fdac3b";
...
async function showTrace(event) {
  ...
  const [plot, { spectrogram }] = await Promise.all([
    import("./seismogram-plot.js?v=20260831-3fdac3b"),
    import("./research/dsp.js?v=20260831-3fdac3b"),
  ]);
  if (stale()) return;
