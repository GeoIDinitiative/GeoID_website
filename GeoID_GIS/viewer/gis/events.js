...
import {
  ...
  activeGroups, sourcesInGroup, groupState, defaultEnabled, restoreSources, gdacsPoints } from "./event-sources.js?v=20260901-d87db3d";
...
async function showTrace(event) {
  ...
  const [plot, { spectrogram }] = await Promise.all([
    import("./seismogram-plot.js?v=20260901-d87db3d"),
    import("./research/dsp.js?v=20260901-d87db3d"),
  ]);
  if (stale()) return;
