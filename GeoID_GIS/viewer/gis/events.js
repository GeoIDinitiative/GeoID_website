...
import {
  ...
  activeGroups, sourcesInGroup, groupState, defaultEnabled, restoreSources, gdacsPoints } from "./event-sources.js?v=20260903-c00bfa0";
...
async function showTrace(event) {
  ...
  const [plot, { spectrogram }] = await Promise.all([
    import("./seismogram-plot.js?v=20260903-c00bfa0"),
    import("./research/dsp.js?v=20260903-c00bfa0"),
  ]);
  if (stale()) return;
