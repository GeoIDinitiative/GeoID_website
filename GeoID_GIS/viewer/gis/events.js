...
import {
  ...
  activeGroups, sourcesInGroup, groupState, defaultEnabled, restoreSources, gdacsPoints } from "./event-sources.js?v=20260901-0fb185c";
...
async function showTrace(event) {
  ...
  const [plot, { spectrogram }] = await Promise.all([
    import("./seismogram-plot.js?v=20260901-0fb185c"),
    import("./research/dsp.js?v=20260901-0fb185c"),
  ]);
  if (stale()) return;
