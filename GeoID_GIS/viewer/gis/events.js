...
import {
  ...
  activeGroups, sourcesInGroup, groupState, defaultEnabled, restoreSources, gdacsPoints } from "./event-sources.js?v=20260902-0c2fb66";
...
async function showTrace(event) {
  ...
  const [plot, { spectrogram }] = await Promise.all([
    import("./seismogram-plot.js?v=20260902-0c2fb66"),
    import("./research/dsp.js?v=20260902-0c2fb66"),
  ]);
  if (stale()) return;
