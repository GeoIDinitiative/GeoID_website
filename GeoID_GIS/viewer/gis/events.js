...
import {
  ...
  activeGroups, sourcesInGroup, groupState, defaultEnabled, restoreSources, gdacsPoints } from "./event-sources.js?v=20260829-dcc721a";
...
async function showTrace(event) {
  ...
  const [plot, { spectrogram }] = await Promise.all([
    import("./seismogram-plot.js?v=20260829-dcc721a"),
    import("./research/dsp.js?v=20260829-dcc721a"),
  ]);
  if (stale()) return;
