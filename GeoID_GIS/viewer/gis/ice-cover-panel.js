...
import { loadDerivedGeologyMap, removeDerivedGeologyMap }
  from "./geology-panel.js?v=20260909-139a227";
import { loadIceNames, iceNameFor } from "./ice-names.js?v=20260909-139a227";
import { loadIceThickness, iceVolumeFor } from "./ice-thickness.js?v=20260909-139a227";
import { addDataset } from "./global-data.js?v=20260909-139a227";
import { refreshPolygonOptions, resolvePolygonExtent, promptDrawTool,
  drawnOverlayBounds } from "./extent-picker.js?v=20260909-139a227";
import { useIceNames, useIceVolumes } from "./ice-card.js?v=20260909-139a227";
