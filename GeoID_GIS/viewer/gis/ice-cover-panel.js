...
import { loadDerivedGeologyMap, removeDerivedGeologyMap }
  from "./geology-panel.js?v=20260909-5e155bc";
import { loadIceNames, iceNameFor } from "./ice-names.js?v=20260909-5e155bc";
import { loadIceThickness, iceVolumeFor } from "./ice-thickness.js?v=20260909-5e155bc";
import { addDataset } from "./global-data.js?v=20260909-5e155bc";
import { refreshPolygonOptions, resolvePolygonExtent, promptDrawTool,
  drawnOverlayBounds } from "./extent-picker.js?v=20260909-5e155bc";
import { useIceNames, useIceVolumes } from "./ice-card.js?v=20260909-5e155bc";
