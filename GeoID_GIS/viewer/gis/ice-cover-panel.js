...
import { loadDerivedGeologyMap, removeDerivedGeologyMap }
  from "./geology-panel.js?v=20260915-436fbaa";
import { loadIceNames, iceNameFor } from "./ice-names.js?v=20260915-436fbaa";
import { loadIceThickness, iceVolumeFor } from "./ice-thickness.js?v=20260915-436fbaa";
import { addDataset } from "./global-data.js?v=20260915-436fbaa";
import { refreshPolygonOptions, resolvePolygonExtent, promptDrawTool,
  drawnOverlayBounds } from "./extent-picker.js?v=20260915-436fbaa";
import { useIceNames, useIceVolumes } from "./ice-card.js?v=20260915-436fbaa";
