...
import { loadDerivedGeologyMap, removeDerivedGeologyMap }
  from "./geology-panel.js?v=20260915-2a75eee";
import { loadIceNames, iceNameFor } from "./ice-names.js?v=20260915-2a75eee";
import { loadIceThickness, iceVolumeFor } from "./ice-thickness.js?v=20260915-2a75eee";
import { addDataset } from "./global-data.js?v=20260915-2a75eee";
import { refreshPolygonOptions, resolvePolygonExtent, promptDrawTool,
  drawnOverlayBounds } from "./extent-picker.js?v=20260915-2a75eee";
import { useIceNames, useIceVolumes } from "./ice-card.js?v=20260915-2a75eee";
