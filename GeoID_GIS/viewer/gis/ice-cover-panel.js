...
import { loadDerivedGeologyMap, removeDerivedGeologyMap }
  from "./geology-panel.js?v=20260908-2125c8a";
import { loadIceNames, iceNameFor } from "./ice-names.js?v=20260908-2125c8a";
import { loadIceThickness, iceVolumeFor } from "./ice-thickness.js?v=20260908-2125c8a";
import { addDataset } from "./global-data.js?v=20260908-2125c8a";
import { refreshPolygonOptions, resolvePolygonExtent, promptDrawTool,
  drawnOverlayBounds } from "./extent-picker.js?v=20260908-2125c8a";
import { useIceNames, useIceVolumes } from "./ice-card.js?v=20260908-2125c8a";
