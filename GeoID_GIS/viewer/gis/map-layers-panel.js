...
import { grouped, addMapLayer, removeMapLayer, layerForMap, layerById } from "./map-layers.js?v=20260827-63cd180";
import { renderCatalogue } from "./catalogue-list.js?v=20260827-63cd180";
