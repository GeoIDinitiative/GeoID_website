...
import { grouped, addMapLayer, removeMapLayer, layerForMap, layerById } from "./map-layers.js?v=20260827-2a7b4b9";
import { renderCatalogue } from "./catalogue-list.js?v=20260827-2a7b4b9";
