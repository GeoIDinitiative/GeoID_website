...
import { grouped, addMapLayer, removeMapLayer, layerForMap, layerById } from "./map-layers.js?v=20260826-df51fe2";
import { renderCatalogue } from "./catalogue-list.js?v=20260826-df51fe2";
