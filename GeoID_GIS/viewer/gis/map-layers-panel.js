...
import { grouped, addMapLayer, removeMapLayer, layerForMap, layerById } from "./map-layers.js?v=20260827-4323be2";
import { renderCatalogue } from "./catalogue-list.js?v=20260827-4323be2";
