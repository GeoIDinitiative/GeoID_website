...
import { grouped, addMapLayer, removeMapLayer, layerForMap, layerById } from "./map-layers.js?v=20260827-90bd2a2";
import { renderCatalogue } from "./catalogue-list.js?v=20260827-90bd2a2";
