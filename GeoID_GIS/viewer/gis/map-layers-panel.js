...
import { grouped, addMapLayer, removeMapLayer, layerForMap, layerById } from "./map-layers.js?v=20260828-53716a9";
import { renderCatalogue } from "./catalogue-list.js?v=20260828-53716a9";
