...
import { grouped, addMapLayer, removeMapLayer, layerForMap, layerById } from "./map-layers.js?v=20260827-df8fe58";
import { renderCatalogue } from "./catalogue-list.js?v=20260827-df8fe58";
