...
import { grouped, addMapLayer, removeMapLayer, layerForMap, layerById } from "./map-layers.js?v=20260826-d0d9d92";
import { renderCatalogue } from "./catalogue-list.js?v=20260826-d0d9d92";
