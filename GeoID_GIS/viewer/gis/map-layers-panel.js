...
import { grouped, addMapLayer, removeMapLayer, layerForMap, layerById } from "./map-layers.js?v=20260827-2d7acfd";
import { renderCatalogue } from "./catalogue-list.js?v=20260827-2d7acfd";
