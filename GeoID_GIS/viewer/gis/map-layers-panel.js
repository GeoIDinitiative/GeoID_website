...
import { grouped, addMapLayer, removeMapLayer, layerForMap, layerById } from "./map-layers.js?v=20260826-b7d1a76";
import { renderCatalogue } from "./catalogue-list.js?v=20260826-b7d1a76";
