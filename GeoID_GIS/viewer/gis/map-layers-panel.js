...
import { grouped, addMapLayer, removeMapLayer, layerForMap, layerById } from "./map-layers.js?v=20260826-801fa5e";
import { renderCatalogue } from "./catalogue-list.js?v=20260826-801fa5e";
