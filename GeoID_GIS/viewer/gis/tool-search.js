...
import { TOOLS, toolById } from "./tool-runner.js?v=20260909-d85ea73";
import { tokenize } from "./search-text.js?v=20260909-d85ea73";
...
import * as toolPrefs from "./tool-prefs.js?v=20260909-d85ea73";
