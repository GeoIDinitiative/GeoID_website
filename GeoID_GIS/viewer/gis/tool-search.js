...
import { TOOLS, toolById } from "./tool-runner.js?v=20260828-2fe26ec";
import { tokenize } from "./search-text.js?v=20260828-2fe26ec";
...
import * as toolPrefs from "./tool-prefs.js?v=20260828-2fe26ec";
