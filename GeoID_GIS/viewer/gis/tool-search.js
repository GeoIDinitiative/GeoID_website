...
import { TOOLS, toolById } from "./tool-runner.js?v=20260916-64b58db";
import { tokenize } from "./search-text.js?v=20260916-64b58db";
...
import * as toolPrefs from "./tool-prefs.js?v=20260916-64b58db";
