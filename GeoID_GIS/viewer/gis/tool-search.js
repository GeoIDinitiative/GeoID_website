...
import { TOOLS, toolById } from "./tool-runner.js?v=20260916-25099d5";
import { tokenize } from "./search-text.js?v=20260916-25099d5";
...
import * as toolPrefs from "./tool-prefs.js?v=20260916-25099d5";
