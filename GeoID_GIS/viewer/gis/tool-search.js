...
import { TOOLS, toolById } from "./tool-runner.js?v=20260916-bf9edbc";
import { tokenize } from "./search-text.js?v=20260916-bf9edbc";
...
import * as toolPrefs from "./tool-prefs.js?v=20260916-bf9edbc";
