...
import { TOOLS, toolById } from "./tool-runner.js?v=20260910-6b1d4e5";
import { tokenize } from "./search-text.js?v=20260910-6b1d4e5";
...
import * as toolPrefs from "./tool-prefs.js?v=20260910-6b1d4e5";
