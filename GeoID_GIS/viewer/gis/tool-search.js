...
import { TOOLS, toolById } from "./tool-runner.js?v=20260828-be98b1a";
import { tokenize } from "./search-text.js?v=20260828-be98b1a";
...
import * as toolPrefs from "./tool-prefs.js?v=20260828-be98b1a";
