...
import { TOOLS, toolById } from "./tool-runner.js?v=20260831-07f3e3f";
import { tokenize } from "./search-text.js?v=20260831-07f3e3f";
...
import * as toolPrefs from "./tool-prefs.js?v=20260831-07f3e3f";
