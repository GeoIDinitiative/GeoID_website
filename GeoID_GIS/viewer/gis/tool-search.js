...
import { TOOLS, toolById } from "./tool-runner.js?v=20260826-df1070c";
import { tokenize } from "./search-text.js?v=20260826-df1070c";
...
import * as toolPrefs from "./tool-prefs.js?v=20260826-df1070c";
