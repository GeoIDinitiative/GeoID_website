...
import { TOOLS, toolById } from "./tool-runner.js?v=20260909-be054cf";
import { tokenize } from "./search-text.js?v=20260909-be054cf";
...
import * as toolPrefs from "./tool-prefs.js?v=20260909-be054cf";
