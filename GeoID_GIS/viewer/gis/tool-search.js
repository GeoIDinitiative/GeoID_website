...
import { TOOLS, toolById } from "./tool-runner.js?v=20260914-4b4e967";
import { tokenize } from "./search-text.js?v=20260914-4b4e967";
...
import * as toolPrefs from "./tool-prefs.js?v=20260914-4b4e967";
