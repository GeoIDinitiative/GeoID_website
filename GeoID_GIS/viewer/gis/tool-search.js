...
import { TOOLS, toolById } from "./tool-runner.js?v=20260912-288ec98";
import { tokenize } from "./search-text.js?v=20260912-288ec98";
...
import * as toolPrefs from "./tool-prefs.js?v=20260912-288ec98";
