...
import { TOOLS, toolById } from "./tool-runner.js?v=20260816-e6ed348";
import { tokenize } from "./search-text.js?v=20260816-e6ed348";
...
import * as toolPrefs from "./tool-prefs.js?v=20260816-e6ed348";
