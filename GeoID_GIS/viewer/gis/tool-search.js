...
import { TOOLS, toolById } from "./tool-runner.js?v=20260816-df073fe";
import { tokenize } from "./search-text.js?v=20260816-df073fe";
...
import * as toolPrefs from "./tool-prefs.js?v=20260816-df073fe";
