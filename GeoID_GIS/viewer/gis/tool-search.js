...
import { TOOLS, toolById } from "./tool-runner.js?v=20260828-db653b7";
import { tokenize } from "./search-text.js?v=20260828-db653b7";
...
import * as toolPrefs from "./tool-prefs.js?v=20260828-db653b7";
