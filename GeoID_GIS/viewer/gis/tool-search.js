...
import { TOOLS, toolById } from "./tool-runner.js?v=20260916-1141f5f";
import { tokenize } from "./search-text.js?v=20260916-1141f5f";
...
import * as toolPrefs from "./tool-prefs.js?v=20260916-1141f5f";
