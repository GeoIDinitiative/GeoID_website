...
import { TOOLS, toolById } from "./tool-runner.js?v=20260823-9a98b82";
import { tokenize } from "./search-text.js?v=20260823-9a98b82";
...
import * as toolPrefs from "./tool-prefs.js?v=20260823-9a98b82";
