...
import { TOOLS, toolById } from "./tool-runner.js?v=20260916-eb57f4d";
import { tokenize } from "./search-text.js?v=20260916-eb57f4d";
...
import * as toolPrefs from "./tool-prefs.js?v=20260916-eb57f4d";
