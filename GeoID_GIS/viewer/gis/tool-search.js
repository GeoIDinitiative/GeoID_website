...
import { TOOLS, toolById } from "./tool-runner.js?v=20260911-cb5be29";
import { tokenize } from "./search-text.js?v=20260911-cb5be29";
...
import * as toolPrefs from "./tool-prefs.js?v=20260911-cb5be29";
