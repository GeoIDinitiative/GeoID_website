...
import { TOOLS, toolById } from "./tool-runner.js?v=20260816-a3afed3";
import { tokenize } from "./search-text.js?v=20260816-a3afed3";
...
import * as toolPrefs from "./tool-prefs.js?v=20260816-a3afed3";
