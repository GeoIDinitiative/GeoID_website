...
import { TOOLS, toolById } from "./tool-runner.js?v=20260909-07f3be8";
import { tokenize } from "./search-text.js?v=20260909-07f3be8";
...
import * as toolPrefs from "./tool-prefs.js?v=20260909-07f3be8";
