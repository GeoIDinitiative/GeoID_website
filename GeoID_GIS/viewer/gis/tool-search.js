...
import { TOOLS, toolById } from "./tool-runner.js?v=20260829-db4ba38";
import { tokenize } from "./search-text.js?v=20260829-db4ba38";
...
import * as toolPrefs from "./tool-prefs.js?v=20260829-db4ba38";
