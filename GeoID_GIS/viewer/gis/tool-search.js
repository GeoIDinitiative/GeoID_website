...
import { TOOLS, toolById } from "./tool-runner.js?v=20260827-184b3d2";
import { tokenize } from "./search-text.js?v=20260827-184b3d2";
...
import * as toolPrefs from "./tool-prefs.js?v=20260827-184b3d2";
