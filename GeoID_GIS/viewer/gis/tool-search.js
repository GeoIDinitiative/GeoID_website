...
import { TOOLS, toolById } from "./tool-runner.js?v=20260903-d94308a";
import { tokenize } from "./search-text.js?v=20260903-d94308a";
...
import * as toolPrefs from "./tool-prefs.js?v=20260903-d94308a";
