...
import { TOOLS, toolById } from "./tool-runner.js?v=20260911-92409f8";
import { tokenize } from "./search-text.js?v=20260911-92409f8";
...
import * as toolPrefs from "./tool-prefs.js?v=20260911-92409f8";
