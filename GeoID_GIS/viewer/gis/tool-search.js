...
import { TOOLS, toolById } from "./tool-runner.js?v=20260912-136b2bf";
import { tokenize } from "./search-text.js?v=20260912-136b2bf";
...
import * as toolPrefs from "./tool-prefs.js?v=20260912-136b2bf";
