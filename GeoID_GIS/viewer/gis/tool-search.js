...
import { TOOLS, toolById } from "./tool-runner.js?v=20260903-7b5a1e0";
import { tokenize } from "./search-text.js?v=20260903-7b5a1e0";
...
import * as toolPrefs from "./tool-prefs.js?v=20260903-7b5a1e0";
