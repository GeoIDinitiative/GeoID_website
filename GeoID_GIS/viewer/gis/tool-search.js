...
import { TOOLS, toolById } from "./tool-runner.js?v=20260828-12252d5";
import { tokenize } from "./search-text.js?v=20260828-12252d5";
...
import * as toolPrefs from "./tool-prefs.js?v=20260828-12252d5";
