...
import { TOOLS, toolById } from "./tool-runner.js?v=20260911-be0ec2a";
import { tokenize } from "./search-text.js?v=20260911-be0ec2a";
...
import * as toolPrefs from "./tool-prefs.js?v=20260911-be0ec2a";
