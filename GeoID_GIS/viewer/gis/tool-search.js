...
import { TOOLS, toolById } from "./tool-runner.js?v=20260830-53d5a1c";
import { tokenize } from "./search-text.js?v=20260830-53d5a1c";
...
import * as toolPrefs from "./tool-prefs.js?v=20260830-53d5a1c";
