...
import { TOOLS, toolById } from "./tool-runner.js?v=20260915-fdefd0f";
import { tokenize } from "./search-text.js?v=20260915-fdefd0f";
...
import * as toolPrefs from "./tool-prefs.js?v=20260915-fdefd0f";
