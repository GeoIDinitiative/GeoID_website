...
import { TOOLS, toolById } from "./tool-runner.js?v=20260916-2fec8a4";
import { tokenize } from "./search-text.js?v=20260916-2fec8a4";
...
import * as toolPrefs from "./tool-prefs.js?v=20260916-2fec8a4";
