...
import { TOOLS, toolById } from "./tool-runner.js?v=20260816-960ffbc";
import { tokenize } from "./search-text.js?v=20260816-960ffbc";
...
import * as toolPrefs from "./tool-prefs.js?v=20260816-960ffbc";
