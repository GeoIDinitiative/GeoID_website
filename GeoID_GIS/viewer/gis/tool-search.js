...
import { TOOLS, toolById } from "./tool-runner.js?v=20260901-515afd0";
import { tokenize } from "./search-text.js?v=20260901-515afd0";
...
import * as toolPrefs from "./tool-prefs.js?v=20260901-515afd0";
