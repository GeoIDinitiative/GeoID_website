...
import { TOOLS, toolById } from "./tool-runner.js?v=20260911-cd1cf4d";
import { tokenize } from "./search-text.js?v=20260911-cd1cf4d";
...
import * as toolPrefs from "./tool-prefs.js?v=20260911-cd1cf4d";
