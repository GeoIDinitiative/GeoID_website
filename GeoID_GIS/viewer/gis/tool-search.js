...
import { TOOLS, toolById } from "./tool-runner.js?v=20260911-79b3dcf";
import { tokenize } from "./search-text.js?v=20260911-79b3dcf";
...
import * as toolPrefs from "./tool-prefs.js?v=20260911-79b3dcf";
