...
import { TOOLS, toolById } from "./tool-runner.js?v=20260916-4d5ed92";
import { tokenize } from "./search-text.js?v=20260916-4d5ed92";
...
import * as toolPrefs from "./tool-prefs.js?v=20260916-4d5ed92";
