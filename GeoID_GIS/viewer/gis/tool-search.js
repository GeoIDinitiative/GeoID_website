...
import { TOOLS, toolById } from "./tool-runner.js?v=20260911-b4bfa93";
import { tokenize } from "./search-text.js?v=20260911-b4bfa93";
...
import * as toolPrefs from "./tool-prefs.js?v=20260911-b4bfa93";
