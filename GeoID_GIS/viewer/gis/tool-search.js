...
import { TOOLS, toolById } from "./tool-runner.js?v=20260816-f61b5f5";
import { tokenize } from "./search-text.js?v=20260816-f61b5f5";
...
import * as toolPrefs from "./tool-prefs.js?v=20260816-f61b5f5";
