...
import { TOOLS, toolById } from "./tool-runner.js?v=20260827-2a7b4b9";
import { tokenize } from "./search-text.js?v=20260827-2a7b4b9";
...
import * as toolPrefs from "./tool-prefs.js?v=20260827-2a7b4b9";
