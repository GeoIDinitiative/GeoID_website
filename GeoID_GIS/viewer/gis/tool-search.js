...
import { TOOLS, toolById } from "./tool-runner.js?v=20260816-1e1ecb0";
import { tokenize } from "./search-text.js?v=20260816-1e1ecb0";
...
import * as toolPrefs from "./tool-prefs.js?v=20260816-1e1ecb0";
