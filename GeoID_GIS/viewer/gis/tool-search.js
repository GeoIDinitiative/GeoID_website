...
import { TOOLS, toolById } from "./tool-runner.js?v=20260915-2a75eee";
import { tokenize } from "./search-text.js?v=20260915-2a75eee";
...
import * as toolPrefs from "./tool-prefs.js?v=20260915-2a75eee";
