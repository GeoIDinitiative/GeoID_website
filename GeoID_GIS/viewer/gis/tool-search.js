...
import { TOOLS, toolById } from "./tool-runner.js?v=20260909-d6a403c";
import { tokenize } from "./search-text.js?v=20260909-d6a403c";
...
import * as toolPrefs from "./tool-prefs.js?v=20260909-d6a403c";
