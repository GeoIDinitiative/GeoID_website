...
import { TOOLS, toolById } from "./tool-runner.js?v=20260821-d1e8adb";
import { tokenize } from "./search-text.js?v=20260821-d1e8adb";
...
import * as toolPrefs from "./tool-prefs.js?v=20260821-d1e8adb";
