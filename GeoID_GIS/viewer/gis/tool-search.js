...
import { TOOLS, toolById } from "./tool-runner.js?v=20260816-05ed4d3";
import { tokenize } from "./search-text.js?v=20260816-05ed4d3";
...
import * as toolPrefs from "./tool-prefs.js?v=20260816-05ed4d3";
