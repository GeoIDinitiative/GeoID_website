...
import { polygonsOf, peopleOnGrid, formatPeople, seriesCsv } from "./exposure.js?v=20260916-325719f";
import { riskMaps, riskMapKind, assessLayer, countsUnder, ringsBox } from "./risk-reader.js?v=20260916-325719f";
...
import { refreshPolygonOptions, promptDrawTool } from "./extent-picker.js?v=20260916-325719f";
import { drawTimeSeries } from "./time-series-plot.js?v=20260916-325719f";
