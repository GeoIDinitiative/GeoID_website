...
import { polygonsOf, peopleOnGrid, formatPeople, seriesCsv } from "./exposure.js?v=20260915-7b1e1b8";
import { riskMaps, riskMapKind, assessLayer, countsUnder, ringsBox } from "./risk-reader.js?v=20260915-7b1e1b8";
...
import { drawTimeSeries } from "./time-series-plot.js?v=20260915-7b1e1b8";
