...
import { polygonsOf, peopleOnGrid, formatPeople, seriesCsv } from "./exposure.js?v=20260915-fdefd0f";
import { riskMaps, riskMapKind, assessLayer, countsUnder, ringsBox } from "./risk-reader.js?v=20260915-fdefd0f";
...
import { drawTimeSeries } from "./time-series-plot.js?v=20260915-fdefd0f";
