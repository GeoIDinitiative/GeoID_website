...
import { polygonsOf, peopleOnGrid, formatPeople, seriesCsv } from "./exposure.js?v=20260918-d5e8fd5";
import { riskMaps, riskMapKind, assessLayer, countsUnder, ringsBox } from "./risk-reader.js?v=20260918-d5e8fd5";
...
import { refreshPolygonOptions, promptDrawTool } from "./extent-picker.js?v=20260918-d5e8fd5";
import { drawTimeSeries } from "./time-series-plot.js?v=20260918-d5e8fd5";
