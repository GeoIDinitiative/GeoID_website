...
import { polygonsOf, peopleOnGrid, formatPeople, seriesCsv } from "./exposure.js?v=20260916-2222f27";
import { riskMaps, riskMapKind, assessLayer, countsUnder, ringsBox } from "./risk-reader.js?v=20260916-2222f27";
...
import { drawTimeSeries } from "./time-series-plot.js?v=20260916-2222f27";
