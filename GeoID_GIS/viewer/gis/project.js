import * as store from "./research/project-store.js?v=20260826-d76160f";
import { currentBodyId, currentBody } from "./bodies.js?v=20260826-d76160f";
import { ready as shellReady } from "./shell.js?v=20260826-d76160f";
