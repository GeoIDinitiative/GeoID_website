import * as store from "./research/project-store.js?v=20260916-24452db";
import { currentBodyId, currentBody } from "./bodies.js?v=20260916-24452db";
import { ready as shellReady } from "./shell.js?v=20260916-24452db";
