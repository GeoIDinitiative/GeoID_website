import * as store from "./research/project-store.js?v=20260916-64b58db";
import { currentBodyId, currentBody } from "./bodies.js?v=20260916-64b58db";
import { ready as shellReady } from "./shell.js?v=20260916-64b58db";
