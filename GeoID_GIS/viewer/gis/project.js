import * as store from "./research/project-store.js?v=20260915-fd4006f";
import { currentBodyId, currentBody } from "./bodies.js?v=20260915-fd4006f";
import { ready as shellReady } from "./shell.js?v=20260915-fd4006f";
