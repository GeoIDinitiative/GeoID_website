import * as store from "./research/project-store.js?v=20260905-256204f";
import { currentBodyId, currentBody } from "./bodies.js?v=20260905-256204f";
import { ready as shellReady } from "./shell.js?v=20260905-256204f";
