import * as store from "./research/project-store.js?v=20260831-9e9a14f";
import { currentBodyId, currentBody } from "./bodies.js?v=20260831-9e9a14f";
import { ready as shellReady } from "./shell.js?v=20260831-9e9a14f";
