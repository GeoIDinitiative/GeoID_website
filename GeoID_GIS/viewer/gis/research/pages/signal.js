import { registerPage } from "../stages.js?v=20260831-4a108ec";
import * as store from "../project-store.js?v=20260831-4a108ec";
import { parseTable, column, indexSeries } from "../table.js?v=20260831-4a108ec";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260831-4a108ec";
import * as dsp from "../dsp.js?v=20260831-4a108ec";
import { needProject } from "./common.js?v=20260831-4a108ec";
