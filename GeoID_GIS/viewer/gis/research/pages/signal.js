import { registerPage } from "../stages.js?v=20260810-d23a7be";
import * as store from "../project-store.js?v=20260810-d23a7be";
import { parseTable, column, indexSeries } from "../table.js?v=20260810-d23a7be";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260810-d23a7be";
import * as dsp from "../dsp.js?v=20260810-d23a7be";
import { needProject } from "./common.js?v=20260810-d23a7be";
