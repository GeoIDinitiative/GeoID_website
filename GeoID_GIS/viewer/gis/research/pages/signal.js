import { registerPage } from "../stages.js?v=20260817-2497cbf";
import * as store from "../project-store.js?v=20260817-2497cbf";
import { parseTable, column, indexSeries } from "../table.js?v=20260817-2497cbf";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260817-2497cbf";
import * as dsp from "../dsp.js?v=20260817-2497cbf";
import { needProject } from "./common.js?v=20260817-2497cbf";
