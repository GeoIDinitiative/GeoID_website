import { registerPage } from "../stages.js?v=20260828-17debbb";
import * as store from "../project-store.js?v=20260828-17debbb";
import { parseTable, column, indexSeries } from "../table.js?v=20260828-17debbb";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260828-17debbb";
import * as dsp from "../dsp.js?v=20260828-17debbb";
import { needProject } from "./common.js?v=20260828-17debbb";
