import { registerPage } from "../stages.js?v=20260827-5caec2a";
import * as store from "../project-store.js?v=20260827-5caec2a";
import { parseTable, column, indexSeries } from "../table.js?v=20260827-5caec2a";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260827-5caec2a";
import * as dsp from "../dsp.js?v=20260827-5caec2a";
import { needProject } from "./common.js?v=20260827-5caec2a";
