import { registerPage } from "../stages.js?v=20260817-f57d1df";
import * as store from "../project-store.js?v=20260817-f57d1df";
import { parseTable, column, indexSeries } from "../table.js?v=20260817-f57d1df";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260817-f57d1df";
import * as dsp from "../dsp.js?v=20260817-f57d1df";
import { needProject } from "./common.js?v=20260817-f57d1df";
