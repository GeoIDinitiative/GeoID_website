import { registerPage } from "../stages.js?v=20260826-3fbbbdd";
import * as store from "../project-store.js?v=20260826-3fbbbdd";
import { parseTable, column, indexSeries } from "../table.js?v=20260826-3fbbbdd";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260826-3fbbbdd";
import * as dsp from "../dsp.js?v=20260826-3fbbbdd";
import { needProject } from "./common.js?v=20260826-3fbbbdd";
