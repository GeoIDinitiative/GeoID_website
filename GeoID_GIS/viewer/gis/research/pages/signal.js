import { registerPage } from "../stages.js?v=20260818-d95b0ab";
import * as store from "../project-store.js?v=20260818-d95b0ab";
import { parseTable, column, indexSeries } from "../table.js?v=20260818-d95b0ab";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260818-d95b0ab";
import * as dsp from "../dsp.js?v=20260818-d95b0ab";
import { needProject } from "./common.js?v=20260818-d95b0ab";
