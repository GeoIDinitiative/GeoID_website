import { registerPage } from "../stages.js?v=20260911-dd2e87b";
import * as store from "../project-store.js?v=20260911-dd2e87b";
import { parseTable, column, indexSeries } from "../table.js?v=20260911-dd2e87b";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260911-dd2e87b";
import * as dsp from "../dsp.js?v=20260911-dd2e87b";
import { needProject } from "./common.js?v=20260911-dd2e87b";
