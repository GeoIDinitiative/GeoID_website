import { registerPage } from "../stages.js?v=20260817-aef6fce";
import * as store from "../project-store.js?v=20260817-aef6fce";
import { parseTable, column, indexSeries } from "../table.js?v=20260817-aef6fce";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260817-aef6fce";
import * as dsp from "../dsp.js?v=20260817-aef6fce";
import { needProject } from "./common.js?v=20260817-aef6fce";
