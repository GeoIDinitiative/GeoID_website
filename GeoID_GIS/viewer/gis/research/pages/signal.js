import { registerPage } from "../stages.js?v=20260816-960ffbc";
import * as store from "../project-store.js?v=20260816-960ffbc";
import { parseTable, column, indexSeries } from "../table.js?v=20260816-960ffbc";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260816-960ffbc";
import * as dsp from "../dsp.js?v=20260816-960ffbc";
import { needProject } from "./common.js?v=20260816-960ffbc";
