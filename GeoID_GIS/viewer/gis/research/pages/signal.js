import { registerPage } from "../stages.js?v=20260910-5468fdc";
import * as store from "../project-store.js?v=20260910-5468fdc";
import { parseTable, column, indexSeries } from "../table.js?v=20260910-5468fdc";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260910-5468fdc";
import * as dsp from "../dsp.js?v=20260910-5468fdc";
import { needProject } from "./common.js?v=20260910-5468fdc";
