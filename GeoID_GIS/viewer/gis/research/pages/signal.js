import { registerPage } from "../stages.js?v=20260910-038cffc";
import * as store from "../project-store.js?v=20260910-038cffc";
import { parseTable, column, indexSeries } from "../table.js?v=20260910-038cffc";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260910-038cffc";
import * as dsp from "../dsp.js?v=20260910-038cffc";
import { needProject } from "./common.js?v=20260910-038cffc";
