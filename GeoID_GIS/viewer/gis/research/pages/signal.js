import { registerPage } from "../stages.js?v=20260828-e0ac21c";
import * as store from "../project-store.js?v=20260828-e0ac21c";
import { parseTable, column, indexSeries } from "../table.js?v=20260828-e0ac21c";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260828-e0ac21c";
import * as dsp from "../dsp.js?v=20260828-e0ac21c";
import { needProject } from "./common.js?v=20260828-e0ac21c";
