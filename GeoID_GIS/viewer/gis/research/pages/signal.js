import { registerPage } from "../stages.js?v=20260915-fe100ae";
import * as store from "../project-store.js?v=20260915-fe100ae";
import { parseTable, column, indexSeries } from "../table.js?v=20260915-fe100ae";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260915-fe100ae";
import * as dsp from "../dsp.js?v=20260915-fe100ae";
import { needProject } from "./common.js?v=20260915-fe100ae";
