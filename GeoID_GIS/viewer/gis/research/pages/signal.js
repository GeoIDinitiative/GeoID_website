import { registerPage } from "../stages.js?v=20260908-f9360ff";
import * as store from "../project-store.js?v=20260908-f9360ff";
import { parseTable, column, indexSeries } from "../table.js?v=20260908-f9360ff";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260908-f9360ff";
import * as dsp from "../dsp.js?v=20260908-f9360ff";
import { needProject } from "./common.js?v=20260908-f9360ff";
