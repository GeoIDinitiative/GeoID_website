import { registerPage } from "../stages.js?v=20260821-4cbbabb";
import * as store from "../project-store.js?v=20260821-4cbbabb";
import { parseTable, column, indexSeries } from "../table.js?v=20260821-4cbbabb";
import { linePlot, heatmap, toPngBlob } from "../plot.js?v=20260821-4cbbabb";
import * as dsp from "../dsp.js?v=20260821-4cbbabb";
import { needProject } from "./common.js?v=20260821-4cbbabb";
