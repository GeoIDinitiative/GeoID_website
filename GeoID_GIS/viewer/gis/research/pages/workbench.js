...
import * as google from "../google-credentials.js?v=20260808-824ab45";
import { column } from "../table.js?v=20260808-824ab45";
import { linePlot } from "../plot.js?v=20260808-824ab45";
...
const mountPlugins = guard("Plugin Manager", async (host) => {
  ...
  box.appendChild(el("p", "research-note",
    ...
    + "actually loaded."));
  const { STAGES: stages, getPage: get } = await import("../stages.js?v=20260808-824ab45");
