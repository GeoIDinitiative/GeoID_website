import { wire, wirePattern } from "./spec-page.js?v=20260808-cf712ff";
import * as store from "./project-store.js?v=20260808-cf712ff";
import * as bridge from "./bridge.js?v=20260808-cf712ff";
import * as dsp from "./dsp.js?v=20260808-cf712ff";
import * as stats from "./stats.js?v=20260808-cf712ff";
import { linePlot } from "./plot.js?v=20260808-cf712ff";
import { parseTable, column } from "./table.js?v=20260808-cf712ff";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260808-cf712ff";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260808-cf712ff`);
