import { wire, wirePattern } from "./spec-page.js?v=20260808-a744c6f";
import * as store from "./project-store.js?v=20260808-a744c6f";
import * as bridge from "./bridge.js?v=20260808-a744c6f";
import * as dsp from "./dsp.js?v=20260808-a744c6f";
import * as stats from "./stats.js?v=20260808-a744c6f";
import { linePlot } from "./plot.js?v=20260808-a744c6f";
import { parseTable, column } from "./table.js?v=20260808-a744c6f";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260808-a744c6f";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260808-a744c6f`);
