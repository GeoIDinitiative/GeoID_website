...
import * as bridge from "./bridge.js?v=20260810-596d640";
import * as dsp from "./dsp.js?v=20260810-596d640";
import * as stats from "./stats.js?v=20260810-596d640";
import { linePlot } from "./plot.js?v=20260810-596d640";
import { parseTable, column } from "./table.js?v=20260810-596d640";
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260810-596d640");
