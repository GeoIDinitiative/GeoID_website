import { wire, wirePattern } from "./spec-page.js?v=20260909-24d6edb";
import * as store from "./project-store.js?v=20260909-24d6edb";
import * as bridge from "./bridge.js?v=20260909-24d6edb";
import * as dsp from "./dsp.js?v=20260909-24d6edb";
import * as stats from "./stats.js?v=20260909-24d6edb";
import { linePlot } from "./plot.js?v=20260909-24d6edb";
import { parseTable, column } from "./table.js?v=20260909-24d6edb";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260909-24d6edb";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260909-24d6edb`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260909-24d6edb");
