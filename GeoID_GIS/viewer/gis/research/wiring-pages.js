import { wire, wirePattern } from "./spec-page.js?v=20260808-16f4ac6";
import * as store from "./project-store.js?v=20260808-16f4ac6";
import * as bridge from "./bridge.js?v=20260808-16f4ac6";
import * as dsp from "./dsp.js?v=20260808-16f4ac6";
import * as stats from "./stats.js?v=20260808-16f4ac6";
import { linePlot } from "./plot.js?v=20260808-16f4ac6";
import { parseTable, column } from "./table.js?v=20260808-16f4ac6";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260808-16f4ac6";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260808-16f4ac6`);
