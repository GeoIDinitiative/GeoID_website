import { wire, wirePattern } from "./spec-page.js?v=20260908-f9360ff";
import * as store from "./project-store.js?v=20260908-f9360ff";
import * as bridge from "./bridge.js?v=20260908-f9360ff";
import * as dsp from "./dsp.js?v=20260908-f9360ff";
import * as stats from "./stats.js?v=20260908-f9360ff";
import { linePlot } from "./plot.js?v=20260908-f9360ff";
import { parseTable, column } from "./table.js?v=20260908-f9360ff";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260908-f9360ff";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260908-f9360ff`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260908-f9360ff");
