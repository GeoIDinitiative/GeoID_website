import { wire, wirePattern } from "./spec-page.js?v=20260909-962490b";
import * as store from "./project-store.js?v=20260909-962490b";
import * as bridge from "./bridge.js?v=20260909-962490b";
import * as dsp from "./dsp.js?v=20260909-962490b";
import * as stats from "./stats.js?v=20260909-962490b";
import { linePlot } from "./plot.js?v=20260909-962490b";
import { parseTable, column } from "./table.js?v=20260909-962490b";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260909-962490b";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260909-962490b`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260909-962490b");
