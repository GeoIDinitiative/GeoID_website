import { wire, wirePattern } from "./spec-page.js?v=20260818-55a4fdb";
import * as store from "./project-store.js?v=20260818-55a4fdb";
import * as bridge from "./bridge.js?v=20260818-55a4fdb";
import * as dsp from "./dsp.js?v=20260818-55a4fdb";
import * as stats from "./stats.js?v=20260818-55a4fdb";
import { linePlot } from "./plot.js?v=20260818-55a4fdb";
import { parseTable, column } from "./table.js?v=20260818-55a4fdb";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260818-55a4fdb";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260818-55a4fdb`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260818-55a4fdb");
