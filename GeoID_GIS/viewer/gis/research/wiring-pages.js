import { wire, wirePattern } from "./spec-page.js?v=20260914-7778b2c";
import * as store from "./project-store.js?v=20260914-7778b2c";
import * as bridge from "./bridge.js?v=20260914-7778b2c";
import * as dsp from "./dsp.js?v=20260914-7778b2c";
import * as stats from "./stats.js?v=20260914-7778b2c";
import { linePlot } from "./plot.js?v=20260914-7778b2c";
import { parseTable, column } from "./table.js?v=20260914-7778b2c";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260914-7778b2c";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260914-7778b2c`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260914-7778b2c");
