import { wire, wirePattern } from "./spec-page.js?v=20260912-b8e3eef";
import * as store from "./project-store.js?v=20260912-b8e3eef";
import * as bridge from "./bridge.js?v=20260912-b8e3eef";
import * as dsp from "./dsp.js?v=20260912-b8e3eef";
import * as stats from "./stats.js?v=20260912-b8e3eef";
import { linePlot } from "./plot.js?v=20260912-b8e3eef";
import { parseTable, column } from "./table.js?v=20260912-b8e3eef";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260912-b8e3eef";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260912-b8e3eef`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260912-b8e3eef");
