import { wire, wirePattern } from "./spec-page.js?v=20260910-42da88f";
import * as store from "./project-store.js?v=20260910-42da88f";
import * as bridge from "./bridge.js?v=20260910-42da88f";
import * as dsp from "./dsp.js?v=20260910-42da88f";
import * as stats from "./stats.js?v=20260910-42da88f";
import { linePlot } from "./plot.js?v=20260910-42da88f";
import { parseTable, column } from "./table.js?v=20260910-42da88f";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260910-42da88f";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260910-42da88f`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260910-42da88f");
