import { wire, wirePattern } from "./spec-page.js?v=20260911-20d18ce";
import * as store from "./project-store.js?v=20260911-20d18ce";
import * as bridge from "./bridge.js?v=20260911-20d18ce";
import * as dsp from "./dsp.js?v=20260911-20d18ce";
import * as stats from "./stats.js?v=20260911-20d18ce";
import { linePlot } from "./plot.js?v=20260911-20d18ce";
import { parseTable, column } from "./table.js?v=20260911-20d18ce";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260911-20d18ce";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260911-20d18ce`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260911-20d18ce");
