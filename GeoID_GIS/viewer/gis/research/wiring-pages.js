import { wire, wirePattern } from "./spec-page.js?v=20260825-631d9fa";
import * as store from "./project-store.js?v=20260825-631d9fa";
import * as bridge from "./bridge.js?v=20260825-631d9fa";
import * as dsp from "./dsp.js?v=20260825-631d9fa";
import * as stats from "./stats.js?v=20260825-631d9fa";
import { linePlot } from "./plot.js?v=20260825-631d9fa";
import { parseTable, column } from "./table.js?v=20260825-631d9fa";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260825-631d9fa";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260825-631d9fa`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260825-631d9fa");
