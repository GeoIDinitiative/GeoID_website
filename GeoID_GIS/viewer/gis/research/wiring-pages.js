import { wire, wirePattern } from "./spec-page.js?v=20260810-ebad563";
...
import { linePlot } from "./plot.js?v=20260810-ebad563";
import { parseTable, column } from "./table.js?v=20260810-ebad563";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260810-ebad563";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260810-ebad563`);
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260810-ebad563");
