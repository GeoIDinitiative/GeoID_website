import { wire, wirePattern } from "./spec-page.js?v=20260810-3a2ffdb";
import * as store from "./project-store.js?v=20260810-3a2ffdb";
import * as bridge from "./bridge.js?v=20260810-3a2ffdb";
import * as dsp from "./dsp.js?v=20260810-3a2ffdb";
import * as stats from "./stats.js?v=20260810-3a2ffdb";
import { linePlot } from "./plot.js?v=20260810-3a2ffdb";
import { parseTable, column } from "./table.js?v=20260810-3a2ffdb";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260810-3a2ffdb";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260810-3a2ffdb`);
