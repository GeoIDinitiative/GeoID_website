import { wire, wirePattern } from "./spec-page.js?v=20260828-2fe26ec";
import * as store from "./project-store.js?v=20260828-2fe26ec";
import * as bridge from "./bridge.js?v=20260828-2fe26ec";
import * as dsp from "./dsp.js?v=20260828-2fe26ec";
import * as stats from "./stats.js?v=20260828-2fe26ec";
import { linePlot } from "./plot.js?v=20260828-2fe26ec";
import { parseTable, column } from "./table.js?v=20260828-2fe26ec";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260828-2fe26ec";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260828-2fe26ec`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260828-2fe26ec");
