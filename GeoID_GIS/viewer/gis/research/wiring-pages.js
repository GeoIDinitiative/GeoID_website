import { wire, wirePattern } from "./spec-page.js?v=20260808-e1ce08e";
import * as store from "./project-store.js?v=20260808-e1ce08e";
import * as bridge from "./bridge.js?v=20260808-e1ce08e";
import * as dsp from "./dsp.js?v=20260808-e1ce08e";
import * as stats from "./stats.js?v=20260808-e1ce08e";
import { linePlot } from "./plot.js?v=20260808-e1ce08e";
import { parseTable, column } from "./table.js?v=20260808-e1ce08e";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260808-e1ce08e";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260808-e1ce08e`);
