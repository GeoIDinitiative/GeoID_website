import { wire, wirePattern } from "./spec-page.js?v=20260909-b1377ab";
import * as store from "./project-store.js?v=20260909-b1377ab";
import * as bridge from "./bridge.js?v=20260909-b1377ab";
...
import { parseTable, column } from "./table.js?v=20260909-b1377ab";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260909-b1377ab";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260909-b1377ab`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260909-b1377ab");
