import { wire, wirePattern } from "./spec-page.js?v=20260808-a4734aa";
...
import { linePlot } from "./plot.js?v=20260808-a4734aa";
import { parseTable, column } from "./table.js?v=20260808-a4734aa";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260808-a4734aa";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260808-a4734aa`);
