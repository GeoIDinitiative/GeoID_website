import { wire, wirePattern } from "./spec-page.js?v=20260817-f57d1df";
import * as store from "./project-store.js?v=20260817-f57d1df";
import * as bridge from "./bridge.js?v=20260817-f57d1df";
import * as dsp from "./dsp.js?v=20260817-f57d1df";
import * as stats from "./stats.js?v=20260817-f57d1df";
import { linePlot } from "./plot.js?v=20260817-f57d1df";
import { parseTable, column } from "./table.js?v=20260817-f57d1df";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260817-f57d1df";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260817-f57d1df`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260817-f57d1df");
