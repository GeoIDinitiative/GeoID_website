import { wire, wirePattern } from "./spec-page.js?v=20260911-d7f4f8c";
import * as store from "./project-store.js?v=20260911-d7f4f8c";
import * as bridge from "./bridge.js?v=20260911-d7f4f8c";
import * as dsp from "./dsp.js?v=20260911-d7f4f8c";
import * as stats from "./stats.js?v=20260911-d7f4f8c";
import { linePlot } from "./plot.js?v=20260911-d7f4f8c";
import { parseTable, column } from "./table.js?v=20260911-d7f4f8c";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260911-d7f4f8c";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260911-d7f4f8c`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260911-d7f4f8c");
