import { wire, wirePattern } from "./spec-page.js?v=20260808-e457625";
import * as store from "./project-store.js?v=20260808-e457625";
import * as bridge from "./bridge.js?v=20260808-e457625";
import * as dsp from "./dsp.js?v=20260808-e457625";
import * as stats from "./stats.js?v=20260808-e457625";
import { linePlot } from "./plot.js?v=20260808-e457625";
import { parseTable, column } from "./table.js?v=20260808-e457625";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260808-e457625";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260808-e457625`);
