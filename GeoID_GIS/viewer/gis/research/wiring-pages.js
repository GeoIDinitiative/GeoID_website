import { wire, wirePattern } from "./spec-page.js?v=20260808-b5b50b0";
...
import { parseTable, column } from "./table.js?v=20260808-b5b50b0";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260808-b5b50b0";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260808-b5b50b0`);
