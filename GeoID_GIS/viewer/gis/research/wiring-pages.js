import { wire, wirePattern } from "./spec-page.js?v=20260828-5c22652";
import * as store from "./project-store.js?v=20260828-5c22652";
import * as bridge from "./bridge.js?v=20260828-5c22652";
import * as dsp from "./dsp.js?v=20260828-5c22652";
import * as stats from "./stats.js?v=20260828-5c22652";
import { linePlot } from "./plot.js?v=20260828-5c22652";
import { parseTable, column } from "./table.js?v=20260828-5c22652";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260828-5c22652";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260828-5c22652`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260828-5c22652");
