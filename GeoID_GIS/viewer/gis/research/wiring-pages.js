import { wire, wirePattern } from "./spec-page.js?v=20260822-cc374dd";
import * as store from "./project-store.js?v=20260822-cc374dd";
import * as bridge from "./bridge.js?v=20260822-cc374dd";
import * as dsp from "./dsp.js?v=20260822-cc374dd";
import * as stats from "./stats.js?v=20260822-cc374dd";
import { linePlot } from "./plot.js?v=20260822-cc374dd";
import { parseTable, column } from "./table.js?v=20260822-cc374dd";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260822-cc374dd";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260822-cc374dd`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260822-cc374dd");
