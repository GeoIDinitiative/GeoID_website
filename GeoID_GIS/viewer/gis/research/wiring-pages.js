import { wire, wirePattern } from "./spec-page.js?v=20260816-d597d22";
import * as store from "./project-store.js?v=20260816-d597d22";
import * as bridge from "./bridge.js?v=20260816-d597d22";
import * as dsp from "./dsp.js?v=20260816-d597d22";
import * as stats from "./stats.js?v=20260816-d597d22";
import { linePlot } from "./plot.js?v=20260816-d597d22";
import { parseTable, column } from "./table.js?v=20260816-d597d22";
import { findTables, loadTable, saveTable, saveFigure } from "./pages/common.js?v=20260816-d597d22";
...
wire("Preprocessing Transforms", {
  "Transform Coordinates": async ({ say }) => {
    ...
    const projection = await import(`../projection.js?v=20260816-d597d22`);
    const zones = new Set();
    let projected = 0;
...
wire("Storyboard", {
  "AI Outline": async ({ say }) => {
    const sidecar = await import("./sidecar.js?v=20260816-d597d22");
