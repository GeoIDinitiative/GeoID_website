import { wirePattern, wire } from "./spec-page.js?v=20260909-5b7fb53";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-5b7fb53";
...
const geo = () => import(`../geoprocessing.js?v=20260909-5b7fb53`);
