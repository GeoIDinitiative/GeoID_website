import { wirePattern, wire } from "./spec-page.js?v=20260909-8a7d11d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-8a7d11d";
...
const geo = () => import(`../geoprocessing.js?v=20260909-8a7d11d`);
