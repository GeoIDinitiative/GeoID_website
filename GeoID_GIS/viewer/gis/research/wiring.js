import { wirePattern, wire } from "./spec-page.js?v=20260826-d0d9d92";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-d0d9d92";
...
const geo = () => import(`../geoprocessing.js?v=20260826-d0d9d92`);
