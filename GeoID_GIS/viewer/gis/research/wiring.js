import { wirePattern, wire } from "./spec-page.js?v=20260908-1357e7f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-1357e7f";
...
const geo = () => import(`../geoprocessing.js?v=20260908-1357e7f`);
