import { wirePattern, wire } from "./spec-page.js?v=20260830-d29d5e8";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-d29d5e8";
...
const geo = () => import(`../geoprocessing.js?v=20260830-d29d5e8`);
