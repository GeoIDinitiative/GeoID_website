import { wirePattern, wire } from "./spec-page.js?v=20260827-6ed43a4";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-6ed43a4";
...
const geo = () => import(`../geoprocessing.js?v=20260827-6ed43a4`);
