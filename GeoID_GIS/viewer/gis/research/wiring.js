import { wirePattern, wire } from "./spec-page.js?v=20260901-daafb14";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260901-daafb14";
...
const geo = () => import(`../geoprocessing.js?v=20260901-daafb14`);
