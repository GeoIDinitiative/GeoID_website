import { wirePattern, wire } from "./spec-page.js?v=20260920-f6aad18";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260920-f6aad18";
...
const geo = () => import(`../geoprocessing.js?v=20260920-f6aad18`);
