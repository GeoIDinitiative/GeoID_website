import { wirePattern, wire } from "./spec-page.js?v=20260919-b0ce896";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260919-b0ce896";
...
const geo = () => import(`../geoprocessing.js?v=20260919-b0ce896`);
