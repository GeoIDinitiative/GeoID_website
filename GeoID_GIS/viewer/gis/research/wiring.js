import { wirePattern, wire } from "./spec-page.js?v=20260810-3a2ffdb";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260810-3a2ffdb";
...
const geo = () => import(`../geoprocessing.js?v=20260810-3a2ffdb`);
