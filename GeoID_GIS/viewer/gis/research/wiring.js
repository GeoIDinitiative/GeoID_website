import { wirePattern, wire } from "./spec-page.js?v=20260908-a3e0dca";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-a3e0dca";
...
const geo = () => import(`../geoprocessing.js?v=20260908-a3e0dca`);
