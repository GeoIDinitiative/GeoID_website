import { wirePattern, wire } from "./spec-page.js?v=20260909-8ebb2d7";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-8ebb2d7";
...
const geo = () => import(`../geoprocessing.js?v=20260909-8ebb2d7`);
