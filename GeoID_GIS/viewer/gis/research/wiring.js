import { wirePattern, wire } from "./spec-page.js?v=20260905-0d3d00f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260905-0d3d00f";
...
const geo = () => import(`../geoprocessing.js?v=20260905-0d3d00f`);
