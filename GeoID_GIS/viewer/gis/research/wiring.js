import { wirePattern, wire } from "./spec-page.js?v=20260816-f61b5f5";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-f61b5f5";
...
const geo = () => import(`../geoprocessing.js?v=20260816-f61b5f5`);
