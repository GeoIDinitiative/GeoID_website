import { wirePattern, wire } from "./spec-page.js?v=20260827-2a7b4b9";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-2a7b4b9";
...
const geo = () => import(`../geoprocessing.js?v=20260827-2a7b4b9`);
