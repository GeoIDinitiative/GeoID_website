import { wirePattern, wire } from "./spec-page.js?v=20260831-00842e4";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-00842e4";
...
const geo = () => import(`../geoprocessing.js?v=20260831-00842e4`);
