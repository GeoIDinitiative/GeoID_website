import { wirePattern, wire } from "./spec-page.js?v=20260916-bdf05b6";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-bdf05b6";
...
const geo = () => import(`../geoprocessing.js?v=20260916-bdf05b6`);
