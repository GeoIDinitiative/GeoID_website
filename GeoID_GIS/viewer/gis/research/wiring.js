import { wirePattern, wire } from "./spec-page.js?v=20260915-436fbaa";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-436fbaa";
...
const geo = () => import(`../geoprocessing.js?v=20260915-436fbaa`);
