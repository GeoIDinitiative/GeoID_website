import { wirePattern, wire } from "./spec-page.js?v=20260909-3924b18";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-3924b18";
...
const geo = () => import(`../geoprocessing.js?v=20260909-3924b18`);
