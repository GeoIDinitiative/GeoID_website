import { wirePattern, wire } from "./spec-page.js?v=20260912-03f0b7a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260912-03f0b7a";
...
const geo = () => import(`../geoprocessing.js?v=20260912-03f0b7a`);
