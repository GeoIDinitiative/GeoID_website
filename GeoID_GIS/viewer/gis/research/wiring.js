import { wirePattern, wire } from "./spec-page.js?v=20260830-97628ed";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-97628ed";
...
const geo = () => import(`../geoprocessing.js?v=20260830-97628ed`);
