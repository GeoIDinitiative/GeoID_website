import { wirePattern, wire } from "./spec-page.js?v=20260810-179ddbc";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260810-179ddbc";
...
const geo = () => import(`../geoprocessing.js?v=20260810-179ddbc`);
