import { wirePattern, wire } from "./spec-page.js?v=20260909-1027e8b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-1027e8b";
...
const geo = () => import(`../geoprocessing.js?v=20260909-1027e8b`);
