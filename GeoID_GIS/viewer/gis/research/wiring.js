import { wirePattern, wire } from "./spec-page.js?v=20260915-1257e0b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-1257e0b";
...
const geo = () => import(`../geoprocessing.js?v=20260915-1257e0b`);
