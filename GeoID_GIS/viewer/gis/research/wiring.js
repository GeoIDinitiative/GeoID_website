import { wirePattern, wire } from "./spec-page.js?v=20260901-d87db3d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260901-d87db3d";
...
const geo = () => import(`../geoprocessing.js?v=20260901-d87db3d`);
