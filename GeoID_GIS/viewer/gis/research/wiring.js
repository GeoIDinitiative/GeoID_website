import { wirePattern, wire } from "./spec-page.js?v=20260818-fb901be";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260818-fb901be";
...
const geo = () => import(`../geoprocessing.js?v=20260818-fb901be`);
