import { wirePattern, wire } from "./spec-page.js?v=20260910-3e9f5be";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-3e9f5be";
...
const geo = () => import(`../geoprocessing.js?v=20260910-3e9f5be`);
