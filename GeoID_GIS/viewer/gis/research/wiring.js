import { wirePattern, wire } from "./spec-page.js?v=20260909-27911d9";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-27911d9";
...
const geo = () => import(`../geoprocessing.js?v=20260909-27911d9`);
