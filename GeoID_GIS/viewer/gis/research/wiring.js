import { wirePattern, wire } from "./spec-page.js?v=20260826-e4a170d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-e4a170d";
...
const geo = () => import(`../geoprocessing.js?v=20260826-e4a170d`);
