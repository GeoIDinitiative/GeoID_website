import { wirePattern, wire } from "./spec-page.js?v=20260827-abab75d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-abab75d";
...
const geo = () => import(`../geoprocessing.js?v=20260827-abab75d`);
