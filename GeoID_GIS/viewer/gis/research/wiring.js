import { wirePattern, wire } from "./spec-page.js?v=20260827-e44795a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-e44795a";
...
const geo = () => import(`../geoprocessing.js?v=20260827-e44795a`);
