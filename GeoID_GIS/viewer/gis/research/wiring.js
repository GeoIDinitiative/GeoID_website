import { wirePattern, wire } from "./spec-page.js?v=20260909-b2e824d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-b2e824d";
...
const geo = () => import(`../geoprocessing.js?v=20260909-b2e824d`);
