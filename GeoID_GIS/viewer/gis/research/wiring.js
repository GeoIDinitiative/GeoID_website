import { wirePattern, wire } from "./spec-page.js?v=20260920-8955db3";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260920-8955db3";
...
const geo = () => import(`../geoprocessing.js?v=20260920-8955db3`);
