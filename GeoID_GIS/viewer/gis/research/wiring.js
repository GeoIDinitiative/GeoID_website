import { wirePattern, wire } from "./spec-page.js?v=20260825-f5a425d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260825-f5a425d";
...
const geo = () => import(`../geoprocessing.js?v=20260825-f5a425d`);
