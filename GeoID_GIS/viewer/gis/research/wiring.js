import { wirePattern, wire } from "./spec-page.js?v=20260828-e738b7e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-e738b7e";
...
const geo = () => import(`../geoprocessing.js?v=20260828-e738b7e`);
