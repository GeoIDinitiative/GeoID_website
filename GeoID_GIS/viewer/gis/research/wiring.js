import { wirePattern, wire } from "./spec-page.js?v=20260904-f62985e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260904-f62985e";
...
const geo = () => import(`../geoprocessing.js?v=20260904-f62985e`);
