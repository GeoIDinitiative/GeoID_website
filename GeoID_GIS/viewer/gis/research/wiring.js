import { wirePattern, wire } from "./spec-page.js?v=20260914-4b4e967";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260914-4b4e967";
...
const geo = () => import(`../geoprocessing.js?v=20260914-4b4e967`);
