import { wirePattern, wire } from "./spec-page.js?v=20260914-8b10d0f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260914-8b10d0f";
...
const geo = () => import(`../geoprocessing.js?v=20260914-8b10d0f`);
