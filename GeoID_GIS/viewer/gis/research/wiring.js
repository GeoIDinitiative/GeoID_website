import { wirePattern, wire } from "./spec-page.js?v=20260925-61682d8";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260925-61682d8";
...
const geo = () => import(`../geoprocessing.js?v=20260925-61682d8`);
