import { wirePattern, wire } from "./spec-page.js?v=20260830-bcaa506";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-bcaa506";
...
const geo = () => import(`../geoprocessing.js?v=20260830-bcaa506`);
