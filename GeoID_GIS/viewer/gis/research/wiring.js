import { wirePattern, wire } from "./spec-page.js?v=20260816-547d4bf";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-547d4bf";
...
const geo = () => import(`../geoprocessing.js?v=20260816-547d4bf`);
