import { wirePattern, wire } from "./spec-page.js?v=20260919-9a38a72";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260919-9a38a72";
...
const geo = () => import(`../geoprocessing.js?v=20260919-9a38a72`);
