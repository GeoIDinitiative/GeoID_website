import { wirePattern, wire } from "./spec-page.js?v=20260828-90f68be";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-90f68be";
...
const geo = () => import(`../geoprocessing.js?v=20260828-90f68be`);
