import { wirePattern, wire } from "./spec-page.js?v=20260910-f54ac16";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-f54ac16";
...
const geo = () => import(`../geoprocessing.js?v=20260910-f54ac16`);
