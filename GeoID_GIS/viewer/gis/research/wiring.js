import { wirePattern, wire } from "./spec-page.js?v=20260817-2497cbf";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260817-2497cbf";
...
const geo = () => import(`../geoprocessing.js?v=20260817-2497cbf`);
