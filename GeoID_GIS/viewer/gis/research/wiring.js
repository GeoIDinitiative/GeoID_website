import { wirePattern, wire } from "./spec-page.js?v=20260811-3fe241a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260811-3fe241a";
...
const geo = () => import(`../geoprocessing.js?v=20260811-3fe241a`);
