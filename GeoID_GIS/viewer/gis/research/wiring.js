import { wirePattern, wire } from "./spec-page.js?v=20260908-32f54a4";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-32f54a4";
...
const geo = () => import(`../geoprocessing.js?v=20260908-32f54a4`);
