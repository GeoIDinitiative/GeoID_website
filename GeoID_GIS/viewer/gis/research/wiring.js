import { wirePattern, wire } from "./spec-page.js?v=20260823-9a98b82";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260823-9a98b82";
...
const geo = () => import(`../geoprocessing.js?v=20260823-9a98b82`);
