import { wirePattern, wire } from "./spec-page.js?v=20260831-8865357";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-8865357";
...
const geo = () => import(`../geoprocessing.js?v=20260831-8865357`);
