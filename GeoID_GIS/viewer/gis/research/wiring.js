import { wirePattern, wire } from "./spec-page.js?v=20260909-d242a3e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-d242a3e";
...
const geo = () => import(`../geoprocessing.js?v=20260909-d242a3e`);
