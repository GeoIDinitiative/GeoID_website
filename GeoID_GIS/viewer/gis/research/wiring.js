import { wirePattern, wire } from "./spec-page.js?v=20260912-7310b6e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260912-7310b6e";
...
const geo = () => import(`../geoprocessing.js?v=20260912-7310b6e`);
