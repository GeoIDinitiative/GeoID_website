import { wirePattern, wire } from "./spec-page.js?v=20260908-4034c94";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-4034c94";
...
const geo = () => import(`../geoprocessing.js?v=20260908-4034c94`);
