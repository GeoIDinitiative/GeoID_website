import { wirePattern, wire } from "./spec-page.js?v=20260830-fe8b92a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-fe8b92a";
...
const geo = () => import(`../geoprocessing.js?v=20260830-fe8b92a`);
