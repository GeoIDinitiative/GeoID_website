import { wirePattern, wire } from "./spec-page.js?v=20260814-9a8aae2";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260814-9a8aae2";
...
const geo = () => import(`../geoprocessing.js?v=20260814-9a8aae2`);
