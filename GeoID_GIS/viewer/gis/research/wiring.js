import { wirePattern, wire } from "./spec-page.js?v=20260830-8ea2e6c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-8ea2e6c";
...
const geo = () => import(`../geoprocessing.js?v=20260830-8ea2e6c`);
