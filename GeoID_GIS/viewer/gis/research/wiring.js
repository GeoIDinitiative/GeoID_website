import { wirePattern, wire } from "./spec-page.js?v=20260826-ff43a5e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-ff43a5e";
...
const geo = () => import(`../geoprocessing.js?v=20260826-ff43a5e`);
