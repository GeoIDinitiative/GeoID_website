import { wirePattern, wire } from "./spec-page.js?v=20260830-974372a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-974372a";
...
const geo = () => import(`../geoprocessing.js?v=20260830-974372a`);
