import { wirePattern, wire } from "./spec-page.js?v=20260808-b0aa879";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260808-b0aa879";
...
const geo = () => import(`../geoprocessing.js?v=20260808-b0aa879`);
