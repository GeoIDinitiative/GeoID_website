import { wirePattern, wire } from "./spec-page.js?v=20260915-e0185f7";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-e0185f7";
...
const geo = () => import(`../geoprocessing.js?v=20260915-e0185f7`);
