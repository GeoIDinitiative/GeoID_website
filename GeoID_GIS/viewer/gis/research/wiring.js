import { wirePattern, wire } from "./spec-page.js?v=20260811-477120d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260811-477120d";
...
const geo = () => import(`../geoprocessing.js?v=20260811-477120d`);
