import { wirePattern, wire } from "./spec-page.js?v=20260920-724172f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260920-724172f";
...
const geo = () => import(`../geoprocessing.js?v=20260920-724172f`);
