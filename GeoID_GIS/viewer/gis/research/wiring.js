import { wirePattern, wire } from "./spec-page.js?v=20260920-4149ca7";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260920-4149ca7";
...
const geo = () => import(`../geoprocessing.js?v=20260920-4149ca7`);
