import { wirePattern, wire } from "./spec-page.js?v=20260901-bd1cc2f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260901-bd1cc2f";
...
const geo = () => import(`../geoprocessing.js?v=20260901-bd1cc2f`);
