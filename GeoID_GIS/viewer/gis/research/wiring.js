import { wirePattern, wire } from "./spec-page.js?v=20260810-e7aa4f0";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260810-e7aa4f0";
...
const geo = () => import(`../geoprocessing.js?v=20260810-e7aa4f0`);
