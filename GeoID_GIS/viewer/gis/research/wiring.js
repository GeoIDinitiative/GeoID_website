import { wirePattern, wire } from "./spec-page.js?v=20260831-b2ed2e1";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-b2ed2e1";
...
const geo = () => import(`../geoprocessing.js?v=20260831-b2ed2e1`);
