import { wirePattern, wire } from "./spec-page.js?v=20260811-d57db16";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260811-d57db16";
...
const geo = () => import(`../geoprocessing.js?v=20260811-d57db16`);
