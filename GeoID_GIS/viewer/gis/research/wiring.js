import { wirePattern, wire } from "./spec-page.js?v=20260816-6ce8ecd";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-6ce8ecd";
...
const geo = () => import(`../geoprocessing.js?v=20260816-6ce8ecd`);
