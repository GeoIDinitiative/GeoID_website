import { wirePattern, wire } from "./spec-page.js?v=20260901-6ffcdfa";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260901-6ffcdfa";
...
const geo = () => import(`../geoprocessing.js?v=20260901-6ffcdfa`);
