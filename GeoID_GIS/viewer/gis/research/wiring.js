import { wirePattern, wire } from "./spec-page.js?v=20260904-946aa8d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260904-946aa8d";
...
const geo = () => import(`../geoprocessing.js?v=20260904-946aa8d`);
