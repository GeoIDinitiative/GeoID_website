import { wirePattern, wire } from "./spec-page.js?v=20260915-fdefd0f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-fdefd0f";
...
const geo = () => import(`../geoprocessing.js?v=20260915-fdefd0f`);
