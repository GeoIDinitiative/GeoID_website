import { wirePattern, wire } from "./spec-page.js?v=20260914-9fe2e4a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260914-9fe2e4a";
...
const geo = () => import(`../geoprocessing.js?v=20260914-9fe2e4a`);
