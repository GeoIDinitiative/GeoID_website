import { wirePattern, wire } from "./spec-page.js?v=20260827-91112f8";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-91112f8";
...
const geo = () => import(`../geoprocessing.js?v=20260827-91112f8`);
