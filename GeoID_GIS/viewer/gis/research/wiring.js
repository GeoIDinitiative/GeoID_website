import { wirePattern, wire } from "./spec-page.js?v=20260826-4d8a13c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-4d8a13c";
...
const geo = () => import(`../geoprocessing.js?v=20260826-4d8a13c`);
