import { wirePattern, wire } from "./spec-page.js?v=20260827-4323be2";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-4323be2";
...
const geo = () => import(`../geoprocessing.js?v=20260827-4323be2`);
