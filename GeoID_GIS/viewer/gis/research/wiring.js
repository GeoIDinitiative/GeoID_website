import { wirePattern, wire } from "./spec-page.js?v=20260831-fd2a91f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-fd2a91f";
...
const geo = () => import(`../geoprocessing.js?v=20260831-fd2a91f`);
