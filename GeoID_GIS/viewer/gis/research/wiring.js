import { wirePattern, wire } from "./spec-page.js?v=20260902-206ed12";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260902-206ed12";
...
const geo = () => import(`../geoprocessing.js?v=20260902-206ed12`);
