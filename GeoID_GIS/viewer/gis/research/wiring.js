import { wirePattern, wire } from "./spec-page.js?v=20260911-fe2cd09";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-fe2cd09";
...
const geo = () => import(`../geoprocessing.js?v=20260911-fe2cd09`);
