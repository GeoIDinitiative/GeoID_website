import { wirePattern, wire } from "./spec-page.js?v=20260816-1e1ecb0";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-1e1ecb0";
...
const geo = () => import(`../geoprocessing.js?v=20260816-1e1ecb0`);
