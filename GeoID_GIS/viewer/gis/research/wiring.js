import { wirePattern, wire } from "./spec-page.js?v=20260909-e56f49d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-e56f49d";
...
const geo = () => import(`../geoprocessing.js?v=20260909-e56f49d`);
