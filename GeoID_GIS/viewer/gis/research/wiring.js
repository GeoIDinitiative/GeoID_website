import { wirePattern, wire } from "./spec-page.js?v=20260830-56f57f4";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-56f57f4";
...
const geo = () => import(`../geoprocessing.js?v=20260830-56f57f4`);
