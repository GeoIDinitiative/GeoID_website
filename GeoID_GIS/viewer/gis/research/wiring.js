import { wirePattern, wire } from "./spec-page.js?v=20260816-e4d702c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-e4d702c";
...
const geo = () => import(`../geoprocessing.js?v=20260816-e4d702c`);
