import { wirePattern, wire } from "./spec-page.js?v=20260828-be98b1a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-be98b1a";
...
const geo = () => import(`../geoprocessing.js?v=20260828-be98b1a`);
