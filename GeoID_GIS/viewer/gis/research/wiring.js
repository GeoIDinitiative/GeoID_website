import { wirePattern, wire } from "./spec-page.js?v=20260909-1803f9a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-1803f9a";
...
const geo = () => import(`../geoprocessing.js?v=20260909-1803f9a`);
