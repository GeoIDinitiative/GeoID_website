import { wirePattern, wire } from "./spec-page.js?v=20260828-536703d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-536703d";
...
const geo = () => import(`../geoprocessing.js?v=20260828-536703d`);
