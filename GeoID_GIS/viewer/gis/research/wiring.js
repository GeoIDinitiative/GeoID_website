import { wirePattern, wire } from "./spec-page.js?v=20260831-1cd7af4";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-1cd7af4";
...
const geo = () => import(`../geoprocessing.js?v=20260831-1cd7af4`);
