import { wirePattern, wire } from "./spec-page.js?v=20260831-0644081";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-0644081";
...
const geo = () => import(`../geoprocessing.js?v=20260831-0644081`);
