import { wirePattern, wire } from "./spec-page.js?v=20260910-4a62fde";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-4a62fde";
...
const geo = () => import(`../geoprocessing.js?v=20260910-4a62fde`);
