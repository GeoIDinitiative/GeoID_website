import { wirePattern, wire } from "./spec-page.js?v=20260911-be0ec2a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-be0ec2a";
...
const geo = () => import(`../geoprocessing.js?v=20260911-be0ec2a`);
