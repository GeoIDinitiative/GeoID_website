import { wirePattern, wire } from "./spec-page.js?v=20260825-0151daf";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260825-0151daf";
...
const geo = () => import(`../geoprocessing.js?v=20260825-0151daf`);
