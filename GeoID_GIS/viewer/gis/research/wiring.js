import { wirePattern, wire } from "./spec-page.js?v=20260810-d23a7be";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260810-d23a7be";
...
const geo = () => import(`../geoprocessing.js?v=20260810-d23a7be`);
