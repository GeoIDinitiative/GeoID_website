import { wirePattern, wire } from "./spec-page.js?v=20260817-9325eb2";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260817-9325eb2";
...
const geo = () => import(`../geoprocessing.js?v=20260817-9325eb2`);
