import { wirePattern, wire } from "./spec-page.js?v=20260828-53769a0";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-53769a0";
...
const geo = () => import(`../geoprocessing.js?v=20260828-53769a0`);
