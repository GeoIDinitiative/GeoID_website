import { wirePattern, wire } from "./spec-page.js?v=20260916-8097ff7";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-8097ff7";
...
const geo = () => import(`../geoprocessing.js?v=20260916-8097ff7`);
