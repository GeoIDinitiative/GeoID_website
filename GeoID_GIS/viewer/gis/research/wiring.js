import { wirePattern, wire } from "./spec-page.js?v=20260907-7ffe8de";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260907-7ffe8de";
...
const geo = () => import(`../geoprocessing.js?v=20260907-7ffe8de`);
