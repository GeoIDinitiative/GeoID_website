import { wirePattern, wire } from "./spec-page.js?v=20260831-f0bd25c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-f0bd25c";
...
const geo = () => import(`../geoprocessing.js?v=20260831-f0bd25c`);
