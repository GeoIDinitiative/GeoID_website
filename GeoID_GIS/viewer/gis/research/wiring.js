import { wirePattern, wire } from "./spec-page.js?v=20260914-4746a56";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260914-4746a56";
...
const geo = () => import(`../geoprocessing.js?v=20260914-4746a56`);
