import { wirePattern, wire } from "./spec-page.js?v=20260910-5468fdc";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-5468fdc";
...
const geo = () => import(`../geoprocessing.js?v=20260910-5468fdc`);
