import { wirePattern, wire } from "./spec-page.js?v=20260909-24d6edb";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-24d6edb";
...
const geo = () => import(`../geoprocessing.js?v=20260909-24d6edb`);
