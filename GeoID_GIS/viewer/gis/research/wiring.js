import { wirePattern, wire } from "./spec-page.js?v=20260909-d9f9bee";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-d9f9bee";
...
const geo = () => import(`../geoprocessing.js?v=20260909-d9f9bee`);
