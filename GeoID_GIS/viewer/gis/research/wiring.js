import { wirePattern, wire } from "./spec-page.js?v=20260915-7a4d9b0";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-7a4d9b0";
...
const geo = () => import(`../geoprocessing.js?v=20260915-7a4d9b0`);
