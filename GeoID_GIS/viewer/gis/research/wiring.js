import { wirePattern, wire } from "./spec-page.js?v=20260902-9fcef8f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260902-9fcef8f";
...
const geo = () => import(`../geoprocessing.js?v=20260902-9fcef8f`);
