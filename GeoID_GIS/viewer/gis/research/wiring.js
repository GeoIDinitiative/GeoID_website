import { wirePattern, wire } from "./spec-page.js?v=20260827-70a3cbc";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-70a3cbc";
...
const geo = () => import(`../geoprocessing.js?v=20260827-70a3cbc`);
