import { wirePattern, wire } from "./spec-page.js?v=20260831-b0a7fcc";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-b0a7fcc";
...
const geo = () => import(`../geoprocessing.js?v=20260831-b0a7fcc`);
