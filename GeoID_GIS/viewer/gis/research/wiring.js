import { wirePattern, wire } from "./spec-page.js?v=20260910-a4cc46f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-a4cc46f";
...
const geo = () => import(`../geoprocessing.js?v=20260910-a4cc46f`);
