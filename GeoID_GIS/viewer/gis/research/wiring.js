import { wirePattern, wire } from "./spec-page.js?v=20260901-0ef7ed6";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260901-0ef7ed6";
...
const geo = () => import(`../geoprocessing.js?v=20260901-0ef7ed6`);
