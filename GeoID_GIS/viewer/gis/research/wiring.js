import { wirePattern, wire } from "./spec-page.js?v=20260831-a4eab47";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-a4eab47";
...
const geo = () => import(`../geoprocessing.js?v=20260831-a4eab47`);
