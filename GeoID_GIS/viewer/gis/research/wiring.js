import { wirePattern, wire } from "./spec-page.js?v=20260908-7888a79";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-7888a79";
...
const geo = () => import(`../geoprocessing.js?v=20260908-7888a79`);
