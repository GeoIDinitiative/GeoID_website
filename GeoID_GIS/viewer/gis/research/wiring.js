import { wirePattern, wire } from "./spec-page.js?v=20260827-00849cb";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-00849cb";
...
const geo = () => import(`../geoprocessing.js?v=20260827-00849cb`);
