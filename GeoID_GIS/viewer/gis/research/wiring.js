import { wirePattern, wire } from "./spec-page.js?v=20260916-64b58db";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-64b58db";
...
const geo = () => import(`../geoprocessing.js?v=20260916-64b58db`);
