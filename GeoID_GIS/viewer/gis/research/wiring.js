import { wirePattern, wire } from "./spec-page.js?v=20260904-b0b1f62";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260904-b0b1f62";
...
const geo = () => import(`../geoprocessing.js?v=20260904-b0b1f62`);
