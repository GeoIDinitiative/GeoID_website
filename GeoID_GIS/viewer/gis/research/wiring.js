import { wirePattern, wire } from "./spec-page.js?v=20260920-1e7b58d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260920-1e7b58d";
...
const geo = () => import(`../geoprocessing.js?v=20260920-1e7b58d`);
