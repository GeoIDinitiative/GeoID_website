import { wirePattern, wire } from "./spec-page.js?v=20260915-fd4006f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-fd4006f";
...
const geo = () => import(`../geoprocessing.js?v=20260915-fd4006f`);
