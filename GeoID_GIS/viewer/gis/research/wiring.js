import { wirePattern, wire } from "./spec-page.js?v=20260910-42da88f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-42da88f";
...
const geo = () => import(`../geoprocessing.js?v=20260910-42da88f`);
