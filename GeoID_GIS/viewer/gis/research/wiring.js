import { wirePattern, wire } from "./spec-page.js?v=20260903-d94308a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260903-d94308a";
...
const geo = () => import(`../geoprocessing.js?v=20260903-d94308a`);
