import { wirePattern, wire } from "./spec-page.js?v=20260826-2e5d2d6";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-2e5d2d6";
...
const geo = () => import(`../geoprocessing.js?v=20260826-2e5d2d6`);
