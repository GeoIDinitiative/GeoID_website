import { wirePattern, wire } from "./spec-page.js?v=20260830-6eb7bd1";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-6eb7bd1";
...
const geo = () => import(`../geoprocessing.js?v=20260830-6eb7bd1`);
