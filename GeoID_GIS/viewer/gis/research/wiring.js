import { wirePattern, wire } from "./spec-page.js?v=20260830-dc5ff7e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-dc5ff7e";
...
const geo = () => import(`../geoprocessing.js?v=20260830-dc5ff7e`);
