import { wirePattern, wire } from "./spec-page.js?v=20260808-b3a4d05";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260808-b3a4d05";
...
const geo = () => import(`../geoprocessing.js?v=20260808-b3a4d05`);
