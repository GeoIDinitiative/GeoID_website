import { wirePattern, wire } from "./spec-page.js?v=20260911-f2003f4";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-f2003f4";
...
const geo = () => import(`../geoprocessing.js?v=20260911-f2003f4`);
