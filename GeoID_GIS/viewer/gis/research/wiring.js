import { wirePattern, wire } from "./spec-page.js?v=20260916-2222f27";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-2222f27";
...
const geo = () => import(`../geoprocessing.js?v=20260916-2222f27`);
