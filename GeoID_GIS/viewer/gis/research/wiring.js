import { wirePattern, wire } from "./spec-page.js?v=20260829-b7effe1";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-b7effe1";
...
const geo = () => import(`../geoprocessing.js?v=20260829-b7effe1`);
