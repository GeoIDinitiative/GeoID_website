import { wirePattern, wire } from "./spec-page.js?v=20260914-3635fdc";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260914-3635fdc";
...
const geo = () => import(`../geoprocessing.js?v=20260914-3635fdc`);
