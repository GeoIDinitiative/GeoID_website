import { wirePattern, wire } from "./spec-page.js?v=20260823-89801a4";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260823-89801a4";
...
const geo = () => import(`../geoprocessing.js?v=20260823-89801a4`);
