import { wirePattern, wire } from "./spec-page.js?v=20260830-290eb7b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-290eb7b";
...
const geo = () => import(`../geoprocessing.js?v=20260830-290eb7b`);
