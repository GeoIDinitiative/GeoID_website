import { wirePattern, wire } from "./spec-page.js?v=20260903-2983b5d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260903-2983b5d";
...
const geo = () => import(`../geoprocessing.js?v=20260903-2983b5d`);
