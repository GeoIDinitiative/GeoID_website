import { wirePattern, wire } from "./spec-page.js?v=20260826-3fbbbdd";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-3fbbbdd";
...
const geo = () => import(`../geoprocessing.js?v=20260826-3fbbbdd`);
