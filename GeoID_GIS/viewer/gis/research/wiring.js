import { wirePattern, wire } from "./spec-page.js?v=20260910-4db3e43";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-4db3e43";
...
const geo = () => import(`../geoprocessing.js?v=20260910-4db3e43`);
