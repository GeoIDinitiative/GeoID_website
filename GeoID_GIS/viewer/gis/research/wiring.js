import { wirePattern, wire } from "./spec-page.js?v=20260828-60a8a89";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-60a8a89";
...
const geo = () => import(`../geoprocessing.js?v=20260828-60a8a89`);
