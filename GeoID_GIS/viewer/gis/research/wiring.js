import { wirePattern, wire } from "./spec-page.js?v=20260825-db3d262";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260825-db3d262";
...
const geo = () => import(`../geoprocessing.js?v=20260825-db3d262`);
