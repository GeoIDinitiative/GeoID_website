import { wirePattern, wire } from "./spec-page.js?v=20260902-9722bf1";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260902-9722bf1";
...
const geo = () => import(`../geoprocessing.js?v=20260902-9722bf1`);
