import { wirePattern, wire } from "./spec-page.js?v=20260827-5caec2a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-5caec2a";
...
const geo = () => import(`../geoprocessing.js?v=20260827-5caec2a`);
