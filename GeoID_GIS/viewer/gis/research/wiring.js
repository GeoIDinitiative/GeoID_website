import { wirePattern, wire } from "./spec-page.js?v=20260815-cb9ed4b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260815-cb9ed4b";
...
const geo = () => import(`../geoprocessing.js?v=20260815-cb9ed4b`);
