import { wirePattern, wire } from "./spec-page.js?v=20260914-2619c4b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260914-2619c4b";
...
const geo = () => import(`../geoprocessing.js?v=20260914-2619c4b`);
