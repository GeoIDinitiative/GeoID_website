import { wirePattern, wire } from "./spec-page.js?v=20260911-dcef8e6";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-dcef8e6";
...
const geo = () => import(`../geoprocessing.js?v=20260911-dcef8e6`);
