import { wirePattern, wire } from "./spec-page.js?v=20260910-fe863bf";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-fe863bf";
...
const geo = () => import(`../geoprocessing.js?v=20260910-fe863bf`);
