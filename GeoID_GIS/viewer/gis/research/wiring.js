import { wirePattern, wire } from "./spec-page.js?v=20260816-821f7db";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-821f7db";
...
const geo = () => import(`../geoprocessing.js?v=20260816-821f7db`);
