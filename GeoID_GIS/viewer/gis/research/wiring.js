import { wirePattern, wire } from "./spec-page.js?v=20260827-0281be8";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-0281be8";
...
const geo = () => import(`../geoprocessing.js?v=20260827-0281be8`);
