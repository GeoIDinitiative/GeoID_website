import { wirePattern, wire } from "./spec-page.js?v=20260910-035787d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-035787d";
...
const geo = () => import(`../geoprocessing.js?v=20260910-035787d`);
