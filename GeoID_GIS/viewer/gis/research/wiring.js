import { wirePattern, wire } from "./spec-page.js?v=20260910-6b1d4e5";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-6b1d4e5";
...
const geo = () => import(`../geoprocessing.js?v=20260910-6b1d4e5`);
