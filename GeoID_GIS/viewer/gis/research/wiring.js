import { wirePattern, wire } from "./spec-page.js?v=20260920-52de73f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260920-52de73f";
...
const geo = () => import(`../geoprocessing.js?v=20260920-52de73f`);
