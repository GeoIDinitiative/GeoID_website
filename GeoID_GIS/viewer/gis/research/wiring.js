import { wirePattern, wire } from "./spec-page.js?v=20260826-cd9ecce";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-cd9ecce";
...
const geo = () => import(`../geoprocessing.js?v=20260826-cd9ecce`);
