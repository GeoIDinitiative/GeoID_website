import { wirePattern, wire } from "./spec-page.js?v=20260828-2fe26ec";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-2fe26ec";
...
const geo = () => import(`../geoprocessing.js?v=20260828-2fe26ec`);
