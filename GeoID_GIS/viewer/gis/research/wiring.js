import { wirePattern, wire } from "./spec-page.js?v=20260828-3353e2b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-3353e2b";
...
const geo = () => import(`../geoprocessing.js?v=20260828-3353e2b`);
