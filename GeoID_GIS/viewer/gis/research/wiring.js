import { wirePattern, wire } from "./spec-page.js?v=20260830-f26914f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-f26914f";
...
const geo = () => import(`../geoprocessing.js?v=20260830-f26914f`);
