import { wirePattern, wire } from "./spec-page.js?v=20260831-07f3e3f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-07f3e3f";
...
const geo = () => import(`../geoprocessing.js?v=20260831-07f3e3f`);
