import { wirePattern, wire } from "./spec-page.js?v=20260910-e87104a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-e87104a";
...
const geo = () => import(`../geoprocessing.js?v=20260910-e87104a`);
