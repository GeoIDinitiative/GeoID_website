import { wirePattern, wire } from "./spec-page.js?v=20260919-2de9a83";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260919-2de9a83";
...
const geo = () => import(`../geoprocessing.js?v=20260919-2de9a83`);
