import { wirePattern, wire } from "./spec-page.js?v=20260831-7b1b918";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-7b1b918";
...
const geo = () => import(`../geoprocessing.js?v=20260831-7b1b918`);
