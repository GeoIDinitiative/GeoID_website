import { wirePattern, wire } from "./spec-page.js?v=20260918-d5e8fd5";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260918-d5e8fd5";
...
const geo = () => import(`../geoprocessing.js?v=20260918-d5e8fd5`);
