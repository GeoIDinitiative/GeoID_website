import { wirePattern, wire } from "./spec-page.js?v=20260915-c94db22";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-c94db22";
...
const geo = () => import(`../geoprocessing.js?v=20260915-c94db22`);
