import { wirePattern, wire } from "./spec-page.js?v=20260831-9648dd6";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-9648dd6";
...
const geo = () => import(`../geoprocessing.js?v=20260831-9648dd6`);
