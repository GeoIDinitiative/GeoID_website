import { wirePattern, wire } from "./spec-page.js?v=20260910-b0dda17";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-b0dda17";
...
const geo = () => import(`../geoprocessing.js?v=20260910-b0dda17`);
