import { wirePattern, wire } from "./spec-page.js?v=20260904-8512f2d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260904-8512f2d";
...
const geo = () => import(`../geoprocessing.js?v=20260904-8512f2d`);
