import { wirePattern, wire } from "./spec-page.js?v=20260912-1833c1f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260912-1833c1f";
...
const geo = () => import(`../geoprocessing.js?v=20260912-1833c1f`);
