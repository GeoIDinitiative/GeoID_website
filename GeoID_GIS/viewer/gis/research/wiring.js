import { wirePattern, wire } from "./spec-page.js?v=20260827-3508b68";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-3508b68";
...
const geo = () => import(`../geoprocessing.js?v=20260827-3508b68`);
