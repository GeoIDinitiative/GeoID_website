import { wirePattern, wire } from "./spec-page.js?v=20260829-5cd6a46";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-5cd6a46";
...
const geo = () => import(`../geoprocessing.js?v=20260829-5cd6a46`);
