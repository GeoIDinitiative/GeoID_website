import { wirePattern, wire } from "./spec-page.js?v=20260903-e9a2f94";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260903-e9a2f94";
...
const geo = () => import(`../geoprocessing.js?v=20260903-e9a2f94`);
