import { wirePattern, wire } from "./spec-page.js?v=20260831-bd8ef1f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-bd8ef1f";
...
const geo = () => import(`../geoprocessing.js?v=20260831-bd8ef1f`);
