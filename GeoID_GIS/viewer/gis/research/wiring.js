import { wirePattern, wire } from "./spec-page.js?v=20260816-8013f52";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-8013f52";
...
const geo = () => import(`../geoprocessing.js?v=20260816-8013f52`);
