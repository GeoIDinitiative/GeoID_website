import { wirePattern, wire } from "./spec-page.js?v=20260911-cb5be29";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-cb5be29";
...
const geo = () => import(`../geoprocessing.js?v=20260911-cb5be29`);
