import { wirePattern, wire } from "./spec-page.js?v=20260903-7b5a1e0";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260903-7b5a1e0";
...
const geo = () => import(`../geoprocessing.js?v=20260903-7b5a1e0`);
