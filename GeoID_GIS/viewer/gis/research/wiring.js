import { wirePattern, wire } from "./spec-page.js?v=20260827-b2fc8ce";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-b2fc8ce";
...
const geo = () => import(`../geoprocessing.js?v=20260827-b2fc8ce`);
