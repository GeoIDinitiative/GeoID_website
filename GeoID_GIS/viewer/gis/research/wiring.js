import { wirePattern, wire } from "./spec-page.js?v=20260915-0e63adf";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-0e63adf";
...
const geo = () => import(`../geoprocessing.js?v=20260915-0e63adf`);
