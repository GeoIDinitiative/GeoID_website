import { wirePattern, wire } from "./spec-page.js?v=20260911-5874fb2";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-5874fb2";
...
const geo = () => import(`../geoprocessing.js?v=20260911-5874fb2`);
