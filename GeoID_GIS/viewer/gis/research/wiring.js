import { wirePattern, wire } from "./spec-page.js?v=20260826-3736cd9";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-3736cd9";
...
const geo = () => import(`../geoprocessing.js?v=20260826-3736cd9`);
