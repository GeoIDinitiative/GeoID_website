import { wirePattern, wire } from "./spec-page.js?v=20260830-b9baa90";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-b9baa90";
...
const geo = () => import(`../geoprocessing.js?v=20260830-b9baa90`);
