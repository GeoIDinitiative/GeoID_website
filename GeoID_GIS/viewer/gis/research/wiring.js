import { wirePattern, wire } from "./spec-page.js?v=20260909-dfeba5f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-dfeba5f";
...
const geo = () => import(`../geoprocessing.js?v=20260909-dfeba5f`);
