import { wirePattern, wire } from "./spec-page.js?v=20260808-3a7b462";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260808-3a7b462";
...
const geo = () => import(`../geoprocessing.js?v=20260808-3a7b462`);
