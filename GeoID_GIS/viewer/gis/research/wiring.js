import { wirePattern, wire } from "./spec-page.js?v=20260911-acdf2a0";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-acdf2a0";
...
const geo = () => import(`../geoprocessing.js?v=20260911-acdf2a0`);
