import { wirePattern, wire } from "./spec-page.js?v=20260907-90f80a3";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260907-90f80a3";
...
const geo = () => import(`../geoprocessing.js?v=20260907-90f80a3`);
