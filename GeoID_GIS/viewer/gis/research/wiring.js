import { wirePattern, wire } from "./spec-page.js?v=20260912-136b2bf";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260912-136b2bf";
...
const geo = () => import(`../geoprocessing.js?v=20260912-136b2bf`);
