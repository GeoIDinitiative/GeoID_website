import { wirePattern, wire } from "./spec-page.js?v=20260816-df073fe";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-df073fe";
...
const geo = () => import(`../geoprocessing.js?v=20260816-df073fe`);
