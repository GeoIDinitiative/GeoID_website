import { wirePattern, wire } from "./spec-page.js?v=20260909-f8794b8";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-f8794b8";
...
const geo = () => import(`../geoprocessing.js?v=20260909-f8794b8`);
