import { wirePattern, wire } from "./spec-page.js?v=20260830-eaf4a61";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-eaf4a61";
...
const geo = () => import(`../geoprocessing.js?v=20260830-eaf4a61`);
