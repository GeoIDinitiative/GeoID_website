import { wirePattern, wire } from "./spec-page.js?v=20260826-737a9a2";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-737a9a2";
...
const geo = () => import(`../geoprocessing.js?v=20260826-737a9a2`);
