import { wirePattern, wire } from "./spec-page.js?v=20260816-628796d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-628796d";
...
const geo = () => import(`../geoprocessing.js?v=20260816-628796d`);
