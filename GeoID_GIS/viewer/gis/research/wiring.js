import { wirePattern, wire } from "./spec-page.js?v=20260810-9fd1bbd";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260810-9fd1bbd";
...
const geo = () => import(`../geoprocessing.js?v=20260810-9fd1bbd`);
