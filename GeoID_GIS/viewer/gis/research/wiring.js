import { wirePattern, wire } from "./spec-page.js?v=20260828-ca4e80a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-ca4e80a";
...
const geo = () => import(`../geoprocessing.js?v=20260828-ca4e80a`);
