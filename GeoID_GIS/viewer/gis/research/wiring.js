import { wirePattern, wire } from "./spec-page.js?v=20260808-605b7bd";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260808-605b7bd";
...
const geo = () => import(`../geoprocessing.js?v=20260808-605b7bd`);
