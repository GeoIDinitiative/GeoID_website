import { wirePattern, wire } from "./spec-page.js?v=20260910-571bffd";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-571bffd";
...
const geo = () => import(`../geoprocessing.js?v=20260910-571bffd`);
