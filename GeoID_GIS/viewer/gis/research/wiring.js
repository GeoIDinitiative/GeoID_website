import { wirePattern, wire } from "./spec-page.js?v=20260909-8b0dcac";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-8b0dcac";
...
const geo = () => import(`../geoprocessing.js?v=20260909-8b0dcac`);
