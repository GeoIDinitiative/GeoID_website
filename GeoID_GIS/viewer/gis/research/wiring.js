import { wirePattern, wire } from "./spec-page.js?v=20260915-2a75eee";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-2a75eee";
...
const geo = () => import(`../geoprocessing.js?v=20260915-2a75eee`);
