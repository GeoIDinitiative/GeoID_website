import { wirePattern, wire } from "./spec-page.js?v=20260827-9217f59";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-9217f59";
...
const geo = () => import(`../geoprocessing.js?v=20260827-9217f59`);
