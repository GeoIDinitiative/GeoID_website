import { wirePattern, wire } from "./spec-page.js?v=20260822-0525c9b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260822-0525c9b";
...
const geo = () => import(`../geoprocessing.js?v=20260822-0525c9b`);
