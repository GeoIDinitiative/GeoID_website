import { wirePattern, wire } from "./spec-page.js?v=20260817-4861be4";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260817-4861be4";
...
const geo = () => import(`../geoprocessing.js?v=20260817-4861be4`);
