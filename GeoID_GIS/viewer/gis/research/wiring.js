import { wirePattern, wire } from "./spec-page.js?v=20260910-db65dfd";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-db65dfd";
...
const geo = () => import(`../geoprocessing.js?v=20260910-db65dfd`);
