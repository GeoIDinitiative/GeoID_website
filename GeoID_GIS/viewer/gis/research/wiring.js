import { wirePattern, wire } from "./spec-page.js?v=20260810-1e77f0e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260810-1e77f0e";
...
const geo = () => import(`../geoprocessing.js?v=20260810-1e77f0e`);
