import { wirePattern, wire } from "./spec-page.js?v=20260908-294767f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-294767f";
...
const geo = () => import(`../geoprocessing.js?v=20260908-294767f`);
