import { wirePattern, wire } from "./spec-page.js?v=20260816-f3d9a1a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-f3d9a1a";
...
const geo = () => import(`../geoprocessing.js?v=20260816-f3d9a1a`);
