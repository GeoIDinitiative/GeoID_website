import { wirePattern, wire } from "./spec-page.js?v=20260828-7a36b7a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-7a36b7a";
...
const geo = () => import(`../geoprocessing.js?v=20260828-7a36b7a`);
