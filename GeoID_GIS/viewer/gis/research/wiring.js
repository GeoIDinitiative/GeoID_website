import { wirePattern, wire } from "./spec-page.js?v=20260910-e8fa215";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-e8fa215";
...
const geo = () => import(`../geoprocessing.js?v=20260910-e8fa215`);
