import { wirePattern, wire } from "./spec-page.js?v=20260818-5954f94";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260818-5954f94";
...
const geo = () => import(`../geoprocessing.js?v=20260818-5954f94`);
