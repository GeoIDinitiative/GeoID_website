import { wirePattern, wire } from "./spec-page.js?v=20260908-f95521b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-f95521b";
...
const geo = () => import(`../geoprocessing.js?v=20260908-f95521b`);
