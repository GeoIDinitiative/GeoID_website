import { wirePattern, wire } from "./spec-page.js?v=20260916-85effe3";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-85effe3";
...
const geo = () => import(`../geoprocessing.js?v=20260916-85effe3`);
