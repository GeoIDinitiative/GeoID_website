import { wirePattern, wire } from "./spec-page.js?v=20260830-f9219a8";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-f9219a8";
...
const geo = () => import(`../geoprocessing.js?v=20260830-f9219a8`);
