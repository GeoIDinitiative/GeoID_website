import { wirePattern, wire } from "./spec-page.js?v=20260908-d4eab7a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-d4eab7a";
...
const geo = () => import(`../geoprocessing.js?v=20260908-d4eab7a`);
