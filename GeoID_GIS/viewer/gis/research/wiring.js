import { wirePattern, wire } from "./spec-page.js?v=20260826-ba1937f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-ba1937f";
...
const geo = () => import(`../geoprocessing.js?v=20260826-ba1937f`);
