import { wirePattern, wire } from "./spec-page.js?v=20260826-148456a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-148456a";
...
const geo = () => import(`../geoprocessing.js?v=20260826-148456a`);
