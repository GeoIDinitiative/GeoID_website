import { wirePattern, wire } from "./spec-page.js?v=20260817-f57d1df";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260817-f57d1df";
...
const geo = () => import(`../geoprocessing.js?v=20260817-f57d1df`);
