import { wirePattern, wire } from "./spec-page.js?v=20260811-657ef02";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260811-657ef02";
...
const geo = () => import(`../geoprocessing.js?v=20260811-657ef02`);
