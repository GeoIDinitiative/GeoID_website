import { wirePattern, wire } from "./spec-page.js?v=20260816-9ed4fe1";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-9ed4fe1";
...
const geo = () => import(`../geoprocessing.js?v=20260816-9ed4fe1`);
