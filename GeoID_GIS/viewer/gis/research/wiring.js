import { wirePattern, wire } from "./spec-page.js?v=20260915-1049a63";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-1049a63";
...
const geo = () => import(`../geoprocessing.js?v=20260915-1049a63`);
