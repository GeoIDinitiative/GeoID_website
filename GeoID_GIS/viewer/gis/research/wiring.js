import { wirePattern, wire } from "./spec-page.js?v=20260818-f75e7e3";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260818-f75e7e3";
...
const geo = () => import(`../geoprocessing.js?v=20260818-f75e7e3`);
