import { wirePattern, wire } from "./spec-page.js?v=20260916-1141f5f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-1141f5f";
...
const geo = () => import(`../geoprocessing.js?v=20260916-1141f5f`);
