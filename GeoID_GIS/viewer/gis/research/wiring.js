import { wirePattern, wire } from "./spec-page.js?v=20260901-21db11b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260901-21db11b";
...
const geo = () => import(`../geoprocessing.js?v=20260901-21db11b`);
