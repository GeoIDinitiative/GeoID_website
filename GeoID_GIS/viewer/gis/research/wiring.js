import { wirePattern, wire } from "./spec-page.js?v=20260826-3316f0e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-3316f0e";
...
const geo = () => import(`../geoprocessing.js?v=20260826-3316f0e`);
