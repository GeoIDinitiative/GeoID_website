import { wirePattern, wire } from "./spec-page.js?v=20260909-40d5ccd";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-40d5ccd";
...
const geo = () => import(`../geoprocessing.js?v=20260909-40d5ccd`);
