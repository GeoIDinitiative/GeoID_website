import { wirePattern, wire } from "./spec-page.js?v=20260826-820cd84";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-820cd84";
...
const geo = () => import(`../geoprocessing.js?v=20260826-820cd84`);
