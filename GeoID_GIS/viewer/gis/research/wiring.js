import { wirePattern, wire } from "./spec-page.js?v=20260830-53d5a1c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-53d5a1c";
...
const geo = () => import(`../geoprocessing.js?v=20260830-53d5a1c`);
