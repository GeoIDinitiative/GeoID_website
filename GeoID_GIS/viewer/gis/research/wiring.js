import { wirePattern, wire } from "./spec-page.js?v=20260908-7645fb7";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-7645fb7";
...
const geo = () => import(`../geoprocessing.js?v=20260908-7645fb7`);
