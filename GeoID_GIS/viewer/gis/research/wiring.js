import { wirePattern, wire } from "./spec-page.js?v=20260904-e8726a8";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260904-e8726a8";
...
const geo = () => import(`../geoprocessing.js?v=20260904-e8726a8`);
