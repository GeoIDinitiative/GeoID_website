import { wirePattern, wire } from "./spec-page.js?v=20260909-f81a4d0";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-f81a4d0";
...
const geo = () => import(`../geoprocessing.js?v=20260909-f81a4d0`);
