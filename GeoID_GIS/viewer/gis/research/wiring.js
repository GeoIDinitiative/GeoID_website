import { wirePattern, wire } from "./spec-page.js?v=20260905-65852a6";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260905-65852a6";
...
const geo = () => import(`../geoprocessing.js?v=20260905-65852a6`);
