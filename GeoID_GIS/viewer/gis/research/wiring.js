import { wirePattern, wire } from "./spec-page.js?v=20260910-a9dc998";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-a9dc998";
...
const geo = () => import(`../geoprocessing.js?v=20260910-a9dc998`);
