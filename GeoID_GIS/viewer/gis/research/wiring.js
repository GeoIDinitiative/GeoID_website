import { wirePattern, wire } from "./spec-page.js?v=20260828-e99a04f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-e99a04f";
...
const geo = () => import(`../geoprocessing.js?v=20260828-e99a04f`);
