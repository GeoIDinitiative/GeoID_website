import { wirePattern, wire } from "./spec-page.js?v=20260828-68f7b77";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-68f7b77";
...
const geo = () => import(`../geoprocessing.js?v=20260828-68f7b77`);
