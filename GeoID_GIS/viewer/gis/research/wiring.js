import { wirePattern, wire } from "./spec-page.js?v=20260815-0887cf5";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260815-0887cf5";
...
const geo = () => import(`../geoprocessing.js?v=20260815-0887cf5`);
