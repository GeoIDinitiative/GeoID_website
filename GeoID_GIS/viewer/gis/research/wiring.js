import { wirePattern, wire } from "./spec-page.js?v=20260829-f75bf4e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-f75bf4e";
...
const geo = () => import(`../geoprocessing.js?v=20260829-f75bf4e`);
