import { wirePattern, wire } from "./spec-page.js?v=20260829-9a71f0d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-9a71f0d";
...
const geo = () => import(`../geoprocessing.js?v=20260829-9a71f0d`);
