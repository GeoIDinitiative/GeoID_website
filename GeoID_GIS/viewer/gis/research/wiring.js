import { wirePattern, wire } from "./spec-page.js?v=20260911-cd1cf4d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-cd1cf4d";
...
const geo = () => import(`../geoprocessing.js?v=20260911-cd1cf4d`);
