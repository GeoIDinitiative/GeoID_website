import { wirePattern, wire } from "./spec-page.js?v=20260912-4294aa5";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260912-4294aa5";
...
const geo = () => import(`../geoprocessing.js?v=20260912-4294aa5`);
