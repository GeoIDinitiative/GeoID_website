import { wirePattern, wire } from "./spec-page.js?v=20260826-b7d1a76";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-b7d1a76";
...
const geo = () => import(`../geoprocessing.js?v=20260826-b7d1a76`);
