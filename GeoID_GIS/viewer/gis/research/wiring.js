import { wirePattern, wire } from "./spec-page.js?v=20260916-325719f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-325719f";
...
const geo = () => import(`../geoprocessing.js?v=20260916-325719f`);
