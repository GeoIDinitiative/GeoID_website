import { wirePattern, wire } from "./spec-page.js?v=20260828-d7a673c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-d7a673c";
...
const geo = () => import(`../geoprocessing.js?v=20260828-d7a673c`);
