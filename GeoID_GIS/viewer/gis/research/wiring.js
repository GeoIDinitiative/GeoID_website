import { wirePattern, wire } from "./spec-page.js?v=20260902-f8f71a8";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260902-f8f71a8";
...
const geo = () => import(`../geoprocessing.js?v=20260902-f8f71a8`);
