import { wirePattern, wire } from "./spec-page.js?v=20260903-4f44fbb";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260903-4f44fbb";
...
const geo = () => import(`../geoprocessing.js?v=20260903-4f44fbb`);
