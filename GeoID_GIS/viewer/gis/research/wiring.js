import { wirePattern, wire } from "./spec-page.js?v=20260909-698a873";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-698a873";
...
const geo = () => import(`../geoprocessing.js?v=20260909-698a873`);
