import { wirePattern, wire } from "./spec-page.js?v=20260911-2446ced";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-2446ced";
...
const geo = () => import(`../geoprocessing.js?v=20260911-2446ced`);
