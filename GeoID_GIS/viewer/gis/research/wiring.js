import { wirePattern, wire } from "./spec-page.js?v=20260829-b2e01b3";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-b2e01b3";
...
const geo = () => import(`../geoprocessing.js?v=20260829-b2e01b3`);
