import { wirePattern, wire } from "./spec-page.js?v=20260925-40bf2a5";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260925-40bf2a5";
...
const geo = () => import(`../geoprocessing.js?v=20260925-40bf2a5`);
