import { wirePattern, wire } from "./spec-page.js?v=20260825-17061aa";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260825-17061aa";
...
const geo = () => import(`../geoprocessing.js?v=20260825-17061aa`);
