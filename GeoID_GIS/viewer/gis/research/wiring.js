import { wirePattern, wire } from "./spec-page.js?v=20260828-0044c07";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-0044c07";
...
const geo = () => import(`../geoprocessing.js?v=20260828-0044c07`);
