import { wirePattern, wire } from "./spec-page.js?v=20260911-e8b0ea4";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-e8b0ea4";
...
const geo = () => import(`../geoprocessing.js?v=20260911-e8b0ea4`);
