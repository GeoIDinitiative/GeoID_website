import { wirePattern, wire } from "./spec-page.js?v=20260919-efed63d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260919-efed63d";
...
const geo = () => import(`../geoprocessing.js?v=20260919-efed63d`);
