import { wirePattern, wire } from "./spec-page.js?v=20260825-4769a6e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260825-4769a6e";
...
const geo = () => import(`../geoprocessing.js?v=20260825-4769a6e`);
