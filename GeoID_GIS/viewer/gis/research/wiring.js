import { wirePattern, wire } from "./spec-page.js?v=20260818-f5feae1";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260818-f5feae1";
...
const geo = () => import(`../geoprocessing.js?v=20260818-f5feae1`);
