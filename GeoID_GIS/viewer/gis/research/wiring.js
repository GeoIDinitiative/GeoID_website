import { wirePattern, wire } from "./spec-page.js?v=20260902-88b3b3f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260902-88b3b3f";
...
const geo = () => import(`../geoprocessing.js?v=20260902-88b3b3f`);
