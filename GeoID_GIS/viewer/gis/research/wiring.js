import { wirePattern, wire } from "./spec-page.js?v=20260821-8ece60f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260821-8ece60f";
...
const geo = () => import(`../geoprocessing.js?v=20260821-8ece60f`);
