import { wirePattern, wire } from "./spec-page.js?v=20260827-a82856f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-a82856f";
...
const geo = () => import(`../geoprocessing.js?v=20260827-a82856f`);
