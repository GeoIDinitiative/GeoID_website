import { wirePattern, wire } from "./spec-page.js?v=20260909-7dcb274";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-7dcb274";
...
const geo = () => import(`../geoprocessing.js?v=20260909-7dcb274`);
