import { wirePattern, wire } from "./spec-page.js?v=20260830-a1b9b72";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-a1b9b72";
...
const geo = () => import(`../geoprocessing.js?v=20260830-a1b9b72`);
