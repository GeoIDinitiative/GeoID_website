import { wirePattern, wire } from "./spec-page.js?v=20260830-2105aca";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-2105aca";
...
const geo = () => import(`../geoprocessing.js?v=20260830-2105aca`);
