import { wirePattern, wire } from "./spec-page.js?v=20260909-2d7fdce";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-2d7fdce";
...
const geo = () => import(`../geoprocessing.js?v=20260909-2d7fdce`);
