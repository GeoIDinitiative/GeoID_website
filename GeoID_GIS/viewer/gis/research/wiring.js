import { wirePattern, wire } from "./spec-page.js?v=20260808-abdc9bf";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260808-abdc9bf";
...
const geo = () => import(`../geoprocessing.js?v=20260808-abdc9bf`);
