import { wirePattern, wire } from "./spec-page.js?v=20260828-2492c45";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-2492c45";
...
const geo = () => import(`../geoprocessing.js?v=20260828-2492c45`);
