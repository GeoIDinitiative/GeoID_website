import { wirePattern, wire } from "./spec-page.js?v=20260821-4cbbabb";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260821-4cbbabb";
...
const geo = () => import(`../geoprocessing.js?v=20260821-4cbbabb`);
