import { wirePattern, wire } from "./spec-page.js?v=20260827-63cd180";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-63cd180";
...
const geo = () => import(`../geoprocessing.js?v=20260827-63cd180`);
