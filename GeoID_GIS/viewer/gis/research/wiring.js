import { wirePattern, wire } from "./spec-page.js?v=20260818-f7ce008";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260818-f7ce008";
...
const geo = () => import(`../geoprocessing.js?v=20260818-f7ce008`);
