import { wirePattern, wire } from "./spec-page.js?v=20260904-0e4b9ad";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260904-0e4b9ad";
...
const geo = () => import(`../geoprocessing.js?v=20260904-0e4b9ad`);
