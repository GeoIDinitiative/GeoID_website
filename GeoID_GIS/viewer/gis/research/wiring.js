import { wirePattern, wire } from "./spec-page.js?v=20260808-e64db71";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260808-e64db71";
...
const geo = () => import(`../geoprocessing.js?v=20260808-e64db71`);
