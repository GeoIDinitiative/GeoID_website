import { wirePattern, wire } from "./spec-page.js?v=20260915-f3f8fff";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-f3f8fff";
...
const geo = () => import(`../geoprocessing.js?v=20260915-f3f8fff`);
