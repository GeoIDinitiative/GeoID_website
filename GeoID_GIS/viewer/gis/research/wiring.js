import { wirePattern, wire } from "./spec-page.js?v=20260816-05ed4d3";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-05ed4d3";
...
const geo = () => import(`../geoprocessing.js?v=20260816-05ed4d3`);
