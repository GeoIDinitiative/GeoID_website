import { wirePattern, wire } from "./spec-page.js?v=20260817-e6905f9";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260817-e6905f9";
...
const geo = () => import(`../geoprocessing.js?v=20260817-e6905f9`);
