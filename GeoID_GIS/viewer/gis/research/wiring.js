import { wirePattern, wire } from "./spec-page.js?v=20260828-eacf7cb";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-eacf7cb";
...
const geo = () => import(`../geoprocessing.js?v=20260828-eacf7cb`);
