import { wirePattern, wire } from "./spec-page.js?v=20260909-59393bf";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-59393bf";
...
const geo = () => import(`../geoprocessing.js?v=20260909-59393bf`);
