import { wirePattern, wire } from "./spec-page.js?v=20260828-6993c3a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-6993c3a";
...
const geo = () => import(`../geoprocessing.js?v=20260828-6993c3a`);
