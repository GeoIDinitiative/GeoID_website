import { wirePattern, wire } from "./spec-page.js?v=20260827-a2e8ca3";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-a2e8ca3";
...
const geo = () => import(`../geoprocessing.js?v=20260827-a2e8ca3`);
