import { wirePattern, wire } from "./spec-page.js?v=20260915-5a781ca";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-5a781ca";
...
const geo = () => import(`../geoprocessing.js?v=20260915-5a781ca`);
