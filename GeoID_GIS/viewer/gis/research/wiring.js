import { wirePattern, wire } from "./spec-page.js?v=20260916-bf9edbc";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-bf9edbc";
...
const geo = () => import(`../geoprocessing.js?v=20260916-bf9edbc`);
