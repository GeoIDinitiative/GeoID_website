import { wirePattern, wire } from "./spec-page.js?v=20260828-e0ac21c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-e0ac21c";
...
const geo = () => import(`../geoprocessing.js?v=20260828-e0ac21c`);
