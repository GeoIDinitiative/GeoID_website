import { wirePattern, wire } from "./spec-page.js?v=20260827-5e51d5b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-5e51d5b";
...
const geo = () => import(`../geoprocessing.js?v=20260827-5e51d5b`);
