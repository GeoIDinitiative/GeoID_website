import { wirePattern, wire } from "./spec-page.js?v=20260903-661eb1e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260903-661eb1e";
...
const geo = () => import(`../geoprocessing.js?v=20260903-661eb1e`);
