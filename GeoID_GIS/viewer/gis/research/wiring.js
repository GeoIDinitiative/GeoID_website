import { wirePattern, wire } from "./spec-page.js?v=20260818-d7ebe33";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260818-d7ebe33";
...
const geo = () => import(`../geoprocessing.js?v=20260818-d7ebe33`);
