import { wirePattern, wire } from "./spec-page.js?v=20260829-8a9afe7";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-8a9afe7";
...
const geo = () => import(`../geoprocessing.js?v=20260829-8a9afe7`);
