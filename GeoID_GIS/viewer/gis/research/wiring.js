import { wirePattern, wire } from "./spec-page.js?v=20260910-da90f84";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-da90f84";
...
const geo = () => import(`../geoprocessing.js?v=20260910-da90f84`);
