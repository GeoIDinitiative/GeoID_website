import { wirePattern, wire } from "./spec-page.js?v=20260901-8fc1fe4";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260901-8fc1fe4";
...
const geo = () => import(`../geoprocessing.js?v=20260901-8fc1fe4`);
