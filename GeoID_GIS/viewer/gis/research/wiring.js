import { wirePattern, wire } from "./spec-page.js?v=20260817-bdac695";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260817-bdac695";
...
const geo = () => import(`../geoprocessing.js?v=20260817-bdac695`);
