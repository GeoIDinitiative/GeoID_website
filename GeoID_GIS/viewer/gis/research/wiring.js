import { wirePattern, wire } from "./spec-page.js?v=20260817-260d8b2";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260817-260d8b2";
...
const geo = () => import(`../geoprocessing.js?v=20260817-260d8b2`);
