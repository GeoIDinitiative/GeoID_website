import { wirePattern, wire } from "./spec-page.js?v=20260909-045648a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-045648a";
...
const geo = () => import(`../geoprocessing.js?v=20260909-045648a`);
