import { wirePattern, wire } from "./spec-page.js?v=20260905-256204f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260905-256204f";
...
const geo = () => import(`../geoprocessing.js?v=20260905-256204f`);
