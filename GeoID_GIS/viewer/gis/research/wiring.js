import { wirePattern, wire } from "./spec-page.js?v=20260916-4d5ed92";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-4d5ed92";
...
const geo = () => import(`../geoprocessing.js?v=20260916-4d5ed92`);
