import { wirePattern, wire } from "./spec-page.js?v=20260902-76018fd";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260902-76018fd";
...
const geo = () => import(`../geoprocessing.js?v=20260902-76018fd`);
