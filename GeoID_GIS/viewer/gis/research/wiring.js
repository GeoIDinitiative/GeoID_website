import { wirePattern, wire } from "./spec-page.js?v=20260903-4088cab";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260903-4088cab";
...
const geo = () => import(`../geoprocessing.js?v=20260903-4088cab`);
