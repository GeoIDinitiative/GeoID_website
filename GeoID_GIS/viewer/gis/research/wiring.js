import { wirePattern, wire } from "./spec-page.js?v=20260816-2d7a44f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-2d7a44f";
...
const geo = () => import(`../geoprocessing.js?v=20260816-2d7a44f`);
