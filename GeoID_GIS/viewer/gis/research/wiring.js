import { wirePattern, wire } from "./spec-page.js?v=20260828-4030a73";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-4030a73";
...
const geo = () => import(`../geoprocessing.js?v=20260828-4030a73`);
