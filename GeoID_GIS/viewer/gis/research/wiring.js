import { wirePattern, wire } from "./spec-page.js?v=20260918-dcbe0e5";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260918-dcbe0e5";
...
const geo = () => import(`../geoprocessing.js?v=20260918-dcbe0e5`);
