import { wirePattern, wire } from "./spec-page.js?v=20260828-3970c61";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-3970c61";
...
const geo = () => import(`../geoprocessing.js?v=20260828-3970c61`);
