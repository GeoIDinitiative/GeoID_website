import { wirePattern, wire } from "./spec-page.js?v=20260828-53716a9";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-53716a9";
...
const geo = () => import(`../geoprocessing.js?v=20260828-53716a9`);
