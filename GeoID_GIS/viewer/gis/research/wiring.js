import { wirePattern, wire } from "./spec-page.js?v=20260916-2dc072a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-2dc072a";
...
const geo = () => import(`../geoprocessing.js?v=20260916-2dc072a`);
