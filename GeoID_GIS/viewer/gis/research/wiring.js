import { wirePattern, wire } from "./spec-page.js?v=20260909-be054cf";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-be054cf";
...
const geo = () => import(`../geoprocessing.js?v=20260909-be054cf`);
