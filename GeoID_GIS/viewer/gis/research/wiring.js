import { wirePattern, wire } from "./spec-page.js?v=20260809-4630c69";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260809-4630c69";
...
const geo = () => import(`../geoprocessing.js?v=20260809-4630c69`);
