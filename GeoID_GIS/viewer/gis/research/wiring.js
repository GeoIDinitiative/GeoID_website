import { wirePattern, wire } from "./spec-page.js?v=20260828-7f6e4bf";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-7f6e4bf";
...
const geo = () => import(`../geoprocessing.js?v=20260828-7f6e4bf`);
