import { wirePattern, wire } from "./spec-page.js?v=20260808-eaa2d1d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260808-eaa2d1d";
...
const geo = () => import(`../geoprocessing.js?v=20260808-eaa2d1d`);
