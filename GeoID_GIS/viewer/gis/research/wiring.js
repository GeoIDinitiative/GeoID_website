import { wirePattern, wire } from "./spec-page.js?v=20260817-a184b6f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260817-a184b6f";
...
const geo = () => import(`../geoprocessing.js?v=20260817-a184b6f`);
