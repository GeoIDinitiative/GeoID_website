import { wirePattern, wire } from "./spec-page.js?v=20260903-3ab48b1";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260903-3ab48b1";
...
const geo = () => import(`../geoprocessing.js?v=20260903-3ab48b1`);
