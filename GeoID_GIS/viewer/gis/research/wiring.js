import { wirePattern, wire } from "./spec-page.js?v=20260826-65f07f9";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-65f07f9";
...
const geo = () => import(`../geoprocessing.js?v=20260826-65f07f9`);
