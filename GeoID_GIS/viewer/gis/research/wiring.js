import { wirePattern, wire } from "./spec-page.js?v=20260828-282632a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-282632a";
...
const geo = () => import(`../geoprocessing.js?v=20260828-282632a`);
