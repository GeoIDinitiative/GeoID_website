import { wirePattern, wire } from "./spec-page.js?v=20260903-7fe01f2";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260903-7fe01f2";
...
const geo = () => import(`../geoprocessing.js?v=20260903-7fe01f2`);
