import { wirePattern, wire } from "./spec-page.js?v=20260826-be4ddd2";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-be4ddd2";
...
const geo = () => import(`../geoprocessing.js?v=20260826-be4ddd2`);
