import { wirePattern, wire } from "./spec-page.js?v=20260828-f1d529c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-f1d529c";
...
const geo = () => import(`../geoprocessing.js?v=20260828-f1d529c`);
