import { wirePattern, wire } from "./spec-page.js?v=20260810-d6a1b07";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260810-d6a1b07";
...
const geo = () => import(`../geoprocessing.js?v=20260810-d6a1b07`);
