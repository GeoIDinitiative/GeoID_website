import { wirePattern, wire } from "./spec-page.js?v=20260828-db653b7";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-db653b7";
...
const geo = () => import(`../geoprocessing.js?v=20260828-db653b7`);
