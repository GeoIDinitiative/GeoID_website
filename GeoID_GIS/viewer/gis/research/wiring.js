import { wirePattern, wire } from "./spec-page.js?v=20260919-8289c1a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260919-8289c1a";
...
const geo = () => import(`../geoprocessing.js?v=20260919-8289c1a`);
