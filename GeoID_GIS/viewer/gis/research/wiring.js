import { wirePattern, wire } from "./spec-page.js?v=20260911-0776ffa";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-0776ffa";
...
const geo = () => import(`../geoprocessing.js?v=20260911-0776ffa`);
