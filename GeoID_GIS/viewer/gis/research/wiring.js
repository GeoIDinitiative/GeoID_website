import { wirePattern, wire } from "./spec-page.js?v=20260829-4d9de29";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-4d9de29";
...
const geo = () => import(`../geoprocessing.js?v=20260829-4d9de29`);
