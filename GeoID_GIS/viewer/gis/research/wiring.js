import { wirePattern, wire } from "./spec-page.js?v=20260911-3209dea";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-3209dea";
...
const geo = () => import(`../geoprocessing.js?v=20260911-3209dea`);
