import { wirePattern, wire } from "./spec-page.js?v=20260811-5a550d1";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260811-5a550d1";
...
const geo = () => import(`../geoprocessing.js?v=20260811-5a550d1`);
