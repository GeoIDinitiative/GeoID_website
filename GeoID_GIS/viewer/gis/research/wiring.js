import { wirePattern, wire } from "./spec-page.js?v=20260829-ffffb8a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-ffffb8a";
...
const geo = () => import(`../geoprocessing.js?v=20260829-ffffb8a`);
