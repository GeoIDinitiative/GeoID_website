import { wirePattern, wire } from "./spec-page.js?v=20260909-acfa6ee";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-acfa6ee";
...
const geo = () => import(`../geoprocessing.js?v=20260909-acfa6ee`);
