import { wirePattern, wire } from "./spec-page.js?v=20260909-0df0bcc";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-0df0bcc";
...
const geo = () => import(`../geoprocessing.js?v=20260909-0df0bcc`);
