import { wirePattern, wire } from "./spec-page.js?v=20260816-1a4e46c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-1a4e46c";
...
const geo = () => import(`../geoprocessing.js?v=20260816-1a4e46c`);
