import { wirePattern, wire } from "./spec-page.js?v=20260904-200ef9b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260904-200ef9b";
...
const geo = () => import(`../geoprocessing.js?v=20260904-200ef9b`);
