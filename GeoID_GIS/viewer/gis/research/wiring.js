import { wirePattern, wire } from "./spec-page.js?v=20260826-baed5fb";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-baed5fb";
...
const geo = () => import(`../geoprocessing.js?v=20260826-baed5fb`);
