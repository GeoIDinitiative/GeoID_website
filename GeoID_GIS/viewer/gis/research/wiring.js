import { wirePattern, wire } from "./spec-page.js?v=20260909-a2d80ee";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-a2d80ee";
...
const geo = () => import(`../geoprocessing.js?v=20260909-a2d80ee`);
