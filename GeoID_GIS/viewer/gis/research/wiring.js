import { wirePattern, wire } from "./spec-page.js?v=20260909-fc4f45f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-fc4f45f";
...
const geo = () => import(`../geoprocessing.js?v=20260909-fc4f45f`);
