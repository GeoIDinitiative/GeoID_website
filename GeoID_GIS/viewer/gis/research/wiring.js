import { wirePattern, wire } from "./spec-page.js?v=20260912-ed0502f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260912-ed0502f";
...
const geo = () => import(`../geoprocessing.js?v=20260912-ed0502f`);
