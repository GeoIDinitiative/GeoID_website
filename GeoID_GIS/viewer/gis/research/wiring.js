import { wirePattern, wire } from "./spec-page.js?v=20260827-2d7acfd";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-2d7acfd";
...
const geo = () => import(`../geoprocessing.js?v=20260827-2d7acfd`);
