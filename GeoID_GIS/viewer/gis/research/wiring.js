import { wirePattern, wire } from "./spec-page.js?v=20260904-f9b616c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260904-f9b616c";
...
const geo = () => import(`../geoprocessing.js?v=20260904-f9b616c`);
