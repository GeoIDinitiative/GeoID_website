import { wirePattern, wire } from "./spec-page.js?v=20260902-989ed19";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260902-989ed19";
...
const geo = () => import(`../geoprocessing.js?v=20260902-989ed19`);
