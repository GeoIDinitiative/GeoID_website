import { wirePattern, wire } from "./spec-page.js?v=20260826-801fa5e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-801fa5e";
...
const geo = () => import(`../geoprocessing.js?v=20260826-801fa5e`);
