import { wirePattern, wire } from "./spec-page.js?v=20260816-3abd38f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-3abd38f";
...
const geo = () => import(`../geoprocessing.js?v=20260816-3abd38f`);
