import { wirePattern, wire } from "./spec-page.js?v=20260911-07928fd";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-07928fd";
...
const geo = () => import(`../geoprocessing.js?v=20260911-07928fd`);
