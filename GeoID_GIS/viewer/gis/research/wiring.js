import { wirePattern, wire } from "./spec-page.js?v=20260828-dec00bc";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-dec00bc";
...
const geo = () => import(`../geoprocessing.js?v=20260828-dec00bc`);
