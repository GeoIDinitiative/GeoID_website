import { wirePattern, wire } from "./spec-page.js?v=20260910-8e7baef";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-8e7baef";
...
const geo = () => import(`../geoprocessing.js?v=20260910-8e7baef`);
