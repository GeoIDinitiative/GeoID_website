import { wirePattern, wire } from "./spec-page.js?v=20260829-9d6736f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-9d6736f";
...
const geo = () => import(`../geoprocessing.js?v=20260829-9d6736f`);
