import { wirePattern, wire } from "./spec-page.js?v=20260912-8103bed";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260912-8103bed";
...
const geo = () => import(`../geoprocessing.js?v=20260912-8103bed`);
