import { wirePattern, wire } from "./spec-page.js?v=20260827-4620e3d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-4620e3d";
...
const geo = () => import(`../geoprocessing.js?v=20260827-4620e3d`);
