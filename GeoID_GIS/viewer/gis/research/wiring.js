import { wirePattern, wire } from "./spec-page.js?v=20260903-bd84f74";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260903-bd84f74";
...
const geo = () => import(`../geoprocessing.js?v=20260903-bd84f74`);
