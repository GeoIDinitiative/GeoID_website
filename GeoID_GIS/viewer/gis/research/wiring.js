import { wirePattern, wire } from "./spec-page.js?v=20260829-0b5e89a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-0b5e89a";
...
const geo = () => import(`../geoprocessing.js?v=20260829-0b5e89a`);
