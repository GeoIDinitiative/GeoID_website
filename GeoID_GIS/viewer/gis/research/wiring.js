import { wirePattern, wire } from "./spec-page.js?v=20260911-0db24ca";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-0db24ca";
...
const geo = () => import(`../geoprocessing.js?v=20260911-0db24ca`);
