import { wirePattern, wire } from "./spec-page.js?v=20260901-31bd6ac";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260901-31bd6ac";
...
const geo = () => import(`../geoprocessing.js?v=20260901-31bd6ac`);
