import { wirePattern, wire } from "./spec-page.js?v=20260916-2870c0f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-2870c0f";
...
const geo = () => import(`../geoprocessing.js?v=20260916-2870c0f`);
