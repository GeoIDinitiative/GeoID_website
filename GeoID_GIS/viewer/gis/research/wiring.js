import { wirePattern, wire } from "./spec-page.js?v=20260810-3675f72";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260810-3675f72";
...
const geo = () => import(`../geoprocessing.js?v=20260810-3675f72`);
