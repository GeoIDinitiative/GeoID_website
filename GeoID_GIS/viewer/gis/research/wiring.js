import { wirePattern, wire } from "./spec-page.js?v=20260908-806509a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-806509a";
...
const geo = () => import(`../geoprocessing.js?v=20260908-806509a`);
