import { wirePattern, wire } from "./spec-page.js?v=20260904-11cd741";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260904-11cd741";
...
const geo = () => import(`../geoprocessing.js?v=20260904-11cd741`);
