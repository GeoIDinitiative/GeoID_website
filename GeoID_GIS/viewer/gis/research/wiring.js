import { wirePattern, wire } from "./spec-page.js?v=20260829-7136ef8";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-7136ef8";
...
const geo = () => import(`../geoprocessing.js?v=20260829-7136ef8`);
