import { wirePattern, wire } from "./spec-page.js?v=20260909-d6a403c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-d6a403c";
...
const geo = () => import(`../geoprocessing.js?v=20260909-d6a403c`);
