import { wirePattern, wire } from "./spec-page.js?v=20260830-262805a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-262805a";
...
const geo = () => import(`../geoprocessing.js?v=20260830-262805a`);
