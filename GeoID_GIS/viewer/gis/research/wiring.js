import { wirePattern, wire } from "./spec-page.js?v=20260821-521ca21";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260821-521ca21";
...
const geo = () => import(`../geoprocessing.js?v=20260821-521ca21`);
