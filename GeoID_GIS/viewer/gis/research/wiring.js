import { wirePattern, wire } from "./spec-page.js?v=20260829-db4ba38";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-db4ba38";
...
const geo = () => import(`../geoprocessing.js?v=20260829-db4ba38`);
