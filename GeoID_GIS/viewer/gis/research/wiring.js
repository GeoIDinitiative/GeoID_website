import { wirePattern, wire } from "./spec-page.js?v=20260905-f8b2b19";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260905-f8b2b19";
...
const geo = () => import(`../geoprocessing.js?v=20260905-f8b2b19`);
