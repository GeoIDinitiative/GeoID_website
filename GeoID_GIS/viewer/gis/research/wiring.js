import { wirePattern, wire } from "./spec-page.js?v=20260831-0eb96bf";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-0eb96bf";
...
const geo = () => import(`../geoprocessing.js?v=20260831-0eb96bf`);
