import { wirePattern, wire } from "./spec-page.js?v=20260907-746df08";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260907-746df08";
...
const geo = () => import(`../geoprocessing.js?v=20260907-746df08`);
