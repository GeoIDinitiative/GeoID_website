import { wirePattern, wire } from "./spec-page.js?v=20260903-151413f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260903-151413f";
...
const geo = () => import(`../geoprocessing.js?v=20260903-151413f`);
