import { wirePattern, wire } from "./spec-page.js?v=20260830-78b3fc0";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-78b3fc0";
...
const geo = () => import(`../geoprocessing.js?v=20260830-78b3fc0`);
