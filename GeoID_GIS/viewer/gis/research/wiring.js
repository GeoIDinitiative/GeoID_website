import { wirePattern, wire } from "./spec-page.js?v=20260831-9e9a14f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-9e9a14f";
...
const geo = () => import(`../geoprocessing.js?v=20260831-9e9a14f`);
