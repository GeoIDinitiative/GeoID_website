import { wirePattern, wire } from "./spec-page.js?v=20260830-14d2b0c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-14d2b0c";
...
const geo = () => import(`../geoprocessing.js?v=20260830-14d2b0c`);
