import { wirePattern, wire } from "./spec-page.js?v=20260908-2e1e098";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-2e1e098";
...
const geo = () => import(`../geoprocessing.js?v=20260908-2e1e098`);
