import { wirePattern, wire } from "./spec-page.js?v=20260829-a9ea5a7";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-a9ea5a7";
...
const geo = () => import(`../geoprocessing.js?v=20260829-a9ea5a7`);
