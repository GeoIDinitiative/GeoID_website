import { wirePattern, wire } from "./spec-page.js?v=20260915-3643e7a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-3643e7a";
...
const geo = () => import(`../geoprocessing.js?v=20260915-3643e7a`);
