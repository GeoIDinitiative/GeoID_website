import { wirePattern, wire } from "./spec-page.js?v=20260827-170d4fd";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-170d4fd";
...
const geo = () => import(`../geoprocessing.js?v=20260827-170d4fd`);
