import { wirePattern, wire } from "./spec-page.js?v=20260830-5e84d2d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-5e84d2d";
...
const geo = () => import(`../geoprocessing.js?v=20260830-5e84d2d`);
