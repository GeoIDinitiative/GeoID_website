import { wirePattern, wire } from "./spec-page.js?v=20260816-e6ed348";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-e6ed348";
...
const geo = () => import(`../geoprocessing.js?v=20260816-e6ed348`);
