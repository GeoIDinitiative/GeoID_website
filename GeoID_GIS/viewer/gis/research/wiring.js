import { wirePattern, wire } from "./spec-page.js?v=20260909-b06fbec";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-b06fbec";
...
const geo = () => import(`../geoprocessing.js?v=20260909-b06fbec`);
