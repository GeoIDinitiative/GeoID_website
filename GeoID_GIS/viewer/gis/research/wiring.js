import { wirePattern, wire } from "./spec-page.js?v=20260828-705b5a2";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-705b5a2";
...
const geo = () => import(`../geoprocessing.js?v=20260828-705b5a2`);
