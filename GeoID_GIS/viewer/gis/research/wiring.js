import { wirePattern, wire } from "./spec-page.js?v=20260916-24452db";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-24452db";
...
const geo = () => import(`../geoprocessing.js?v=20260916-24452db`);
