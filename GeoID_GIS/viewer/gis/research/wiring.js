import { wirePattern, wire } from "./spec-page.js?v=20260915-b1aefb2";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-b1aefb2";
...
const geo = () => import(`../geoprocessing.js?v=20260915-b1aefb2`);
