import { wirePattern, wire } from "./spec-page.js?v=20260810-60090db";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260810-60090db";
...
const geo = () => import(`../geoprocessing.js?v=20260810-60090db`);
