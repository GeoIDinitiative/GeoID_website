import { wirePattern, wire } from "./spec-page.js?v=20260822-da9d1b8";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260822-da9d1b8";
...
const geo = () => import(`../geoprocessing.js?v=20260822-da9d1b8`);
