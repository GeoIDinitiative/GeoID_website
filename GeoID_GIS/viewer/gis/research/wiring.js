import { wirePattern, wire } from "./spec-page.js?v=20260831-3fdac3b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-3fdac3b";
...
const geo = () => import(`../geoprocessing.js?v=20260831-3fdac3b`);
