import { wirePattern, wire } from "./spec-page.js?v=20260828-6e7f7fe";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-6e7f7fe";
...
const geo = () => import(`../geoprocessing.js?v=20260828-6e7f7fe`);
