import { wirePattern, wire } from "./spec-page.js?v=20260831-f70f91b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-f70f91b";
...
const geo = () => import(`../geoprocessing.js?v=20260831-f70f91b`);
