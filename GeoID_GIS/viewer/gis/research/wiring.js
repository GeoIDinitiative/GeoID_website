import { wirePattern, wire } from "./spec-page.js?v=20260808-903ae5a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260808-903ae5a";
...
const geo = () => import(`../geoprocessing.js?v=20260808-903ae5a`);
