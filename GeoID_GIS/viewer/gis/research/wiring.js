import { wirePattern, wire } from "./spec-page.js?v=20260810-2b39f6b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260810-2b39f6b";
...
const geo = () => import(`../geoprocessing.js?v=20260810-2b39f6b`);
