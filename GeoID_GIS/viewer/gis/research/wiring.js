import { wirePattern, wire } from "./spec-page.js?v=20260912-eacfbab";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260912-eacfbab";
...
const geo = () => import(`../geoprocessing.js?v=20260912-eacfbab`);
