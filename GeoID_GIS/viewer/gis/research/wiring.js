import { wirePattern, wire } from "./spec-page.js?v=20260908-2125c8a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-2125c8a";
...
const geo = () => import(`../geoprocessing.js?v=20260908-2125c8a`);
