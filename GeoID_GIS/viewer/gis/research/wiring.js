import { wirePattern, wire } from "./spec-page.js?v=20260826-422c702";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-422c702";
...
const geo = () => import(`../geoprocessing.js?v=20260826-422c702`);
