import { wirePattern, wire } from "./spec-page.js?v=20260826-df1070c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-df1070c";
...
const geo = () => import(`../geoprocessing.js?v=20260826-df1070c`);
