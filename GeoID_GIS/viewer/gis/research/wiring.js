import { wirePattern, wire } from "./spec-page.js?v=20260826-8b90f9b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-8b90f9b";
...
const geo = () => import(`../geoprocessing.js?v=20260826-8b90f9b`);
