import { wirePattern, wire } from "./spec-page.js?v=20260910-038cffc";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-038cffc";
...
const geo = () => import(`../geoprocessing.js?v=20260910-038cffc`);
