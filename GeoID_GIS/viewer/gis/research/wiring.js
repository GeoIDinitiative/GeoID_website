import { wirePattern, wire } from "./spec-page.js?v=20260827-df8fe58";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-df8fe58";
...
const geo = () => import(`../geoprocessing.js?v=20260827-df8fe58`);
