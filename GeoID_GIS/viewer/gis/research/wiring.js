import { wirePattern, wire } from "./spec-page.js?v=20260910-074cd23";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-074cd23";
...
const geo = () => import(`../geoprocessing.js?v=20260910-074cd23`);
