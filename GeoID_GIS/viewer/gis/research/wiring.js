import { wirePattern, wire } from "./spec-page.js?v=20260901-6fd0a7e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260901-6fd0a7e";
...
const geo = () => import(`../geoprocessing.js?v=20260901-6fd0a7e`);
