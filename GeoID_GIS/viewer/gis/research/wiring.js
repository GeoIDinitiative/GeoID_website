import { wirePattern, wire } from "./spec-page.js?v=20260912-472df3d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260912-472df3d";
...
const geo = () => import(`../geoprocessing.js?v=20260912-472df3d`);
