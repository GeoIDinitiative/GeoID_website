import { wirePattern, wire } from "./spec-page.js?v=20260916-cde4f6a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-cde4f6a";
...
const geo = () => import(`../geoprocessing.js?v=20260916-cde4f6a`);
