import { wirePattern, wire } from "./spec-page.js?v=20260808-2cd5a76";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260808-2cd5a76";
...
const geo = () => import(`../geoprocessing.js?v=20260808-2cd5a76`);
