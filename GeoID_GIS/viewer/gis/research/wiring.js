import { wirePattern, wire } from "./spec-page.js?v=20260830-7fe2a24";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-7fe2a24";
...
const geo = () => import(`../geoprocessing.js?v=20260830-7fe2a24`);
