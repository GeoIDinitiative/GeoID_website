import { wirePattern, wire } from "./spec-page.js?v=20260831-ef6ec85";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-ef6ec85";
...
const geo = () => import(`../geoprocessing.js?v=20260831-ef6ec85`);
