import { wirePattern, wire } from "./spec-page.js?v=20260911-231e03f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-231e03f";
...
const geo = () => import(`../geoprocessing.js?v=20260911-231e03f`);
