import { wirePattern, wire } from "./spec-page.js?v=20260910-3907c30";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-3907c30";
...
const geo = () => import(`../geoprocessing.js?v=20260910-3907c30`);
