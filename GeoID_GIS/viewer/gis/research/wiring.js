import { wirePattern, wire } from "./spec-page.js?v=20260911-bc6912f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-bc6912f";
...
const geo = () => import(`../geoprocessing.js?v=20260911-bc6912f`);
