import { wirePattern, wire } from "./spec-page.js?v=20260911-dd2e87b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-dd2e87b";
...
const geo = () => import(`../geoprocessing.js?v=20260911-dd2e87b`);
