import { wirePattern, wire } from "./spec-page.js?v=20260902-19d0d1b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260902-19d0d1b";
...
const geo = () => import(`../geoprocessing.js?v=20260902-19d0d1b`);
