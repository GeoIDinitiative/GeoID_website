import { wirePattern, wire } from "./spec-page.js?v=20260909-98d5a4e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-98d5a4e";
...
const geo = () => import(`../geoprocessing.js?v=20260909-98d5a4e`);
