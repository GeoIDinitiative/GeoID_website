import { wirePattern, wire } from "./spec-page.js?v=20260908-f3feb0d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-f3feb0d";
...
const geo = () => import(`../geoprocessing.js?v=20260908-f3feb0d`);
