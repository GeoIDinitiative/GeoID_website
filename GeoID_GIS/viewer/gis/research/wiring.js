import { wirePattern, wire } from "./spec-page.js?v=20260821-4259a79";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260821-4259a79";
...
const geo = () => import(`../geoprocessing.js?v=20260821-4259a79`);
