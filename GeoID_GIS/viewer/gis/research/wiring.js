import { wirePattern, wire } from "./spec-page.js?v=20260831-489244a";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-489244a";
...
const geo = () => import(`../geoprocessing.js?v=20260831-489244a`);
