import { wirePattern, wire } from "./spec-page.js?v=20260821-d1e8adb";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260821-d1e8adb";
...
const geo = () => import(`../geoprocessing.js?v=20260821-d1e8adb`);
