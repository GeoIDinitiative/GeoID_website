import { wirePattern, wire } from "./spec-page.js?v=20260916-eb57f4d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-eb57f4d";
...
const geo = () => import(`../geoprocessing.js?v=20260916-eb57f4d`);
