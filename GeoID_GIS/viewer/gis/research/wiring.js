import { wirePattern, wire } from "./spec-page.js?v=20260911-92409f8";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-92409f8";
...
const geo = () => import(`../geoprocessing.js?v=20260911-92409f8`);
