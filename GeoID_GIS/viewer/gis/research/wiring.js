import { wirePattern, wire } from "./spec-page.js?v=20260911-79b3dcf";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-79b3dcf";
...
const geo = () => import(`../geoprocessing.js?v=20260911-79b3dcf`);
