import { wirePattern, wire } from "./spec-page.js?v=20260915-3e86bba";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260915-3e86bba";
...
const geo = () => import(`../geoprocessing.js?v=20260915-3e86bba`);
