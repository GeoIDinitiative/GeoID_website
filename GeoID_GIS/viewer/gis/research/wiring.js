import { wirePattern, wire } from "./spec-page.js?v=20260831-609a8fc";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260831-609a8fc";
...
const geo = () => import(`../geoprocessing.js?v=20260831-609a8fc`);
