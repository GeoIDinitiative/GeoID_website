import { wirePattern, wire } from "./spec-page.js?v=20260914-7778b2c";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260914-7778b2c";
...
const geo = () => import(`../geoprocessing.js?v=20260914-7778b2c`);
