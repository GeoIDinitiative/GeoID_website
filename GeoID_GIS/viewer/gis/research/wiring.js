import { wirePattern, wire } from "./spec-page.js?v=20260827-1b4ae4e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-1b4ae4e";
...
const geo = () => import(`../geoprocessing.js?v=20260827-1b4ae4e`);
