import { wirePattern, wire } from "./spec-page.js?v=20260829-f46ef70";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-f46ef70";
...
const geo = () => import(`../geoprocessing.js?v=20260829-f46ef70`);
