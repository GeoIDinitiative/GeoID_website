import { wirePattern, wire } from "./spec-page.js?v=20260910-bd9b6b8";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-bd9b6b8";
...
const geo = () => import(`../geoprocessing.js?v=20260910-bd9b6b8`);
