import { wirePattern, wire } from "./spec-page.js?v=20260912-b8e3eef";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260912-b8e3eef";
...
const geo = () => import(`../geoprocessing.js?v=20260912-b8e3eef`);
