import { wirePattern, wire } from "./spec-page.js?v=20260902-7061b5b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260902-7061b5b";
...
const geo = () => import(`../geoprocessing.js?v=20260902-7061b5b`);
