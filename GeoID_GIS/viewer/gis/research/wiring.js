import { wirePattern, wire } from "./spec-page.js?v=20260826-4b7dfdc";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-4b7dfdc";
...
const geo = () => import(`../geoprocessing.js?v=20260826-4b7dfdc`);
