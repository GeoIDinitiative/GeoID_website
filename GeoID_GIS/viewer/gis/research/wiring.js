import { wirePattern, wire } from "./spec-page.js?v=20260905-e7d5e68";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260905-e7d5e68";
...
const geo = () => import(`../geoprocessing.js?v=20260905-e7d5e68`);
