import { wirePattern, wire } from "./spec-page.js?v=20260909-402fbee";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-402fbee";
...
const geo = () => import(`../geoprocessing.js?v=20260909-402fbee`);
