import { wirePattern, wire } from "./spec-page.js?v=20260904-8334fff";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260904-8334fff";
...
const geo = () => import(`../geoprocessing.js?v=20260904-8334fff`);
