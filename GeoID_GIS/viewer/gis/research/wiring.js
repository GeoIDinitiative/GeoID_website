import { wirePattern, wire } from "./spec-page.js?v=20260910-22915e4";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260910-22915e4";
...
const geo = () => import(`../geoprocessing.js?v=20260910-22915e4`);
