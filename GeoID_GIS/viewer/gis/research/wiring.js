import { wirePattern, wire } from "./spec-page.js?v=20260827-90bd2a2";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260827-90bd2a2";
...
const geo = () => import(`../geoprocessing.js?v=20260827-90bd2a2`);
