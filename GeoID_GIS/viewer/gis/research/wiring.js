import { wirePattern, wire } from "./spec-page.js?v=20260914-64d3a3d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260914-64d3a3d";
...
const geo = () => import(`../geoprocessing.js?v=20260914-64d3a3d`);
