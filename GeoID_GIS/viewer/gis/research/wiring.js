import { wirePattern, wire } from "./spec-page.js?v=20260903-fae9a8b";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260903-fae9a8b";
...
const geo = () => import(`../geoprocessing.js?v=20260903-fae9a8b`);
