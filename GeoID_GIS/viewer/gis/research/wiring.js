import { wirePattern, wire } from "./spec-page.js?v=20260904-7721c52";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260904-7721c52";
...
const geo = () => import(`../geoprocessing.js?v=20260904-7721c52`);
