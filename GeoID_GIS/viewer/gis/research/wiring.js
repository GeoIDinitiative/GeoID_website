import { wirePattern, wire } from "./spec-page.js?v=20260830-82104e7";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-82104e7";
...
const geo = () => import(`../geoprocessing.js?v=20260830-82104e7`);
