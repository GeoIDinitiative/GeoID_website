import { wirePattern, wire } from "./spec-page.js?v=20260830-2688cd6";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-2688cd6";
...
const geo = () => import(`../geoprocessing.js?v=20260830-2688cd6`);
