import { wirePattern, wire } from "./spec-page.js?v=20260822-e946bec";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260822-e946bec";
...
const geo = () => import(`../geoprocessing.js?v=20260822-e946bec`);
