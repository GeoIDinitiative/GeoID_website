import { wirePattern, wire } from "./spec-page.js?v=20260909-8e2ee95";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260909-8e2ee95";
...
const geo = () => import(`../geoprocessing.js?v=20260909-8e2ee95`);
