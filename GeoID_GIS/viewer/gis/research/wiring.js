import { wirePattern, wire } from "./spec-page.js?v=20260816-960ffbc";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-960ffbc";
...
const geo = () => import(`../geoprocessing.js?v=20260816-960ffbc`);
