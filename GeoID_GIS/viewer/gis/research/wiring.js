import { wirePattern, wire } from "./spec-page.js?v=20260902-0cb4e4f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260902-0cb4e4f";
...
const geo = () => import(`../geoprocessing.js?v=20260902-0cb4e4f`);
