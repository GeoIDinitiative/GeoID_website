import { wirePattern, wire } from "./spec-page.js?v=20260811-af82be9";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260811-af82be9";
...
const geo = () => import(`../geoprocessing.js?v=20260811-af82be9`);
