import { wirePattern, wire } from "./spec-page.js?v=20260919-d3176b1";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260919-d3176b1";
...
const geo = () => import(`../geoprocessing.js?v=20260919-d3176b1`);
