import { wirePattern, wire } from "./spec-page.js?v=20260919-d4689ee";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260919-d4689ee";
...
const geo = () => import(`../geoprocessing.js?v=20260919-d4689ee`);
