import { wirePattern, wire } from "./spec-page.js?v=20260903-965d9bd";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260903-965d9bd";
...
const geo = () => import(`../geoprocessing.js?v=20260903-965d9bd`);
