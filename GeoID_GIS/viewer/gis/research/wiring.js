import { wirePattern, wire } from "./spec-page.js?v=20260816-bdb55a5";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260816-bdb55a5";
...
const geo = () => import(`../geoprocessing.js?v=20260816-bdb55a5`);
