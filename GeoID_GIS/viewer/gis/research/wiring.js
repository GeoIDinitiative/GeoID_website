import { wirePattern, wire } from "./spec-page.js?v=20260829-d3cc9f6";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260829-d3cc9f6";
...
const geo = () => import(`../geoprocessing.js?v=20260829-d3cc9f6`);
