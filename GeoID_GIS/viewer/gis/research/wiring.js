import { wirePattern, wire } from "./spec-page.js?v=20260912-28305db";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260912-28305db";
...
const geo = () => import(`../geoprocessing.js?v=20260912-28305db`);
