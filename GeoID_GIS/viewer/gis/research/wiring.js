import { wirePattern, wire } from "./spec-page.js?v=20260911-eae60d5";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-eae60d5";
...
const geo = () => import(`../geoprocessing.js?v=20260911-eae60d5`);
