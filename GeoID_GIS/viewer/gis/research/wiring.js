import { wirePattern, wire } from "./spec-page.js?v=20260908-bbceb3e";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260908-bbceb3e";
...
const geo = () => import(`../geoprocessing.js?v=20260908-bbceb3e`);
