import { wirePattern, wire } from "./spec-page.js?v=20260809-95d7b49";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260809-95d7b49";
...
const geo = () => import(`../geoprocessing.js?v=20260809-95d7b49`);
