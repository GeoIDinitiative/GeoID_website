import { wirePattern, wire } from "./spec-page.js?v=20260916-dacf706";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-dacf706";
...
const geo = () => import(`../geoprocessing.js?v=20260916-dacf706`);
