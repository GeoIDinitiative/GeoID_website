import { wirePattern, wire } from "./spec-page.js?v=20260828-f00d0ce";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260828-f00d0ce";
...
const geo = () => import(`../geoprocessing.js?v=20260828-f00d0ce`);
