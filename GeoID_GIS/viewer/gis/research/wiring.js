import { wirePattern, wire } from "./spec-page.js?v=20260916-9211f8d";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260916-9211f8d";
...
const geo = () => import(`../geoprocessing.js?v=20260916-9211f8d`);
