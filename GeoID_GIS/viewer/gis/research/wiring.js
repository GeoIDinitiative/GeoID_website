import { wirePattern, wire } from "./spec-page.js?v=20260911-f4b36fe";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260911-f4b36fe";
...
const geo = () => import(`../geoprocessing.js?v=20260911-f4b36fe`);
