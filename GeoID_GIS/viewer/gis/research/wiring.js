import { wirePattern, wire } from "./spec-page.js?v=20260826-b3e16d7";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260826-b3e16d7";
...
const geo = () => import(`../geoprocessing.js?v=20260826-b3e16d7`);
