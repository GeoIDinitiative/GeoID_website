import { wirePattern, wire } from "./spec-page.js?v=20260810-564fd5f";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260810-564fd5f";
...
const geo = () => import(`../geoprocessing.js?v=20260810-564fd5f`);
