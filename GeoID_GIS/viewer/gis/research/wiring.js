import { wirePattern, wire } from "./spec-page.js?v=20260830-a91b1d2";
...
import { findTables, loadTable, saveFigure } from "./pages/common.js?v=20260830-a91b1d2";
...
const geo = () => import(`../geoprocessing.js?v=20260830-a91b1d2`);
