import { handlerFor } from "./spec-page.js?v=20260915-fdefd0f";
import * as store from "./project-store.js?v=20260915-fdefd0f";
import { el, persistentStatus } from "./pages/common.js?v=20260915-fdefd0f";
import { install as installRuntime, RUNTIME } from "./qt-runtime.js?v=20260915-fdefd0f";
