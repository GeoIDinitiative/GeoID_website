import { handlerFor } from "./spec-page.js?v=20260909-dfeba5f";
import * as store from "./project-store.js?v=20260909-dfeba5f";
import { el, persistentStatus } from "./pages/common.js?v=20260909-dfeba5f";
import { install as installRuntime, RUNTIME } from "./qt-runtime.js?v=20260909-dfeba5f";
