import * as hub from "./hub.js?v=20260828-c350daa";
import { registeredCount } from "./stages.js?v=20260828-c350daa";
...
import "./pages/dashboard.js?v=20260828-c350daa";
...
import "./pages/workspace.js?v=20260828-c350daa";
import "./pages/projects.js?v=20260828-c350daa";
import "./pages/repository.js?v=20260828-c350daa";
import "./pages/notes.js?v=20260828-c350daa";
import "./pages/plotter.js?v=20260828-c350daa";
import "./pages/signal.js?v=20260828-c350daa";
import "./pages/fem.js?v=20260828-c350daa";
import "./pages/storyboard.js?v=20260828-c350daa";
import "./pages/docs.js?v=20260828-c350daa";
import "./pages/builder.js?v=20260828-c350daa";
import "./pages/notebook.js?v=20260828-c350daa";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260828-c350daa";
...
import "./wiring.js?v=20260828-c350daa";
import "./wiring-pages.js?v=20260828-c350daa";
import "./wiring-final.js?v=20260828-c350daa";
import "./pages/ingest.js?v=20260828-c350daa";
import "./pages/postprocess.js?v=20260828-c350daa";
import "./pages/prepare.js?v=20260828-c350daa";
import "./pages/analysis.js?v=20260828-c350daa";
import "./pages/manage.js?v=20260828-c350daa";
import "./pages/workbench.js?v=20260828-c350daa";
