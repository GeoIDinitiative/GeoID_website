import * as hub from "./hub.js?v=20260903-d94308a";
import { registeredCount } from "./stages.js?v=20260903-d94308a";
...
import "./pages/dashboard.js?v=20260903-d94308a";
...
import "./pages/workspace.js?v=20260903-d94308a";
import "./pages/projects.js?v=20260903-d94308a";
import "./pages/repository.js?v=20260903-d94308a";
import "./pages/notes.js?v=20260903-d94308a";
import "./pages/plotter.js?v=20260903-d94308a";
import "./pages/signal.js?v=20260903-d94308a";
import "./pages/fem.js?v=20260903-d94308a";
import "./pages/storyboard.js?v=20260903-d94308a";
import "./pages/docs.js?v=20260903-d94308a";
import "./pages/builder.js?v=20260903-d94308a";
import "./pages/notebook.js?v=20260903-d94308a";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260903-d94308a";
...
import "./wiring.js?v=20260903-d94308a";
import "./wiring-pages.js?v=20260903-d94308a";
import "./wiring-final.js?v=20260903-d94308a";
import "./pages/ingest.js?v=20260903-d94308a";
import "./pages/postprocess.js?v=20260903-d94308a";
import "./pages/prepare.js?v=20260903-d94308a";
import "./pages/analysis.js?v=20260903-d94308a";
import "./pages/manage.js?v=20260903-d94308a";
import "./pages/workbench.js?v=20260903-d94308a";
