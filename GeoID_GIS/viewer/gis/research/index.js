import * as hub from "./hub.js?v=20260828-f00d0ce";
import { registeredCount } from "./stages.js?v=20260828-f00d0ce";
...
import "./pages/dashboard.js?v=20260828-f00d0ce";
...
import "./pages/workspace.js?v=20260828-f00d0ce";
import "./pages/projects.js?v=20260828-f00d0ce";
import "./pages/repository.js?v=20260828-f00d0ce";
import "./pages/notes.js?v=20260828-f00d0ce";
import "./pages/plotter.js?v=20260828-f00d0ce";
import "./pages/signal.js?v=20260828-f00d0ce";
import "./pages/fem.js?v=20260828-f00d0ce";
import "./pages/storyboard.js?v=20260828-f00d0ce";
import "./pages/docs.js?v=20260828-f00d0ce";
import "./pages/builder.js?v=20260828-f00d0ce";
import "./pages/notebook.js?v=20260828-f00d0ce";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260828-f00d0ce";
...
import "./wiring.js?v=20260828-f00d0ce";
import "./wiring-pages.js?v=20260828-f00d0ce";
import "./wiring-final.js?v=20260828-f00d0ce";
import "./pages/ingest.js?v=20260828-f00d0ce";
import "./pages/postprocess.js?v=20260828-f00d0ce";
import "./pages/prepare.js?v=20260828-f00d0ce";
import "./pages/analysis.js?v=20260828-f00d0ce";
import "./pages/manage.js?v=20260828-f00d0ce";
import "./pages/workbench.js?v=20260828-f00d0ce";
