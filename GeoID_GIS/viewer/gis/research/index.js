import * as hub from "./hub.js?v=20260830-97628ed";
import { registeredCount } from "./stages.js?v=20260830-97628ed";
...
import "./pages/dashboard.js?v=20260830-97628ed";
...
import "./pages/workspace.js?v=20260830-97628ed";
import "./pages/projects.js?v=20260830-97628ed";
import "./pages/repository.js?v=20260830-97628ed";
import "./pages/notes.js?v=20260830-97628ed";
import "./pages/plotter.js?v=20260830-97628ed";
import "./pages/signal.js?v=20260830-97628ed";
import "./pages/fem.js?v=20260830-97628ed";
import "./pages/storyboard.js?v=20260830-97628ed";
import "./pages/docs.js?v=20260830-97628ed";
import "./pages/builder.js?v=20260830-97628ed";
import "./pages/notebook.js?v=20260830-97628ed";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260830-97628ed";
...
import "./wiring.js?v=20260830-97628ed";
import "./wiring-pages.js?v=20260830-97628ed";
import "./wiring-final.js?v=20260830-97628ed";
import "./pages/ingest.js?v=20260830-97628ed";
import "./pages/postprocess.js?v=20260830-97628ed";
import "./pages/prepare.js?v=20260830-97628ed";
import "./pages/analysis.js?v=20260830-97628ed";
import "./pages/manage.js?v=20260830-97628ed";
import "./pages/workbench.js?v=20260830-97628ed";
