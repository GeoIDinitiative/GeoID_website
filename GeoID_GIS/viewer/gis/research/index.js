import * as hub from "./hub.js?v=20260916-2dc072a";
import { registeredCount } from "./stages.js?v=20260916-2dc072a";
...
import "./pages/dashboard.js?v=20260916-2dc072a";
...
import "./pages/workspace.js?v=20260916-2dc072a";
import "./pages/projects.js?v=20260916-2dc072a";
import "./pages/repository.js?v=20260916-2dc072a";
import "./pages/notes.js?v=20260916-2dc072a";
import "./pages/plotter.js?v=20260916-2dc072a";
import "./pages/signal.js?v=20260916-2dc072a";
import "./pages/fem.js?v=20260916-2dc072a";
import "./pages/storyboard.js?v=20260916-2dc072a";
import "./pages/docs.js?v=20260916-2dc072a";
import "./pages/builder.js?v=20260916-2dc072a";
import "./pages/notebook.js?v=20260916-2dc072a";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260916-2dc072a";
...
import "./wiring.js?v=20260916-2dc072a";
import "./wiring-pages.js?v=20260916-2dc072a";
import "./wiring-final.js?v=20260916-2dc072a";
import "./pages/ingest.js?v=20260916-2dc072a";
import "./pages/postprocess.js?v=20260916-2dc072a";
import "./pages/prepare.js?v=20260916-2dc072a";
import "./pages/analysis.js?v=20260916-2dc072a";
import "./pages/manage.js?v=20260916-2dc072a";
import "./pages/workbench.js?v=20260916-2dc072a";
