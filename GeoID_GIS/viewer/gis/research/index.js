import * as hub from "./hub.js?v=20260827-2d7acfd";
import { registeredCount } from "./stages.js?v=20260827-2d7acfd";
...
import "./pages/dashboard.js?v=20260827-2d7acfd";
...
import "./pages/workspace.js?v=20260827-2d7acfd";
import "./pages/projects.js?v=20260827-2d7acfd";
import "./pages/repository.js?v=20260827-2d7acfd";
import "./pages/notes.js?v=20260827-2d7acfd";
import "./pages/plotter.js?v=20260827-2d7acfd";
import "./pages/signal.js?v=20260827-2d7acfd";
import "./pages/fem.js?v=20260827-2d7acfd";
import "./pages/storyboard.js?v=20260827-2d7acfd";
import "./pages/docs.js?v=20260827-2d7acfd";
import "./pages/builder.js?v=20260827-2d7acfd";
import "./pages/notebook.js?v=20260827-2d7acfd";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260827-2d7acfd";
...
import "./wiring.js?v=20260827-2d7acfd";
import "./wiring-pages.js?v=20260827-2d7acfd";
import "./wiring-final.js?v=20260827-2d7acfd";
import "./pages/ingest.js?v=20260827-2d7acfd";
import "./pages/postprocess.js?v=20260827-2d7acfd";
import "./pages/prepare.js?v=20260827-2d7acfd";
import "./pages/analysis.js?v=20260827-2d7acfd";
import "./pages/manage.js?v=20260827-2d7acfd";
import "./pages/workbench.js?v=20260827-2d7acfd";
