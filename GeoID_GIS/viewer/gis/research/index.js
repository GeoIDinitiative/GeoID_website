import * as hub from "./hub.js?v=20260827-d4c59fb";
import { registeredCount } from "./stages.js?v=20260827-d4c59fb";
...
import "./pages/dashboard.js?v=20260827-d4c59fb";
...
import "./pages/workspace.js?v=20260827-d4c59fb";
import "./pages/projects.js?v=20260827-d4c59fb";
import "./pages/repository.js?v=20260827-d4c59fb";
import "./pages/notes.js?v=20260827-d4c59fb";
import "./pages/plotter.js?v=20260827-d4c59fb";
import "./pages/signal.js?v=20260827-d4c59fb";
import "./pages/fem.js?v=20260827-d4c59fb";
import "./pages/storyboard.js?v=20260827-d4c59fb";
import "./pages/docs.js?v=20260827-d4c59fb";
import "./pages/builder.js?v=20260827-d4c59fb";
import "./pages/notebook.js?v=20260827-d4c59fb";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260827-d4c59fb";
...
import "./wiring.js?v=20260827-d4c59fb";
import "./wiring-pages.js?v=20260827-d4c59fb";
import "./wiring-final.js?v=20260827-d4c59fb";
import "./pages/ingest.js?v=20260827-d4c59fb";
import "./pages/postprocess.js?v=20260827-d4c59fb";
import "./pages/prepare.js?v=20260827-d4c59fb";
import "./pages/analysis.js?v=20260827-d4c59fb";
import "./pages/manage.js?v=20260827-d4c59fb";
import "./pages/workbench.js?v=20260827-d4c59fb";
