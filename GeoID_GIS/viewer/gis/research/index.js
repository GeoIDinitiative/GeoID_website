import * as hub from "./hub.js?v=20260827-80c964b";
import { registeredCount } from "./stages.js?v=20260827-80c964b";
...
import "./pages/dashboard.js?v=20260827-80c964b";
...
import "./pages/workspace.js?v=20260827-80c964b";
import "./pages/projects.js?v=20260827-80c964b";
import "./pages/repository.js?v=20260827-80c964b";
import "./pages/notes.js?v=20260827-80c964b";
import "./pages/plotter.js?v=20260827-80c964b";
import "./pages/signal.js?v=20260827-80c964b";
import "./pages/fem.js?v=20260827-80c964b";
import "./pages/storyboard.js?v=20260827-80c964b";
import "./pages/docs.js?v=20260827-80c964b";
import "./pages/builder.js?v=20260827-80c964b";
import "./pages/notebook.js?v=20260827-80c964b";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260827-80c964b";
...
import "./wiring.js?v=20260827-80c964b";
import "./wiring-pages.js?v=20260827-80c964b";
import "./wiring-final.js?v=20260827-80c964b";
import "./pages/ingest.js?v=20260827-80c964b";
import "./pages/postprocess.js?v=20260827-80c964b";
import "./pages/prepare.js?v=20260827-80c964b";
import "./pages/analysis.js?v=20260827-80c964b";
import "./pages/manage.js?v=20260827-80c964b";
import "./pages/workbench.js?v=20260827-80c964b";
