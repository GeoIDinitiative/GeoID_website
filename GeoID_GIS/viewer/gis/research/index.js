import * as hub from "./hub.js?v=20260826-cd9ecce";
import { registeredCount } from "./stages.js?v=20260826-cd9ecce";
...
import "./pages/dashboard.js?v=20260826-cd9ecce";
...
import "./pages/workspace.js?v=20260826-cd9ecce";
import "./pages/projects.js?v=20260826-cd9ecce";
import "./pages/repository.js?v=20260826-cd9ecce";
import "./pages/notes.js?v=20260826-cd9ecce";
import "./pages/plotter.js?v=20260826-cd9ecce";
import "./pages/signal.js?v=20260826-cd9ecce";
import "./pages/fem.js?v=20260826-cd9ecce";
import "./pages/storyboard.js?v=20260826-cd9ecce";
import "./pages/docs.js?v=20260826-cd9ecce";
import "./pages/builder.js?v=20260826-cd9ecce";
import "./pages/notebook.js?v=20260826-cd9ecce";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260826-cd9ecce";
...
import "./wiring.js?v=20260826-cd9ecce";
import "./wiring-pages.js?v=20260826-cd9ecce";
import "./wiring-final.js?v=20260826-cd9ecce";
import "./pages/ingest.js?v=20260826-cd9ecce";
import "./pages/postprocess.js?v=20260826-cd9ecce";
import "./pages/prepare.js?v=20260826-cd9ecce";
import "./pages/analysis.js?v=20260826-cd9ecce";
import "./pages/manage.js?v=20260826-cd9ecce";
import "./pages/workbench.js?v=20260826-cd9ecce";
