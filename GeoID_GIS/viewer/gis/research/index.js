import * as hub from "./hub.js?v=20260910-4df45fd";
import { registeredCount } from "./stages.js?v=20260910-4df45fd";
...
import "./pages/dashboard.js?v=20260910-4df45fd";
...
import "./pages/workspace.js?v=20260910-4df45fd";
import "./pages/projects.js?v=20260910-4df45fd";
import "./pages/repository.js?v=20260910-4df45fd";
import "./pages/notes.js?v=20260910-4df45fd";
import "./pages/plotter.js?v=20260910-4df45fd";
import "./pages/signal.js?v=20260910-4df45fd";
import "./pages/fem.js?v=20260910-4df45fd";
import "./pages/storyboard.js?v=20260910-4df45fd";
import "./pages/docs.js?v=20260910-4df45fd";
import "./pages/builder.js?v=20260910-4df45fd";
import "./pages/notebook.js?v=20260910-4df45fd";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260910-4df45fd";
...
import "./wiring.js?v=20260910-4df45fd";
import "./wiring-pages.js?v=20260910-4df45fd";
import "./wiring-final.js?v=20260910-4df45fd";
import "./pages/ingest.js?v=20260910-4df45fd";
import "./pages/postprocess.js?v=20260910-4df45fd";
import "./pages/prepare.js?v=20260910-4df45fd";
import "./pages/analysis.js?v=20260910-4df45fd";
import "./pages/manage.js?v=20260910-4df45fd";
import "./pages/workbench.js?v=20260910-4df45fd";
