import * as hub from "./hub.js?v=20260919-14763da";
import { openDrawer } from "./drawers.js?v=20260919-14763da";
import { registeredCount } from "./stages.js?v=20260919-14763da";
...
import "./pages/dashboard.js?v=20260919-14763da";
...
import "./pages/workspace.js?v=20260919-14763da";
import "./pages/projects.js?v=20260919-14763da";
import "./pages/repository.js?v=20260919-14763da";
import "./pages/notes.js?v=20260919-14763da";
import "./pages/plotter.js?v=20260919-14763da";
import "./pages/signal.js?v=20260919-14763da";
import "./pages/fem.js?v=20260919-14763da";
import "./pages/storyboard.js?v=20260919-14763da";
import "./pages/docs.js?v=20260919-14763da";
import "./pages/builder.js?v=20260919-14763da";
import "./pages/notebook.js?v=20260919-14763da";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260919-14763da";
...
import "./wiring.js?v=20260919-14763da";
import "./wiring-pages.js?v=20260919-14763da";
import "./wiring-final.js?v=20260919-14763da";
import "./pages/ingest.js?v=20260919-14763da";
import "./pages/postprocess.js?v=20260919-14763da";
import "./pages/prepare.js?v=20260919-14763da";
import "./pages/analysis.js?v=20260919-14763da";
import "./pages/manage.js?v=20260919-14763da";
import "./pages/workbench.js?v=20260919-14763da";
