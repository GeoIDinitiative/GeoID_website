import * as hub from "./hub.js?v=20260912-b8e3eef";
import { registeredCount } from "./stages.js?v=20260912-b8e3eef";
...
import "./pages/dashboard.js?v=20260912-b8e3eef";
...
import "./pages/workspace.js?v=20260912-b8e3eef";
import "./pages/projects.js?v=20260912-b8e3eef";
import "./pages/repository.js?v=20260912-b8e3eef";
import "./pages/notes.js?v=20260912-b8e3eef";
import "./pages/plotter.js?v=20260912-b8e3eef";
import "./pages/signal.js?v=20260912-b8e3eef";
import "./pages/fem.js?v=20260912-b8e3eef";
import "./pages/storyboard.js?v=20260912-b8e3eef";
import "./pages/docs.js?v=20260912-b8e3eef";
import "./pages/builder.js?v=20260912-b8e3eef";
import "./pages/notebook.js?v=20260912-b8e3eef";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260912-b8e3eef";
...
import "./wiring.js?v=20260912-b8e3eef";
import "./wiring-pages.js?v=20260912-b8e3eef";
import "./wiring-final.js?v=20260912-b8e3eef";
import "./pages/ingest.js?v=20260912-b8e3eef";
import "./pages/postprocess.js?v=20260912-b8e3eef";
import "./pages/prepare.js?v=20260912-b8e3eef";
import "./pages/analysis.js?v=20260912-b8e3eef";
import "./pages/manage.js?v=20260912-b8e3eef";
import "./pages/workbench.js?v=20260912-b8e3eef";
