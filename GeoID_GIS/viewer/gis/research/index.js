import * as hub from "./hub.js?v=20260925-ef2f43e";
import { openDrawer } from "./drawers.js?v=20260925-ef2f43e";
import { registeredCount } from "./stages.js?v=20260925-ef2f43e";
...
import "./pages/dashboard.js?v=20260925-ef2f43e";
...
import "./pages/workspace.js?v=20260925-ef2f43e";
import "./pages/projects.js?v=20260925-ef2f43e";
import "./pages/repository.js?v=20260925-ef2f43e";
import "./pages/notes.js?v=20260925-ef2f43e";
import "./pages/plotter.js?v=20260925-ef2f43e";
import "./pages/signal.js?v=20260925-ef2f43e";
import "./pages/fem.js?v=20260925-ef2f43e";
import "./pages/storyboard.js?v=20260925-ef2f43e";
import "./pages/docs.js?v=20260925-ef2f43e";
import "./pages/builder.js?v=20260925-ef2f43e";
import "./pages/notebook.js?v=20260925-ef2f43e";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260925-ef2f43e";
...
import "./wiring.js?v=20260925-ef2f43e";
import "./wiring-pages.js?v=20260925-ef2f43e";
import "./wiring-final.js?v=20260925-ef2f43e";
import "./pages/ingest.js?v=20260925-ef2f43e";
import "./pages/postprocess.js?v=20260925-ef2f43e";
import "./pages/prepare.js?v=20260925-ef2f43e";
import "./pages/analysis.js?v=20260925-ef2f43e";
import "./pages/manage.js?v=20260925-ef2f43e";
import "./pages/workbench.js?v=20260925-ef2f43e";
...
window.GeoIDResearch = {
  ...
  sidecar,
  setPage: hub.setPage,
  // The drawers, for a page that offers a door to one -- Settings opens the
  // Atlas panel this way now that the shell row is a rail of four.
  openDrawer: (name) => openDrawer(name, { store, bridge, sidecar }),
