import * as hub from "./hub.js?v=20260830-d644fbd";
import { registeredCount } from "./stages.js?v=20260830-d644fbd";
...
import "./pages/dashboard.js?v=20260830-d644fbd";
...
import "./pages/workspace.js?v=20260830-d644fbd";
import "./pages/projects.js?v=20260830-d644fbd";
import "./pages/repository.js?v=20260830-d644fbd";
import "./pages/notes.js?v=20260830-d644fbd";
import "./pages/plotter.js?v=20260830-d644fbd";
import "./pages/signal.js?v=20260830-d644fbd";
import "./pages/fem.js?v=20260830-d644fbd";
import "./pages/storyboard.js?v=20260830-d644fbd";
import "./pages/docs.js?v=20260830-d644fbd";
import "./pages/builder.js?v=20260830-d644fbd";
import "./pages/notebook.js?v=20260830-d644fbd";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260830-d644fbd";
...
import "./wiring.js?v=20260830-d644fbd";
import "./wiring-pages.js?v=20260830-d644fbd";
import "./wiring-final.js?v=20260830-d644fbd";
import "./pages/ingest.js?v=20260830-d644fbd";
import "./pages/postprocess.js?v=20260830-d644fbd";
import "./pages/prepare.js?v=20260830-d644fbd";
import "./pages/analysis.js?v=20260830-d644fbd";
import "./pages/manage.js?v=20260830-d644fbd";
import "./pages/workbench.js?v=20260830-d644fbd";
