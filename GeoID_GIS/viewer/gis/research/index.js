import * as hub from "./hub.js?v=20260912-136b2bf";
import { registeredCount } from "./stages.js?v=20260912-136b2bf";
...
import "./pages/dashboard.js?v=20260912-136b2bf";
...
import "./pages/workspace.js?v=20260912-136b2bf";
import "./pages/projects.js?v=20260912-136b2bf";
import "./pages/repository.js?v=20260912-136b2bf";
import "./pages/notes.js?v=20260912-136b2bf";
import "./pages/plotter.js?v=20260912-136b2bf";
import "./pages/signal.js?v=20260912-136b2bf";
import "./pages/fem.js?v=20260912-136b2bf";
import "./pages/storyboard.js?v=20260912-136b2bf";
import "./pages/docs.js?v=20260912-136b2bf";
import "./pages/builder.js?v=20260912-136b2bf";
import "./pages/notebook.js?v=20260912-136b2bf";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260912-136b2bf";
...
import "./wiring.js?v=20260912-136b2bf";
import "./wiring-pages.js?v=20260912-136b2bf";
import "./wiring-final.js?v=20260912-136b2bf";
import "./pages/ingest.js?v=20260912-136b2bf";
import "./pages/postprocess.js?v=20260912-136b2bf";
import "./pages/prepare.js?v=20260912-136b2bf";
import "./pages/analysis.js?v=20260912-136b2bf";
import "./pages/manage.js?v=20260912-136b2bf";
import "./pages/workbench.js?v=20260912-136b2bf";
