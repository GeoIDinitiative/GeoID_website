import * as hub from "./hub.js?v=20260817-b9230ec";
import { registeredCount } from "./stages.js?v=20260817-b9230ec";
...
import "./pages/dashboard.js?v=20260817-b9230ec";
...
import "./pages/workspace.js?v=20260817-b9230ec";
import "./pages/projects.js?v=20260817-b9230ec";
import "./pages/repository.js?v=20260817-b9230ec";
import "./pages/notes.js?v=20260817-b9230ec";
import "./pages/plotter.js?v=20260817-b9230ec";
import "./pages/signal.js?v=20260817-b9230ec";
import "./pages/fem.js?v=20260817-b9230ec";
import "./pages/storyboard.js?v=20260817-b9230ec";
import "./pages/docs.js?v=20260817-b9230ec";
import "./pages/builder.js?v=20260817-b9230ec";
import "./pages/notebook.js?v=20260817-b9230ec";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260817-b9230ec";
...
import "./wiring.js?v=20260817-b9230ec";
import "./wiring-pages.js?v=20260817-b9230ec";
import "./wiring-final.js?v=20260817-b9230ec";
import "./pages/ingest.js?v=20260817-b9230ec";
import "./pages/postprocess.js?v=20260817-b9230ec";
import "./pages/prepare.js?v=20260817-b9230ec";
import "./pages/analysis.js?v=20260817-b9230ec";
import "./pages/manage.js?v=20260817-b9230ec";
import "./pages/workbench.js?v=20260817-b9230ec";
