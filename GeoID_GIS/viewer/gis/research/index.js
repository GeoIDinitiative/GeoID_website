import * as hub from "./hub.js?v=20260829-e48729d";
import { registeredCount } from "./stages.js?v=20260829-e48729d";
...
import "./pages/dashboard.js?v=20260829-e48729d";
...
import "./pages/workspace.js?v=20260829-e48729d";
import "./pages/projects.js?v=20260829-e48729d";
import "./pages/repository.js?v=20260829-e48729d";
import "./pages/notes.js?v=20260829-e48729d";
import "./pages/plotter.js?v=20260829-e48729d";
import "./pages/signal.js?v=20260829-e48729d";
import "./pages/fem.js?v=20260829-e48729d";
import "./pages/storyboard.js?v=20260829-e48729d";
import "./pages/docs.js?v=20260829-e48729d";
import "./pages/builder.js?v=20260829-e48729d";
import "./pages/notebook.js?v=20260829-e48729d";

// Imported last on purpose: it wraps whatever each page already does.
import { completeAllPages } from "./spec-page.js?v=20260829-e48729d";
...
import "./wiring.js?v=20260829-e48729d";
import "./wiring-pages.js?v=20260829-e48729d";
import "./wiring-final.js?v=20260829-e48729d";
import "./pages/ingest.js?v=20260829-e48729d";
import "./pages/postprocess.js?v=20260829-e48729d";
import "./pages/prepare.js?v=20260829-e48729d";
import "./pages/analysis.js?v=20260829-e48729d";
import "./pages/manage.js?v=20260829-e48729d";
import "./pages/workbench.js?v=20260829-e48729d";
