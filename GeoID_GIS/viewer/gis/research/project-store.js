import { directoryAdapter, memoryAdapter, indexedDbAdapter } from "./fs-adapter.js?v=20260920-724172f";
import { currentBodyId, getBody } from "../bodies.js?v=20260920-724172f";
import { saveRootHandle, loadRootHandle, clearRootHandle } from "./handles.js?v=20260920-724172f";
