import { directoryAdapter, memoryAdapter } from "./fs-adapter.js?v=20260810h";
import { currentBodyId } from "../bodies.js?v=20260810h";
import { saveRootHandle, loadRootHandle, clearRootHandle } from "./handles.js?v=20260810h";
