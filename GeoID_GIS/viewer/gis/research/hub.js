import { STAGES, getPage, stageOf } from "./stages.js?v=20260909-dfeba5f";
import { openDrawer, closeDrawer, currentDrawer } from "./drawers.js?v=20260909-dfeba5f";
import { PAGE_BLURBS } from "./page-blurbs.js?v=20260909-dfeba5f";
import * as sidecar from "./sidecar.js?v=20260909-dfeba5f";
