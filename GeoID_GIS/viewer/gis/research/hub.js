import { STAGES, getPage, stageOf } from "./stages.js?v=20260915-e0420cc";
import { openDrawer, closeDrawer, currentDrawer } from "./drawers.js?v=20260915-e0420cc";
import { PAGE_BLURBS } from "./page-blurbs.js?v=20260915-e0420cc";
import * as sidecar from "./sidecar.js?v=20260915-e0420cc";
import * as store from "./project-store.js?v=20260915-e0420cc";
import { install as installDocWindows } from "./gdoc-windows.js?v=20260915-e0420cc";
